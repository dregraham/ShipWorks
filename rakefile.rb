...
Albacore.configure do |config|
	...
	config.msbuild do |msbuild|
		...
		unless File.exists? msbuild.command
			msbuild.command = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/MSBuild/Current/Bin/MSBuild.exe"
		end
...
@revisionFilePath = "\\\\intdev1201\\NetworkShare\\DevShare\\BuildConfig\\NextRevision.txt"
