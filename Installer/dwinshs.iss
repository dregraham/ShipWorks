...
// =====================================================================================================================
//    $Rev: 125 $  $Id: dwinshs.iss 125 2017-01-01 14:18:00Z hanjy $
// =====================================================================================================================
...
#ifdef UNICODE
  #define BIG_INT "Int64"
#else
  #define BIG_INT "LongInt"
#endif
...
type
  ...
  TOnRead = function(URL, Agent: String; Method: TReadMethod; Index, TotalSize, ReadSize, CurrentSize: {#BIG_INT};
    var ReadStr: String): Boolean;

procedure ParseURL(URL: String; var Scheme: TReadScheme; var Host, Path, Data, Username, Password: String;
  var Port: Integer);
var
  i: Integer;
begin
...
procedure DwinsHs_SetProxy(Mode: TProxyMode; Protocol: TProxyProtocol; Host: String; Port: Integer;
...
function CreateConnect(URL, Agent: String; Method: TReadMethod; var hSession, hConnect, hRequest: HINTERNET;
  var Size: {#BIG_INT}): Integer;
var
  Scheme: TReadScheme;
  ProxyProtocolName, Host, Path, Data, Username, Password: String;
  Port, i: Integer;
  Buffer: String;
  Flag, Bytes: DWord;
  Sended: Boolean;
...
begin
  ...
  case Scheme of
    ...
    begin
      ...
      #ifdef UNICODE
      SizeL := FtpGetFileSize(hRequest, SizeH);
      Size := (SizeH shl 32) or SizeL;
      #else
...
function DwinsHs_GetRemoteSize(URL, Agent: String; Method: TReadMethod): {#BIG_INT};
var
...
function DwinsHs_ReadRemoteURL(URL, Agent: String; Method: TReadMethod; var Response: String;
  var Size: {#BIG_INT}; SaveFilename: string; OnRead: TOnRead): Integer;
var
  hSession, hConnect, hRequest: HINTERNET;
  Buffer, ReadStr: String;
  ToContinue: Boolean;
  Bytes: DWORD;
  Readed, Index: {#BIG_INT};
begin
...
var
  Scheme: TReadScheme;
  SchemeTxt, Host, Path, Username, Password, Data: String;
  Port: Integer;
begin
  ParseURL(URL, Scheme, Host, Path, Data, Username, Password, Port);
  case Scheme of
...
function FormatSize(Size: {#BIG_INT}): string;
begin
  if Size < 1024 then
...
type
  TDownloadWizardDefine = record
    ...
    BeginTime: LongInt;
    AllFilesSize, DownloadedSize: {#BIG_INT};
...
function UpdateDownloadingPage(URL, Agent: String; Method: TReadMethod; Index, TotalSize, ReadSize,
...
procedure DwinsHs_AppendRemoteFile(Filename: string; URL, Agent: String; Method: TReadMethod; FileSize: {#BIG_INT});
var
  i, c: Integer;
  Finded: Boolean;
begin
...
procedure DwinsHs_AppendMirrorFile(Filename: string; URL, Agent: String; Method: TReadMethod);
var
  i, c: Integer;
  Finded: Boolean;
begin
...
function FindMirror(Filename: string; var URL, Agent: String; var Method: TReadMethod;
...
function DwinsHs_ResetRemoteFile(Filename: string; FileSize: {#BIG_INT}): Boolean;
var
  i: Integer;
begin
  Filename := Trim(Filename);
...
begin
  ...
  #ifdef UNICODE
  DwinsHs_AppendRemoteFile(Filename, URL, Agent, MethodValue, FileSize + FileSizeHigh * 2147483648);
  #else
...
var
  CurURL, CurAgent: String;
  CurMethod: TReadMethod;
  CurDownloadedSize: {#BIG_INT};
  Response: String;
  CurrentSize, Size: {#BIG_INT};
