...
"C:\Program Files (x86)\Inno Setup 5\ISCC.EXE" ..\Installer\ShipWorks.iss /O"..\Artifacts\Distribute" /F"ShipWorksSetup_Test" /DEditionType=Standard /DVersion=0.0.0.0 /DAppArtifacts="..\Artifacts\Application" /DRequiredSchemaID=12345
