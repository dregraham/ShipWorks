...
namespace ShipWorks.Tests.Shipping.ScanForms
{
	...
	public class ScanFormUtilityTest
	{
		...
		public ScanFormUtilityTest()
		{
			...
			ScanForm sampleForm = new ScanForm(carrierAccount.Object, 123, 1000, string.Empty, DateTime.Parse("10/26/2012 3:30 PM", new CultureInfo("en-US")));
			...
			{
				CreatedDate = DateTime.Parse("10/26/2012 3:30 PM", new CultureInfo("en-US"))
			};
