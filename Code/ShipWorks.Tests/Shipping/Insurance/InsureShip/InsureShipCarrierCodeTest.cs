...
namespace ShipWorks.Tests.Shipping.Insurance.InsureShip
{
    public class InsureShipCarrierCodeTest : IDisposable
    {
        ...
        [InlineData(FedExServiceType.FedExFreightEconomy, "FEDEX")]
        [InlineData(FedExServiceType.FedExFreightPriority, "FEDEX")]
        ...
        [InlineData(FedExServiceType.FedExFreightEconomy, "FEDEX-I")]
        [InlineData(FedExServiceType.FedExFreightPriority, "FEDEX-I")]
