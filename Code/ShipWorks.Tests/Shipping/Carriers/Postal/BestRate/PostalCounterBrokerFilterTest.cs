...
namespace ShipWorks.Tests.Shipping.Carriers.Postal.BestRate
{
    ...
    public class PostalCounterBrokerFilterTest
    {
        ...
        {
            var testBroker1 = new StampsCounterRatesBroker(new Mock<ICarrierAccountRepository<UspsAccountEntity>>().Object);
            var testBroker2 = new StampsCounterRatesBroker(new Mock<ICarrierAccountRepository<UspsAccountEntity>>().Object);
            var brokers = new List<IBestRateShippingBroker> { testBroker1, testBroker2 };
