    ...
    public class Express1CreditCardPaymentValidatorTest
    {
        ...
        public void Initialize()
        {
            ...
            paymentInfo = new Express1PaymentInfo(Express1PaymentType.CreditCard)
                {
                    CcAccountNumber = "41111111111111111",
                    CcCvn = 411,
                    CcExpirationDate = DateTime.Now.AddMonths(5),
                    CcType = Express1CreditCardType.Visa,
                    CcBillingAddress = billingAddress,
        ...
        {
            paymentInfo.CcBillingAddress = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressFirstNameIsInvalid_Test()
        {
            ...
            // FirstName is null
            paymentInfo.CcBillingAddress.FirstName = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            // FirstName is blank
            paymentInfo.CcBillingAddress.FirstName = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressLastNameIsInvalid_Test()
        {
            ...
            // LastName is null
            paymentInfo.CcBillingAddress.LastName = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            // LastName is blank
            paymentInfo.CcBillingAddress.LastName = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressCityIsInvalid_Test()
        {
            ...
            // City is null
            paymentInfo.CcBillingAddress.City = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            // City is blank
            paymentInfo.CcBillingAddress.City = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressCountryCodeIsInvalid_Test()
        {
            ...
            // CountryCode is null
            paymentInfo.CcBillingAddress.CountryCode = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            paymentInfo.CcBillingAddress.CountryCode = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressPostalCodeIsInvalid_Test()
        {
            ...
            // PostalCode is null
            paymentInfo.CcBillingAddress.PostalCode = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            // PostalCode is blank
            paymentInfo.CcBillingAddress.PostalCode = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressStateProvCodeIsInvalid_Test()
        {
            ...
            paymentInfo.CcBillingAddress.StateProvCode = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            paymentInfo.CcBillingAddress.StateProvCode = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenBillingAddressStreet1IsInvalid_Test()
        {
            ...
            // Street1 is null
            paymentInfo.CcBillingAddress.Street1 = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
            ...
            // Street1 is blank
            paymentInfo.CcBillingAddress.Street1 = "";
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenCardAccountNumberIsInvalid_Test()
        {
            ...
            paymentInfo.CcAccountNumber = null;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
        ...
        public void ValidatePaymentInfo_ReturnsError_WhenCardExpirationDateIsInvalid_Test()
        {
            ...
            paymentInfo.CcExpirationDate = DateTime.MinValue;
            testObject = new Express1CreditCardPaymentValidator(paymentInfo);
