...
namespace ShipWorks.Tests.Shipping.Carriers.OnTrac.Tracking
{
    ...
    public class OnTracTrackingRequestTest
    {
        ...
        public void Initialize()
        {
            ...
            testObject = new OnTracTrackedShipment(37, "testpass", mockedSubmitter.Object, mockedLogger.Object);
        ...
        public void RequestTracking_UriInCorrectFormat_WhenParametersAndResultsAreValid_Test()
        {
            ...
            Assert.AreEqual(
                "https://www.shipontrac.net/OnTracTestWebServices/OnTracServices.svc/v1/37/shipments?pw=testpass&tn=123456&requestType=track",
