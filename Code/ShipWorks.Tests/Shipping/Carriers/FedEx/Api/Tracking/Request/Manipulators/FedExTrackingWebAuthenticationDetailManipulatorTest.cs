...
namespace ShipWorks.Tests.Shipping.Carriers.FedEx.Api.Tracking.Request.Manipulators
{
    public class FedExTrackingWebAuthenticationDetailManipulatorTest
    {
        ...
        [Fact]
        public void Manipulate_ThrowsCarrierException_WhenNativeRequestIsNotTrackRequest()
        {
        ...
        [Fact]
        public void Manipulate_SetsWebAuthenticationDetail_WhenWebAuthenticationDetailsIsNull_ForTracking()
        {
        ...
        [Fact]
        public void Manipulate_SetsWebAuthenticationDetail_WhenWebAuthenticationDetailsIsNotNull_ForTracking()
        {
