...
namespace ShipWorks.Tests.Stores.Shopify
{
    public class ShopifyEndpointsTest
    {
        ...
        public void InventoryLevelForItemsUrl_ReturnsCorrect()
        {
            ...
            Assert.Equal("https://test.myshopify.com/admin/api/2021-04/inventory_levels.json?inventory_item_ids=123,456,789", url);
        }
        ...
        public void InventoryLevelForLocationsUrl_ReturnsCorrect()
        {
            ...
            Assert.Equal("https://test.myshopify.com/admin/api/2021-04/inventory_levels.json?location_ids=123,456,789", url);
        }
    }
}