...
{
    /// <summary>
    /// Summary description for XmlTokenWriterTest
    /// </summary>
    [TestClass]
    public class XmlTokenWriterTest
    {
        ...
        public void Initialize()
        {
            ...
            testObject = new XmlTokenWriter(stream);
        }
        ...
        [TestMethod]
        public void Write_WritesXmlToStream_Test()
        {
            testObject.Write(token);

            // Read back the data written to our stream 
            string dataWrittenToStream = GetStreamData();

            // Just checking that the data was valid XML
            Assert.IsTrue(IsValidXml(dataWrittenToStream));
        }

        [TestMethod]
        public void Write_WritesTokenToXml_Test()
        {
            testObject.Write(token);

            // Read back the data written to our stream 
            string tokenXml = GetStreamData();            
