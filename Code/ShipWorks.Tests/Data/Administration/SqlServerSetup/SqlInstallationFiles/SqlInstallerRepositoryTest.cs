...
namespace ShipWorks.Tests.Data.Administration.SqlServerSetup.SqlInstallationFiles
{
    public class SqlInstallerRepositoryTest
    {
        ...
        [Fact]
        public void Windows10x64_SqlServer2008R2_IsFirst_WhenClrVersionNotHighEnough()
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(true);
            environment.Setup(e => e.OSVersion).Returns(Win10_10_0_14393);
            clrHelper.Setup(ch => ch.ClrVersions).Returns(allClrVersions.Where(v => v <= new Version(3, 5, 0, 0)));

            testObject = new SqlInstallerRepository(clrHelper.Object, environment.Object);

            ISqlInstallerInfo si = testObject.SqlInstallersForThisMachine().First();
            Assert.True(si.Edition == SqlServerEditionType.Express2008R2Sp2 && si.Is64Bit);
        }
        ...
        [Fact]
        public void Windows10x64_SqlServerExpress2008R2Sp2IsAvailable_WhenClrVersionNotHighEnough()
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(true);
            environment.Setup(e => e.OSVersion).Returns(Win10_10_0_14393);
            clrHelper.Setup(ch => ch.ClrVersions).Returns(allClrVersions.Where(v => v <= new Version(3, 5, 0, 0)));
            ...
            Assert.True(testObject.SqlInstallersForThisMachine().Any(si => si.Edition == SqlServerEditionType.Express2008R2Sp2 && si.Is64Bit));
        }
        ...
        [Fact]
        public void Windows10x86_SqlServerExpress2008R2Sp2_IsFirst_WhenClrVersionNotHighEnough()
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(false);
            environment.Setup(e => e.OSVersion).Returns(Win10_10_0_14393);
            clrHelper.Setup(ch => ch.ClrVersions).Returns(allClrVersions.Where(v => v <= new Version(3, 5, 0, 0)));
            ...
            ISqlInstallerInfo si = testObject.SqlInstallersForThisMachine().FirstOrDefault();
            Assert.True(si.Is64Bit == false && si.Edition == SqlServerEditionType.Express2008R2Sp2);
        }

        [Theory]
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void WindowsXPx64_SqlServer2008R2_IsFirst(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(is64Bit ? Xp_5_2_2600_64Bit : Xp_5_1_2600_32Bit);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void WindowsXPx64_SqlServer2008R2_IsOnlyAvailable(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(is64Bit ? Xp_5_2_2600_64Bit : Xp_5_1_2600_32Bit);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void WindowsVista_SqlServer2008R2_IsFirst(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Vista_6_0_6002);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void WindowsVista_SqlServer2008R2_IsOnlyAvailable(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Vista_6_0_6002);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void Server2003_SqlServer2008R2_IsFirst(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Server2003_5_2);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void Server2003_SqlServer2008R2_IsOnlyAvailable(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Server2003_5_2);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void Server2008_SqlServer2008R2_IsFirst(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Server2008_6_0);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void Server2008_SqlServer2008R2_IsOnlyAvailable(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Server2008_6_0);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void Server2008R2_SqlServer2008R2_IsFirst(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Server2008R2_6_1);
        ...
        [InlineData(false, SqlServerEditionType.Express2008R2Sp2)]
        [InlineData(true, SqlServerEditionType.Express2008R2Sp2)]
        public void Server2008R2_SqlServer2008R2_IsOnlyAvailable(bool is64Bit, SqlServerEditionType expectedEdition)
        {
            environment.Setup(e => e.Is64BitOperatingSystem).Returns(is64Bit);
            environment.Setup(e => e.OSVersion).Returns(Server2008R2_6_1);
