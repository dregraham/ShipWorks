...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Download1000Orders recording.
    /// </summary>
    [TestModule("0c512ee3-ca82-4919-aa9d-702582587e02", ModuleType.Recording, 1)]
    public partial class Download1000Orders : ITestModule
    {
        /// <summary>
        ...
        static Download1000Orders instance = new Download1000Orders();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Download1000Orders()
        {
        }
        ...
        /// </summary>
        public static Download1000Orders Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Preparing Shipments box appears
            Report.Log(ReportLevel.Info, "Wait", "Preparing Shipments box appears\r\nWaiting 5m to exist. Associated repository item: 'ProgressDlg'", repo.ProgressDlg.SelfInfo, new ActionTimeout(300000), new RecordItemIndex(8));
            repo.ProgressDlg.SelfInfo.WaitForExists(300000);
            
            // Preparing Shipments box appears
            Report.Log(ReportLevel.Info, "Wait", "Preparing Shipments box appears\r\nWaiting 15m to not exist. Associated repository item: 'ProgressDlg'", repo.ProgressDlg.SelfInfo, new ActionTimeout(900000), new RecordItemIndex(9));
            repo.ProgressDlg.SelfInfo.WaitForNotExists(900000);
            
            // Cursor moves to the ALL filter = 1,000
            Report.Log(ReportLevel.Info, "Validation", "Cursor moves to the ALL filter = 1,000\r\nValidating AttributeEqual (RawText='(1,000)') on item 'MainForm.RawText1000'.", repo.MainForm.RawText1000Info, new RecordItemIndex(10));
            Validate.AttributeEqual(repo.MainForm.RawText1000Info, "RawText", "(1,000)");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "User", "End 1", new RecordItemIndex(11));
