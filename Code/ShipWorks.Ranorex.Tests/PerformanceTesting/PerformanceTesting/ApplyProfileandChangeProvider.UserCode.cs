...
{
    public partial class ApplyProfileandChangeProvider
        {
    	string starttime;
        /// <summary>
        ...
        {  
          ...
          //  string s = "Step 5: " + duration.Minutes.ToString()+":"+duration.Seconds.ToString()+"."+duration.Milliseconds.ToString() + "\r\n";  
        ...
        {  
            ...
            TimeSpan duration = end - start; 
			DurationResults.AddDuration(duration);            
           // string s = "Step 6: " + duration.Minutes.ToString()+":"+duration.Seconds.ToString()+"."+duration.Milliseconds.ToString() + "\r\n";  
           // Report.Log(ReportLevel.Info,duration.Minutes.ToString()+":"+duration.Seconds.ToString()+"."+duration.Milliseconds.ToString());  
