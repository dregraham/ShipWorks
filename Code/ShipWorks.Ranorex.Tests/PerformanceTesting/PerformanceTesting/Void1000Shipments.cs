...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("4271985a-35f6-48eb-8648-6c7ef3eeade0", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "User", "Start 9", new RecordItemIndex(11));
            
            getStartTime();
            Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'SomeForm.RawTextOK' at Center.", repo.SomeForm.RawTextOKInfo, new RecordItemIndex(13));
            //repo.SomeForm.RawTextOK.MoveTo();
            //Delay.Milliseconds(0);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SomeForm.RawTextOK' at Center.", repo.SomeForm.RawTextOKInfo, new RecordItemIndex(14));
            //repo.SomeForm.RawTextOK.Click();
            //Delay.Milliseconds(0);
            ...
            // Preparing
            Report.Log(ReportLevel.Info, "Wait", "Preparing\r\nWaiting 5s to exist. Associated repository item: 'ProgressDlg'", repo.ProgressDlg.SelfInfo, new ActionTimeout(5000), new RecordItemIndex(17));
            repo.ProgressDlg.SelfInfo.WaitForExists(5000);
            
            // Preparing
            Report.Log(ReportLevel.Info, "Wait", "Preparing\r\nWaiting 15m to not exist. Associated repository item: 'ProgressDlg'", repo.ProgressDlg.SelfInfo, new ActionTimeout(900000), new RecordItemIndex(18));
            repo.ProgressDlg.SelfInfo.WaitForNotExists(900000);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Close') on item 'ShippingDlg.Close'.", repo.ShippingDlg.CloseInfo, new RecordItemIndex(19));
            Validate.AttributeEqual(repo.ShippingDlg.CloseInfo, "Text", "Close");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "User", "End 9", new RecordItemIndex(20));
            
            getEndTime();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'ShippingDlg.Close' at Center.", repo.ShippingDlg.CloseInfo, new RecordItemIndex(22));
            repo.ShippingDlg.Close.MoveTo();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ShippingDlg.Close' at Center.", repo.ShippingDlg.CloseInfo, new RecordItemIndex(23));
            repo.ShippingDlg.Close.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", "Start 10", new RecordItemIndex(24));
            
            getStartTime2();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (RawText='(1,000)') on item 'MainForm.RawText1000'.", repo.MainForm.RawText1000Info, new RecordItemIndex(26));
            Validate.AttributeEqual(repo.MainForm.RawText1000Info, "RawText", "(1,000)");
            Delay.Milliseconds(100);
            
            Report.Log(ReportLevel.Info, "User", "End 10", new RecordItemIndex(27));
