...
{
    public partial class SelectandUnselect1000Shipments
    {
    	string starttime;
        /// <summary>
        ...
        //    string s = "Step 3: " + duration.Minutes.ToString()+":"+duration.Seconds.ToString()+"."+duration.Milliseconds.ToString() + "\r\n";  
       ...
       //     System.IO.File.AppendAllText(@"C:\Users\jeman.INTERAPPTIVE\Documents\test.txt", s);
        ...
        {  
            ...
            TimeSpan duration = end - start;  
            DurationResults.AddDuration(duration);
         //   string s = "Step 4: " + duration.Minutes.ToString()+":"+duration.Seconds.ToString()+"."+duration.Milliseconds.ToString() + "\r\n";  
         //   Report.Log(ReportLevel.Info,duration.Minutes.ToString()+":"+duration.Seconds.ToString()+"."+duration.Milliseconds.ToString());  
