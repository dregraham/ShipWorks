...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The CreateNewShipment_ProvderOnTrac recording.
    /// </summary>
    [TestModule("9a5c564e-a727-4ff0-9497-10473ab4b5e7", ModuleType.Recording, 1)]
    public partial class CreateNewShipment_ProvderOnTrac : ITestModule
    {
        /// <summary>
        ...
        static CreateNewShipment_ProvderOnTrac instance = new CreateNewShipment_ProvderOnTrac();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public CreateNewShipment_ProvderOnTrac()
        {
        }
        ...
        /// </summary>
        public static CreateNewShipment_ProvderOnTrac Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Click the Provider Dropdown\r\nMouse Left Click item 'ShippingDlg.SplitContainer.ComboShipmentType' at Center.", repo.ShippingDlg.SplitContainer.ComboShipmentTypeInfo, new RecordItemIndex(3));
            repo.ShippingDlg.SplitContainer.ComboShipmentType.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'List1000.OnTrac' at Center.", repo.List1000.OnTracInfo, new RecordItemIndex(4));
            repo.List1000.OnTrac.MoveTo();
            Delay.Milliseconds(200);
            
            // Select OnTrac from the Provider dropdown
            Report.Log(ReportLevel.Info, "Mouse", "Select OnTrac from the Provider dropdown\r\nMouse Left Click item 'List1000.OnTrac' at Center.", repo.List1000.OnTracInfo, new RecordItemIndex(5));
            repo.List1000.OnTrac.Click();
            Delay.Milliseconds(200);
