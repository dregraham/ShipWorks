...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ProcessUSPSExpress1InternationalPriority recording.
    /// </summary>
    [TestModule("f5b499cd-445c-4787-b256-b1aa863f9115", ModuleType.Recording, 1)]
    public partial class ProcessUSPSExpress1InternationalPriority : ITestModule
    {
        /// <summary>
        ...
        static ProcessUSPSExpress1InternationalPriority instance = new ProcessUSPSExpress1InternationalPriority();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ProcessUSPSExpress1InternationalPriority()
        {
        }
        ...
        /// </summary>
        public static ProcessUSPSExpress1InternationalPriority Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Give Focus: Length
            Report.Log(ReportLevel.Info, "Invoke action", "Give Focus: Length\r\nInvoking Focus() on item 'ShipOrders1.SplitContainer.LengthUSPSExpress1'.", repo.ShipOrders1.SplitContainer.LengthUSPSExpress1Info, new RecordItemIndex(7));
            repo.ShipOrders1.SplitContainer.LengthUSPSExpress1.Focus();
            Delay.Milliseconds(0);
            
            // Mouse move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse move to avoid click inconsistency\r\nMouse Left Move item 'ShipOrders1.SplitContainer.LengthUSPSExpress1' at Center.", repo.ShipOrders1.SplitContainer.LengthUSPSExpress1Info, new RecordItemIndex(8));
            repo.ShipOrders1.SplitContainer.LengthUSPSExpress1.MoveTo();
            Delay.Milliseconds(200);
            
            // Set Length: 3
            Report.Log(ReportLevel.Info, "Keyboard", "Set Length: 3\r\nKey sequence '3' with focus on 'ShipOrders1.SplitContainer.LengthUSPSExpress1'.", repo.ShipOrders1.SplitContainer.LengthUSPSExpress1Info, new RecordItemIndex(9));
            repo.ShipOrders1.SplitContainer.LengthUSPSExpress1.PressKeys("3");
            Delay.Milliseconds(0);
            
            // Give Focus: Width
            Report.Log(ReportLevel.Info, "Invoke action", "Give Focus: Width\r\nInvoking Focus() on item 'ShipOrders1.SplitContainer.WidthUSPSExpress1'.", repo.ShipOrders1.SplitContainer.WidthUSPSExpress1Info, new RecordItemIndex(10));
            repo.ShipOrders1.SplitContainer.WidthUSPSExpress1.Focus();
            Delay.Milliseconds(0);
            
            // Mouse move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse move to avoid click inconsistency\r\nMouse Left Move item 'ShipOrders1.SplitContainer.WidthUSPSExpress1' at Center.", repo.ShipOrders1.SplitContainer.WidthUSPSExpress1Info, new RecordItemIndex(11));
            repo.ShipOrders1.SplitContainer.WidthUSPSExpress1.MoveTo();
            Delay.Milliseconds(200);
            
            // Set Width: 3
            Report.Log(ReportLevel.Info, "Keyboard", "Set Width: 3\r\nKey sequence '3' with focus on 'ShipOrders1.SplitContainer.WidthUSPSExpress1'.", repo.ShipOrders1.SplitContainer.WidthUSPSExpress1Info, new RecordItemIndex(12));
            repo.ShipOrders1.SplitContainer.WidthUSPSExpress1.PressKeys("3");
            Delay.Milliseconds(0);
            
            // Give Focus: Height
            Report.Log(ReportLevel.Info, "Invoke action", "Give Focus: Height\r\nInvoking Focus() on item 'ShipOrders1.SplitContainer.HeightUSPSExpress1'.", repo.ShipOrders1.SplitContainer.HeightUSPSExpress1Info, new RecordItemIndex(13));
            repo.ShipOrders1.SplitContainer.HeightUSPSExpress1.Focus();
            Delay.Milliseconds(0);
            
            // Mouse move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse move to avoid click inconsistency\r\nMouse Left Move item 'ShipOrders1.SplitContainer.HeightUSPSExpress1' at Center.", repo.ShipOrders1.SplitContainer.HeightUSPSExpress1Info, new RecordItemIndex(14));
            repo.ShipOrders1.SplitContainer.HeightUSPSExpress1.MoveTo();
            Delay.Milliseconds(200);
            
            // Set Height: 3
            Report.Log(ReportLevel.Info, "Keyboard", "Set Height: 3\r\nKey sequence '3' with focus on 'ShipOrders1.SplitContainer.HeightUSPSExpress1'.", repo.ShipOrders1.SplitContainer.HeightUSPSExpress1Info, new RecordItemIndex(15));
