...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The OLMProcessShipmentUPSDomesticGround recording.
    /// </summary>
    [TestModule("36f71bfb-afee-4998-9c63-5af4b047ce6c", ModuleType.Recording, 1)]
    public partial class OLMProcessShipmentUPSDomesticGround : ITestModule
    {
        /// <summary>
        ...
        static OLMProcessShipmentUPSDomesticGround instance = new OLMProcessShipmentUPSDomesticGround();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public OLMProcessShipmentUPSDomesticGround()
        {
        }
        ...
        /// </summary>
        public static OLMProcessShipmentUPSDomesticGround Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Checks if the UPS Ground rate is displayed\r\nWaiting 30s to exist. Associated repository item: 'MainForm.PanelDockingArea.UPSGround'", repo.MainForm.PanelDockingArea.UPSGroundInfo, new ActionTimeout(30000), new RecordItemIndex(5));
            repo.MainForm.PanelDockingArea.UPSGroundInfo.WaitForExists(30000);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'MainForm.PanelDockingArea.UPSGround' at Center.", repo.MainForm.PanelDockingArea.UPSGroundInfo, new RecordItemIndex(6));
            repo.MainForm.PanelDockingArea.UPSGround.MoveTo();
            Delay.Milliseconds(200);
