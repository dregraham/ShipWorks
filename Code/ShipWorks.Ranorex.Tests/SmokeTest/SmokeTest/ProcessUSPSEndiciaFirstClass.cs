...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("71dc49ce-f7af-45e2-9ecf-81c3446a36d0", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Give Focus: Length
            Report.Log(ReportLevel.Info, "Invoke action", "Give Focus: Length\r\nInvoking Focus() on item 'ShipOrders1.SplitContainer.LengthUSPSEndicia'.", repo.ShipOrders1.SplitContainer.LengthUSPSEndiciaInfo, new RecordItemIndex(7));
            repo.ShipOrders1.SplitContainer.LengthUSPSEndicia.Focus();
            Delay.Milliseconds(0);
            
            // Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Move to avoid click inconsistency\r\nMouse Left Move item 'ShipOrders1.SplitContainer.LengthUSPSEndicia' at Center.", repo.ShipOrders1.SplitContainer.LengthUSPSEndiciaInfo, new RecordItemIndex(8));
            repo.ShipOrders1.SplitContainer.LengthUSPSEndicia.MoveTo(300);
            Delay.Milliseconds(200);
            
            // Set Length: 6
            Report.Log(ReportLevel.Info, "Keyboard", "Set Length: 6\r\nKey sequence '7' with focus on 'ShipOrders1.SplitContainer.LengthUSPSEndicia'.", repo.ShipOrders1.SplitContainer.LengthUSPSEndiciaInfo, new RecordItemIndex(9));
            repo.ShipOrders1.SplitContainer.LengthUSPSEndicia.PressKeys("7");
            Delay.Milliseconds(0);
            
            // Give Focus: Width
            Report.Log(ReportLevel.Info, "Invoke action", "Give Focus: Width\r\nInvoking Focus() on item 'ShipOrders1.SplitContainer.WidthUSPSEndicia'.", repo.ShipOrders1.SplitContainer.WidthUSPSEndiciaInfo, new RecordItemIndex(10));
            repo.ShipOrders1.SplitContainer.WidthUSPSEndicia.Focus();
            Delay.Milliseconds(0);
            
            // Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Move to avoid click inconsistency\r\nMouse Left Move item 'ShipOrders1.SplitContainer.WidthUSPSEndicia' at Center.", repo.ShipOrders1.SplitContainer.WidthUSPSEndiciaInfo, new RecordItemIndex(11));
            repo.ShipOrders1.SplitContainer.WidthUSPSEndicia.MoveTo(300);
            Delay.Milliseconds(200);
            
            // Set Width: 7
            Report.Log(ReportLevel.Info, "Keyboard", "Set Width: 7\r\nKey sequence '8' with focus on 'ShipOrders1.SplitContainer.WidthUSPSEndicia'.", repo.ShipOrders1.SplitContainer.WidthUSPSEndiciaInfo, new RecordItemIndex(12));
            repo.ShipOrders1.SplitContainer.WidthUSPSEndicia.PressKeys("8");
            Delay.Milliseconds(0);
            
            // Give Focus: Height
            Report.Log(ReportLevel.Info, "Invoke action", "Give Focus: Height\r\nInvoking Focus() on item 'ShipOrders1.SplitContainer.HeightUSPSEndicia'.", repo.ShipOrders1.SplitContainer.HeightUSPSEndiciaInfo, new RecordItemIndex(13));
            repo.ShipOrders1.SplitContainer.HeightUSPSEndicia.Focus();
            Delay.Milliseconds(0);
            
            // Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Move to avoid click inconsistency\r\nMouse Left Move item 'ShipOrders1.SplitContainer.HeightUSPSEndicia' at Center.", repo.ShipOrders1.SplitContainer.HeightUSPSEndiciaInfo, new RecordItemIndex(14));
            repo.ShipOrders1.SplitContainer.HeightUSPSEndicia.MoveTo(300);
            Delay.Milliseconds(200);
            
            // Set Height: 8
            Report.Log(ReportLevel.Info, "Keyboard", "Set Height: 8\r\nKey sequence '9' with focus on 'ShipOrders1.SplitContainer.HeightUSPSEndicia'.", repo.ShipOrders1.SplitContainer.HeightUSPSEndiciaInfo, new RecordItemIndex(15));
