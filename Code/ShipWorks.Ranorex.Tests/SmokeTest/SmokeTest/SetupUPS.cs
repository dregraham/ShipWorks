...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(55));
            repo.UpsSetupWizard.Next.MoveTo();
            Delay.Milliseconds(200);
            
            // Click Next on the Account Registration ShipWorks exclusive promotion from UPS page
            Report.Log(ReportLevel.Info, "Mouse", "Click Next on the Account Registration ShipWorks exclusive promotion from UPS page\r\nMouse Left Click item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(56));
            repo.UpsSetupWizard.Next.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(57));
            repo.UpsSetupWizard.Next.MoveTo();
            Delay.Milliseconds(200);
            
            // Click Next on the Origin Address Enter the origin addresses for your shipments page
            Report.Log(ReportLevel.Info, "Mouse", "Click Next on the Origin Address Enter the origin addresses for your shipments page\r\nMouse Left Click item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(58));
            repo.UpsSetupWizard.Next.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(59));
            repo.UpsSetupWizard.Next.MoveTo();
            Delay.Milliseconds(200);
            
            // Click Next on the Shipping Defaults Configure defaults settings for shipments page
            Report.Log(ReportLevel.Info, "Mouse", "Click Next on the Shipping Defaults Configure defaults settings for shipments page\r\nMouse Left Click item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(60));
            repo.UpsSetupWizard.Next.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.MainPanel.PrintActionBox' at Center.", repo.UpsSetupWizard.MainPanel.PrintActionBoxInfo, new RecordItemIndex(61));
            repo.UpsSetupWizard.MainPanel.PrintActionBox.MoveTo();
            Delay.Milliseconds(200);
            
            // Select the Automatically print labels after processing checkbox
            Report.Log(ReportLevel.Info, "Invoke action", "Select the Automatically print labels after processing checkbox\r\nInvoking Check() on item 'UpsSetupWizard.MainPanel.PrintActionBox'.", repo.UpsSetupWizard.MainPanel.PrintActionBoxInfo, new RecordItemIndex(62));
            repo.UpsSetupWizard.MainPanel.PrintActionBox.Check();
            Delay.Milliseconds(0);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(63));
            repo.UpsSetupWizard.Next.MoveTo();
            Delay.Milliseconds(200);
            
            // Click Next on the Printing Setup Configure what to print when printing shipments page
            Report.Log(ReportLevel.Info, "Mouse", "Click Next on the Printing Setup Configure what to print when printing shipments page\r\nMouse Left Click item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(64));
            repo.UpsSetupWizard.Next.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'TemplatePrinterSelectionDlg.UseDefault1' at Center.", repo.TemplatePrinterSelectionDlg.UseDefault1Info, new RecordItemIndex(65));
            repo.TemplatePrinterSelectionDlg.UseDefault1.MoveTo();
            Delay.Milliseconds(200);
            
            // Click: Use Default - Labels\Thermal
            Report.Log(ReportLevel.Info, "Mouse", "Click: Use Default - Labels\\Thermal\r\nMouse Left Click item 'TemplatePrinterSelectionDlg.UseDefault1' at Center.", repo.TemplatePrinterSelectionDlg.UseDefault1Info, new RecordItemIndex(66));
            repo.TemplatePrinterSelectionDlg.UseDefault1.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'TemplatePrinterSelectionDlg.UseDefault2' at Center.", repo.TemplatePrinterSelectionDlg.UseDefault2Info, new RecordItemIndex(67));
            repo.TemplatePrinterSelectionDlg.UseDefault2.MoveTo();
            Delay.Milliseconds(200);
            
            // Click: Use Default - Labels\Standard
            Report.Log(ReportLevel.Info, "Mouse", "Click: Use Default - Labels\\Standard\r\nMouse Left Click item 'TemplatePrinterSelectionDlg.UseDefault2' at Center.", repo.TemplatePrinterSelectionDlg.UseDefault2Info, new RecordItemIndex(68));
            repo.TemplatePrinterSelectionDlg.UseDefault2.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'TemplatePrinterSelectionDlg.UseDefault' at Center.", repo.TemplatePrinterSelectionDlg.UseDefaultInfo, new RecordItemIndex(69));
            repo.TemplatePrinterSelectionDlg.UseDefault.MoveTo();
            Delay.Milliseconds(200);
            
            // Click: Use Default - Labels\Commercial
            Report.Log(ReportLevel.Info, "Mouse", "Click: Use Default - Labels\\Commercial\r\nMouse Left Click item 'TemplatePrinterSelectionDlg.UseDefault' at Center.", repo.TemplatePrinterSelectionDlg.UseDefaultInfo, new RecordItemIndex(70));
            repo.TemplatePrinterSelectionDlg.UseDefault.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'TemplatePrinterSelectionDlg.ButtonOk' at Center.", repo.TemplatePrinterSelectionDlg.ButtonOkInfo, new RecordItemIndex(71));
            repo.TemplatePrinterSelectionDlg.ButtonOk.MoveTo();
            Delay.Milliseconds(200);
            
            // Click OK on the Printer Selection popup
            Report.Log(ReportLevel.Info, "Mouse", "Click OK on the Printer Selection popup\r\nMouse Left Click item 'TemplatePrinterSelectionDlg.ButtonOk' at Center.", repo.TemplatePrinterSelectionDlg.ButtonOkInfo, new RecordItemIndex(72));
            repo.TemplatePrinterSelectionDlg.ButtonOk.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(73));
            repo.UpsSetupWizard.Next.MoveTo();
            Delay.Milliseconds(200);
            
            // Click Next on the Processing Setup Configure automated processing tasks page
            Report.Log(ReportLevel.Info, "Mouse", "Click Next on the Processing Setup Configure automated processing tasks page\r\nMouse Left Click item 'UpsSetupWizard.Next' at Center.", repo.UpsSetupWizard.NextInfo, new RecordItemIndex(74));
            repo.UpsSetupWizard.Next.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'UpsSetupWizard.Finish' at Center.", repo.UpsSetupWizard.FinishInfo, new RecordItemIndex(75));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Click Finish on the Account Registration You are now ready to use UPS with ShipWorks page\r\nMouse Left Click item 'UpsSetupWizard.Finish' at Center.", repo.UpsSetupWizard.FinishInfo, new RecordItemIndex(76));
            repo.UpsSetupWizard.Finish.Click();
            Delay.Milliseconds(200);
            
            // Mouse Move to avoid click inconsistency
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Move to avoid click inconsistency\r\nMouse Left Move item 'ShippingSettingsDlg.Close' at Center.", repo.ShippingSettingsDlg.CloseInfo, new RecordItemIndex(77));
            repo.ShippingSettingsDlg.Close.MoveTo();
            Delay.Milliseconds(200);
            
            // Click Close on the Shipping Settings window
            Report.Log(ReportLevel.Info, "Mouse", "Click Close on the Shipping Settings window\r\nMouse Left Click item 'ShippingSettingsDlg.Close' at Center.", repo.ShippingSettingsDlg.CloseInfo, new RecordItemIndex(78));
            repo.ShippingSettingsDlg.Close.Click();
            Delay.Milliseconds(200);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'UpsSetupWizard.MainPanel.InvoiceNumber' at 30;9.", repo.UpsSetupWizard.MainPanel.InvoiceNumberInfo, new RecordItemIndex(79));
            //repo.UpsSetupWizard.MainPanel.InvoiceNumber.Click("30;9");
            //Delay.Milliseconds(200);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'UpsSetupWizard.MainPanel.List172019' at 9;17.", repo.UpsSetupWizard.MainPanel.List172019Info, new RecordItemIndex(80));
            //repo.UpsSetupWizard.MainPanel.List172019.Click("9;17");
            //Delay.Milliseconds(200);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'UpsSetupWizard.MainPanel.InvoiceAmount' at 6;16.", repo.UpsSetupWizard.MainPanel.InvoiceAmountInfo, new RecordItemIndex(81));
            //repo.UpsSetupWizard.MainPanel.InvoiceAmount.Click("6;16");
            //Delay.Milliseconds(200);
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'UpsSetupWizard.MainPanel.ControlID' at 6;10.", repo.UpsSetupWizard.MainPanel.ControlIDInfo, new RecordItemIndex(82));
            //repo.UpsSetupWizard.MainPanel.ControlID.Click("6;10");
            //Delay.Milliseconds(200);
