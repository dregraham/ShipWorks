...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The OLMProcessShipmentFedExInternational recording.
    /// </summary>
    [TestModule("e27a4195-b534-4be6-b39d-d0b854d2597a", ModuleType.Recording, 1)]
    public partial class OLMProcessShipmentFedExInternational : ITestModule
    {
        /// <summary>
        ...
        static OLMProcessShipmentFedExInternational instance = new OLMProcessShipmentFedExInternational();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public OLMProcessShipmentFedExInternational()
        {
        }
        ...
        /// </summary>
        public static OLMProcessShipmentFedExInternational Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Checks if the UPS Ground rate is displayed\r\nWaiting 30s to exist. Associated repository item: 'MainForm.PanelDockingArea.FedExInternationalPriorityR'", repo.MainForm.PanelDockingArea.FedExInternationalPriorityRInfo, new ActionTimeout(30000), new RecordItemIndex(5));
            repo.MainForm.PanelDockingArea.FedExInternationalPriorityRInfo.WaitForExists(30000);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'MainForm.PanelDockingArea.FedExInternationalPriorityR' at Center.", repo.MainForm.PanelDockingArea.FedExInternationalPriorityRInfo, new RecordItemIndex(6));
            repo.MainForm.PanelDockingArea.FedExInternationalPriorityR.MoveTo();
            Delay.Milliseconds(200);
