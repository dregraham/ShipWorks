...
namespace SmokeTest
{
    public partial class OLMProcessShipmentFedExInternational
    {
        /// <summary>
        ...
        public void ProcessFedexInternational()
        {            
            if (repo.MainForm.PanelDockingArea.FedExInternationalPriorityRInfo.Exists(30000) == false)
            {
