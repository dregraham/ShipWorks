...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The OLMProcessShipmentUSPSInternational recording.
    /// </summary>
    [TestModule("ccfe2d1f-0279-4d0c-af5a-3ccbe97a631f", ModuleType.Recording, 1)]
    public partial class OLMProcessShipmentUSPSInternational : ITestModule
    {
        /// <summary>
        ...
        static OLMProcessShipmentUSPSInternational instance = new OLMProcessShipmentUSPSInternational();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public OLMProcessShipmentUSPSInternational()
        {
        }
        ...
        /// </summary>
        public static OLMProcessShipmentUSPSInternational Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Checks if the UPS Ground rate is displayed\r\nWaiting 30s to exist. Associated repository item: 'ShipWorksSa.PanelDockingArea.InternationalPriority'", repo.ShipWorksSa.PanelDockingArea.InternationalPriorityInfo, new ActionTimeout(30000), new RecordItemIndex(5));
            repo.ShipWorksSa.PanelDockingArea.InternationalPriorityInfo.WaitForExists(30000);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Move item 'ShipWorksSa.PanelDockingArea.InternationalPriority' at Center.", repo.ShipWorksSa.PanelDockingArea.InternationalPriorityInfo, new RecordItemIndex(6));
            repo.ShipWorksSa.PanelDockingArea.InternationalPriority.MoveTo();
            Delay.Milliseconds(200);
