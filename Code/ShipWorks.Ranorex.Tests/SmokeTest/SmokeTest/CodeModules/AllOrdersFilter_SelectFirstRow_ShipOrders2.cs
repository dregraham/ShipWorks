...
namespace SmokeTest.CodeModules
{
    ...
    [TestModule("F89D1DD0-A3BB-4025-8D7C-63F28F923B0D", ModuleType.UserCode, 1)]
    public class AllOrdersFilter_SelectFirstRow_ShipOrders2 : ITestModule
    {
        ...
        void ITestModule.Run()
        {
            ...
            CloseShipOrdersDialog closeDialog = new CloseShipOrdersDialog();
            ...
            TestModuleRunner.Run(closeDialog);            
