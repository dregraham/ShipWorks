...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ChooseUPSTube recording.
    /// </summary>
    [TestModule("b4a29f35-ce25-4fcb-9732-44931c680957", ModuleType.Recording, 1)]
    public partial class ChooseUPSTube : ITestModule
    {
        /// <summary>
        ...
        static ChooseUPSTube instance = new ChooseUPSTube();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ChooseUPSTube()
        {
        }
        ...
        /// </summary>
        public static ChooseUPSTube Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Set Packaging: FedEx Large Box\r\nSetting attribute SelectedItemText to 'UPS Tube' on item 'ShippingDlg.SplitContainer.PackagingType'.", repo.ShippingDlg.SplitContainer.PackagingTypeInfo, new RecordItemIndex(2));
            repo.ShippingDlg.SplitContainer.PackagingType.Element.SetAttributeValue("SelectedItemText", "UPS Tube");
            Delay.Milliseconds(0);
