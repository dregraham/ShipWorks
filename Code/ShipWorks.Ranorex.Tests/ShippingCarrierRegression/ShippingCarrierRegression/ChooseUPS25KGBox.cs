...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ChooseUPS25KGBox recording.
    /// </summary>
    [TestModule("274ca80e-c8f1-4117-93d3-23b19b3e0dfb", ModuleType.Recording, 1)]
    public partial class ChooseUPS25KGBox : ITestModule
    {
        /// <summary>
        ...
        static ChooseUPS25KGBox instance = new ChooseUPS25KGBox();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ChooseUPS25KGBox()
        {
        }
        ...
        /// </summary>
        public static ChooseUPS25KGBox Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Set Packaging: FedEx Large Box\r\nSetting attribute SelectedItemText to 'UPS 25 KG Box®' on item 'ShippingDlg.SplitContainer.PackagingType'.", repo.ShippingDlg.SplitContainer.PackagingTypeInfo, new RecordItemIndex(2));
            repo.ShippingDlg.SplitContainer.PackagingType.Element.SetAttributeValue("SelectedItemText", "UPS 25 KG Box®");
            Delay.Milliseconds(0);
