...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ChooseUPSLetter recording.
    /// </summary>
    [TestModule("3fc742ac-0e16-4668-8ee3-f5949d6e58e9", ModuleType.Recording, 1)]
    public partial class ChooseUPSLetter : ITestModule
    {
        /// <summary>
        ...
        static ChooseUPSLetter instance = new ChooseUPSLetter();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ChooseUPSLetter()
        {
        }
        ...
        /// </summary>
        public static ChooseUPSLetter Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Set Packaging: FedEx Large Box\r\nSetting attribute SelectedItemText to 'UPS Letter' on item 'ShippingDlg.SplitContainer.PackagingType'.", repo.ShippingDlg.SplitContainer.PackagingTypeInfo, new RecordItemIndex(2));
            repo.ShippingDlg.SplitContainer.PackagingType.Element.SetAttributeValue("SelectedItemText", "UPS Letter");
            Delay.Milliseconds(0);
