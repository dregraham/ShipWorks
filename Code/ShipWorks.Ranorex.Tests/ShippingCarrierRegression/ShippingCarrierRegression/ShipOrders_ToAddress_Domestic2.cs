...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("4a7abdfb-a8ae-47fd-b0d0-08ce88bdc4b4", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set Full Name: Full Name\r\nKey sequence '{LControlKey down}{Akey}{LControlKey up}Full Name' with focus on 'ShippingDlg.SplitContainer.FullName'.", repo.ShippingDlg.SplitContainer.FullNameInfo, new RecordItemIndex(3));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set Company: Company Name\r\nKey sequence '{LControlKey down}{Akey}{LControlKey up}Company Name' with focus on 'ShippingDlg.SplitContainer.Company'.", repo.ShippingDlg.SplitContainer.CompanyInfo, new RecordItemIndex(5));
            repo.ShippingDlg.SplitContainer.Company.PressKeys("{LControlKey down}{Akey}{LControlKey up}Company Name");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set Street: 1 Memorial Dr{Return}Suite 2000\r\nKey sequence '{LShiftKey down}{End}{Down}{LShiftKey up}1 Memorial Dr{Return}Suite 2000' with focus on 'ShippingDlg.SplitContainer.Street'.", repo.ShippingDlg.SplitContainer.StreetInfo, new RecordItemIndex(7));
            repo.ShippingDlg.SplitContainer.Street.PressKeys("{LShiftKey down}{End}{Down}{LShiftKey up}1 Memorial Dr{Return}Suite 2000");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set City: Saint Louis\r\nKey sequence '{LControlKey down}{Akey}{LControlKey up}Saint Louis' with focus on 'ShippingDlg.SplitContainer.City'.", repo.ShippingDlg.SplitContainer.CityInfo, new RecordItemIndex(9));
            repo.ShippingDlg.SplitContainer.City.PressKeys("{LControlKey down}{Akey}{LControlKey up}Saint Louis");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set PostalCode: 63102\r\nKey sequence '{LControlKey down}{Akey}{LControlKey up}63102' with focus on 'ShippingDlg.SplitContainer.PostalCode'.", repo.ShippingDlg.SplitContainer.PostalCodeInfo, new RecordItemIndex(14));
            repo.ShippingDlg.SplitContainer.PostalCode.PressKeys("{LControlKey down}{Akey}{LControlKey up}63102");
            Delay.Milliseconds(0);
