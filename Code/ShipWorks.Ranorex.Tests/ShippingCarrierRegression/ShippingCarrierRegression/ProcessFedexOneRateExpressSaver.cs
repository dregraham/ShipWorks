...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ProcessFedexOneRateExpressSaver recording.
    /// </summary>
    [TestModule("68b21ebb-ec3f-434f-92b8-92f6bba7a309", ModuleType.Recording, 1)]
    public partial class ProcessFedexOneRateExpressSaver : ITestModule
    {
        /// <summary>
        ...
        static ProcessFedexOneRateExpressSaver instance = new ProcessFedexOneRateExpressSaver();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ProcessFedexOneRateExpressSaver()
        {
        }
        ...
        /// </summary>
        public static ProcessFedexOneRateExpressSaver Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Set Service: FedEx One Rate® (Express Saver)
            Report.Log(ReportLevel.Info, "Set Value", "Set Service: FedEx One Rate® (Express Saver)\r\nSetting attribute SelectedItemText to 'FedEx One Rate® (Express Saver)' on item 'ShippingDlg.SplitContainer.Service'.", repo.ShippingDlg.SplitContainer.ServiceInfo, new RecordItemIndex(5));
            repo.ShippingDlg.SplitContainer.Service.Element.SetAttributeValue("SelectedItemText", "FedEx One Rate® (Express Saver)");
            Delay.Milliseconds(0);
