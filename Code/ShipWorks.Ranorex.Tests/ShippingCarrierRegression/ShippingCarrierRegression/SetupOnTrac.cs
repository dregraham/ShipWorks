...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("1ed38e5b-2bbf-47de-bd1b-fa0522f59261", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Enter the Account
            Report.Log(ReportLevel.Info, "Keyboard", "Enter the Account\r\nKey sequence '{LControlKey down}{Akey}{LControlKey up}37' with focus on 'OnTracSetupWizard.MainPanel.EnterTheAccountNumberAndAPIPasswor'.", repo.OnTracSetupWizard.MainPanel.EnterTheAccountNumberAndAPIPassworInfo, new RecordItemIndex(14));
            repo.OnTracSetupWizard.MainPanel.EnterTheAccountNumberAndAPIPasswor.PressKeys("{LControlKey down}{Akey}{LControlKey up}37");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Enter the Password field\r\nKey sequence '{LControlKey down}{Akey}{LControlKey up}testpass' with focus on 'OnTracSetupWizard.MainPanel.Password'.", repo.OnTracSetupWizard.MainPanel.PasswordInfo, new RecordItemIndex(17));
            repo.OnTracSetupWizard.MainPanel.Password.PressKeys("{LControlKey down}{Akey}{LControlKey up}testpass");
            Delay.Milliseconds(0);
            ...
            // Uncheck the Automatically print labels afer processing checkbox
            Report.Log(ReportLevel.Info, "Invoke Action", "Uncheck the Automatically print labels afer processing checkbox\r\nInvoking Uncheck() on item 'OnTracSetupWizard.MainPanel.PrintActionBox'.", repo.OnTracSetupWizard.MainPanel.PrintActionBoxInfo, new RecordItemIndex(54));
