...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("840a7b20-8a1a-4813-9465-1e71ca3a3d93", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Set Service: FedEx One Rate® (Standard Overnight)\r\nSetting attribute SelectedItemText to 'FedEx One Rate® (Standard Overnight)' on item 'ShippingDlg.SplitContainer.Service'.", repo.ShippingDlg.SplitContainer.ServiceInfo, new RecordItemIndex(5));
