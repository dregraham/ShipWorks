...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ChooseUPSExpressEnvelope recording.
    /// </summary>
    [TestModule("6088b858-79b4-4911-a8c8-70060e98979b", ModuleType.Recording, 1)]
    public partial class ChooseUPSExpressEnvelope : ITestModule
    {
        /// <summary>
        ...
        static ChooseUPSExpressEnvelope instance = new ChooseUPSExpressEnvelope();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ChooseUPSExpressEnvelope()
        {
        }
        ...
        /// </summary>
        public static ChooseUPSExpressEnvelope Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Set Packaging: FedEx Large Box\r\nSetting attribute SelectedItemText to 'UPS Express Envelope' on item 'ShippingDlg.SplitContainer.PackagingType'.", repo.ShippingDlg.SplitContainer.PackagingTypeInfo, new RecordItemIndex(2));
            repo.ShippingDlg.SplitContainer.PackagingType.Element.SetAttributeValue("SelectedItemText", "UPS Express Envelope");
            Delay.Milliseconds(0);
