...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ProcessFedExOneRate2Day recording.
    /// </summary>
    [TestModule("17a022af-a8bc-4d03-8861-1cd9926a45c9", ModuleType.Recording, 1)]
    public partial class ProcessFedExOneRate2Day : ITestModule
    {
        /// <summary>
        ...
        static ProcessFedExOneRate2Day instance = new ProcessFedExOneRate2Day();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ProcessFedExOneRate2Day()
        {
        }
        ...
        /// </summary>
        public static ProcessFedExOneRate2Day Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Set Service: FedEx One Rate® (2Day)
            Report.Log(ReportLevel.Info, "Set Value", "Set Service: FedEx One Rate® (2Day)\r\nSetting attribute SelectedItemText to 'FedEx One Rate® (2Day)' on item 'ShippingDlg.SplitContainer.Service'.", repo.ShippingDlg.SplitContainer.ServiceInfo, new RecordItemIndex(5));
            repo.ShippingDlg.SplitContainer.Service.Element.SetAttributeValue("SelectedItemText", "FedEx One Rate® (2Day)");
            Delay.Milliseconds(0);
