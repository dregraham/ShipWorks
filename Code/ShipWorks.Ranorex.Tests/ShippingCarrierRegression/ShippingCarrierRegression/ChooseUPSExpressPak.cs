...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ChooseUPSExpressPak recording.
    /// </summary>
    [TestModule("877ac1d2-9cd2-4d03-b9e0-e1f246753d4f", ModuleType.Recording, 1)]
    public partial class ChooseUPSExpressPak : ITestModule
    {
        /// <summary>
        ...
        static ChooseUPSExpressPak instance = new ChooseUPSExpressPak();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ChooseUPSExpressPak()
        {
        }
        ...
        /// </summary>
        public static ChooseUPSExpressPak Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set Value", "Set Packaging: FedEx Large Box\r\nSetting attribute SelectedItemText to 'UPS Express® Pak' on item 'ShippingDlg.SplitContainer.PackagingType'.", repo.ShippingDlg.SplitContainer.PackagingTypeInfo, new RecordItemIndex(2));
            repo.ShippingDlg.SplitContainer.PackagingType.Element.SetAttributeValue("SelectedItemText", "UPS Express® Pak");
            Delay.Milliseconds(0);
