...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("9d10e6ec-6b1b-49d7-83ea-87a51562017f", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set Street: 1 Memorial Dr{Return}Suite 2000\r\nKey sequence '6801 Hollywood Blvd{Return}Suite 105' with focus on 'ShippingDlg.SplitContainer.Street'.", repo.ShippingDlg.SplitContainer.StreetInfo, new RecordItemIndex(7));
            repo.ShippingDlg.SplitContainer.Street.PressKeys("6801 Hollywood Blvd{Return}Suite 105");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set City: Saint Louis\r\nKey sequence 'Hollywood' with focus on 'ShippingDlg.SplitContainer.City'.", repo.ShippingDlg.SplitContainer.CityInfo, new RecordItemIndex(9));
            repo.ShippingDlg.SplitContainer.City.PressKeys("Hollywood");
            Delay.Milliseconds(0);
            ...
            // Set State: Missouri
            Report.Log(ReportLevel.Info, "Keyboard", "Set State: Missouri\r\nKey sequence 'California' with focus on 'ShippingDlg.SplitContainer.State'.", repo.ShippingDlg.SplitContainer.StateInfo, new RecordItemIndex(12));
            repo.ShippingDlg.SplitContainer.State.PressKeys("California");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Set PostalCode: 63102\r\nKey sequence '90028-6137' with focus on 'ShippingDlg.SplitContainer.PostalCode'.", repo.ShippingDlg.SplitContainer.PostalCodeInfo, new RecordItemIndex(14));
            repo.ShippingDlg.SplitContainer.PostalCode.PressKeys("90028-6137");
            Delay.Milliseconds(0);
