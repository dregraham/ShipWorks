...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ProcessFedExOneRate2DayAM recording.
    /// </summary>
    [TestModule("473dc2df-a083-4604-a460-7400c07a1f52", ModuleType.Recording, 1)]
    public partial class ProcessFedExOneRate2DayAM : ITestModule
    {
        /// <summary>
        ...
        static ProcessFedExOneRate2DayAM instance = new ProcessFedExOneRate2DayAM();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ProcessFedExOneRate2DayAM()
        {
        }
        ...
        /// </summary>
        public static ProcessFedExOneRate2DayAM Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Set Service: FedEx One Rate® (2 Day A.M.)
            Report.Log(ReportLevel.Info, "Set Value", "Set Service: FedEx One Rate® (2 Day A.M.)\r\nSetting attribute SelectedItemText to 'FedEx One Rate® (2Day A.M.)' on item 'ShippingDlg.SplitContainer.Service'.", repo.ShippingDlg.SplitContainer.ServiceInfo, new RecordItemIndex(3));
            repo.ShippingDlg.SplitContainer.Service.Element.SetAttributeValue("SelectedItemText", "FedEx One Rate® (2Day A.M.)");
            Delay.Milliseconds(0);
