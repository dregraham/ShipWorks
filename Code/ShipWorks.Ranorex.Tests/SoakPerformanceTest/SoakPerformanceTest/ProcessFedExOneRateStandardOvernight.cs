...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The ProcessFedExOneRateStandardOvernight recording.
    /// </summary>
    [TestModule("8cb46db7-159c-445d-b75b-b982b6cbbb04", ModuleType.Recording, 1)]
    public partial class ProcessFedExOneRateStandardOvernight : ITestModule
    {
        /// <summary>
        ...
        static ProcessFedExOneRateStandardOvernight instance = new ProcessFedExOneRateStandardOvernight();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ProcessFedExOneRateStandardOvernight()
        {
        }
        ...
        /// </summary>
        public static ProcessFedExOneRateStandardOvernight Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Set Service: FedEx One Rate® (Standard Overnight)
            Report.Log(ReportLevel.Info, "Set Value", "Set Service: FedEx One Rate® (Standard Overnight)\r\nSetting attribute SelectedItemText to 'FedEx One Rate® (Standard Overnight)' on item 'ShippingDlg.SplitContainer.Service'.", repo.ShippingDlg.SplitContainer.ServiceInfo, new RecordItemIndex(3));
            repo.ShippingDlg.SplitContainer.Service.Element.SetAttributeValue("SelectedItemText", "FedEx One Rate® (Standard Overnight)");
            Delay.Milliseconds(0);
            ...
            // Set Weight: 5
            Report.Log(ReportLevel.Info, "Keyboard", "Set Weight: 5\r\nKey sequence '5' with focus on 'ShippingDlg.SplitContainer.Weight'.", repo.ShippingDlg.SplitContainer.WeightInfo, new RecordItemIndex(6));
