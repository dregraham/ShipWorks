...
namespace ShipWorksPerformanceTestSuite
{
	...
	public class ApplyProfileTo500Orders : ITestModule
	{
		...
		void ITestModule.Run()
		{
			...
			Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ShippingDlg.SplitContainer.RawText1' at 3;11.", repo.ShippingDlg.SplitContainer.RawText1Info, new RecordItemIndex(0));
			repo.ShippingDlg.SplitContainer.RawText1.Click();
			...
			//            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ProgressDlg.ProcessingShipments' at Center.", repo.ProgressDlg.ProcessingShipmentsInfo, new RecordItemIndex(4));
			...
			repo.ShippingDlg.SplitContainer.ShipDate.Click();
			Delay.Milliseconds(0);
		}
	}
}
