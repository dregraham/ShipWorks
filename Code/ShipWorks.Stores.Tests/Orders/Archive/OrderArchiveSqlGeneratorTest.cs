        ...
        private IEnumerable<Type> CurrentlySupportedEntities
        {
            get
            {
                return new Type[]
                {
                    ...
                    typeof(AmazonSFPShipmentEntity),
                    typeof(AmazonSWAShipmentEntity),
                    ...
                    typeof(DhlEcommerceShipmentEntity),
                    ...
                    typeof(OverstockOrderEntity),
                    typeof(OverstockOrderItemEntity),
                    typeof(OverstockOrderSearchEntity),
        ...
        private IEnumerable<Type> ExcludedEntities
        {
            get
            {
                return new Type[]
                {
                    ...
                    typeof(AmazonSFPProfileEntity),
                    typeof(AmazonSFPServiceTypeEntity),
                    typeof(AmazonStoreEntity),
                    typeof(AmeriCommerceStoreEntity),
                    typeof(AmazonSWAAccountEntity),
                    typeof(AmazonSWAProfileEntity),
                    ...
                    typeof(OverstockStoreEntity),
                    typeof(PackageProfileEntity),
