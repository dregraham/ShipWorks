...
IF OBJECT_ID(N'[dbo].[DhlEcommerceScanForm]', 'U') IS NULL
	...
	[ScanFormTransactionID] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[ScanFormUrl] [varchar] (2048) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[CreatedDate] [datetime] NOT NULL,
	[ScanFormBatchID] [bigint] NOT NULL,
	[Description] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT((''))
	)
GO
...
IF OBJECT_ID(N'[dbo].[DhlEcommerceAccount]', 'U') IS NULL
	...
	[ShipEngineCarrierId] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[ClientId] [nvarchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[ApiSecret] [nvarchar] (400) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[PickupNumber] [nvarchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[DistributionCenter] [nvarchar] (12) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[SoldTo] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Description] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[FirstName] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[MiddleName] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[LastName] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Company] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Street1] [nvarchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Street2] [nvarchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Street3] [nvarchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[City] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[StateProvCode] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[PostalCode] [nvarchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[CountryCode] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Phone] [nvarchar] (26) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[Email] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL DEFAULT(('')),
	[CreatedDate] [datetime] NOT NULL
	)
GO
