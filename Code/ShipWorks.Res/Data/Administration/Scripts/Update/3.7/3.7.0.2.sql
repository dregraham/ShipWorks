...
GO
INSERT INTO [dbo].[tmp_rg_xx_Configuration]([ConfigurationID], [LogOnMethod], [AddressCasing], [CustomerCompareEmail], [CustomerCompareAddress], [CustomerUpdateBilling], [CustomerUpdateShipping], [AuditNewOrders], AuditDeletedOrders) 
                                     SELECT [ConfigurationID], [LogOnMethod], [AddressCasing], [CustomerCompareEmail], [CustomerCompareAddress], [CustomerUpdateBilling], [CustomerUpdateShipping], [AuditNewOrders], 0 FROM [dbo].[Configuration]
GO
