...
GO
INSERT INTO [dbo].[tmp_rg_xx_NeweggStore]([StoreID], [SellerID], [SecretKey], [ExcludeFulfilledByNewegg], [Channel]) 
SELECT [StoreID], [SellerID], [SecretKey], [ExcludeFulfilledByNewegg], 0 FROM [dbo].[NeweggStore]
GO
