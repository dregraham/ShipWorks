...
GO
INSERT INTO [dbo].[tmp_rg_xx_UspsAccount]([UspsAccountID], [Description], [Username], [Password], [FirstName], [MiddleName], [LastName], [Company], [Street1], [Street2], [Street3], [City], [StateProvCode], [PostalCode], [CountryCode], [Phone], [Email], [Website], [MailingPostalCode], [UspsReseller], [ContractType], [CreatedDate]) 
SELECT [UspsAccountID], '', [Username], [Password], [FirstName], [MiddleName], [LastName], [Company], [Street1], [Street2], [Street3], [City], [StateProvCode], [PostalCode], [CountryCode], [Phone], [Email], [Website], [MailingPostalCode], [UspsReseller], [ContractType], [CreatedDate] FROM [dbo].[UspsAccount]
GO
...
-- Not Express1
-- OR Express1 changed their Username structure
UPDATE UspsAccount
SET Description = Username
WHERE UspsReseller != 1 Or (len(Username) != 36 and UspsReseller = 1)
GO
-- Must be Express1
UPDATE UspsAccount
SET Description = Street1 + ', ' + PostalCode
Where UspsReseller = 1 and len(Username) = 36
GO