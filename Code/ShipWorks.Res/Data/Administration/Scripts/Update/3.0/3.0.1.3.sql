...
GO
INSERT INTO [dbo].[tmp_rg_xx_Store]([StoreID], [License], [Edition], [TypeCode], [StoreName], [Company], [Street1], [Street2], [Street3], [City], [StateProvCode], [PostalCode], [CountryCode], [Phone], [Fax], [Email], [Website], [IsSetupComplete], [AutoDownload], [AutoDownloadMinutes], [AutoDownloadOnlyAway], [DefaultEmailAccountID], [ManualOrderPrefix], [ManualOrderPostfix], [InitialDownloadDays], [InitialDownloadOrder]) SELECT [StoreID], [License], '', [TypeCode], [StoreName], [Company], [Street1], [Street2], [Street3], [City], [StateProvCode], [PostalCode], [CountryCode], [Phone], [Fax], [Email], [Website], [IsSetupComplete], [AutoDownload], [AutoDownloadMinutes], [AutoDownloadOnlyAway], [DefaultEmailAccountID], [ManualOrderPrefix], [ManualOrderPostfix], [InitialDownloadDays], [InitialDownloadOrder] FROM [dbo].[Store]
GO
SET IDENTITY_INSERT [dbo].[tmp_rg_xx_Store] OFF
GO
DECLARE @idVal INT
SELECT @idVal = IDENT_CURRENT(N'Store')
DBCC CHECKIDENT(tmp_rg_xx_Store, RESEED, @idVal)
GO
...
[GenericOrderNumberComplete] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
GO
