...
{	
	...
	/// <summary>
	/// Strongly typed collection of EquaShipProfileEntity
	/// </summary>
	public class EquaShipProfileCollection : EntityCollection<EquaShipProfileEntity>
	{
        /// <summary>
        /// Gets the count of all EquaShipProfileEntity rows
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all EquaShipProfileEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new EquaShipProfileEntityFactory().CreateFields(), bucket);
        }
		
        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static EquaShipProfileCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static EquaShipProfileCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            EquaShipProfileCollection collection = new EquaShipProfileCollection();
	...
	/// <summary>
	/// Strongly typed collection of EquaShipAccountEntity
	/// </summary>
	public class EquaShipAccountCollection : EntityCollection<EquaShipAccountEntity>
	{
        /// <summary>
        /// Gets the count of all EquaShipAccountEntity rows
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all EquaShipAccountEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new EquaShipAccountEntityFactory().CreateFields(), bucket);
        }
		
        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static EquaShipAccountCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static EquaShipAccountCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            EquaShipAccountCollection collection = new EquaShipAccountCollection();
	...
	/// <summary>
	/// Strongly typed collection of EquaShipShipmentEntity
	/// </summary>
	public class EquaShipShipmentCollection : EntityCollection<EquaShipShipmentEntity>
	{
        /// <summary>
        /// Gets the count of all EquaShipShipmentEntity rows
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all EquaShipShipmentEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new EquaShipShipmentEntityFactory().CreateFields(), bucket);
        }
		
        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static EquaShipShipmentCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static EquaShipShipmentCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            EquaShipShipmentCollection collection = new EquaShipShipmentCollection();
	...
	/// <summary>
	/// Strongly typed collection of AddressEntity
	/// </summary>
	public class AddressCollection : EntityCollection<AddressEntity>
	{
        /// <summary>
        /// Gets the count of all AddressEntity rows
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all AddressEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new AddressEntityFactory().CreateFields(), bucket);
        }
		
        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static AddressCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static AddressCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
	...
	/// <summary>
	/// Strongly typed collection of UpdateQueueEntity
	/// </summary>
	public class UpdateQueueCollection : EntityCollection<UpdateQueueEntity>
	{
        /// <summary>
        /// Gets the count of all UpdateQueueEntity rows
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all UpdateQueueEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(DataAccessAdapterBase adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new UpdateQueueEntityFactory().CreateFields(), bucket);
        }
		
        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static UpdateQueueCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static UpdateQueueCollection Fetch(DataAccessAdapterBase adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            UpdateQueueCollection collection = new UpdateQueueCollection();
