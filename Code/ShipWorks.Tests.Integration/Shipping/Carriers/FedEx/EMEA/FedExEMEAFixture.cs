...
{
    public class FedExEMEAFixture : FedExInternationalPrototypeFixture
    {
        public string ShipperTinType { get; set; }
        public string ShipperTinsNumber { get; set; }
        public string EtdRequestedDocumentCopies { get; set; }
        public string EtdLineNumber { get; set; }
        public string EtdDocumentProducer { get; set; }
        public string EtdDocumentType { get; set; }
        public string EtdDocumentId { get; set; }
        public string EtdDocumentIdProducer { get; set; }
        ...
        public string PackageLineItemCustomerReferenceType { get; set; }
        public string PackageLineItemCustomerReferenceValue { get; set; }
        public string HazardClass { get; set; }
        public string HazardSequenceNumber { get; set; }
        ...
        public static List<ColumnPropertyMapDefinition> Mapping
        {
            get
            {
                if (columnPropertyMap == null || !columnPropertyMap.Any())
                {
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.ShippingChargesPayment.Payor.ResponsibleParty.Contact.CountryCode", PropertyName = "ResponsiblePartyCountryCode", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.SpecialServicesRequested.EtdDetail..RequestedDocumentCopies", PropertyName = "EtdRequestedDocumentCopies", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.SpecialServicesRequested.EtdDetail.DocumentReferences.LineNumber", PropertyName = "EtdLineNumber", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.SpecialServicesRequested.EtdDetail.DocumentReferences.DocumentProducer", PropertyName = "EtdDocumentProducer", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.SpecialServicesRequested.EtdDetail.DocumentReferences.DocumentType", PropertyName = "EtdDocumentType", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.SpecialServicesRequested.EtdDetail.DocumentReferences.DocumentId", PropertyName = "EtdDocumentId", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.SpecialServicesRequested.EtdDetail.DocumentReferences.DocumentIdProducer", PropertyName = "EtdDocumentIdProducer", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.AccountNumber", PropertyName = "ImporterOfRecordAccountNumber", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Tins.TinType", PropertyName = "ImporterOfRecordTinType", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Tins.Number", PropertyName = "ImporterOfRecordTinsNumber", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Contact.PersonName", PropertyName = "ImporterOfRecordPersonName", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Contact.CompanyName", PropertyName = "ImporterOfRecordCompanyName", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Contact.PhoneNumber", PropertyName = "ImporterOfRecordPhoneNumber", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Address.StreetLines", PropertyName = "ImporterOfRecordStreetLines", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Address.City", PropertyName = "ImporterOfRecordCity", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Address.StateOrProvinceCode", PropertyName = "ImporterOfRecordStateProvinceCode", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Address.PostalCode", PropertyName = "ImporterOfRecordPostalCode", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.CustomsClearanceDetail.ImporterOfRecord.Address.CountryCode", PropertyName = "ImporterOfRecordCountryCode", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.CustomerReferences.CustomerReferenceType", PropertyName = "PackageLineItemCustomerReferenceType", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.CustomerReferences.Value", PropertyName = "PackageLineItemCustomerReferenceValue", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedShipment.RequestedPackageLineItems.SpecialServicesRequested(Repetitions).SpecialServiceTypes", PropertyName = "PackageLineItemSpecialServiceType2", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedShipment.RequestedPackageLineItems.SpecialServicesRequested(Repetitions2).SpecialServiceTypes", PropertyName = "PackageLineItemSpecialServiceType3", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.SpecialServicesRequested.DangerousGoodsDetail.Containers.ContainerType", PropertyName = "DangerousGoodsContainerType", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.SpecialServicesRequested.DangerousGoodsDetail.Containers.HazardousCommodities.Description.SequenceNumber", PropertyName = "HazardSequenceNumber", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.SpecialServicesRequested.DangerousGoodsDetail.Containers.HazardousCommodities.Description.PackingDetails.CargoAircraftOnly", PropertyName = "PackageCargoAircraftOnly", SpreadsheetColumnIndex = -1 });
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.SpecialServicesRequested.DangerousGoodsDetail.Containers.HazardousCommodities.Description.PackingDetails.PackingInstructions", PropertyName = "PackagePackingInstructions", SpreadsheetColumnIndex = -1 });
        ...
        private void SetupExportDetail(ShipmentEntity shipment)
        {
                ...
                (!string.IsNullOrEmpty(SpecialServiceType2) && SpecialServiceType2.ToLower() == "international_controlled_export_service"))
            {
                ...
                FedExInternationalControlledExportType internationalControlledExportDetailType;
                Enum.TryParse(HazardousPackingGroup, true, out internationalControlledExportDetailType);

                shipment.FedEx.IntlExportDetailType = (int) internationalControlledExportDetailType;
        ...
        {
            FedExCustomsRecipientIdentificationType defaultCustomsRecipientIdentificationType;
            Enum.TryParse(CustomsRecipientIdType, true, out defaultCustomsRecipientIdentificationType);

            shipment.FedEx.CustomsRecipientIdentificationType = (int) defaultCustomsRecipientIdentificationType;
        ...
        protected override void SetLinearUnits(ShipmentEntity shipment)
        {
            ...
            if (!string.IsNullOrEmpty(PackageLineItemUnits))
            {
                if (PackageLineItemUnits.ToLower() == "cm")
                {
        ...
        protected virtual void SetupCommercialInvoice(ShipmentEntity shipment)
        {
            ...
            FedExCommercialInvoicePurpose commercialInvoicePurpose;
            Enum.TryParse(CommercialInvoicePurpose, true, out commercialInvoicePurpose);

            shipment.FedEx.CommercialInvoicePurpose = (int) commercialInvoicePurpose;
            ...
            if (!string.IsNullOrWhiteSpace(PackageDangerousGoodsDetail) || !string.IsNullOrWhiteSpace(DangerousGoodsAccessibility))
            {
                foreach (FedExPackageEntity package in shipment.FedEx.Packages)
                {
                    ...
                    if (package.DangerousGoodsType == (int)FedExDangerousGoodsMaterialType.HazardousMaterials || !string.IsNullOrEmpty(HazardProperShippingName))
                    {
                        ...
                        package.DangerousGoodsCargoAircraftOnly = Convert.ToBoolean(int.Parse(PackageCargoAircraftOnly));

                        FedExHazardousMaterialsPackingGroup hazardousPackingGroup;
                        Enum.TryParse(HazardousPackingGroup, true, out hazardousPackingGroup);
                        package.HazardousMaterialPackingGroup = (int) hazardousPackingGroup;
                    }
                }
            }
        }
