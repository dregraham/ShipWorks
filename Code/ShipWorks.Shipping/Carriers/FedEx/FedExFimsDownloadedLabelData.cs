...
namespace ShipWorks.Shipping.Carriers.FedEx
{
    ...
    public class FedFimsExDownloadedLabelData : IDownloadedLabelData
    {
        ...
        /// Constructor
        /// </summary>
        public FedFimsExDownloadedLabelData(IEnumerable<IFedExShipResponse> carrierResponses, Func<Type, ILog> getLogger)
        {
