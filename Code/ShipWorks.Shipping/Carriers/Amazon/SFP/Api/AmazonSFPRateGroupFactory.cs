...
{
    public class AmazonSFPRateGroupFactory : IAmazonSFPRateGroupFactory
    {
        ...
        public AmazonSFPRateGroupFactory(IMessenger messenger, IEnumerable<IAmazonSFPRateGroupFilter> rateFilters, IAmazonSFPServiceTypeRepository serviceTypeRepository)
        {
