...
namespace ShipWorks.Shipping.Services.ShipmentProcessorPhases
{
    ...
    public class GetLabelResult : IGetLabelResult
    {
        ...
        /// Constructor
        /// </summary>
        public GetLabelResult(PrepareShipmentResult result)
        {
        ...
        /// Constructor
        /// </summary>
        public GetLabelResult(PrepareShipmentResult result, bool canceled) : this(result)
        {
            Canceled = canceled;
        }
        ...
        /// Constructor
        /// </summary>
        public GetLabelResult(PrepareShipmentResult result, ShippingException exception) : this(result)
        {
            Exception = exception;
        }
        ...
        /// Constructor
        /// </summary>
        public GetLabelResult(PrepareShipmentResult result, IDownloadedLabelData labelData,
