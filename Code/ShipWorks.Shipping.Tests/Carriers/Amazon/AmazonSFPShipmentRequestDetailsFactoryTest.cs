...
{
    public class AmazonSFPShipmentRequestDetailsFactoryTest
    {
        ...
        readonly AmazonSFPShipmentRequestDetailsFactory amazonShipmentRequestDetailsFactory;

        public AmazonSFPShipmentRequestDetailsFactoryTest()
        {
            mock = AutoMockExtensions.GetLooseThatReturnsMocks();
            order = mock.Build<IAmazonOrder>();
            amazonShipmentRequestDetailsFactory = mock.Create<AmazonSFPShipmentRequestDetailsFactory>();
        }
        ...
        public void CreateReturns_ShipmentRequestDetailsWith_DeliveryExperience()
        {
            ...
            Assert.Equal(testObject.ShippingServiceOptions.DeliveryExperience, EnumHelper.GetApiValue((AmazonSFPDeliveryExperienceType) 1));
        }
    }
}