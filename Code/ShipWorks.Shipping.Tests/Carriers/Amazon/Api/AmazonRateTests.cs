    ...
    public class AmazonRateTests
    {
        ...
        public void AmazonRate_GetRates_ProcessesReturnFromWebClient_Test()
        {
            using (var mock = AutoMock.GetLoose())
            {
                ...
                // First rate is 20.56
                GetEligibleShippingServicesResponse response = SerializationUtility.DeserializeFromXml<GetEligibleShippingServicesResponse>(GetEmbeddedResourceXml("ShipWorks.Shipping.Tests.Carriers.Amazon.Api.Artifacts.GetEligibleShippingServicesResponse.xml"));
                ...
                Assert.Equal(20.56m, resultRateGroup.Rates.First().Amount);
            }
        }
