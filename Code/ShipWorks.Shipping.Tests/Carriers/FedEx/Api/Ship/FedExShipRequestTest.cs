...
namespace ShipWorks.Shipping.Tests.Carriers.FedEx.Api.Ship
{
    public class FedExShipRequestTest
    {
        ...
        public void Submit_ReturnsResponseFromShipResult()
        {
            ...
            TelemetricResult<GenericResult<ProcessShipmentReply>> telemetricShipmentReply = new TelemetricResult<GenericResult<ProcessShipmentReply>>(TelemetricResultBaseName.ApiResponseTimeInMilliseconds);
