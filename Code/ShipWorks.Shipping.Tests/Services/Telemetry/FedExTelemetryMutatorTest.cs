...
namespace ShipWorks.Shipping.Tests.Services.Telemetry
{
    public class FedExTelemetryMutatorTest
    {
        ...
        public void MutateTelemetry_SetsTelemetryPropertiesFromShipment()
        {
            ...
            fedExShipment.VerifyGet(x => x.BrokerEnabled);
            ...
            fedExShipment.VerifyGet(x => x.CodAddFreight);
            ...
            fedExShipment.VerifyGet(x => x.CodEnabled);
            ...
            fedExShipment.VerifyGet(x => x.CommercialInvoice);
            ...
            fedExShipment.VerifyGet(x => x.CustomsDocumentsOnly);
            ...
            fedExShipment.VerifyGet(x => x.CustomsNaftaEnabled);
            ...
            fedExShipment.VerifyGet(x => x.EmailNotifyBroker);
            ...
            fedExShipment.VerifyGet(x => x.EmailNotifyOther);
            ...
            fedExShipment.VerifyGet(x => x.EmailNotifyRecipient);
            trackedDurationEventMock.Verify(x => x.AddProperty("Label.FedEx.EmailNotifySender", "True"));
            fedExShipment.VerifyGet(x => x.EmailNotifySender);
            ...
            fedExShipment.VerifyGet(x => x.FedExHoldAtLocationEnabled);
            ...
            fedExShipment.VerifyGet(x => x.FreightInsideDelivery);
            trackedDurationEventMock.Verify(x => x.AddProperty("Label.FedEx.FreightInsidePickup", "True"));
            fedExShipment.VerifyGet(x => x.FreightInsidePickup);
            ...
            fedExShipment.VerifyGet(x => x.HoldResidential);
            ...
            fedExShipment.VerifyGet(x => x.ImporterOfRecord);
            ...
            fedExShipment.VerifyGet(x => x.InternationalTrafficInArmsService);
            ...
            fedExShipment.VerifyGet(x => x.NonStandardContainer);
            ...
            fedExShipment.VerifyGet(x => x.ReturnSaturdayPickup);
            trackedDurationEventMock.Verify(x => x.AddProperty("Label.FedEx.ReturnsClearance", "True"));
            fedExShipment.VerifyGet(x => x.ReturnsClearance);
            ...
            fedExShipment.VerifyGet(x => x.SaturdayDelivery);
            ...
            fedExShipment.VerifyGet(x => x.SmartPostConfirmation);
            ...
            fedExShipment.VerifyGet(x => x.ThirdPartyConsignee);
            ...
            package.VerifyGet(x => x.ContainsAlcohol);
            ...
            package.VerifyGet(x => x.DangerousGoodsCargoAircraftOnly);
            ...
            package.VerifyGet(x => x.DangerousGoodsEnabled);
            ...
            package.VerifyGet(x => x.DimsAddWeight);
            ...
            package.VerifyGet(x => x.PackingDetailsCargoAircraftOnly);
            ...
            package.VerifyGet(x => x.PriorityAlert);
