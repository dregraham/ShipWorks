...
{
    public class PrepareShipmentPhaseTest : IDisposable
    {
        readonly ShipmentEntity shipment;
        readonly AutoMock mock;
        readonly PrepareShipmentPhase testObject;
        private ProcessShipmentState defaultInput;

        public PrepareShipmentPhaseTest()
        {
            mock = AutoMockExtensions.GetLooseThatReturnsMocks();
            testObject = mock.Create<PrepareShipmentPhase>();
