...
{
    public class CompleteLabelPhaseTest : IDisposable
    {
        readonly AutoMock mock;
        Mock<ISaveLabelResult> input;
        ShipmentEntity shipment;
        StoreEntity store;
        private readonly CompleteLabelPhase testObject;

        public CompleteLabelPhaseTest()
        {
            ...
            testObject = mock.Create<CompleteLabelPhase>();
        }

        [Fact]
        public void Finish_ClearsErrors_ForShipment()
        {
            testObject.Finish(input.Object);
        ...
        public void Finish_ReturnsInsufficientFundsException_WhenInputExceptionContainsInsufficientFundsException(int levels)
        {
            ...
            var result = testObject.Finish(input.Object);
