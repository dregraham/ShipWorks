...
namespace ShipWorks.Shipping.Tests.ShipEngine
{
    public class ShipmentElementFactoryTest : IDisposable
    {
        ...
        public void CreatePurchaseLabelRequest_PopulatesShipToAddress()
        {
            ...
            var request = testObject.CreatePurchaseLabelRequest(shipment, new List<IPackageAdapter>(), string.Empty, (a) => string.Empty, (a,b) => { });
        ...
        public void CreatePurchaseLabelRequest_ThrowsShipEngineException_WhenRequestedLabelFormatIsEPL()
        {
            ...
            Assert.Throws<ShipEngineException>(()=>testObject.CreatePurchaseLabelRequest(shipment, new List<IPackageAdapter>(), string.Empty, (a) => string.Empty, (a, b) => { }));
        }
        ...
        public void CreatePurchaseLabelRequest_PopulatesServiceCode()
        {
            ...
            var request = testObject.CreatePurchaseLabelRequest(shipment, new List<IPackageAdapter>(), "Foo", (a) => string.Empty, (a, b) => { });
