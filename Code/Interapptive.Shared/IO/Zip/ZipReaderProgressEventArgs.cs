...
{
    /// <summary>
    /// EventArgs for when a zip file is being read
    /// </summary>
    public class ZipReaderProgressEventArgs : CancelEventArgs
    {
        // Item currently being read
        ZipReaderItem currentItem;
        ...
        /// Constructor
        /// </summary>
        public ZipReaderProgressEventArgs(
            ZipReaderItem currentItem,
            long itemBytesProcessed,
            long itemBytesTotal,
            long totalBytesProcessed,
        ...
        /// </summary>
        public ZipReaderItem CurrentItem
        {
