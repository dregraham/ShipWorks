...
namespace Interapptive.Shared.IO.UnblockFiles
{
    ...
    /// </summary>
    /// <remarks>In Windows Server 2003 and later, to specify a zone in the enhanced security configuration, 
    /// combine one of the above values with ESC_FLAG using a bitwise OR.</remarks>
