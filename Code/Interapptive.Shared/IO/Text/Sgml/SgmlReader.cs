...
namespace Interapptive.Shared.IO.Text.Sgml {
    ...
    public class SgmlReader : XmlReader {
        ...
        void ParseDocType() {
            ...
            if (ch != '>') {
                ...
                if(this.dtd != null && string.Compare(this.dtd.Name, name, true) != 0) {
        ...
        bool ParseCData() {
            ...
            // NOTE (steveb): check if CDATA section begins and ends with an commented out CDATA section
            if(value.StartsWith("/*<![CDATA[*/") && value.EndsWith("/*]]>*/")) {
                value = value.Substring(13, value.Length - 20);
            }
        ...
        bool ValidAttributeName(string name) {
            try {
