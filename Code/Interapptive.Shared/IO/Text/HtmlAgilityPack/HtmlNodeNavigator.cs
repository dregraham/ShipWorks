...
namespace Interapptive.Shared.IO.Text.HtmlAgilityPack
{
	...
	{
		private HtmlAgilityDocument _doc = new HtmlAgilityDocument();
		...
		internal HtmlNodeNavigator(HtmlAgilityDocument doc, HtmlNode currentNode)
		{
			if (currentNode == null)
			{
		...
		/// </summary>
		public HtmlAgilityDocument CurrentDocument
		{
			get
			{
				return _doc;
