...
namespace Interapptive.Shared.IO.Text.HtmlAgilityPack
{
	...
	public class HtmlAttribute: IComparable
	{
		...
		internal HtmlAgilityDocument _ownerdocument; // attribute can exists without a node
		internal HtmlNode _ownernode;
		internal string _name;
		internal string _value;

		internal HtmlAttribute(HtmlAgilityDocument ownerdocument)
		{
		...
		internal string XmlName
		{
			get
			{
				return HtmlAgilityDocument.GetXmlName(Name);
			}
		}
