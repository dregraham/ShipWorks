...
{
    /// <summary>
    /// Implementation of IPdfBlackAndWhiteDocument that uses Apitron to convert a PDF to an image (TIFF) .
    /// </summary>
    [KeyedComponent(typeof(IPdfDocument), PdfDocumentType.BlackAndWhite)]
    public class PdfBlackAndWhiteDocument : IPdfDocument
    {
        /// <summary>
        ...
        /// </summary>
        private T SavePage<T>(int pageNumber, Image tiff, FrameDimension dimension, Func<MemoryStream, int, T> savePageFunction)
        {
