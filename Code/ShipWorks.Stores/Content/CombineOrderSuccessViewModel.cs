...
namespace ShipWorks.Stores.Content
{
    ...
    /// </summary>
    [Component]
    public class CombineOrderSuccessViewModel : ICombineOrderSuccessViewModel
    {
        private const UserConditionalNotificationType notificationType = UserConditionalNotificationType.CombineOrders;
        private readonly ICombineOrderSuccessDialog dialog;
        ...
        /// Constructor
        /// </summary>
        public CombineOrderSuccessViewModel(ICombineOrderSuccessDialog dialog, ICurrentUserSettings currentUserSettings, IMessageHelper messageHelper)
        {
