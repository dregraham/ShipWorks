...
namespace ShipWorks.Stores.Content
{
    ...
    public class CombineOrderViewModel : ICombineOrdersViewModel, INotifyPropertyChanged
    {
        private readonly IMessageHelper messageHelper;
        private readonly ICombineOrderDialog combineOrdersDialog;
        ...
        /// Constructor
        /// </summary>
        public CombineOrderViewModel(IMessageHelper messageHelper,
            ICombineOrderDialog combineOrdersDialog,
            ICombineOrderAddressComparer addressComparer)
        {
