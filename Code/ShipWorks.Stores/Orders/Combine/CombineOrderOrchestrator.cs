...
namespace ShipWorks.Stores.Orders.Combine
{
    ...
    /// </summary>
    [Component]
    public class CombineOrderOrchestrator : ICombineOrderOrchestrator
    {
        private readonly ICombineOrderGateway gateway;
        private readonly IMessageHelper messageHelper;
        private readonly IOrderCombinationUserInteraction userInteraction;
        ...
        /// Constructor
        /// </summary>
        public CombineOrderOrchestrator(ICombineOrderGateway gateway,
