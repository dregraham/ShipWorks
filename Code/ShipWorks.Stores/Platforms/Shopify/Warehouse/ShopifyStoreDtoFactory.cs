...
namespace ShipWorks.Stores.Platforms.Shopify.Warehouse
{
	...
	public class ShopifyStoreDtoFactory : IStoreDtoFactory
	{
		...
		/// Constructor
		/// </summary>
		public ShopifyStoreDtoFactory(IDownloadStartingPoint downloadStartingPoint, IEncryptionProviderFactory encryptionProviderFactory,
									IStoreDtoHelpers helpers, ILicenseService licenseService, ITangoWebClient tangoWebClient)
		{
