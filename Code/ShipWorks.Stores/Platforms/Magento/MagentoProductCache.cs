...
namespace ShipWorks.Stores.Platforms.Magento
{
    ...
    {
        private readonly Dictionary<string, LruCache<string, IProduct>> storeProductCaches;
        ...
        {
            storeProductCaches = new Dictionary<string, LruCache<string, IProduct>>();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public LruCache<string, IProduct> GetStoreProductCache(long storeID)
        {
            // Create the key for the store
            string key = $"{storeID}";

            LruCache<string, IProduct> productCache;
            ...
            {
                productCache = new LruCache<string, IProduct>(1000);
