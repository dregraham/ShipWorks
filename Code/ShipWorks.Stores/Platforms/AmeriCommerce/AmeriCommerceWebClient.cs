...
namespace ShipWorks.Stores.Platforms.AmeriCommerce
{
    ...
    public class AmeriCommerceWebClient : IAmeriCommerceWebClient
    {
        ...
        private readonly Dictionary<int, string> stateCache = new Dictionary<int, string>();
        private readonly Dictionary<int, string> countryCache = new Dictionary<int, string>();
