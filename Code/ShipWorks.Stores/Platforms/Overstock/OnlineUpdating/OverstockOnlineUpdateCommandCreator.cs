...
namespace ShipWorks.Stores.Platforms.Overstock.OnlineUpdating
{
    ...
    /// </summary>
    [KeyedComponent(typeof(IOnlineUpdateCommandCreator), StoreTypeCode.Overstock)]
    public class OverstockOnlineUpdateCommandCreator : IOnlineUpdateCommandCreator
    {
        private readonly IOverstockShipmentDetailsUpdater shipmentUpdater;
        ...
        /// Constructor
        /// </summary>
        public OverstockOnlineUpdateCommandCreator(IOverstockShipmentDetailsUpdater shipmentUpdater,
        ...
        public IEnumerable<IMenuCommand> CreateOnlineUpdateCommonCommands() =>
            new[] { new AsyncMenuCommand("Upload Shipment Details", OnUploadShipmentDetails) };
