...
namespace ShipWorks.Stores.Platforms.LemonStand
{
    ...
    {
        private static Dictionary<string, LruCache<int, LemonStandItem>> storeProductCaches = new Dictionary<string, LruCache<int, LemonStandItem>>();
        ...
        public static LruCache<int, LemonStandItem> GetStoreProductImageCache(string storeUrl, string accessToken)
        {
            ...
            string key = string.Format("{0}-{1}", storeUrl, accessToken);
