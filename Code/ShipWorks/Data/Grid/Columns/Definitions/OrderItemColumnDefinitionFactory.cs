            ...
            GridColumnDefinitionCollection definitions = new GridColumnDefinitionCollection
                     {
                        ...
                        new GridColumnDefinition("{47FACE52-9D1C-45ad-B0E6-4217517935EB}", true,
                         ...
                         new GridColumnDefinition("{8D37F80C-A435-44A3-AD61-B3E66B99FE5B}", false,
                             new GridTextDisplayType(), "Custom Field 2", "Custom Field 2",
                             OrderItemFields.Custom2),

                         new GridColumnDefinition("{B8F1A84C-4AF0-4A4E-9F6E-C9BB37E8B4FD}", false,
                             new GridTextDisplayType(), "Custom Field 3", "Custom Field 3",
                             OrderItemFields.Custom3),

                         new GridColumnDefinition("{E676687E-EFFA-42CD-AD59-210F0F6E2071}", false,
                        ...
                        new GridColumnDefinition("{BFDB0A70-5F25-49a4-BBD0-9884675DBB98}",
                         ...
                         new GridColumnDefinition("{B5E61F0E-FE6E-4F8F-9106-0B8F0F7557C7}",
                             new GridTextDisplayType(), "Distribution Center ID", "0",
                             ChannelAdvisorOrderItemFields.DistributionCenterID)
                         {
                             StoreTypeCode = StoreTypeCode.ChannelAdvisor,
                         },
