    ...
    public static class SqlAdapterRetry
    {
        ...
        public static GenericResult<Unit> ExecuteWithRetry(
            ...
            Using(
                ...
                _ => Retry(method.ToFunc(), options.Retries, options.RetryDelay, isHandleableException, options.Log));
        ...
        public static Task<T> ExecuteWithRetryAsync<T>(
            ...
            UsingAsync(
                ...
                _ => RetryAsync(method, options.Retries, options.RetryDelay, isHandleableException, options.Log));
    }
}
