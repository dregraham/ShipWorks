...
VALUES (N'Delete old labels', 1, 0, '', 0, N'', 6, CONVERT(xml,N'<Settings><DailyActionSchedule><ScheduleType>2</ScheduleType><StartDateTimeInUtc>' + @StartDateTimeString  + '</StartDateTimeInUtc><FrequencyInDays>1</FrequencyInDays></DailyActionSchedule></Settings>',1), N'PurgeDatabase', NULL)
...
VALUES (CONVERT(BIGINT, @ActionID), N'PurgeDatabase', CONVERT(xml,N'<Settings><CanTimeout value="True"/><TimeoutInHours value="6"/><RetentionPeriodInDays value="30"/><Purges><Item type="ShipWorks.Actions.Tasks.Common.PurgeDatabaseType" value="3"/></Purges></Settings>',1), 0, 1, -1, 0, -1, 0, 0, 0)
