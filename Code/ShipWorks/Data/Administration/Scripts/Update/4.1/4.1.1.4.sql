...
[LastFilterTargetSelected] [int] NOT NULL
)
GO
INSERT INTO [dbo].[tmp_rg_xx_UserSettings]([UserID], [DisplayColorScheme], [DisplaySystemTray], [WindowLayout], [GridMenuLayout], [FilterInitialUseLastActive], [OrderFilterInitialSpecified], [FilterInitialSortType], [OrderFilterLastActive], [OrderFilterExpandedFolders], [ShippingWeightFormat], [TemplateExpandedFolders], [TemplateLastSelected], [CustomerFilterInitialSpecified], [CustomerFilterLastActive], 
		[CustomerFilterExpandedFolders], [LastFilterTargetSelected]) 
	SELECT [UserID], [DisplayColorScheme], [DisplaySystemTray], [WindowLayout], [GridMenuLayout], [FilterInitialUseLastActive], [OrderFilterInitialSpecified], [FilterInitialSortType], [OrderFilterLastActive], [OrderFilterExpandedFolders], [ShippingWeightFormat], [TemplateExpandedFolders], [TemplateLastSelected], [CustomerFilterInitialSpecified], [CustomerFilterLastActive], 
		[CustomerFilterExpandedFolders], 0 FROM [dbo].[UserSettings]
GO
