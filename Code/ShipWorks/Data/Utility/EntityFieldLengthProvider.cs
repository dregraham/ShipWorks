    ...
    public partial class EntityFieldLengthProvider : Component, IExtenderProvider, ISupportInitialize
    {
        ...
        private static EntityField2 GetSourceField(EntityFieldLengthSource source)
        {
            switch (source)
            {
                ...
                case EntityFieldLengthSource.OrderItemHarmonizedCode: return OrderItemFields.HarmonizedCode;
                ...
                case EntityFieldLengthSource.ShipEngineDescription: return ShipEngineAccountFields.Description;
            }
