...
namespace ShipWorks.Shipping.ShipEngine.DTOs
{
    ...
    public partial class Shipment : IEquatable<Shipment>, IValidatableObject
    {
        ...
        /// <param name="taxIdentifiers">taxIdentifiers.</param>
        public Shipment(
            string shipmentId = default(string),
            string carrierId = default(string),
            ...
            DateTime? modifiedAt = default(DateTime?),
            ShipmentStatusEnum? shipmentStatus = default(ShipmentStatusEnum?),
            Address shipTo = default(Address),
            Address shipFrom = default(Address),
            string warehouseId = default(string),
            Address returnTo = default(Address),
            ConfirmationEnum? confirmation = default(ConfirmationEnum?),
            InternationalOptions customs = default(InternationalOptions),
            string externalOrderId = default(string),
            OrderSourceCodeEnum? orderSourceCode = default(OrderSourceCodeEnum?),
            AdvancedOptions advancedOptions = default(AdvancedOptions),
            InsuranceProviderEnum? insuranceProvider = default(InsuranceProviderEnum?),
            List<TagResponse> tags = default(List<TagResponse>),
            List<ShipmentPackage> packages = default(List<ShipmentPackage>),
            List<ShipmentItem> items = default(List<ShipmentItem>),
            List<TaxIdentifier> taxIdentifiers = default(List<TaxIdentifier>)
        )
        {
        ...
        /// </summary>
        [DataMember(Name = "tax_identifiers", EmitDefaultValue = false)]
