...
namespace ShipWorks.Shipping.Carriers.UPS.OnLineTools.Api
{
    ...
    public static class UpsApiShipClient
    {
        ...
        private static TelemetricResult<XmlDocument> ProcessShipConfirm(ShipmentEntity shipment)
        {
            ...
            {
                PersonAdapter soldTo = recipient.CopyToNew();
                soldTo.PostalCode = soldTo.PostalCode?.Replace("-", string.Empty);
            ...
            TelemetricResult<XmlDocument> telemetricResult = new TelemetricResult<XmlDocument>($"UpsShipConfirm.{TelemetricResultBaseName.ApiResponsetimeInMs}");
        ...
        private static TelemetricResult<UpsLabelResponse> CallShipAccept(ShipmentEntity shipment, XPathNavigator shipConfirmNavigator)
        {
            ...
            TelemetricResult<UpsLabelResponse> telemetricResult = new TelemetricResult<UpsLabelResponse>($"UpsShipAccept.{TelemetricResultBaseName.ApiResponsetimeInMs}");
