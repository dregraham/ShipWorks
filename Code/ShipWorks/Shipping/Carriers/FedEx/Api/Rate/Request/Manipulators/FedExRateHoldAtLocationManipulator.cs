...
namespace ShipWorks.Shipping.Carriers.FedEx.Api.Rate.Request.Manipulators
{
    ...
    /// </summary>
    public class FedExRateHoldAtLocationManipulator : ICarrierRequestManipulator
    {
        /// <summary>
        ...
        public void Manipulate(CarrierRequest request)
        {
            ...
            RateRequest requestedShipment = request.NativeRequest as RateRequest;
            ...
            if (fedExShipment.FedExHoldAtLocationEnabled)
            {
                ...
                if (requestedShipment.RequestedShipment.SpecialServicesRequested.SpecialServiceTypes == null)
                {
                    requestedShipment.RequestedShipment.SpecialServicesRequested.SpecialServiceTypes = new ShipmentSpecialServiceType[0];
                }

                // Add the hold at location service type
                List<ShipmentSpecialServiceType> serviceTypes = requestedShipment.RequestedShipment.SpecialServicesRequested.SpecialServiceTypes.ToList();
                serviceTypes.Add(ShipmentSpecialServiceType.HOLD_AT_LOCATION);
                requestedShipment.RequestedShipment.SpecialServicesRequested.SpecialServiceTypes = serviceTypes.ToArray();

                HoldAtLocationDetail holdAtLocationDetail = requestedShipment.RequestedShipment.SpecialServicesRequested.HoldAtLocationDetail;
