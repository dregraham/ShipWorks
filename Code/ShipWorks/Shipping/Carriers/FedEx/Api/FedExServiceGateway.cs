...
namespace ShipWorks.Shipping.Carriers.FedEx.Api
{
    ...
    public class FedExServiceGateway : IFedExServiceGateway
    {
        ...
        {
            TelemetricResult<GenericResult<ProcessShipmentReply>> result = new TelemetricResult<GenericResult<ProcessShipmentReply>>(TelemetricResultBaseName.ApiResponsetimeInMs);
            ...
            {   // Point the service to the correct endpoint
                ...
                result.RunTimedEvent(TelemetricEventType.GetLabel, () => processReply = service.processShipment(nativeShipmentRequest));
