...
namespace ShipWorks.Shipping.Carriers.FedEx.Api
{
    ...
    public class FedExApiCarrierException : CarrierException
    {
        ...
        /// Constructor
        /// </summary>
        public FedExApiCarrierException(WebServices.v2013.Track.Notification[] notifications)
            : base(GenerateMessage(notifications.Select(n => n.Message ?? n.Code)))
        {
        }
        ...
        /// Constructor
        /// </summary>
        public FedExApiCarrierException(WebServices.v2013.Close.Notification[] notifications)
                :base(GenerateMessage(notifications.Select(n => n.Message ?? n.Code)))
        {
        }
