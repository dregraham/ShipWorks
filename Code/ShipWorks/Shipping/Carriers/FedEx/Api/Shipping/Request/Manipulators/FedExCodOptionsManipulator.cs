...
namespace ShipWorks.Shipping.Carriers.FedEx.Api.Shipping.Request.Manipulators
{
    ...
    public class FedExCodOptionsManipulator : FedExShippingRequestManipulatorBase
    {
        ...
        /// </summary>
        public FedExCodOptionsManipulator()
        ...
        public FedExCodOptionsManipulator(FedExSettings fedExSettings)
            : base(fedExSettings)
        {
        }
        ...
        public FedExCodOptionsManipulator(ICarrierSettingsRepository settingsRepository) : base(settingsRepository)
        {
        }
