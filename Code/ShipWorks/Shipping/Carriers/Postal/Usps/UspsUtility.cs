...
namespace ShipWorks.Shipping.Carriers.Postal.Usps
{
	...
	public static class UspsUtility
	{
			...
			new Dictionary<ServiceType, PostalServiceType>
		{
			...
			{ServiceType.USRETURN, PostalServiceType.PayOnUseReturn},
			{ServiceType.SCGPPSSS, PostalServiceType.GlobalPostParcelSelectSmartSaver},
			{ServiceType.USGA, PostalServiceType.GroundAdvantage }
		};
