...
namespace ShipWorks.Shipping.Carriers.Postal.Usps.Api.Labels
{
    ...
    public class LabelFactory
    {
        ...
        public IEnumerable<Label> CreateLabels(ShipmentEntity shipment, List<string> labelUrls)
        {
            ...
            //            {
            //                // Standard
            //                labels.Add(CreateStandardLabel(shipment, "LabelPrimary", labelUrls[0], CroppingStyles.None)); //  CroppingStyles.MilitaryPrimaryCrop));
            //                labels.Add(CreateStandardLabel(shipment, "LabelPart2", labelUrls[0], CroppingStyles.None)); //  CroppingStyles.MilitaryContinuationCrop));

            //                // Sometimes we don't get additional label urls (large envelope, etc..), so only try to add 3 and 4 if they exist.
            //                if (labelUrls.Count >= 2)
            //                {
            //                    labels.Add(CreateStandardLabel(shipment, "LabelPart3", labelUrls[1], CroppingStyles.None)); //  CroppingStyles.MilitaryPrimaryCrop));
            //                    labels.Add(CreateStandardLabel(shipment, "LabelPart4", labelUrls[1], CroppingStyles.None)); //  CroppingStyles.MilitaryContinuationCrop));
            //                }
            //            }
            //        }
            //        else
            ...
            //            Rectangle croppingStyle = CroppingStyles.None; // PostalPackagingType.Envelope == (PostalPackagingType) shipment.Postal.PackagingType ? CroppingStyles.None : CroppingStyles.SingleInternationalCrop;
            ...
            //    //    Rectangle croppingStyle = CroppingStyles.None; // PostalPackagingType.Envelope == (PostalPackagingType)shipment.Postal.PackagingType ? 
            //    //        //CroppingStyles.None : 
        ...
        //    //    for (int i = 0; i < labelUrls.Count; i++)
        //    //    {
        //    //        string labelUrl = labelUrls[i];

        //    //        if (i == 0)
        //    //        {
        //    //            labels.Add(CreateLabel(shipment, "LabelPrimary", labelUrl, CroppingStyles.None));
        //    //        }
        //    //        else
        //    //        {
        //    //            labels.Add(CreateLabel(shipment, string.Format("LabelPart{0}", i), labelUrl, CroppingStyles.None));
        //    //        }
        //    //    }
        //    //}
        ...
        //    //    labels.Add(CreateLabel(shipment, "LabelPrimary", labelUrls[0], CroppingStyles.None)); // CroppingStyles.SingleInternationalCrop));
        //    //}
        ...
        //    //        labels.Add(CreateLabel(shipment, "LabelPrimary", labelUrls[0], CroppingStyles.None)); // CroppingStyles.PrimaryCrop));
        //    //        labels.Add(CreateLabel(shipment, "LabelPart2", labelUrls[0], CroppingStyles.None)); // CroppingStyles.ContinuationCrop));
        //    //        labels.Add(CreateLabel(shipment, "LabelPart3", labelUrls[1], CroppingStyles.None)); // CroppingStyles.PrimaryCrop));
        //    //        labels.Add(CreateLabel(shipment, "LabelPart4", labelUrls[1], CroppingStyles.None)); // CroppingStyles.ContinuationCrop));
        //    //    }
        //    //    else
        //    //    {
        ...
        //    //        labels.Add(CreateLabel(shipment, "LabelPart5", labelUrls[2], CroppingStyles.None)); // CroppingStyles.PrimaryCrop));

        //    //        // create a blank png so that the sender's copy and continuation page are separate from the Dispatch Note
        //    //        if (shipment.ActualLabelFormat == null)
        //    //        {
        //    //            labels.Add(CreateBlankLabel(shipment, "LabelPartBlank", CroppingStyles.None)); // CroppingStyles.PrimaryCrop));
        //    //        }

        //    //        // Sender's Copy + continuation
        //    //        labels.Add(CreateLabel(shipment, "LabelPart6", labelUrls[3], CroppingStyles.None)); // CroppingStyles.PrimaryCrop));
        //    //        labels.Add(CreateLabel(shipment, "LabelPart7", labelUrls[3], CroppingStyles.None)); // CroppingStyles.ContinuationCrop));
        //    //    }
        //    //}
        //}
