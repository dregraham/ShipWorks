    ...
    public static class Express1EndiciaCustomerServiceClient
    {
        ...
        private static string EncryptData(string dataString)
        {
            using (Rijndael rijndael = Rijndael.Create())
            {
                ...
                // our secret stuff
                string key = Express1EndiciaUtility.CertificateID.Substring(0, 32);
        ...
        public static string GetCustomerInfoString(string customerID)
        {
            ...
            string info = string.Format("{0}|{1}|Account", Express1EndiciaUtility.FranchiseID, customerID);
        ...
        public static void Signup(EndiciaAccountEntity account, PersonAdapter address, EndiciaPaymentInfo paymentInfo)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    customerData.CreditCard.CardType = Express1EndiciaUtility.GetExpress1CardType(paymentInfo.CardType); // enum values align, we're ok 
                ...
                {
                    CustomerCredentials returnedCredentials = service.RegisterCustomer(Express1EndiciaUtility.ApiKey, GetCustomerInfoString(Guid.NewGuid().ToString()), customerData);
