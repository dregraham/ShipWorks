...
namespace ShipWorks.Shipping.Carriers.Postal.Endicia.Express1
{
    ...
    /// </summary>
    public class EndiciaExpress1SettingsFacade : IExpress1SettingsFacade
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndiciaExpress1SettingsFacade"/> class.
        /// </summary>
        /// <param name="settings">The shipping settings being used as the data source for the facade.</param>
        public EndiciaExpress1SettingsFacade(ShippingSettingsEntity settings)
        {
            if (settings == null)
            {
