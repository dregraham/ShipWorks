...
namespace ShipWorks.Shipping.Carriers.Postal.Express1
{
    ...
    static class Express1Utility
    {
        ...
        public static bool UseTestServer
        {
            get
            {
                return InterapptiveOnly.Registry.GetValue("Express1TestServer", false);
            }
            set
            {
                InterapptiveOnly.Registry.SetValue("Express1TestServer", value);
            }
        }
