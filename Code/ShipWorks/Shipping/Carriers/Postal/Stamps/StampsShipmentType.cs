    ...
    public class StampsShipmentType : PostalShipmentType
    {
        ...
        public override IBestRateShippingBroker GetShippingBroker(ShipmentEntity shipment)
        {
            ...
            else
            {
                ...
                return new StampsCounterRatesBroker(new StampsCounterRateAccountRepository(TangoCredentialStore.Instance));
            }
        }
        ...
        protected override RateGroup GetCounterRates(ShipmentEntity shipment)
        {
            ...
            try
            {
                ...
                AccountRepository = new StampsCounterRateAccountRepository(TangoCredentialStore.Instance);
                CertificateInspector = new CertificateInspector(TangoCredentialStore.Instance.StampsCertificateVerificationData);
