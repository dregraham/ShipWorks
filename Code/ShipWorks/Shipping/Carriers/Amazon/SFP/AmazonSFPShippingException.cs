...
namespace ShipWorks.Shipping.Carriers.Amazon.SFP
{
    ...
    /// </summary>
    [Serializable]
    public class AmazonSFPShippingException : ShippingException
    {
        ...
        /// Constructor
        /// </summary>
        public AmazonSFPShippingException()
            : this(null, null, null)
        { }
        ...
        /// Constructor
        /// </summary>
        public AmazonSFPShippingException(string message)
        ...
        /// Constructor
        /// </summary>
        public AmazonSFPShippingException(string message, Exception ex)
        ...
        /// Constructor
        /// </summary>
        public AmazonSFPShippingException(string message, string code)
        ...
        /// Constructor
        /// </summary>
        public AmazonSFPShippingException(string message, string code, Exception innerException)
        ...
        /// Constructor
        /// </summary>
        protected AmazonSFPShippingException(SerializationInfo serializationInfo, StreamingContext streamingContext) :
