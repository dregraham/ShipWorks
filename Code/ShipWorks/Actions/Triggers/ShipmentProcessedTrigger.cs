...
{
    /// <summary>
    /// A shipment has been processed
    /// </summary>
    public class ShipmentProcessedTrigger : ActionTrigger
    {
        ...
        /// </summary>
        public ShipmentProcessedTrigger()
            : base(null)
        {
        ...
        /// Constructor
        /// </summary>
        public ShipmentProcessedTrigger(string xmlSettings)
            : base(xmlSettings)
        {
        ...
        {
            get { return ActionTriggerType.ShipmentProcessed; }
        }
        ...
        {
            return new ShipmentProcessedTriggerEditor(this);
        }
        ...
        /// <summary>
        /// Indicates if the action should be restricted to running only when a specified shipment type is processed
        /// </summary>
