...
{
    partial class AuctionSoundAccountPage
    {
        /// <summary> 
        ...
        {
            this.accountSettingsControl = new ShipWorks.Stores.Platforms.AuctionSound.AuctionSoundAccountSettingsControl();
            this.SuspendLayout();
            // 
        ...
        private AuctionSoundAccountSettingsControl accountSettingsControl;
    }
}
