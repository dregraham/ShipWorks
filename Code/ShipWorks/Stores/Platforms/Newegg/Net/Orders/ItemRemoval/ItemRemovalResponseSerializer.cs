...
namespace ShipWorks.Stores.Platforms.Newegg.Net.Orders.ItemRemoval
{
    ...
    /// a ItemRemovalResult object.
    /// </summary>
    public class ItemRemovalResponseSerializer : INeweggSerializer
    {
        /// <summary>
        ...
        {
            ItemRemovalResult removalResult = SerializationUtility.DeserializeFromXml<ItemRemovalResult>(xml) as ItemRemovalResult;
