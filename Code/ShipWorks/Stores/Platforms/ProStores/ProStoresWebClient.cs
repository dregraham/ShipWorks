...
namespace ShipWorks.Stores.Platforms.ProStores
{
    ...
    public class ProStoresWebClient : IProStoresWebClient
    {
        ...
        /// </summary>
        public XmlDocument GetStoreApiInfo(string apiEntryPoint)
        {
            try
            {
        ...
        /// </summary>
        public string CreateApiLogonUrl(IProStoresStoreEntity store, out string ticket)
        {
        ...
        /// </summary>
        public XmlDocument GetTokenFromTicket(IProStoresStoreEntity store, string ticket)
        {
            HttpVariableRequestSubmitter request = new HttpVariableRequestSubmitter();
        ...
        /// </summary>
        public void CheckTokenLoginMethodAvailability(ProStoresStoreEntity store)
        {
        ...
        /// </summary>
        public void TestXteConnection(IProStoresStoreEntity store)
        {
        ...
        /// </summary>
        public int GetOrderCount(IProStoresStoreEntity store, DateTime? lastModified)
        {
        ...
        /// Get the number of online orders for the store after the given date
        /// </summary>
        private static int GetOrderCountLegacy(IProStoresStoreEntity store, DateTime? lastModified)
        {
            XmlTextWriter xmlRequest = CreateXteRequest(store, "Invoice");
        ...
        /// </summary>
        public XmlDocument GetNextOrderPage(IProStoresStoreEntity store, DateTime? lastModified, bool proVersion)
        {
            XmlTextWriter xmlRequest = CreateXteRequest(store, "Invoice");
        ...
        /// </summary>
        public void UploadShipmentDetails(IProStoresStoreEntity store, ShipmentEntity shipment, OrderUploadDetails orderDetails)
        {
        ...
        /// </summary>
        private static string GetRestUrl(IProStoresStoreEntity store, string name, string verb)
        {
        ...
        private static XmlTextWriter CreateXteRequest(IProStoresStoreEntity store, string requestType)
        {
        ...
        {
            IProStoresStoreEntity store = (IProStoresStoreEntity) ((TaggedXmlTextWriter) xmlWriter).Tag;
        ...
        /// </summary>
        private static string GetXteUrl(IProStoresStoreEntity store)
        {
            if (store.LoginMethod == (int) ProStoresLoginMethod.ApiToken)
            {
