...
{
    /// <summary>
    /// Condition for the ChannelAdvisor marketplace name
    /// </summary>
    [ConditionElement("ChannelAdvisor Marketplace", "ChannelAdvisorOrderItem.SiteName")]
    [ConditionStoreType(StoreTypeCode.ChannelAdvisor)]
    public class ChannelAdvisorMarketplaceNameCondition : StringCondition
    {
        /// <summary>
        ...
        public override string GenerateSql(SqlGenerationContext context)
        {
            ...
            {
                return scope.Adorn(GenerateSql(context.GetColumnReference(ChannelAdvisorOrderItemFields.MarketplaceName), context));
            }
        }
    }
}
