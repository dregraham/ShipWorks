...
{
    /// <summary>
    /// Condition for the ChannelAdvisor buyer
    /// </summary>
    [ConditionElement("ChannelAdvisor Buyer ID", "ChannelAdvisorOrderItem.BuyerID")]
    [ConditionStoreType(StoreTypeCode.ChannelAdvisor)]
    public class ChannelAdvisorMarketplaceBuyerCondition : StringCondition
    {
        /// <summary>
        ...
        public override string GenerateSql(SqlGenerationContext context)
        {
            ...
            {
                return scope.Adorn(GenerateSql(context.GetColumnReference(ChannelAdvisorOrderItemFields.MarketplaceBuyerID), context));
            }
        }
    }
}
