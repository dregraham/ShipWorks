...
{
    /// <summary>
    /// Handles api responses from MWS API
    /// </summary>
    public static class AmazonMwsResponseHandler
    {
        ...
        /// </summary>
        public static XPathNamespaceNavigator GetXPathNavigator(IHttpResponseReader response, AmazonMwsApiCall apiCall, IAmazonMwsWebClientSettings mwsSettings)
        {
            if (response == null)
            {
        ...
        /// </summary>
        public static void RaiseErrors(AmazonMwsApiCall api, IHttpResponseReader reader, IAmazonMwsWebClientSettings mwsSettings)
        {
            if (mwsSettings == null)
            {
                throw new ArgumentNullException("mwsSettings");
