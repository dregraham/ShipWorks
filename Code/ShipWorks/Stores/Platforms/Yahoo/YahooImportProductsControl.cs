...
namespace ShipWorks.Stores.Platforms.Yahoo
{
    ...
    /// </summary>
    public partial class YahooImportProductsControl : UserControl
    {
        long storeID = 0;
        ...
        /// Constructor
        /// </summary>
        public YahooImportProductsControl()
        {
            InitializeComponent();
        }
        ...
        private void BackgroundImportInventory(object state)
        {
            ...
            try
            {
                YahooProductManager.ImportProductCatalog(progressItem, storeID, url);
            }
