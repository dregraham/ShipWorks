...
namespace ShipWorks.Stores.Platforms.ChannelSale
{
    ...
    /// </summary>
    [KeyedComponent(typeof(StoreType), StoreTypeCode.ChannelSale)]
    ...
    public class ChannelSaleStoreType : GenericModuleStoreType
    {
        ...
        /// Constructor
        /// </summary>
        public ChannelSaleStoreType(StoreEntity store, IMessageHelper messageHelper, IOrderManager orderManager)
