...
namespace ShipWorks.Stores.Platforms.Ebay
{
    ...
    public class EbayWebClient : IEbayWebClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EbayWebClient"/> class.
        /// </summary>
        public EbayWebClient()
        ...
        public EbayWebClient(IRequestFactory requestFactory)
        {
        ...
        private static TokenData CreateTokenData(string tokenKey)
        {
            ...
            return new TokenData { Key = tokenKey };
        }
    }
}
