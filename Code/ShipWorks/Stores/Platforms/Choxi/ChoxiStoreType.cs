...
namespace ShipWorks.Stores.Platforms.Choxi
{
    ...
    public class ChoxiStoreType : GenericModuleStoreType
    {
        ...
        /// </summary>
        public ChoxiStoreType(StoreEntity store, IMessageHelper messageHelper, IOrderManager orderManager)
        ...
        /// </summary>
        public override string AccountSettingsHelpUrl => "https://shipworks.zendesk.com/hc/en-us/articles/360022656291";
    }
}
