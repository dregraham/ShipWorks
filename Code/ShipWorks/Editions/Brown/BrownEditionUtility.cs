...
namespace ShipWorks.Editions.Brown
{
    ...
    public static class BrownEditionUtility
    {
        ...
        public static bool IsShipmentTypeAllowed(ShipmentTypeCode shipmentType)
        {
            ...
            if (shipmentType == ShipmentTypeCode.Endicia || shipmentType == ShipmentTypeCode.Stamps || shipmentType == ShipmentTypeCode.Express1Endicia || shipmentType == ShipmentTypeCode.Express1Stamps)
            {
                return true;
            }
