...
{
    /// <summary>
    /// Advanced page of the Settings window
    /// </summary>
    public partial class SettingsPageAdvanced : SettingsPageBase
    {
        // Logger
        private static readonly ILog log = LogManager.GetLogger(typeof(SettingsPageAdvanced));
        private ConfigurationEntity config;

        /// <summary>
        /// Constructor
        /// </summary>
        public SettingsPageAdvanced()
        {
            InitializeComponent();
        }
