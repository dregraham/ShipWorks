...
namespace ShipWorks.ApplicationCore.Licensing.Warehouse
{
	...
	public static class WarehouseEndpoints
	{
		...
		public const string GetMessages = "api/account-service/account/messages?username={0}&version={1}";
		...
		public const string GetRates = "api/billing-service/insurance/rates";
