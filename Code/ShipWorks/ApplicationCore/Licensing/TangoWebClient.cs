...
{
    /// <summary>
    /// Interface for working with the license server
    /// </summary>
    ...
    public static class TangoWebClient
    {
        ...
        internal static AssociateShipWorksWithItselfResponse AssociateShipworksWithItself(AssociateShipworksWithItselfRequest request)
        {
            ...
            try
            {
                XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "associateshipworkswithitself", false);
        ...
        public static ILicenseAccountDetail GetLicenseStatus(string licenseKey, StoreEntity store, bool collectTelemetry)
        {
            ...
            return ProcessAccountRequest(postRequest, store, license, collectTelemetry);
        }
        ...
        public static List<Nudge> GetNudges(StoreEntity store)
        {
            ...
            XmlDocument nudgesDoc = ProcessXmlRequest(postRequest, "GetNudges", false);
        ...
        public static void LogNudgeOption(NudgeOption option)
        {
            ...
            ProcessRequest(postRequest, "LogNudgeOption", false);
        }
        ...
        public static void SendAccountPassword(string email, string password)
        {
            ...
            ProcessXmlRequest(postRequest, "SendAccountPassword", false);
        }
        ...
        public static void SendAccountUsername(string email, string username)
        {
            ...
            ProcessXmlRequest(postRequest, "SendAccountUsername", false);
        }
        ...
        public static void LogSubmitInsuranceClaim(ShipmentEntity shipment)
        {
            ...
            ProcessXmlRequest(postRequest, "SubmitInsuranceClaim", false);
        }
        ...
        public static void LogStampsAccount(ILicenseAccountDetail license, ShipmentTypeCode shipmentTypeCode, string accountIdentifier, UspsAccountContractType uspsAccountContractType)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "LogStampsAccount", false);
        ...
        public static LicenseAccountDetail GetFreemiumStatus(EbayStoreEntity store)
        {
            ...
            // Process the request
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "FreemiumStatus", false);
        ...
        public static void CreateFreemiumStore(StoreEntity store, PersonAdapter accountAddress, EndiciaPaymentInfo paymentInfo, string dazzleAccount, bool validateOnly)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "FreemiumCreate", false);
        ...
        public static void SetFreemiumAccountNumber(StoreEntity store, string freemiumAccount)
        {
            ...
            LicenseAccountDetail accountDetail = ProcessAccountRequest(postRequest, store, new ShipWorksLicense(store.License), false);
        ...
        public static (string Email, string FirstAndLastName) GetCustomerEmail(string storeLicense, string customerKey)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "GetCustomerEmail", false);
        ...
        private static XmlDocument GetLicenseCapabilitiesXmlDocument(ICustomerLicense license)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "GetLicenseCapabilities", false);
        ...
        /// </summary>
        public static IAddStoreResponse AddStore(string customerLicenseKey, StoreEntity store)
        {
            HttpVariableRequestSubmitter postRequest = new HttpVariableRequestSubmitter();
            ...
            postRequest.Variables.Add("customerlicense", customerLicenseKey);
        ...
        public static IEnumerable<ActiveStore> GetActiveStores(ICustomerLicense license)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "GetActiveStores", false);
        ...
        public static void DeleteStore(ICustomerLicense customerLicense, string storeLicenseKey)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "DeleteStore", false);
        ...
        public static void DeleteStores(ICustomerLicense customerLicense, IEnumerable<string> storeLicenseKeys)
        {
            ...
            XmlDocument xmlResponse = ProcessXmlRequest(postRequest, "DeleteStores", false);
