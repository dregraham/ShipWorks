...
namespace ShipWorks.Filters.Content.Conditions.Customers
{
    ...
    /// </summary>
    [ConditionElement("For every print...", "Customer.ForEveryPrint")]
    public class ForEveryPrintCondition : ContainerCondition
    {
        /// <summary>
        ...
        {
            using (SqlGenerationScope scope = CustomerPrintedCondition.CreateChildScope(context, SqlGenerationScopeType.EveryChild))
            {
