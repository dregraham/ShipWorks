...
namespace ShipWorks.Filters.Content.Conditions.Orders
{
    ...
    /// </summary>
    [ConditionElement("For every print...", "Order.ForEveryPrint")]
    public class ForEveryPrintCondition : ContainerCondition
    {
        ...
        {
            using (SqlGenerationScope scope = context.PushScope(OrderFields.OrderID, PrintResultFields.RelatedObjectID, SqlGenerationScopeType.EveryChild))
            {
