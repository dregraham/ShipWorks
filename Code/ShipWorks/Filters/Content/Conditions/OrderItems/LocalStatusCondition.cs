...
namespace ShipWorks.Filters.Content.Conditions.OrderItems
{
    ...
    /// </summary>
    [ConditionElement("Local Status", "OrderItem.LocalStatus")]
    public class LocalStatusCondition : StringCondition
    {
        ...
        {
            return GenerateSql(context.GetColumnReference(OrderItemFields.LocalStatus), context);
        }
        ...
        {
            return StatusPresetManager.GetAllPresets(StatusPresetTarget.OrderItem);
        }
    }
}
