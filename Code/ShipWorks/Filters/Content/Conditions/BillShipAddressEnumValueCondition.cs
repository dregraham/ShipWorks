...
{
    /// <summary>
    /// Base for status conditions that are address and have a billing and shipping component
    /// </summary>
    public abstract class BillShipAddressEnumValueCondition<T> : EnumCondition<T> where T : struct
    {
        ...
        {
            return new BillShipAddressEnumValueEditor<T>(this);
        }
    }
}