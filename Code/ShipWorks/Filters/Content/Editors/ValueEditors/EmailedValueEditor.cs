...
namespace ShipWorks.Filters.Content.Editors.ValueEditors
{
    ...
    /// </summary>
    public partial class EmailedValueEditor : TemplateValueEditor
    {
        EmailedCondition condition;

        /// <summary>
        /// Constructor
        /// </summary>
        public EmailedValueEditor(EmailedCondition condition) :
            base(condition)
        {
            InitializeComponent();
        ...
        {
            labelQueryType.InitializeFromEnumType(typeof(EmailedQueryType));
        ...
        {
            EmailedQueryType op = (EmailedQueryType) labelQueryType.SelectedValue;
