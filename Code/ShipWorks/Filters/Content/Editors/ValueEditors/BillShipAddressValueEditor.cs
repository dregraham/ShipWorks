...
namespace ShipWorks.Filters.Content.Editors.ValueEditors
{
    ...
    /// </summary>
    public partial class BillShipAddressValueEditor : ValueEditor
    {
        BillShipAddressCondition condition;

        /// <summary>
        /// Constructor
        /// </summary>
        public BillShipAddressValueEditor(BillShipAddressCondition condition)
        {
            InitializeComponent();
