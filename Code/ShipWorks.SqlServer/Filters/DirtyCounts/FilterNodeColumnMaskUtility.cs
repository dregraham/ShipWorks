...
namespace ShipWorks.SqlServer.Filters.DirtyCounts
{
    ...
    public static class FilterNodeColumnMaskUtility
    {
        ...
        static FilterNodeColumnMaskUtility()
        {
            ...
            tableBitCount[(int) FilterNodeColumnMaskTable.AmazonOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.ChannelAdvisorOrderSearch] = 3;
            ...
            tableBitCount[(int) FilterNodeColumnMaskTable.MarketplaceAdvisorOrderSearch] = 4;
            tableBitCount[(int) FilterNodeColumnMaskTable.NetworkSolutionsOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.OrderMotionOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.PayPalOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.ProStoresOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.SearsOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.ShopifyOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.ThreeDCartOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.WalmartOrderSearch] = 3;
            tableBitCount[(int) FilterNodeColumnMaskTable.YahooOrderSearch] = 3;
