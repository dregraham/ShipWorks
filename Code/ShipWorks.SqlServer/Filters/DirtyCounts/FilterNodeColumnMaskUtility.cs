...
namespace ShipWorks.SqlServer.Filters.DirtyCounts
{
    ...
    public static class FilterNodeColumnMaskUtility
    {
        ...
        static FilterNodeColumnMaskUtility()
        {
            ...
            tableBitCount[(int) FilterNodeColumnMaskTable.OrderItem] = 38;
            tableBitCount[(int) FilterNodeColumnMaskTable.OrderCharge] = 7;
            tableBitCount[(int) FilterNodeColumnMaskTable.Note] = 8;
            tableBitCount[(int) FilterNodeColumnMaskTable.Shipment] = 84;
            ...
            tableBitCount[(int) FilterNodeColumnMaskTable.FedExShipment] = 167;
            ...
            tableBitCount[(int) FilterNodeColumnMaskTable.DhlEcommerceShipment] = 26;
