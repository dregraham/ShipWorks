...
public partial class StoredProcedures
{
    ...
    IF OBJECT_ID('tempdb.dbo.#AuditPurgeBatch', 'U') IS NOT NULL
        DROP TABLE #AuditPurgeBatch; 
    ...
    BEGIN
        ...
        BEGIN TRANSACTION;
		    ...
		    FROM AuditChangeDetail acd
			    INNER JOIN #AuditPurgeBatch b ON acd.AuditID = b.AuditID;

		    DELETE ObjectLabel
		    FROM AuditChange ac 
			    INNER JOIN #AuditPurgeBatch b ON b.AuditID = ac.AuditID
		    ...
		    DELETE [Audit]
		    FROM [Audit] a
			    INNER JOIN #AuditPurgeBatch b ON b.AuditID = a.AuditID;
