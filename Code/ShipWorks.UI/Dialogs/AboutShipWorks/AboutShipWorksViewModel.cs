...
namespace ShipWorks.UI.Dialogs.AboutShipWorks
{
    ...
    public class AboutShipWorksViewModel
    {
        ...
        public AboutShipWorksViewModel()
        {
            ...
            CopyrightInfo = $"Copyright © 2003 – {DateTime.Now.Year} Auctane, Inc. All rights reserved. Auctane, ShipWorks, and the ShipWorks logo are trademarks or registered trademarks of Auctane, Inc.";
        }
