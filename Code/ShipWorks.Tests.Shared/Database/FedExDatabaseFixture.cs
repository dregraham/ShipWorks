...
namespace ShipWorks.Tests.Shared.Database
{
    ...
    public class FedExDatabaseFixture : DatabaseFixture
    {
        ...
        private static void GenerateAccounts()
        {
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "605517846 - UK Test Account")
                .Set(x => x.AccountNumber, "605517846")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757167")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "UK")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "14 TOTTENHAM COURT ROAD")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "LONDON")
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "602550940 - France Test Account")
                .Set(x => x.AccountNumber, "602550940")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757168")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "France")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "ROUTE DE 1 ARPENTEUR")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "PARIS")
                .Set(x => x.StateProvCode, "")
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "604849268 - Sweden Test Account")
                .Set(x => x.AccountNumber, "604849268")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757170")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "Sweden")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "Hagagatan 1, vi")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "Stockholm")
                .Set(x => x.StateProvCode, "")
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "604824729 - Spain Test Account")
                .Set(x => x.AccountNumber, "604824729")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757171")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "Spain")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "Calle Aduana, 29")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "MADRID")
                .Set(x => x.StateProvCode, "")
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "604808006 - Poland Test Account")
                .Set(x => x.AccountNumber, "604808006")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757173")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "Poland")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "Ul. Bosmanska 1")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "GDYNIA")
                .Set(x => x.StateProvCode, "")
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "602810100 - Italy Test Account")
                .Set(x => x.AccountNumber, "602810100")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757176")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "Italy")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "VIA APPIA NUOVA 123/4")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "ROMA")
                .Set(x => x.StateProvCode, "")
            ...
            Create.CarrierAccount<FedExAccountEntity, IFedExAccountEntity>()
                .Set(x => x.Description, "604818907 - Finland Test Account")
                .Set(x => x.AccountNumber, "604818907")
                .Set(x => x.SignatureRelease, "")
                .Set(x => x.MeterNumber, "118757177")
                .Set(x => x.SmartPostHubList, "<Root />")
                .Set(x => x.FirstName, "Finland")
                .Set(x => x.MiddleName, "Test")
                .Set(x => x.LastName, "Account")
                .Set(x => x.Company, "ShipWorks")
                .Set(x => x.Street1, "Vesakkotic 1399")
                .Set(x => x.Street2, "")
                .Set(x => x.City, "HELSINKI")
                .Set(x => x.StateProvCode, "")
