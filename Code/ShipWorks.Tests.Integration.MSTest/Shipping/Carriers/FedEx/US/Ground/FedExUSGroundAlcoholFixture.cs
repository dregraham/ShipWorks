        ...
        public static List<ColumnPropertyMapDefinition> Mapping
        {
            get
            {
                if (mapping == null || mapping.Count == 0)
                {
                    ...
                    mapping.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.RequestedPackageLineItems.SpecialServicesRequested.AlcoholDetail.RecipientType", PropertyName = "", SpreadsheetColumnIndex = -1 });
                    ...
                    mapping.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.RequestedShipment.RequestedPackageLineItems.SpecialServicesRequested.CodDetail.CodRecipient.AccountNumber", PropertyName = "ResponsiblePartyAccountNumber", SpreadsheetColumnIndex = -1 });
