...
namespace ShipWorks.Tests.Integration.MSTest.Fixtures.Shipping.Carriers.FedEx
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FedExCAGroundDomesticInternationalFixture" /> class.
        /// </summary>
        public FedExCAGroundDomesticInternationalFixture()
            : base()
        {
        ...
        public static List<ColumnPropertyMapDefinition> FedExCAGroundDomesticInternationalMapping
        {
            get
            {
...
//                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "CustomsClearanceDetail.Commodities.Quantity", PropertyName = "CommoditiesQuantity", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "Recipient.Address.PostalCode.PostalCode", PropertyName = "RecipientPostalCode", SpreadsheetColumnIndex = -1 });
...
//                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.CustomerReferences.Value", PropertyName = "CustomerReferenceType", SpreadsheetColumnIndex = -1 });
...
//                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedShipment.ShipTimestamp", PropertyName = "ShipTimestamp", SpreadsheetColumnIndex = -1 });
                    ...
                    columnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedShipment.Weight.Units", PropertyName = "ShipmentWeightUnits", SpreadsheetColumnIndex = -1 });
