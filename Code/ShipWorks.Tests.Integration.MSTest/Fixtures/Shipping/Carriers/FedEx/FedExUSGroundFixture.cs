        ...
        public static List<ColumnPropertyMapDefinition> UsGroundDomesticMapping
        {
            get
            {
                if (usGroundDomesticMapping == null || usGroundDomesticMapping.Count == 0)
                {
                    ...
                    //usGroundDomesticMapping.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedPackageLineItems.SpecialServicesRequested.DangerousGoodsDetail.Options", PropertyName = "", SpreadsheetColumnIndex = -1 });
