        ...
        public static List<ColumnPropertyMapDefinition> SmartPostMapping
        {
            get
            {
                if (smartPostColumnPropertyMap == null || !smartPostColumnPropertyMap.Any())
                {
                    ...
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.SpecialServicesRequested.CustomerReferences.CustomerReferenceType", PropertyName = "CustomerReferenceType", SpreadsheetColumnIndex = -1 });
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.SpecialServicesRequested.CustomerReferences.Value", PropertyName = "CustomerReferenceValue", SpreadsheetColumnIndex = -1 });
                    ...
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "Recipient.Contact.CompanyName", PropertyName = "RecipientCompanyName", SpreadsheetColumnIndex = -1 });
                    ...
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedShipment.SmartPostDetail.CustomerManifestId", PropertyName = "SmartPostCustomerManifestId", SpreadsheetColumnIndex = -1 });
                    ...
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "SpecialServicesRequested.ReturnShipmentDetail.Rma.Reason", PropertyName = "ReturnRmaReason", SpreadsheetColumnIndex = -1 });
                    ...
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.SpecialServicesRequested.ReturnShipmentDetail.Rma.Number", PropertyName = "ReturnRmaNumber", SpreadsheetColumnIndex = -1 });
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "ProcessShipmentRequest.SpecialServicesRequested.ReturnShipmentDetail.Rma.Reason", PropertyName = "ReturnRmaReason", SpreadsheetColumnIndex = -1 });
                    smartPostColumnPropertyMap.Add(new ColumnPropertyMapDefinition { SpreadsheetColumnName = "RequestedShipment.LabelSpecification.LabelStockType", PropertyName = "SmartPostLabelStockType", SpreadsheetColumnIndex = -1 });
                }
