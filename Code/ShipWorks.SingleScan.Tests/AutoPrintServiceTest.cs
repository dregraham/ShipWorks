...
namespace ShipWorks.SingleScan.Tests
{
    public class AutoPrintServiceTest : IDisposable
    {
        ...
        public async Task OrderScanned_SendsProcessMessage_WhenOrderHasOneUnprocessedShipment()
        {
            ...
            await testObject.Print(new AutoPrintServiceDto(singleScanFilterUpdateCompleteMessage, new SingleScanMessage(this, "A", IntPtr.Zero)));
        ...
        public async Task MultipleOrdersScanned_SecondScanProcesses_WhenShipmentConfirmationServiceReturnsNoShipmentsTheFirstTime()
        {
            ...
            await testObject.Print(new AutoPrintServiceDto(singleScanFilterUpdateCompleteMessage, new SingleScanMessage(this, "FirstScan", IntPtr.Zero)));

            shipments.Add(new ShipmentEntity(1));
            await testObject.Print(new AutoPrintServiceDto(singleScanFilterUpdateCompleteMessage, new SingleScanMessage(this, "SecondScan", IntPtr.Zero)));
