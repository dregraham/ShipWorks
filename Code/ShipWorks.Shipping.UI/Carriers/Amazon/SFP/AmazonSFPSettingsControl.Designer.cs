...
{
    partial class AmazonSFPSettingsControl
    {
        /// <summary>
        ...
        {
            this.amazonOptionsControl1 = new ShipWorks.Shipping.Carriers.Amazon.SFP.AmazonSFPOptionsControl();
    ...
    "you. Simply select the services below.";
        ...
        #endregion
        private AmazonSFPOptionsControl amazonOptionsControl1;
