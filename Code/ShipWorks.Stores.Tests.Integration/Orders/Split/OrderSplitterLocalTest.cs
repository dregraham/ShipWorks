...
namespace ShipWorks.Stores.Tests.Integration.Orders.Split
{
    ...
    public class OrderSplitterLocalTest : IDisposable
    {
        private readonly DataContext context;
        private readonly ThreeDCartStoreEntity threeDCartStore;

        public OrderSplitterLocalTest(DatabaseFixture db)
        {
        ...
        public async Task Split_MovesAllItemsAndChargesToNewOrder_WhenAllRequested()
        {
            ...
            IOrderSplitter testObject = context.Mock.Create<OrderSplitterLocal>();
            ...
            OrderSplitDefinition orderSplitDefinition = new OrderSplitDefinition(originalOrder, itemQuanities, chargeAmounts, newOrderNumber, OrderSplitterType.Local);
        ...
        public async Task Split_DoesNotMoveItemsOrCharges_WhenOriginalValueIsZero()
        {
            ...
            var result = await testObject.Split(
                new OrderSplitDefinition(order, itemQuanities, chargeAmounts, "ABC", OrderSplitterType.Local), new ProgressItem("Foo"));
