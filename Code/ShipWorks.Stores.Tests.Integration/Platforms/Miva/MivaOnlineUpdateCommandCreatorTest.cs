...
namespace ShipWorks.Stores.Tests.Integration.Platforms.Miva
{
    [Collection("Database collection")]
    [Trait("Category", "ContinuousIntegration")]
    [Trait("Category", "CombinedOrderUpdates")]
    public class MivaOnlineUpdateCommandCreatorTest : IDisposable
    {
        private readonly DataContext context;
        private readonly ITestOutputHelper output;
        private readonly MivaStoreEntity store;
        ...
        public MivaOnlineUpdateCommandCreatorTest(DatabaseFixture db, ITestOutputHelper output)
        {
            this.output = output;
            ...
            store = Create.Store<MivaStoreEntity>(StoreTypeCode.GenericModule)
                .Set(x => x.StoreTypeCode, StoreTypeCode.Miva)
                .Set(x => x.TypeCode, (int) StoreTypeCode.Miva)
                .Set(x => x.ModuleUrl, "https://shipworks.miva.com")
