...
namespace ShipWorks.Stores.Tests.Integration.Platforms.Ebay
{
    ...
    public class EbayCombineAndSplitTest : IDisposable
    {
        ...
        public async Task SplitManualCombineWithNotManualOrder_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 2000L }, identities_A_M_1_C.Select(i => i.EbayOrderID));
        ...
        public async Task CombineMixManualSplit_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 2000L }, identities_B_0.Select(i => i.EbayOrderID));
            Assert.Equal(new[] { 2000L }, identities_B_1.Select(i => i.EbayOrderID));
        }
        ...
        public async Task SplitThenCombineOrder_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L, 2000L }, identities_A_C.Select(i => i.EbayOrderID));
            Assert.Equal(new[] { 1000L }, identities_A_1.Select(i => i.EbayOrderID));
        ...
        public async Task CombineSplitWithBSurviving_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L, 2000L }, identities_B_0.Select(i => i.EbayOrderID));
            Assert.Equal(new[] { 1000L, 2000L }, identities_B_1.Select(i => i.EbayOrderID));
        ...
        public async Task CombineSplitWithASurviving_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L, 2000L }, identities_A_0.Select(i => i.EbayOrderID));
            Assert.Equal(new[] { 1000L, 2000L }, identities_A_1.Select(i => i.EbayOrderID));
        ...
        public async Task SplitCombine_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L }, identities_A_C.Select(i => i.EbayOrderID));
        ...
        public async Task SplitCombine_SplitSurvivingOrder_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L }, identities_A_1_C.Select(i => i.EbayOrderID));
        ...
        public async Task SplitACombineBCombineRemainingTwo_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L, 2000L }, identities_A_1_C_1.Select(i => i.EbayOrderID));
        ...
        public async Task SplitCombineWithManualOrder_WithOrderNumbers()
        {
            ...
            Assert.Equal(new[] { 1000L }, identities_B_M_C.Select(i => i.EbayOrderID));
