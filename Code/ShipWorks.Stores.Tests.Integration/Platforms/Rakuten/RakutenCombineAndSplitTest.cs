...
namespace ShipWorks.Stores.Tests.Integration.Platforms.Rakuten
{
    ...
    public class RakutenCombineAndSplitTest : IDisposable
    {
        ...
        public RakutenCombineAndSplitTest(DatabaseFixture db, ITestOutputHelper output)
        {
            this.output = output;
            ...
            store = Create.Store<RakutenStoreEntity>()
