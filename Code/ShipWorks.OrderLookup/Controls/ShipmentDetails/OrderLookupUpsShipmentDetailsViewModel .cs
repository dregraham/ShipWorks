...
namespace ShipWorks.OrderLookup.Controls.ShipmentDetails
{
    ...
    /// </summary>
    [KeyedComponent(typeof(IOrderLookupDetailsViewModel), ShipmentTypeCode.UpsOnLineTools)]
    [WpfView(typeof(OrderLookupUpsShipmentDetailsControl))]
    public class OrderLookupUpsShipmentDetailsViewModel : IOrderLookupDetailsViewModel, INotifyPropertyChanged
    {
