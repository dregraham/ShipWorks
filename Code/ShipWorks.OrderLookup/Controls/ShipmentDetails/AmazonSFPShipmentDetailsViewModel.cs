...
namespace ShipWorks.OrderLookup.Controls.ShipmentDetails
{
    ...
    public class AmazonSFPShipmentDetailsViewModel : GenericSinglePackageShipmentDetailsViewModel, IDataErrorInfo
    {
        ...
        /// Constructor
        /// </summary>
        public AmazonSFPShipmentDetailsViewModel(
            ...
            OrderLookupFieldLayoutProvider fieldLayoutProvider) : base(shipmentModel, fieldLayoutProvider)
        {
            ...
            ConfirmationTypes =
                EnumHelper.GetEnumList<AmazonSFPDeliveryExperienceType>()
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                return InputValidation<AmazonSFPShipmentDetailsViewModel>.Validate(this, columnName);
            }
        }
