...
namespace ShipWorks.OrderLookup.Controls.From
{
    ...
    public class OrderLookupUspsFromViewModel : AddressViewModel, IOrderLookupFromViewModel
    {
        ...
        /// Constructor
        /// </summary>
        public OrderLookupUspsFromViewModel(IOrderLookupShipmentModel shipmentModel, IShippingOriginManager shippingOriginManager, IMessageHelper messageHelper,
