...
namespace ShipWorks.Data.Model
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void Init()
		{
			...
			InitAmazonSWAProfileEntityMappings();
			InitAmazonSWAShipmentEntityMappings();
			...
			InitChannelAdvisorOrderSearchEntityMappings();
			InitChannelAdvisorStoreEntityMappings();
			InitClickCartProOrderEntityMappings();
			InitClickCartProOrderSearchEntityMappings();
			InitCommerceInterfaceOrderEntityMappings();
			InitCommerceInterfaceOrderSearchEntityMappings();
			InitComputerEntityMappings();
			InitConfigurationEntityMappings();
			InitCustomerEntityMappings();
			InitDeviceEntityMappings();
			InitDhlEcommerceAccountEntityMappings();
			InitDhlEcommerceProfileEntityMappings();
			InitDhlEcommerceShipmentEntityMappings();
			...
			InitEbayOrderSearchEntityMappings();
			...
			InitGenericModuleOrderEntityMappings();
			InitGenericModuleOrderItemEntityMappings();
			...
			InitGrouponOrderSearchEntityMappings();
			...
			InitNetworkSolutionsOrderSearchEntityMappings();
			...
			InitSearsOrderSearchEntityMappings();
			...
			InitShipEngineManifestEntityMappings();
			...
			InitThreeDCartOrderSearchEntityMappings();
			...
			InitWalmartOrderSearchEntityMappings();
			...
			InitYahooOrderSearchEntityMappings();
			InitYahooProductEntityMappings();
			InitYahooStoreEntityMappings();
			InitShipWorksDisabledDefaultIndexesTypedViewMappings();
			InitShipWorksMissingIndexRequestsTypedViewMappings();
		}
		...
		/// <summary>Inits AmazonOrderSearchEntity's mappings</summary>
		private void InitAmazonOrderSearchEntityMappings()
		{
			this.AddElementMapping("AmazonOrderSearchEntity", @"ShipWorksLocal", @"dbo", "AmazonOrderSearch", 4, 0);
			this.AddElementFieldMapping("AmazonOrderSearchEntity", "AmazonOrderSearchID", "AmazonOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("AmazonOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("AmazonOrderSearchEntity", "AmazonOrderID", "AmazonOrderID", false, "VarChar", 32, 0, 0, false, "", null, typeof(System.String), 2);
		...
		{
			this.AddElementMapping("AmazonSFPShipmentEntity", @"ShipWorksLocal", @"dbo", "AmazonSFPShipment", 18, 0);
			...
			this.AddElementFieldMapping("AmazonSFPShipmentEntity", "ShipEngineLabelID", "ShipEngineLabelID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 17);
		}
		...
		{
			this.AddElementMapping("AmazonSWAAccountEntity", @"ShipWorksLocal", @"dbo", "AmazonSWAAccount", 15, 0);
			...
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "ShipEngineCarrierId", "ShipEngineCarrierId", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "Description", "Description", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 3);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "FirstName", "FirstName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "MiddleName", "MiddleName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 5);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "LastName", "LastName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 6);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "Company", "Company", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 7);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "Street1", "Street1", false, "NVarChar", 43, 0, 0, false, "", null, typeof(System.String), 8);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "City", "City", false, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "StateProvCode", "StateProvCode", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 10);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "PostalCode", "PostalCode", false, "NVarChar", 10, 0, 0, false, "", null, typeof(System.String), 11);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "CountryCode", "CountryCode", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 12);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "Email", "Email", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 13);
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "Phone", "Phone", false, "NVarChar", 15, 0, 0, false, "", null, typeof(System.String), 14);
		}
		...
		private void InitAmazonSWAShipmentEntityMappings()
		{
			...
			this.AddElementFieldMapping("AmazonSWAShipmentEntity", "ShipEngineLabelID", "ShipEngineLabelID", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 4);
		...
		private void InitAmeriCommerceStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("AmeriCommerceStoreEntity", "Password", "Password", false, "NVarChar", 280, 0, 0, false, "", null, typeof(System.String), 2);
		...
		private void InitAsendiaShipmentEntityMappings()
		{
			...
			this.AddElementFieldMapping("AsendiaShipmentEntity", "RequestedLabelFormat", "RequestedLabelFormat", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 3);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "Contents", "Contents", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 4);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "NonDelivery", "NonDelivery", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 5);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "ShipEngineLabelID", "ShipEngineLabelID", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 6);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "DimsProfileID", "DimsProfileID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 7);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "DimsLength", "DimsLength", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 8);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "DimsWidth", "DimsWidth", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 9);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "DimsHeight", "DimsHeight", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 10);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "DimsAddWeight", "DimsAddWeight", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 11);
			this.AddElementFieldMapping("AsendiaShipmentEntity", "DimsWeight", "DimsWeight", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 12);
		...
		private void InitBigCommerceStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("BigCommerceStoreEntity", "Identifier", "Identifier", false, "NVarChar", 1024, 0, 0, false, "", null, typeof(System.String), 10);
		}
		...
		private void InitBuyDotComStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("BuyDotComStoreEntity", "FtpPassword", "FtpPassword", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 2);
		}
		...
		private void InitChannelAdvisorOrderItemEntityMappings()
		{
			...
			this.AddElementFieldMapping("ChannelAdvisorOrderItemEntity", "DistributionCenterID", "DistributionCenterID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 8);
			this.AddElementFieldMapping("ChannelAdvisorOrderItemEntity", "DistributionCenterName", "DistributionCenterName", false, "NVarChar", 100, 0, 0, false, "", null, typeof(System.String), 9);
		}

		/// <summary>Inits ChannelAdvisorOrderSearchEntity's mappings</summary>
		private void InitChannelAdvisorOrderSearchEntityMappings()
		{
			this.AddElementMapping("ChannelAdvisorOrderSearchEntity", @"ShipWorksLocal", @"dbo", "ChannelAdvisorOrderSearch", 4, 0);
			this.AddElementFieldMapping("ChannelAdvisorOrderSearchEntity", "ChannelAdvisorOrderSearchID", "ChannelAdvisorOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("ChannelAdvisorOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("ChannelAdvisorOrderSearchEntity", "CustomOrderIdentifier", "CustomOrderIdentifier", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("ChannelAdvisorOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}

		/// <summary>Inits ChannelAdvisorStoreEntity's mappings</summary>
		private void InitChannelAdvisorStoreEntityMappings()
		{
			this.AddElementMapping("ChannelAdvisorStoreEntity", @"ShipWorksLocal", @"dbo", "ChannelAdvisorStore", 11, 0);
			...
			this.AddElementFieldMapping("ChannelAdvisorStoreEntity", "RefreshToken", "RefreshToken", false, "NVarChar", 800, 0, 0, false, "", null, typeof(System.String), 8);
			this.AddElementFieldMapping("ChannelAdvisorStoreEntity", "DownloadDaysBack", "DownloadDaysBack", false, "TinyInt", 0, 3, 0, false, "", null, typeof(System.Byte), 9);
			this.AddElementFieldMapping("ChannelAdvisorStoreEntity", "ExcludeFBA", "ExcludeFBA", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 10);
		}
		...
		/// <summary>Inits ClickCartProOrderSearchEntity's mappings</summary>
		private void InitClickCartProOrderSearchEntityMappings()
		{
			this.AddElementMapping("ClickCartProOrderSearchEntity", @"ShipWorksLocal", @"dbo", "ClickCartProOrderSearch", 4, 0);
			this.AddElementFieldMapping("ClickCartProOrderSearchEntity", "ClickCartProOrderSearchID", "ClickCartProOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("ClickCartProOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("ClickCartProOrderSearchEntity", "ClickCartProOrderID", "ClickCartProOrderID", false, "VarChar", 25, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("ClickCartProOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		/// <summary>Inits CommerceInterfaceOrderSearchEntity's mappings</summary>
		private void InitCommerceInterfaceOrderSearchEntityMappings()
		{
			this.AddElementMapping("CommerceInterfaceOrderSearchEntity", @"ShipWorksLocal", @"dbo", "CommerceInterfaceOrderSearch", 4, 0);
			this.AddElementFieldMapping("CommerceInterfaceOrderSearchEntity", "CommerceInterfaceOrderSearchID", "CommerceInterfaceOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("CommerceInterfaceOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("CommerceInterfaceOrderSearchEntity", "CommerceInterfaceOrderNumber", "CommerceInterfaceOrderNumber", false, "NVarChar", 60, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("CommerceInterfaceOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		{
			this.AddElementMapping("ConfigurationEntity", @"ShipWorksLocal", @"dbo", "Configuration", 24, 0);
			...
			this.AddElementFieldMapping("ConfigurationEntity", "LegacyCustomerKey", "LegacyCustomerKey", false, "NVarChar", 2147483647, 0, 0, false, "", null, typeof(System.String), 23);
		}
		...
		private void InitDhlEcommerceAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "ClientId", "ClientId", false, "NVarChar", 60, 0, 0, false, "", null, typeof(System.String), 3);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "ApiSecret", "ApiSecret", false, "NVarChar", 400, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "PickupNumber", "PickupNumber", false, "NVarChar", 20, 0, 0, false, "", null, typeof(System.String), 5);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "DistributionCenter", "DistributionCenter", false, "NVarChar", 12, 0, 0, false, "", null, typeof(System.String), 6);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "SoldTo", "SoldTo", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 7);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "Description", "Description", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 8);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "FirstName", "FirstName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "MiddleName", "MiddleName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 10);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "LastName", "LastName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 11);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "Company", "Company", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 12);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "Street1", "Street1", false, "NVarChar", 60, 0, 0, false, "", null, typeof(System.String), 13);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "City", "City", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 14);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "StateProvCode", "StateProvCode", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 15);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "PostalCode", "PostalCode", false, "NVarChar", 20, 0, 0, false, "", null, typeof(System.String), 16);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "CountryCode", "CountryCode", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 17);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "Phone", "Phone", false, "NVarChar", 26, 0, 0, false, "", null, typeof(System.String), 18);
			this.AddElementFieldMapping("DhlEcommerceAccountEntity", "Email", "Email", false, "NVarChar", 100, 0, 0, false, "", null, typeof(System.String), 19);
		...
		private void InitDhlEcommerceProfileEntityMappings()
		{
			...
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "DeliveryDutyPaid", "DeliveryDutyPaid", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 3);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "NonMachinable", "NonMachinable", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 4);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "SaturdayDelivery", "SaturdayDelivery", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 5);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "Contents", "Contents", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 6);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "NonDelivery", "NonDelivery", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 7);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "ResidentialDelivery", "ResidentialDelivery", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 8);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "CustomsRecipientTin", "CustomsRecipientTin", true, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("DhlEcommerceProfileEntity", "CustomsTaxIdType", "CustomsTaxIdType", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 10);
		...
		private void InitDhlEcommerceShipmentEntityMappings()
		{
			...
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DeliveredDutyPaid", "DeliveredDutyPaid", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 3);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "NonMachinable", "NonMachinable", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 4);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "SaturdayDelivery", "SaturdayDelivery", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 5);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "RequestedLabelFormat", "RequestedLabelFormat", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 6);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "Contents", "Contents", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 7);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "NonDelivery", "NonDelivery", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 8);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "ShipEngineLabelID", "ShipEngineLabelID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "IntegratorTransactionID", "IntegratorTransactionID", true, "UniqueIdentifier", 0, 0, 0, false, "", null, typeof(System.Guid), 10);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "ResidentialDelivery", "ResidentialDelivery", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 11);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "CustomsRecipientTin", "CustomsRecipientTin", true, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 12);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "CustomsTaxIdType", "CustomsTaxIdType", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 13);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "CustomsTinIssuingAuthority", "CustomsTinIssuingAuthority", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 14);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "PackagingType", "PackagingType", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 15);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DimsProfileID", "DimsProfileID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 16);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DimsLength", "DimsLength", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 17);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DimsWidth", "DimsWidth", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 18);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DimsHeight", "DimsHeight", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 19);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DimsWeight", "DimsWeight", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 20);
			this.AddElementFieldMapping("DhlEcommerceShipmentEntity", "DimsAddWeight", "DimsAddWeight", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 21);
		...
		private void InitDhlExpressAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("DhlExpressAccountEntity", "ShipEngineCarrierId", "ShipEngineCarrierId", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 3);
			...
			this.AddElementFieldMapping("DhlExpressAccountEntity", "MiddleName", "MiddleName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 6);
			this.AddElementFieldMapping("DhlExpressAccountEntity", "LastName", "LastName", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 7);
			this.AddElementFieldMapping("DhlExpressAccountEntity", "Company", "Company", false, "NVarChar", 30, 0, 0, false, "", null, typeof(System.String), 8);
			this.AddElementFieldMapping("DhlExpressAccountEntity", "Street1", "Street1", false, "NVarChar", 43, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("DhlExpressAccountEntity", "City", "City", false, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 10);
			this.AddElementFieldMapping("DhlExpressAccountEntity", "StateProvCode", "StateProvCode", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 11);
			this.AddElementFieldMapping("DhlExpressAccountEntity", "PostalCode", "PostalCode", false, "NVarChar", 10, 0, 0, false, "", null, typeof(System.String), 12);
		...
		private void InitDhlExpressPackageEntityMappings()
		{
			...
			this.AddElementFieldMapping("DhlExpressPackageEntity", "DimsProfileID", "DimsProfileID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
			this.AddElementFieldMapping("DhlExpressPackageEntity", "DimsLength", "DimsLength", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 4);
			this.AddElementFieldMapping("DhlExpressPackageEntity", "DimsWidth", "DimsWidth", false, "Float", 0, 38, 0, false, "", null, typeof(System.Double), 5);
		...
		{
			this.AddElementMapping("DhlExpressProfileEntity", @"ShipWorksLocal", @"dbo", "DhlExpressProfile", 12, 0);
			...
			this.AddElementFieldMapping("DhlExpressProfileEntity", "CustomsRecipientTin", "CustomsRecipientTin", true, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("DhlExpressProfileEntity", "CustomsTaxIdType", "CustomsTaxIdType", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 10);
			this.AddElementFieldMapping("DhlExpressProfileEntity", "CustomsTinIssuingAuthority", "CustomsTinIssuingAuthority", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 11);
		}

		/// <summary>Inits DhlExpressShipmentEntity's mappings</summary>
		private void InitDhlExpressShipmentEntityMappings()
		{
			this.AddElementMapping("DhlExpressShipmentEntity", @"ShipWorksLocal", @"dbo", "DhlExpressShipment", 16, 0);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "ShipmentID", "ShipmentID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "DhlExpressAccountID", "DhlExpressAccountID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "Service", "Service", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "DeliveredDutyPaid", "DeliveredDutyPaid", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 3);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "NonMachinable", "NonMachinable", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 4);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "SaturdayDelivery", "SaturdayDelivery", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 5);
			...
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "ShipEngineLabelID", "ShipEngineLabelID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "IntegratorTransactionID", "IntegratorTransactionID", true, "UniqueIdentifier", 0, 0, 0, false, "", null, typeof(System.Guid), 10);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "StampsTransactionID", "StampsTransactionID", true, "UniqueIdentifier", 0, 0, 0, false, "", null, typeof(System.Guid), 11);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "ResidentialDelivery", "ResidentialDelivery", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 12);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "CustomsRecipientTin", "CustomsRecipientTin", true, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 13);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "CustomsTaxIdType", "CustomsTaxIdType", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 14);
			this.AddElementFieldMapping("DhlExpressShipmentEntity", "CustomsTinIssuingAuthority", "CustomsTinIssuingAuthority", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 15);
		}
		...
		private void InitEmailAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("EmailAccountEntity", "IncomingPassword", "IncomingPassword", false, "NVarChar", 600, 0, 0, false, "", null, typeof(System.String), 10);
			...
			this.AddElementFieldMapping("EmailAccountEntity", "OutgoingPassword", "OutgoingPassword", false, "NVarChar", 600, 0, 0, false, "", null, typeof(System.String), 16);
		...
		private void InitEndiciaAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("EndiciaAccountEntity", "WebPassword", "WebPassword", false, "NVarChar", 1000, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("EndiciaAccountEntity", "ApiInitialPassword", "ApiInitialPassword", false, "NVarChar", 1000, 0, 0, false, "", null, typeof(System.String), 5);
			this.AddElementFieldMapping("EndiciaAccountEntity", "ApiUserPassword", "ApiUserPassword", false, "NVarChar", 1000, 0, 0, false, "", null, typeof(System.String), 6);
		...
		{
			this.AddElementMapping("EndiciaProfileEntity", @"ShipWorksLocal", @"dbo", "EndiciaProfile", 9, 0);
		...
		private void InitEtsyStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("EtsyStoreEntity", "OAuthToken", "OAuthToken", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("EtsyStoreEntity", "OAuthTokenSecret", "OAuthTokenSecret", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 5);
		}
		...
		{
			this.AddElementMapping("FedExAccountEntity", @"ShipWorksLocal", @"dbo", "FedExAccount", 26, 0);
			...
			this.AddElementFieldMapping("FedExAccountEntity", "SmartPostHub", "SmartPostHub", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 25);
		}
		...
		{
			this.AddElementMapping("FedExPackageEntity", @"ShipWorksLocal", @"dbo", "FedExPackage", 48, 0);
		...
		{
			this.AddElementMapping("FedExProfileEntity", @"ShipWorksLocal", @"dbo", "FedExProfile", 45, 0);
			...
			this.AddElementFieldMapping("FedExProfileEntity", "PayorCountryCode", "PayorCountryCode", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 41);
			this.AddElementFieldMapping("FedExProfileEntity", "PayorPostalCode", "PayorPostalCode", true, "NVarChar", 10, 0, 0, false, "", null, typeof(System.String), 42);
			this.AddElementFieldMapping("FedExProfileEntity", "DeliveredDutyPaid", "DeliveredDutyPaid", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 43);
			this.AddElementFieldMapping("FedExProfileEntity", "CustomsTinIssuingAuthority", "CustomsTinIssuingAuthority", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 44);
		}

		/// <summary>Inits FedExProfilePackageEntity's mappings</summary>
		private void InitFedExProfilePackageEntityMappings()
		{
			this.AddElementMapping("FedExProfilePackageEntity", @"ShipWorksLocal", @"dbo", "FedExProfilePackage", 30, 0);
			...
			this.AddElementFieldMapping("FedExProfilePackageEntity", "DangerousGoodsAuthorization", "DangerousGoodsAuthorization", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 29);
		}

		/// <summary>Inits FedExShipmentEntity's mappings</summary>
		private void InitFedExShipmentEntityMappings()
		{
			this.AddElementMapping("FedExShipmentEntity", @"ShipWorksLocal", @"dbo", "FedExShipment", 169, 0);
			...
			this.AddElementFieldMapping("FedExShipmentEntity", "PayorCountryCode", "PayorCountryCode", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 164);
			this.AddElementFieldMapping("FedExShipmentEntity", "PayorPostalCode", "PayorPostalCode", true, "NVarChar", 10, 0, 0, false, "", null, typeof(System.String), 165);
			this.AddElementFieldMapping("FedExShipmentEntity", "ShipEngineLabelId", "ShipEngineLabelId", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 166);
			this.AddElementFieldMapping("FedExShipmentEntity", "DeliveredDutyPaid", "DeliveredDutyPaid", true, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 167);
			this.AddElementFieldMapping("FedExShipmentEntity", "CustomsTinIssuingAuthority", "CustomsTinIssuingAuthority", true, "NVarChar", 2, 0, 0, false, "", null, typeof(System.String), 168);
		}
		...
		private void InitFtpAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("FtpAccountEntity", "Password", "Password", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 3);
		...
		private void InitGenericModuleOrderItemEntityMappings()
		{
			this.AddElementMapping("GenericModuleOrderItemEntity", @"ShipWorksLocal", @"dbo", "GenericModuleOrderItem", 2, 0);
			this.AddElementFieldMapping("GenericModuleOrderItemEntity", "OrderItemID", "OrderItemID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("GenericModuleOrderItemEntity", "AmazonOrderItemCode", "AmazonOrderItemCode", false, "NVarChar", 64, 0, 0, false, "", null, typeof(System.String), 1);
		}
		...
		private void InitGenericModuleStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("GenericModuleStoreEntity", "ModulePassword", "ModulePassword", false, "NVarChar", 320, 0, 0, false, "", null, typeof(System.String), 2);
		...
		{
			this.AddElementMapping("GrouponOrderSearchEntity", @"ShipWorksLocal", @"dbo", "GrouponOrderSearch", 5, 0);
			...
			this.AddElementFieldMapping("GrouponOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 4);
		}
		...
		private void InitIParcelAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("IParcelAccountEntity", "Password", "Password", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 3);
		...
		private void InitJetStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("JetStoreEntity", "Secret", "Secret", false, "NVarChar", 400, 0, 0, false, "", null, typeof(System.String), 2);
		}
		...
		/// <summary>Inits LemonStandOrderSearchEntity's mappings</summary>
		private void InitLemonStandOrderSearchEntityMappings()
		{
			this.AddElementMapping("LemonStandOrderSearchEntity", @"ShipWorksLocal", @"dbo", "LemonStandOrderSearch", 4, 0);
			this.AddElementFieldMapping("LemonStandOrderSearchEntity", "LemonStandOrderSearchID", "LemonStandOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("LemonStandOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("LemonStandOrderSearchEntity", "LemonStandOrderID", "LemonStandOrderID", false, "NVarChar", 20, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("LemonStandOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		/// <summary>Inits MagentoOrderSearchEntity's mappings</summary>
		private void InitMagentoOrderSearchEntityMappings()
		{
			this.AddElementMapping("MagentoOrderSearchEntity", @"ShipWorksLocal", @"dbo", "MagentoOrderSearch", 4, 0);
			this.AddElementFieldMapping("MagentoOrderSearchEntity", "MagentoOrderSearchID", "MagentoOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("MagentoOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("MagentoOrderSearchEntity", "MagentoOrderID", "MagentoOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 2);
			this.AddElementFieldMapping("MagentoOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		/// <summary>Inits MarketplaceAdvisorOrderSearchEntity's mappings</summary>
		private void InitMarketplaceAdvisorOrderSearchEntityMappings()
		{
			this.AddElementMapping("MarketplaceAdvisorOrderSearchEntity", @"ShipWorksLocal", @"dbo", "MarketplaceAdvisorOrderSearch", 5, 0);
			this.AddElementFieldMapping("MarketplaceAdvisorOrderSearchEntity", "MarketplaceAdvisorOrderSearchID", "MarketplaceAdvisorOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("MarketplaceAdvisorOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("MarketplaceAdvisorOrderSearchEntity", "InvoiceNumber", "InvoiceNumber", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("MarketplaceAdvisorOrderSearchEntity", "SellerOrderNumber", "SellerOrderNumber", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
			this.AddElementFieldMapping("MarketplaceAdvisorOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 4);
		}
		...
		private void InitMarketplaceAdvisorStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("MarketplaceAdvisorStoreEntity", "Password", "Password", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 2);
		...
		private void InitMivaStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("MivaStoreEntity", "EncryptionPassphrase", "EncryptionPassphrase", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 1);
		...
		/// <summary>Inits NetworkSolutionsOrderSearchEntity's mappings</summary>
		private void InitNetworkSolutionsOrderSearchEntityMappings()
		{
			this.AddElementMapping("NetworkSolutionsOrderSearchEntity", @"ShipWorksLocal", @"dbo", "NetworkSolutionsOrderSearch", 4, 0);
			this.AddElementFieldMapping("NetworkSolutionsOrderSearchEntity", "NetworkSolutionsOrderSearchID", "NetworkSolutionsOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("NetworkSolutionsOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("NetworkSolutionsOrderSearchEntity", "NetworkSolutionsOrderID", "NetworkSolutionsOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 2);
			this.AddElementFieldMapping("NetworkSolutionsOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		private void InitOnTracAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("OnTracAccountEntity", "Password", "Password", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 3);
		...
		{
			this.AddElementMapping("OnTracShipmentEntity", @"ShipWorksLocal", @"dbo", "OnTracShipment", 23, 0);
			...
			this.AddElementFieldMapping("OnTracShipmentEntity", "Insurance", "Insurance", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 22);
		}
		...
		private void InitOrderEntityMappings()
		{
			...
			this.AddElementFieldMapping("OrderEntity", "HubOrderID", "HubOrderID", true, "UniqueIdentifier", 0, 0, 0, false, "", null, typeof(System.Guid), 82);
			this.AddElementFieldMapping("OrderEntity", "HubSequence", "HubSequence", true, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 83);
			this.AddElementFieldMapping("OrderEntity", "Verified", "Verified", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 84);
			this.AddElementFieldMapping("OrderEntity", "VerifiedBy", "VerifiedBy", true, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 85);
			this.AddElementFieldMapping("OrderEntity", "VerifiedDate", "VerifiedDate", true, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 86);
			this.AddElementFieldMapping("OrderEntity", "Custom6", "Custom6", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 87);
			this.AddElementFieldMapping("OrderEntity", "Custom7", "Custom7", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 88);
		...
		{
			this.AddElementMapping("OrderItemEntity", @"ShipWorksLocal", @"dbo", "OrderItem", 37, 0);
			...
			this.AddElementFieldMapping("OrderItemEntity", "Brand", "Brand", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 22);
			this.AddElementFieldMapping("OrderItemEntity", "Height", "Height", false, "Decimal", 0, 10, 2, false, "", null, typeof(System.Decimal), 23);
			this.AddElementFieldMapping("OrderItemEntity", "Custom1", "Custom1", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 24);
			this.AddElementFieldMapping("OrderItemEntity", "MPN", "MPN", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 25);
			...
			this.AddElementFieldMapping("OrderItemEntity", "Custom6", "Custom6", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 30);
			this.AddElementFieldMapping("OrderItemEntity", "HubItemID", "HubItemID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 31);
			this.AddElementFieldMapping("OrderItemEntity", "Custom7", "Custom7", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 32);
			this.AddElementFieldMapping("OrderItemEntity", "Custom8", "Custom8", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 33);
			this.AddElementFieldMapping("OrderItemEntity", "Custom9", "Custom9", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 34);
			this.AddElementFieldMapping("OrderItemEntity", "Custom10", "Custom10", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 35);
			this.AddElementFieldMapping("OrderItemEntity", "StoreOrderItemID", "StoreOrderItemID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 36);
		}
		...
		/// <summary>Inits OrderMotionOrderSearchEntity's mappings</summary>
		private void InitOrderMotionOrderSearchEntityMappings()
		{
			this.AddElementMapping("OrderMotionOrderSearchEntity", @"ShipWorksLocal", @"dbo", "OrderMotionOrderSearch", 4, 0);
			this.AddElementFieldMapping("OrderMotionOrderSearchEntity", "OrderMotionOrderSearchID", "OrderMotionOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("OrderMotionOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("OrderMotionOrderSearchEntity", "OrderMotionShipmentID", "OrderMotionShipmentID", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
			this.AddElementFieldMapping("OrderMotionOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		private void InitOrderPaymentDetailEntityMappings()
		{
			...
			this.AddElementFieldMapping("OrderPaymentDetailEntity", "Value", "Value", false, "NVarChar", 400, 0, 0, false, "", null, typeof(System.String), 4);
		}

		/// <summary>Inits OrderSearchEntity's mappings</summary>
		private void InitOrderSearchEntityMappings()
		{
			this.AddElementMapping("OrderSearchEntity", @"ShipWorksLocal", @"dbo", "OrderSearch", 8, 0);
			...
			this.AddElementFieldMapping("OrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 6);
			this.AddElementFieldMapping("OrderSearchEntity", "OriginalChannelOrderID", "OriginalChannelOrderID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 7);
		}
		...
		{
			this.AddElementMapping("OtherShipmentEntity", @"ShipWorksLocal", @"dbo", "OtherShipment", 5, 0);
		...
		/// <summary>Inits PayPalOrderSearchEntity's mappings</summary>
		private void InitPayPalOrderSearchEntityMappings()
		{
			this.AddElementMapping("PayPalOrderSearchEntity", @"ShipWorksLocal", @"dbo", "PayPalOrderSearch", 4, 0);
			this.AddElementFieldMapping("PayPalOrderSearchEntity", "PayPalOrderSearchID", "PayPalOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("PayPalOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("PayPalOrderSearchEntity", "TransactionID", "TransactionID", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("PayPalOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		{
			this.AddElementMapping("PostalProfileEntity", @"ShipWorksLocal", @"dbo", "PostalProfile", 17, 0);
			...
			this.AddElementFieldMapping("PostalProfileEntity", "InternalTransactionNumber", "InternalTransactionNumber", true, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 16);
		}

		/// <summary>Inits PostalShipmentEntity's mappings</summary>
		private void InitPostalShipmentEntityMappings()
		{
			this.AddElementMapping("PostalShipmentEntity", @"ShipWorksLocal", @"dbo", "PostalShipment", 25, 0);
			...
			this.AddElementFieldMapping("PostalShipmentEntity", "InternalTransactionNumber", "InternalTransactionNumber", true, "NVarChar", 25, 0, 0, false, "", null, typeof(System.String), 24);
		}
		...
		{
			this.AddElementMapping("ProcessedShipmentEntity", @"ShipWorksLocal", @"dbo", "ProcessedShipmentsView", 31, 4);
			...
			this.AddElementFieldMapping("ProcessedShipmentEntity", "Insurance", "Insurance", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 3);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "InsuranceProvider", "InsuranceProvider", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 4);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ProcessedDate", "ProcessedDate", true, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 5);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ProcessedUserID", "ProcessedUserID", true, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 6);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ProcessedComputerID", "ProcessedComputerID", true, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 7);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "Voided", "Voided", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 8);
			...
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ShipAddressValidationStatus", "ShipAddressValidationStatus", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 16);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ShipResidentialStatus", "ShipResidentialStatus", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 17);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ShipPOBox", "ShipPOBox", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 18);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ShipMilitaryAddress", "ShipMilitaryAddress", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 19);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "RequestedLabelFormat", "RequestedLabelFormat", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 20);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "ActualLabelFormat", "ActualLabelFormat", true, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 21);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 22);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "OrderNumberComplete", "OrderNumberComplete", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 23);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "Service", "Service", true, "NVarChar", 101, 0, 0, false, "", null, typeof(System.String), 24);
			...
			this.AddElementFieldMapping("ProcessedShipmentEntity", "Verified", "Verified", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 29);
			this.AddElementFieldMapping("ProcessedShipmentEntity", "TrackingStatus", "TrackingStatus", false, "TinyInt", 0, 3, 0, false, "", null, typeof(System.Byte), 30);
		}
		...
		/// <summary>Inits ProStoresOrderSearchEntity's mappings</summary>
		private void InitProStoresOrderSearchEntityMappings()
		{
			this.AddElementMapping("ProStoresOrderSearchEntity", @"ShipWorksLocal", @"dbo", "ProStoresOrderSearch", 4, 0);
			this.AddElementFieldMapping("ProStoresOrderSearchEntity", "ProStoresOrderSearchID", "ProStoresOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("ProStoresOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("ProStoresOrderSearchEntity", "ConfirmationNumber", "ConfirmationNumber", false, "VarChar", 12, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("ProStoresOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		/// <summary>Inits SearsOrderSearchEntity's mappings</summary>
		private void InitSearsOrderSearchEntityMappings()
		{
			this.AddElementMapping("SearsOrderSearchEntity", @"ShipWorksLocal", @"dbo", "SearsOrderSearch", 4, 0);
			this.AddElementFieldMapping("SearsOrderSearchEntity", "SearsOrderSearchID", "SearsOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("SearsOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("SearsOrderSearchEntity", "PoNumber", "PoNumber", false, "VarChar", 30, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("SearsOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		/// <summary>Inits ShipEngineManifestEntity's mappings</summary>
		private void InitShipEngineManifestEntityMappings()
		{
			this.AddElementMapping("ShipEngineManifestEntity", @"ShipWorksLocal", @"dbo", "ShipEngineManifest", 12, 0);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "ShipEngineManifestID", "ShipEngineManifestID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "CarrierAccountID", "CarrierAccountID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "ShipmentTypeCode", "ShipmentTypeCode", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 2);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "ManifestID", "ManifestID", false, "VarChar", 50, 0, 0, false, "", null, typeof(System.String), 3);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "FormID", "FormID", false, "VarChar", 50, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "CreatedAt", "CreatedAt", false, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 5);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "ShipDate", "ShipDate", false, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 6);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "ShipmentCount", "ShipmentCount", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 7);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "PlatformWarehouseID", "PlatformWarehouseID", false, "VarChar", 50, 0, 0, false, "", null, typeof(System.String), 8);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "SubmissionID", "SubmissionID", false, "VarChar", 255, 0, 0, false, "", null, typeof(System.String), 9);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "CarrierID", "CarrierID", false, "VarChar", 50, 0, 0, false, "", null, typeof(System.String), 10);
			this.AddElementFieldMapping("ShipEngineManifestEntity", "ManifestUrl", "ManifestUrl", false, "VarChar", 2048, 0, 0, false, "", null, typeof(System.String), 11);
		}
		...
		private void InitShipmentEntityMappings()
		{
			...
			this.AddElementFieldMapping("ShipmentEntity", "TrackingHubTimestamp", "TrackingHubTimestamp", true, "DateTime2", 0, 3, 0, false, "", null, typeof(System.DateTime), 80);
		...
		{
			this.AddElementMapping("ShippingSettingsEntity", @"ShipWorksLocal", @"dbo", "ShippingSettings", 60, 0);
			...
			this.AddElementFieldMapping("ShippingSettingsEntity", "FedExPassword", "FedExPassword", true, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 10);
			...
			this.AddElementFieldMapping("ShippingSettingsEntity", "UpsAccessKey", "UpsAccessKey", true, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 16);
			...
			this.AddElementFieldMapping("ShippingSettingsEntity", "DhlEcommerceInsuranceProvider", "DhlEcommerceInsuranceProvider", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 58);
			this.AddElementFieldMapping("ShippingSettingsEntity", "DhlEcommerceInsurancePennyOne", "DhlEcommerceInsurancePennyOne", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 59);
		}
		...
		private void InitShopifyOrderSearchEntityMappings()
		{
			this.AddElementMapping("ShopifyOrderSearchEntity", @"ShipWorksLocal", @"dbo", "ShopifyOrderSearch", 4, 0);
			this.AddElementFieldMapping("ShopifyOrderSearchEntity", "ShopifyOrderSearchID", "ShopifyOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("ShopifyOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("ShopifyOrderSearchEntity", "ShopifyOrderID", "ShopifyOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 2);
			this.AddElementFieldMapping("ShopifyOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}

		/// <summary>Inits ShopifyStoreEntity's mappings</summary>
		private void InitShopifyStoreEntityMappings()
		{
			this.AddElementMapping("ShopifyStoreEntity", @"ShipWorksLocal", @"dbo", "ShopifyStore", 9, 0);
			...
			this.AddElementFieldMapping("ShopifyStoreEntity", "ShopifyFulfillmentLocation", "ShopifyFulfillmentLocation", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 8);
		}
		...
		private void InitShopSiteStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("ShopSiteStoreEntity", "Password", "Password", false, "NVarChar", 200, 0, 0, false, "", null, typeof(System.String), 2);
		...
		{
			this.AddElementMapping("StoreEntity", @"ShipWorksLocal", @"dbo", "Store", 39, 0);
			...
			this.AddElementFieldMapping("StoreEntity", "ShouldMigrate", "ShouldMigrate", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 38);
		}
		...
		/// <summary>Inits ThreeDCartOrderSearchEntity's mappings</summary>
		private void InitThreeDCartOrderSearchEntityMappings()
		{
			this.AddElementMapping("ThreeDCartOrderSearchEntity", @"ShipWorksLocal", @"dbo", "ThreeDCartOrderSearch", 4, 0);
			this.AddElementFieldMapping("ThreeDCartOrderSearchEntity", "ThreeDCartOrderSearchID", "ThreeDCartOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("ThreeDCartOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("ThreeDCartOrderSearchEntity", "ThreeDCartOrderID", "ThreeDCartOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 2);
			this.AddElementFieldMapping("ThreeDCartOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		private void InitUpsAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("UpsAccountEntity", "Password", "Password", false, "NVarChar", 100, 0, 0, false, "", null, typeof(System.String), 5);
		...
		{
			this.AddElementMapping("UpsProfileEntity", @"ShipWorksLocal", @"dbo", "UpsProfile", 39, 0);
		...
		{
			this.AddElementMapping("UpsShipmentEntity", @"ShipWorksLocal", @"dbo", "UpsShipment", 54, 0);
		...
		private void InitUspsAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("UspsAccountEntity", "Password", "Password", false, "NVarChar", 400, 0, 0, false, "", null, typeof(System.String), 4);
		...
		{
			this.AddElementMapping("UspsShipmentEntity", @"ShipWorksLocal", @"dbo", "UspsShipment", 11, 0);
			...
			this.AddElementFieldMapping("UspsShipmentEntity", "Insurance", "Insurance", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 10);
		}
		...
		/// <summary>Inits WalmartOrderSearchEntity's mappings</summary>
		private void InitWalmartOrderSearchEntityMappings()
		{
			this.AddElementMapping("WalmartOrderSearchEntity", @"ShipWorksLocal", @"dbo", "WalmartOrderSearch", 5, 0);
			this.AddElementFieldMapping("WalmartOrderSearchEntity", "WalmartOrderSearchID", "WalmartOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("WalmartOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("WalmartOrderSearchEntity", "PurchaseOrderID", "PurchaseOrderID", false, "VarChar", 32, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("WalmartOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
			this.AddElementFieldMapping("WalmartOrderSearchEntity", "CustomerOrderID", "CustomerOrderID", false, "VarChar", 50, 0, 0, false, "", null, typeof(System.String), 4);
		}

		/// <summary>Inits WalmartStoreEntity's mappings</summary>
		private void InitWalmartStoreEntityMappings()
		{
			this.AddElementMapping("WalmartStoreEntity", @"ShipWorksLocal", @"dbo", "WalmartStore", 6, 0);
			...
			this.AddElementFieldMapping("WalmartStoreEntity", "DownloadModifiedNumberOfDaysBack", "DownloadModifiedNumberOfDaysBack", false, "Int", 0, 10, 0, false, "", null, typeof(System.Int32), 3);
			this.AddElementFieldMapping("WalmartStoreEntity", "ClientID", "ClientID", false, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 4);
			this.AddElementFieldMapping("WalmartStoreEntity", "ClientSecret", "ClientSecret", false, "NVarChar", 2000, 0, 0, false, "", null, typeof(System.String), 5);
		}
		...
		{
			this.AddElementMapping("WorldShipPackageEntity", @"ShipWorksLocal", @"dbo", "WorldShipPackage", 45, 0);
			...
			this.AddElementFieldMapping("WorldShipPackageEntity", "Insurance", "Insurance", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 44);
		}
		...
		/// <summary>Inits YahooOrderSearchEntity's mappings</summary>
		private void InitYahooOrderSearchEntityMappings()
		{
			this.AddElementMapping("YahooOrderSearchEntity", @"ShipWorksLocal", @"dbo", "YahooOrderSearch", 4, 0);
			this.AddElementFieldMapping("YahooOrderSearchEntity", "YahooOrderSearchID", "YahooOrderSearchID", false, "BigInt", 0, 19, 0, true, "SCOPE_IDENTITY()", null, typeof(System.Int64), 0);
			this.AddElementFieldMapping("YahooOrderSearchEntity", "OrderID", "OrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 1);
			this.AddElementFieldMapping("YahooOrderSearchEntity", "YahooOrderID", "YahooOrderID", false, "VarChar", 50, 0, 0, false, "", null, typeof(System.String), 2);
			this.AddElementFieldMapping("YahooOrderSearchEntity", "OriginalOrderID", "OriginalOrderID", false, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 3);
		}
		...
		/// <summary>Inits ShipWorksDisabledDefaultIndexesView's mappings</summary>
		private void InitShipWorksDisabledDefaultIndexesTypedViewMappings()
		{
			this.AddElementMapping("ShipWorksDisabledDefaultIndexesTypedView", @"ShipWorksLocal", @"dbo", "ShipWorksDisabledDefaultIndexes", 7);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "TableName", "TableName", false, "NVarChar", 128, 0, 0, false, string.Empty, null, typeof(System.String), 0);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "IndexName", "IndexName", false, "NVarChar", 128, 0, 0, false, string.Empty, null, typeof(System.String), 1);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "ColumnName", "ColumnName", false, "NVarChar", 128, 0, 0, false, string.Empty, null, typeof(System.String), 2);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "EnableIndex", "EnableIndex", false, "NVarChar", 825, 0, 0, false, string.Empty, null, typeof(System.String), 3);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "IndexID", "IndexID", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 4);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "IndexColumnId", "IndexColumnId", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 5);
			this.AddElementFieldMapping("ShipWorksDisabledDefaultIndexesTypedView", "IsIncluded", "IsIncluded", false, "Bit", 0, 0, 0, false, string.Empty, null, typeof(System.Boolean), 6);
		}


		/// <summary>Inits ShipWorksMissingIndexRequestsView's mappings</summary>
		private void InitShipWorksMissingIndexRequestsTypedViewMappings()
		{
			this.AddElementMapping("ShipWorksMissingIndexRequestsTypedView", @"ShipWorksLocal", @"dbo", "ShipWorksMissingIndexRequests", 7);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "IndexHandle", "IndexHandle", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 0);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "TableName", "TableName", false, "NVarChar", 128, 0, 0, false, string.Empty, null, typeof(System.String), 1);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "IndexAdvantage", "IndexAdvantage", false, "Float", 0, 38, 0, false, string.Empty, null, typeof(System.Double), 2);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "GroupHandle", "GroupHandle", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 3);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "ColumnID", "ColumnID", false, "Int", 0, 10, 0, false, string.Empty, null, typeof(System.Int32), 4);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "ColumnName", "ColumnName", false, "NVarChar", 4000, 0, 0, false, string.Empty, null, typeof(System.String), 5);
			this.AddElementFieldMapping("ShipWorksMissingIndexRequestsTypedView", "ColumnUsage", "ColumnUsage", false, "NVarChar", 4000, 0, 0, false, string.Empty, null, typeof(System.String), 6);
		}
