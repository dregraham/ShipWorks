...
namespace ShipWorks.Data.Model
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("ActionQueueEntity", @"ShipWorksLocal", @"dbo", "ActionQueue", 14, 0);
		...
		{
			this.AddElementMapping("FedExPackageEntity", @"ShipWorksLocal", @"dbo", "FedExPackage", 34, 0);
		...
		{
			this.AddElementMapping("OdbcStoreEntity", @"ShipWorksLocal", @"dbo", "OdbcStore", 11, 0);
		...
		{
			this.AddElementMapping("UserSettingsEntity", @"ShipWorksLocal", @"dbo", "UserSettings", 15, 0);
