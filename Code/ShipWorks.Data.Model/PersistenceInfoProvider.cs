...
namespace ShipWorks.Data.Model
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitAmazonSWAAccountEntityMappings()
		{
			...
			this.AddElementFieldMapping("AmazonSWAAccountEntity", "ShipEngineCarrierId", "ShipEngineCarrierId", false, "NVarChar", 12, 0, 0, false, "", null, typeof(System.String), 2);
		...
		private void InitAsendiaShipmentEntityMappings()
		{
			...
			this.AddElementFieldMapping("AsendiaShipmentEntity", "ShipEngineLabelID", "ShipEngineLabelID", false, "NVarChar", 12, 0, 0, false, "", null, typeof(System.String), 6);
		...
		{
			this.AddElementMapping("DhlExpressShipmentEntity", @"ShipWorksLocal", @"dbo", "DhlExpressShipment", 10, 0);
		...
		private void InitStoreEntityMappings()
		{
			...
			this.AddElementFieldMapping("StoreEntity", "ShipEngineOrderSourceID", "ShipEngineOrderSourceID", true, "UniqueIdentifier", 0, 0, 0, false, "", null, typeof(System.Guid), 34);
			this.AddElementFieldMapping("StoreEntity", "ShipEngineAccountID", "ShipEngineAccountID", true, "NVarChar", 50, 0, 0, false, "", null, typeof(System.String), 35);
		}
		...
		private void InitUserSettingsEntityMappings()
		{
			...
			this.AddElementFieldMapping("UserSettingsEntity", "ScanToShipAutoAdvance", "ScanToShipAutoAdvance", false, "Bit", 0, 0, 0, false, "", null, typeof(System.Boolean), 24);
		}

		/// <summary>Inits UspsAccountEntity's mappings</summary>
		private void InitUspsAccountEntityMappings()
		{
			this.AddElementMapping("UspsAccountEntity", @"ShipWorksLocal", @"dbo", "UspsAccount", 26, 0);
