...
{
    /// <summary>
    /// Entity interface which represents the entity 'DhlEcommerceProfile'. <br/><br/>
    /// 
    /// </summary>
    public partial interface IDhlEcommerceProfileEntity
    {
        ...
        Nullable<System.Int64> DhlEcommerceAccountID { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        Nullable<System.Int32> AncillaryEndorsement { get; }
        ...
        /// </summary>
        IDhlEcommerceProfileEntity AsReadOnly();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        IDhlEcommerceProfileEntity AsReadOnly(IDictionary<object, object> objectMap);
    }
}
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    /// 
    /// </summary>
    public partial class DhlEcommerceProfileEntity : IDhlEcommerceProfileEntity
    {
        IShippingProfileEntity IDhlEcommerceProfileEntity.ShippingProfile => ShippingProfile;
        ...
        /// Get a read only version of the entity
        /// </summary>
        public virtual IDhlEcommerceProfileEntity AsReadOnly() =>
            AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public virtual IDhlEcommerceProfileEntity AsReadOnly(IDictionary<object, object> objectMap)
        {
            if (objectMap.ContainsKey(this))
            {
                return (IDhlEcommerceProfileEntity) objectMap[this];
            }

            objectMap.Add(this, null);

            return new ReadOnlyDhlEcommerceProfileEntity(this, objectMap);
        }
