...
namespace ShipWorks.Data.Model.EntityInterfaces
{
    ...
    public partial interface ILemonStandOrderItemEntity: IOrderItemEntity
    {
        ...
        /// </summary>
        ILemonStandOrderItemEntity AsReadOnlyLemonStandOrderItem();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        ILemonStandOrderItemEntity AsReadOnlyLemonStandOrderItem(IDictionary<object, object> objectMap);
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    public partial class LemonStandOrderItemEntity : ILemonStandOrderItemEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public ILemonStandOrderItemEntity AsReadOnlyLemonStandOrderItem() =>
            (ILemonStandOrderItemEntity) AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public ILemonStandOrderItemEntity AsReadOnlyLemonStandOrderItem(IDictionary<object, object> objectMap) =>
            (ILemonStandOrderItemEntity) AsReadOnly(objectMap);
