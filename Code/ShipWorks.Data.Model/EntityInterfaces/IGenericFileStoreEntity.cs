...
{
    /// <summary>
    /// Entity interface which represents the entity 'GenericFileStore'. <br/><br/>
    /// 
    /// </summary>
    public partial interface IGenericFileStoreEntity: IStoreEntity
    {
        ...
        Nullable<System.Int64> FtpAccountID { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        Nullable<System.Int64> EmailAccountID { get; }
        ...
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.String EmailIncomingFolder { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.Int64 EmailFolderValidityID { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.Int64 EmailFolderLastMessageID { get; }
        ...
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.Boolean EmailOnlyUnread { get; }
        ...
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        System.String NamePatternMatch { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        System.String NamePatternSkip { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.Int32 SuccessAction { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 355<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.String SuccessMoveFolder { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 355<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.String ErrorMoveFolder { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 355<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        System.String XmlXsltFileName { get; }
        ...
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        System.String XmlXsltContent { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): NText, 0, 0, 1073741823<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        System.String FlatImportMap { get; }
        ...
        /// </summary>
        IGenericFileStoreEntity AsReadOnlyGenericFileStore();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        IGenericFileStoreEntity AsReadOnlyGenericFileStore(IDictionary<object, object> objectMap);
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    /// 
    /// </summary>
    public partial class GenericFileStoreEntity : IGenericFileStoreEntity
    {
        ...
        public override IStoreEntity AsReadOnly(IDictionary<object, object> objectMap)
        {
            ...
            {
                return (IGenericFileStoreEntity) objectMap[this];
            }

            objectMap.Add(this, null);

            return new ReadOnlyGenericFileStoreEntity(this, objectMap);
        }
        ...
        /// Get a read only version of the entity
        /// </summary>
        public IGenericFileStoreEntity AsReadOnlyGenericFileStore() =>
            (IGenericFileStoreEntity) AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public IGenericFileStoreEntity AsReadOnlyGenericFileStore(IDictionary<object, object> objectMap) =>
            (IGenericFileStoreEntity) AsReadOnly(objectMap);
