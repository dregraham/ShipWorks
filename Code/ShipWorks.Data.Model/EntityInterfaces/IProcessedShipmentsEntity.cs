...
{
    /// <summary>
    /// Entity interface which represents the entity 'ProcessedShipments'. <br/><br/>
    /// 
    /// </summary>
    public partial interface IProcessedShipmentsEntity
    {
        ...
        /// </summary>
        IProcessedShipmentsEntity AsReadOnly();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        IProcessedShipmentsEntity AsReadOnly(IDictionary<object, object> objectMap);
    }
}
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    /// 
    /// </summary>
    public partial class ProcessedShipmentsEntity : IProcessedShipmentsEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public virtual IProcessedShipmentsEntity AsReadOnly() =>
            AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public virtual IProcessedShipmentsEntity AsReadOnly(IDictionary<object, object> objectMap)
        {
            if (objectMap.ContainsKey(this))
            {
                return (IProcessedShipmentsEntity) objectMap[this];
            }

            objectMap.Add(this, null);

            return new ReadOnlyProcessedShipmentsEntity(this, objectMap);
        }
