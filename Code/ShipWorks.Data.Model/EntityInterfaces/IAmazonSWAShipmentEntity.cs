...
{
    /// <summary>
    /// Entity interface which represents the entity 'AmazonSWAShipment'. <br/><br/>
    /// 
    /// </summary>
    public partial interface IAmazonSWAShipmentEntity
    {
        ...
        /// </summary>
        IAmazonSWAShipmentEntity AsReadOnly();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        IAmazonSWAShipmentEntity AsReadOnly(IDictionary<object, object> objectMap);
    }
}
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    /// 
    /// </summary>
    public partial class AmazonSWAShipmentEntity : IAmazonSWAShipmentEntity
    {
        IShipmentEntity IAmazonSWAShipmentEntity.Shipment => Shipment;
        ...
        /// Get a read only version of the entity
        /// </summary>
        public virtual IAmazonSWAShipmentEntity AsReadOnly() =>
            AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public virtual IAmazonSWAShipmentEntity AsReadOnly(IDictionary<object, object> objectMap)
        {
            if (objectMap.ContainsKey(this))
            {
                return (IAmazonSWAShipmentEntity) objectMap[this];
            }

            objectMap.Add(this, null);

            return new ReadOnlyAmazonSWAShipmentEntity(this, objectMap);
        }
