...
{
    /// <summary>
    /// Entity interface which represents the entity 'NeweggOrderSearch'. <br/><br/>
    /// 
    /// </summary>
    public partial interface INeweggOrderSearchEntity
    {
        ...
        System.Int64 NeweggOrderSearchID { get; }
        ...
        INeweggOrderEntity NeweggOrder { get; }
        ...
        /// </summary>
        INeweggOrderSearchEntity AsReadOnly();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        INeweggOrderSearchEntity AsReadOnly(IDictionary<object, object> objectMap);
    }
}
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    /// 
    /// </summary>
    public partial class NeweggOrderSearchEntity : INeweggOrderSearchEntity
    {
        
        INeweggOrderEntity INeweggOrderSearchEntity.NeweggOrder => NeweggOrder;
        IStoreEntity INeweggOrderSearchEntity.Store => Store;
        

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        public virtual INeweggOrderSearchEntity AsReadOnly() =>
            AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public virtual INeweggOrderSearchEntity AsReadOnly(IDictionary<object, object> objectMap)
        {
            if (objectMap.ContainsKey(this))
            {
                return (INeweggOrderSearchEntity) objectMap[this];
            }

            objectMap.Add(this, null);

            return new ReadOnlyNeweggOrderSearchEntity(this, objectMap);
        }
    }
}
