...
{
    /// <summary>
    /// Entity interface which represents the entity 'ProductListItem'. <br/><br/>
    /// 
    /// </summary>
    public partial interface IProductListItemEntity
    {
        ...
        /// </summary>
        IProductListItemEntity AsReadOnly();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        IProductListItemEntity AsReadOnly(IDictionary<object, object> objectMap);
    }
}
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    /// 
    /// </summary>
    public partial class ProductListItemEntity : IProductListItemEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public virtual IProductListItemEntity AsReadOnly() =>
            AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public virtual IProductListItemEntity AsReadOnly(IDictionary<object, object> objectMap)
        {
            if (objectMap.ContainsKey(this))
            {
                return (IProductListItemEntity) objectMap[this];
            }

            objectMap.Add(this, null);

            return new ReadOnlyProductListItemEntity(this, objectMap);
        }
