...
namespace ShipWorks.Data.Model.EntityInterfaces
{
    ...
    public partial interface IInfopiaOrderItemEntity: IOrderItemEntity
    {
        ...
        /// </summary>
        IInfopiaOrderItemEntity AsReadOnlyInfopiaOrderItem();

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        IInfopiaOrderItemEntity AsReadOnlyInfopiaOrderItem(IDictionary<object, object> objectMap);
...
namespace ShipWorks.Data.Model.EntityClasses
{
    ...
    public partial class InfopiaOrderItemEntity : IInfopiaOrderItemEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public IInfopiaOrderItemEntity AsReadOnlyInfopiaOrderItem() =>
            (IInfopiaOrderItemEntity) AsReadOnly(new Dictionary<object, object>());

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public IInfopiaOrderItemEntity AsReadOnlyInfopiaOrderItem(IDictionary<object, object> objectMap) =>
            (IInfopiaOrderItemEntity) AsReadOnly(objectMap);
