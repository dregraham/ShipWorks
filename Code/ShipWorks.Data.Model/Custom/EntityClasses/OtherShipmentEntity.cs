...
{
    /// <summary>
    /// Partial class extention of the LLBLGen OtherShipmentEntity
    /// </summary>
    public partial class OtherShipmentEntity
    {
        /// <summary>
        ...
        protected override void OnFieldValueChanged(object originalValue, IEntityField2 field)
        {
            ...
            if (field.FieldIndex == (int)OtherShipmentFieldIndex.RequestedLabelFormat)
            {
