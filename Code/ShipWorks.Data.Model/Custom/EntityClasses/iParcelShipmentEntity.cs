...
{
    /// <summary>
    /// Partial class extention of the LLBLGen IParcelShipmentEntity
    /// </summary>
    public partial class IParcelShipmentEntity
    {
        /// <summary>
        ...
        protected override void OnFieldValueChanged(object originalValue, IEntityField2 field)
        {
            ...
            if (field.FieldIndex == (int)IParcelShipmentFieldIndex.RequestedLabelFormat)
            {
