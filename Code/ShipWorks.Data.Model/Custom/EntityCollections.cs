...
{	
	...
	/// <summary>
	/// Strongly typed collection of RakutenOrderEntity
	/// </summary>
	public class RakutenOrderCollection : EntityCollection<RakutenOrderEntity>
	{
        /// <summary>
        /// Gets the count of all RakutenOrderEntity rows
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all RakutenOrderEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new RakutenOrderEntityFactory().CreateFields(), bucket);
        }

        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static RakutenOrderCollection Fetch(IDataAccessAdapter adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static RakutenOrderCollection Fetch(IDataAccessAdapter adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            RakutenOrderCollection collection = new RakutenOrderCollection();
	...
	/// <summary>
	/// Strongly typed collection of RakutenOrderItemEntity
	/// </summary>
	public class RakutenOrderItemCollection : EntityCollection<RakutenOrderItemEntity>
	{
        /// <summary>
        /// Gets the count of all RakutenOrderItemEntity rows
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all RakutenOrderItemEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new RakutenOrderItemEntityFactory().CreateFields(), bucket);
        }

        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static RakutenOrderItemCollection Fetch(IDataAccessAdapter adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static RakutenOrderItemCollection Fetch(IDataAccessAdapter adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            RakutenOrderItemCollection collection = new RakutenOrderItemCollection();
	...
	{
        /// <summary>
        /// Gets the count of all RakutenStoreEntity rows
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all RakutenStoreEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new RakutenStoreEntityFactory().CreateFields(), bucket);
        }

        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static RakutenStoreCollection Fetch(IDataAccessAdapter adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static RakutenStoreCollection Fetch(IDataAccessAdapter adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
            RakutenStoreCollection collection = new RakutenStoreCollection();
