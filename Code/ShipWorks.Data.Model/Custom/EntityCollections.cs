...
{	
	...
	/// <summary>
	/// Strongly typed collection of DeviceEntity
	/// </summary>
	public class DeviceCollection : EntityCollection<DeviceEntity>
	{
        /// <summary>
        /// Gets the count of all DeviceEntity rows
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter)
        {
            return GetCount(adapter, null);
        ...
        /// <summary>
        /// Gets the count of all DeviceEntity rows filtered by the given predicate
        /// </summary>
        public static int GetCount(IDataAccessAdapter adapter, IPredicate filter)
        {
            RelationPredicateBucket bucket = null;
            ...
            return adapter.GetDbCount(new DeviceEntityFactory().CreateFields(), bucket);
        }

        /// <summary>
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static DeviceCollection Fetch(IDataAccessAdapter adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static DeviceCollection Fetch(IDataAccessAdapter adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
