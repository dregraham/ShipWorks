...
{	
	...
	public class DhlExpressProfilePackageCollection : EntityCollection<DhlExpressProfilePackageEntity>
	{
        ...
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static DhlExpressProfilePackageCollection Fetch(IDataAccessAdapter adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static DhlExpressProfilePackageCollection Fetch(IDataAccessAdapter adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
	...
	public class IParcelProfilePackageCollection : EntityCollection<IParcelProfilePackageEntity>
	{
        ...
        /// Fetch a new collection object that matches the specified filter.
        /// </summary>
        public static IParcelProfilePackageCollection Fetch(IDataAccessAdapter adapter, IPredicate filter)
        {
			return Fetch(adapter, filter, null);
        }
        ...
        /// Fetch a new collection object that matches the specified filter and uses the given prefetch.
        /// </summary>
        public static IParcelProfilePackageCollection Fetch(IDataAccessAdapter adapter, IPredicate filter, IPrefetchPath2 prefetchPath)
        {
