...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> The DhlExpressAccountID property of the Entity DhlExpressProfile<br/><br/></summary>
		/// <remarks>Mapped on  table field: "DhlExpressProfile"."DhlExpressAccountID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		[DataMember]
		public virtual Nullable<System.Int64> DhlExpressAccountID
		{
			get { return (Nullable<System.Int64>)GetValue((int)DhlExpressProfileFieldIndex.DhlExpressAccountID, false); }
			set	{ SetValue((int)DhlExpressProfileFieldIndex.DhlExpressAccountID, value); }
		}
		...
		/// <summary> The CustomsRecipientTin property of the Entity DhlExpressProfile<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)DhlExpressProfileFieldIndex.CustomsRecipientTin, true); }
			set	{ SetValue((int)DhlExpressProfileFieldIndex.CustomsRecipientTin, value); }
		}

		/// <summary> The CustomsTaxIdType property of the Entity DhlExpressProfile<br/><br/></summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)DhlExpressProfileFieldIndex.CustomsTaxIdType, false); }
			set	{ SetValue((int)DhlExpressProfileFieldIndex.CustomsTaxIdType, value); }
		}

		/// <summary> The CustomsTinIssuingAuthority property of the Entity DhlExpressProfile<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)DhlExpressProfileFieldIndex.CustomsTinIssuingAuthority, true); }
			set	{ SetValue((int)DhlExpressProfileFieldIndex.CustomsTinIssuingAuthority, value); }
		}
