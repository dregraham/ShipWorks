...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'YahooOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class YahooOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static YahooOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public YahooOrderItemEntity()
		{
			SetName("YahooOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public YahooOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("YahooOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this YahooOrderItemEntity</param>
		public YahooOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("YahooOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for YahooOrderItem which data should be fetched into this YahooOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public YahooOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("YahooOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this YahooOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public YahooOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("YahooOrderItemEntity");
		}
		...
		protected YahooOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((YahooOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return YahooOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("YahooOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("YahooOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("YahooOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(YahooOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(YahooOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("YahooOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new YahooOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.YahooOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(YahooOrderItemEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this YahooOrderItemEntity</param>
		...
		public new static YahooOrderItemRelations Relations
		{
			get	{ return new YahooOrderItemRelations(); }
		}
		...
		{
			get { return YahooOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return YahooOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity YahooOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "YahooOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)YahooOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)YahooOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.YahooOrderItemEntity; }
		}
		#endregion
