...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UpsLetterRate'.<br/><br/></summary>
	[Serializable]
	public partial class UpsLetterRateEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static UpsLetterRateEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public UpsLetterRateEntity():base("UpsLetterRateEntity")
		{
		...
		public UpsLetterRateEntity(IEntityFields2 fields):base("UpsLetterRateEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this UpsLetterRateEntity</param>
		public UpsLetterRateEntity(IValidator validator):base("UpsLetterRateEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="upsLetterRateID">PK value for UpsLetterRate which data should be fetched into this UpsLetterRate object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UpsLetterRateEntity(System.Int64 upsLetterRateID):base("UpsLetterRateEntity")
		{
			InitClassEmpty(null, null);
			this.UpsLetterRateID = upsLetterRateID;
		}
		...
		/// <param name="validator">The custom validator object for this UpsLetterRateEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UpsLetterRateEntity(System.Int64 upsLetterRateID, IValidator validator):base("UpsLetterRateEntity")
		{
			InitClassEmpty(validator, null);
			this.UpsLetterRateID = upsLetterRateID;
		}
		...
		protected UpsLetterRateEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((UpsLetterRateFieldIndex)fieldIndex)
			{
				case UpsLetterRateFieldIndex.UpsRateTableID:
		...
		{
			return new UpsLetterRateRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(UpsLetterRateEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("UpsLetterRateID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _upsRateTable, new PropertyChangedEventHandler( OnUpsRateTablePropertyChanged ), "UpsRateTable", ShipWorks.Data.Model.RelationClasses.StaticUpsLetterRateRelations.UpsRateTableEntityUsingUpsRateTableIDStatic, true, signalRelatedEntity, "UpsLetterRate", resetFKFields, new int[] { (int)UpsLetterRateFieldIndex.UpsRateTableID } );
			_upsRateTable = null;
		}
		...
		private void SetupSyncUpsRateTable(IEntityCore relatedEntity)
		{
			if(_upsRateTable!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _upsRateTable, new PropertyChangedEventHandler( OnUpsRateTablePropertyChanged ), "UpsRateTable", ShipWorks.Data.Model.RelationClasses.StaticUpsLetterRateRelations.UpsRateTableEntityUsingUpsRateTableIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this UpsLetterRateEntity</param>
		...
		public  static UpsLetterRateRelations Relations
		{
			get	{ return new UpsLetterRateRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UpsRateTableEntityFactory))),	(IEntityRelation)GetRelationsForField("UpsRateTable")[0], (int)ShipWorks.Data.Model.EntityType.UpsLetterRateEntity, (int)ShipWorks.Data.Model.EntityType.UpsRateTableEntity, 0, null, null, null, null, "UpsRateTable", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual System.Int64 UpsLetterRateID
		{
			...
			set	{ SetValue((int)UpsLetterRateFieldIndex.UpsLetterRateID, value); }
		}

		/// <summary> The UpsRateTableID property of the Entity UpsLetterRate<br/><br/></summary>
		...
		{
			get { return (System.Int64)GetValue((int)UpsLetterRateFieldIndex.UpsRateTableID, true); }
			set	{ SetValue((int)UpsLetterRateFieldIndex.UpsRateTableID, value); }
		}

		/// <summary> The Zone property of the Entity UpsLetterRate<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)UpsLetterRateFieldIndex.Zone, true); }
			set	{ SetValue((int)UpsLetterRateFieldIndex.Zone, value); }
		}

		/// <summary> The Service property of the Entity UpsLetterRate<br/><br/></summary>
		/// <remarks>Mapped on  table field: "UpsLetterRate"."Service"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 Service
		{
			get { return (System.Int32)GetValue((int)UpsLetterRateFieldIndex.Service, true); }
			set	{ SetValue((int)UpsLetterRateFieldIndex.Service, value); }
		}

		/// <summary> The Rate property of the Entity UpsLetterRate<br/><br/></summary>
		/// <remarks>Mapped on  table field: "UpsLetterRate"."Rate"<br/>
		/// Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Decimal Rate
		{
			get { return (System.Decimal)GetValue((int)UpsLetterRateFieldIndex.Rate, true); }
			set	{ SetValue((int)UpsLetterRateFieldIndex.Rate, value); }
		}
		...
		public virtual UpsRateTableEntity UpsRateTable
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UpsLetterRate", "UpsRateTable", _upsRateTable, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.UpsLetterRateEntity; }
		}
