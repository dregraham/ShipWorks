...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ChannelAdvisorOrder'.<br/><br/></summary>
	[Serializable]
	public partial class ChannelAdvisorOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ChannelAdvisorOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public ChannelAdvisorOrderEntity()
		{
			InitClassEmpty();
			SetName("ChannelAdvisorOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ChannelAdvisorOrderEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("ChannelAdvisorOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ChannelAdvisorOrderEntity</param>
		public ChannelAdvisorOrderEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("ChannelAdvisorOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for ChannelAdvisorOrder which data should be fetched into this ChannelAdvisorOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ChannelAdvisorOrderEntity(System.Int64 orderID):base(orderID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this ChannelAdvisorOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ChannelAdvisorOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			InitClassEmpty();
		...
		protected ChannelAdvisorOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ChannelAdvisorOrderSearch":
					toReturn.Add(Relations.ChannelAdvisorOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ChannelAdvisorOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ChannelAdvisorOrderEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ChannelAdvisorOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ChannelAdvisorOrderRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoChannelAdvisorOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ChannelAdvisorOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ChannelAdvisorOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ResellerID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("OnlineShippingStatus", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("OnlineCheckoutStatus", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("OnlinePaymentStatus", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("FlagStyle", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("FlagDescription", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("FlagType", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this ChannelAdvisorOrderEntity</param>
		...
		public new static ChannelAdvisorOrderRelations Relations
		{
			get	{ return new ChannelAdvisorOrderRelations(); }
		}
		...
		/// <summary> The CustomOrderIdentifier property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.String CustomOrderIdentifier
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.CustomOrderIdentifier, value); }
		}

		/// <summary> The ResellerID property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.String ResellerID
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.ResellerID, value); }
		}

		/// <summary> The OnlineShippingStatus property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int32 OnlineShippingStatus
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.OnlineShippingStatus, value); }
		}

		/// <summary> The OnlineCheckoutStatus property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int32 OnlineCheckoutStatus
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.OnlineCheckoutStatus, value); }
		}

		/// <summary> The OnlinePaymentStatus property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int32 OnlinePaymentStatus
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.OnlinePaymentStatus, value); }
		}

		/// <summary> The FlagStyle property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.String FlagStyle
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.FlagStyle, value); }
		}

		/// <summary> The FlagDescription property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.String FlagDescription
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.FlagDescription, value); }
		}

		/// <summary> The FlagType property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int32 FlagType
		{
			...
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.FlagType, value); }
		}

		/// <summary> The MarketplaceNames property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		/// <summary> The IsPrime property of the Entity ChannelAdvisorOrder<br/><br/></summary>
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ChannelAdvisorOrderEntity; }
		}
