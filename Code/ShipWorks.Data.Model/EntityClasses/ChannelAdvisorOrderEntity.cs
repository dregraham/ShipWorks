...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ChannelAdvisorOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ChannelAdvisorOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((ChannelAdvisorOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ChannelAdvisorOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ChannelAdvisorOrderEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(ChannelAdvisorOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ChannelAdvisorOrderFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ChannelAdvisorOrderEntity);
		}
		...
		{
			get { return ChannelAdvisorOrderEntity.CustomProperties;}
		}
		...
		{
			get { return ChannelAdvisorOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity ChannelAdvisorOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ChannelAdvisorOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)ChannelAdvisorOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)ChannelAdvisorOrderFieldIndex.OrderID, value); }
		}
