...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'OrderMotionOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OrderMotionOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((OrderMotionOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return OrderMotionOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("OrderMotionOrderEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(OrderMotionOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(OrderMotionOrderFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.OrderMotionOrderEntity);
		}
		...
		{
			get { return OrderMotionOrderEntity.CustomProperties;}
		}
		...
		{
			get { return OrderMotionOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity OrderMotionOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "OrderMotionOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)OrderMotionOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)OrderMotionOrderFieldIndex.OrderID, value); }
		}
