...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'IParcelProfilePackage'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class IParcelProfilePackageEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return IParcelProfilePackageEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "IParcelProfile":
					toReturn.Add(IParcelProfilePackageEntity.Relations.IParcelProfileEntityUsingShippingProfileID);
					break;
		...
		public bool TestOriginalFieldValueForNull(IParcelProfilePackageFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(IParcelProfilePackageFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.IParcelProfilePackageEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_iParcelProfile!=null)
			{
				_iParcelProfile.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _iParcelProfile, new PropertyChangedEventHandler( OnIParcelProfilePropertyChanged ), "IParcelProfile", IParcelProfilePackageEntity.Relations.IParcelProfileEntityUsingShippingProfileID, true, signalRelatedEntity, "Packages", resetFKFields, new int[] { (int)IParcelProfilePackageFieldIndex.ShippingProfileID } );		
			_iParcelProfile = null;
		}

		/// <summary> setups the sync logic for member _iParcelProfile</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncIParcelProfile(IEntity2 relatedEntity)
		{
			if(_iParcelProfile!=relatedEntity)
			{
				DesetupSyncIParcelProfile(true, true);
				_iParcelProfile = (IParcelProfileEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _iParcelProfile, new PropertyChangedEventHandler( OnIParcelProfilePropertyChanged ), "IParcelProfile", IParcelProfilePackageEntity.Relations.IParcelProfileEntityUsingShippingProfileID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathIParcelProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IParcelProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("IParcelProfile")[0], (int)ShipWorks.Data.Model.EntityType.IParcelProfilePackageEntity, (int)ShipWorks.Data.Model.EntityType.IParcelProfileEntity, 0, null, null, null, null, "IParcelProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return IParcelProfilePackageEntity.CustomProperties;}
		}
		...
		{
			get { return IParcelProfilePackageEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_iParcelProfile != null)
						{
							_iParcelProfile.UnsetRelatedEntity(this, "Packages");
						}
					}
					else
					{
						if(_iParcelProfile!=value)
						{
