...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ActionQueueSelection'.<br/><br/></summary>
	[Serializable]
	public partial class ActionQueueSelectionEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ActionQueueSelectionEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public ActionQueueSelectionEntity():base("ActionQueueSelectionEntity")
		{
		...
		public ActionQueueSelectionEntity(IEntityFields2 fields):base("ActionQueueSelectionEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ActionQueueSelectionEntity</param>
		public ActionQueueSelectionEntity(IValidator validator):base("ActionQueueSelectionEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="actionQueueSelectionID">PK value for ActionQueueSelection which data should be fetched into this ActionQueueSelection object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ActionQueueSelectionEntity(System.Int64 actionQueueSelectionID):base("ActionQueueSelectionEntity")
		{
			InitClassEmpty(null, null);
			this.ActionQueueSelectionID = actionQueueSelectionID;
		}
		...
		/// <param name="validator">The custom validator object for this ActionQueueSelectionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ActionQueueSelectionEntity(System.Int64 actionQueueSelectionID, IValidator validator):base("ActionQueueSelectionEntity")
		{
			InitClassEmpty(validator, null);
			this.ActionQueueSelectionID = actionQueueSelectionID;
		}
		...
		protected ActionQueueSelectionEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return new ActionQueueSelectionRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ActionQueueSelectionEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ActionQueueSelectionID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		private void SetupSyncActionQueue(IEntityCore relatedEntity)
		{
			if(_actionQueue!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _actionQueue, new PropertyChangedEventHandler( OnActionQueuePropertyChanged ), "ActionQueue", ShipWorks.Data.Model.RelationClasses.StaticActionQueueSelectionRelations.ActionQueueEntityUsingActionQueueIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this ActionQueueSelectionEntity</param>
		...
		public  static ActionQueueSelectionRelations Relations
		{
			get	{ return new ActionQueueSelectionRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ActionQueueEntityFactory))),	(IEntityRelation)GetRelationsForField("ActionQueue")[0], (int)ShipWorks.Data.Model.EntityType.ActionQueueSelectionEntity, (int)ShipWorks.Data.Model.EntityType.ActionQueueEntity, 0, null, null, null, null, "ActionQueue", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The ActionQueueSelectionID property of the Entity ActionQueueSelection<br/><br/></summary>
		...
		public virtual System.Int64 ActionQueueSelectionID
		{
			...
			set	{ SetValue((int)ActionQueueSelectionFieldIndex.ActionQueueSelectionID, value); }
		}

		/// <summary> The ActionQueueID property of the Entity ActionQueueSelection<br/><br/></summary>
		...
		public virtual ActionQueueEntity ActionQueue
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ActionQueueSelection", "ActionQueue", _actionQueue, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ActionQueueSelectionEntity; }
		}
