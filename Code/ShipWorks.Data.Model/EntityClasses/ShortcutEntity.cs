...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ShortcutEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public ShortcutEntity():base("ShortcutEntity")
		{
		...
		public ShortcutEntity(IEntityFields2 fields):base("ShortcutEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ShortcutEntity</param>
		public ShortcutEntity(IValidator validator):base("ShortcutEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="shortcutID">PK value for Shortcut which data should be fetched into this Shortcut object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShortcutEntity(System.Int64 shortcutID):base("ShortcutEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this ShortcutEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShortcutEntity(System.Int64 shortcutID, IValidator validator):base("ShortcutEntity")
		{
			InitClassEmpty(validator, null);
			this.ShortcutID = shortcutID;
		}
		...
		protected ShortcutEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return new ShortcutRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ShortcutEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this ShortcutEntity</param>
		...
		public  static ShortcutRelations Relations
		{
			get	{ return new ShortcutRelations(); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ShortcutEntity; }
		}
