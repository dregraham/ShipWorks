...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'GenericModuleStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GenericModuleStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((GenericModuleStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return GenericModuleStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("GenericModuleStoreEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(GenericModuleStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(GenericModuleStoreFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.GenericModuleStoreEntity);
		}
		...
		{
			get { return GenericModuleStoreEntity.CustomProperties;}
		}
		...
		{
			get { return GenericModuleStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity GenericModuleStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GenericModuleStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)GenericModuleStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)GenericModuleStoreFieldIndex.StoreID, value); }
		}
