...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'NeweggStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class NeweggStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NeweggStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public NeweggStoreEntity()
		{
			SetName("NeweggStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public NeweggStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("NeweggStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NeweggStoreEntity</param>
		public NeweggStoreEntity(IValidator validator):base(validator)
		{
			SetName("NeweggStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for NeweggStore which data should be fetched into this NeweggStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NeweggStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("NeweggStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this NeweggStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NeweggStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("NeweggStoreEntity");
		}
		...
		protected NeweggStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((NeweggStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return NeweggStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("NeweggStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NeweggStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NeweggStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(NeweggStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(NeweggStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("NeweggStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new NeweggStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.NeweggStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NeweggStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this NeweggStoreEntity</param>
		...
		public new static NeweggStoreRelations Relations
		{
			get	{ return new NeweggStoreRelations(); }
		}
		...
		{
			get { return NeweggStoreEntity.CustomProperties;}
		}
		...
		{
			get { return NeweggStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity NeweggStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "NeweggStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)NeweggStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)NeweggStoreFieldIndex.StoreID, value); }
		}
		...
		{
			get { return (System.String)GetValue((int)NeweggStoreFieldIndex.SellerID, true); }
			set	{ SetValue((int)NeweggStoreFieldIndex.SellerID, value); }
		}
		...
		{
			get { return (System.String)GetValue((int)NeweggStoreFieldIndex.SecretKey, true); }
			set	{ SetValue((int)NeweggStoreFieldIndex.SecretKey, value); }
		}
		...
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean ExcludeFulfilledByNewegg
		{
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.NeweggStoreEntity; }
		}
		#endregion
