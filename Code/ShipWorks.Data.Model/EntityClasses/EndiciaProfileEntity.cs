...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EndiciaProfile'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EndiciaProfileEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EndiciaProfileEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EndiciaProfileEntity():base("EndiciaProfileEntity")
		{
		...
		public EndiciaProfileEntity(IEntityFields2 fields):base("EndiciaProfileEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EndiciaProfileEntity</param>
		public EndiciaProfileEntity(IValidator validator):base("EndiciaProfileEntity")
		{
		...
		/// <summary> CTor</summary>
		/// <param name="shippingProfileID">PK value for EndiciaProfile which data should be fetched into this EndiciaProfile object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EndiciaProfileEntity(System.Int64 shippingProfileID):base("EndiciaProfileEntity")
		{
			InitClassEmpty(null, CreateFields());
		...
		/// <param name="validator">The custom validator object for this EndiciaProfileEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EndiciaProfileEntity(System.Int64 shippingProfileID, IValidator validator):base("EndiciaProfileEntity")
		{
			InitClassEmpty(validator, CreateFields());
			this.ShippingProfileID = shippingProfileID;
		}
		...
		protected EndiciaProfileEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EndiciaProfileFieldIndex)fieldIndex)
			{
				case EndiciaProfileFieldIndex.ShippingProfileID:
		...
		{
			return EndiciaProfileEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "PostalProfile":
					toReturn.Add(EndiciaProfileEntity.Relations.PostalProfileEntityUsingShippingProfileID);
					break;
				default:
		...
		public bool TestOriginalFieldValueForNull(EndiciaProfileFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EndiciaProfileFieldIndex fieldIndex)
		{
		...
		{
			return new EndiciaProfileRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EndiciaProfileEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EndiciaProfileEntityFactory));
		}
#if !CF
		...
		{
			base.PerformDesetupSyncRelatedEntity( _postalProfile, new PropertyChangedEventHandler( OnPostalProfilePropertyChanged ), "PostalProfile", EndiciaProfileEntity.Relations.PostalProfileEntityUsingShippingProfileID, true, signalRelatedEntity, "Endicia", false, new int[] { (int)EndiciaProfileFieldIndex.ShippingProfileID } );
			_postalProfile = null;
		}
		...
		private void SetupSyncPostalProfile(IEntity2 relatedEntity)
		{
			if(_postalProfile!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _postalProfile, new PropertyChangedEventHandler( OnPostalProfilePropertyChanged ), "PostalProfile", EndiciaProfileEntity.Relations.PostalProfileEntityUsingShippingProfileID, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this EndiciaProfileEntity</param>
		...
		public  static EndiciaProfileRelations Relations
		{
			get	{ return new EndiciaProfileRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPostalProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PostalProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("PostalProfile")[0], (int)ShipWorks.Data.Model.EntityType.EndiciaProfileEntity, (int)ShipWorks.Data.Model.EntityType.PostalProfileEntity, 0, null, null, null, null, "PostalProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return EndiciaProfileEntity.CustomProperties;}
		}
		...
		{
			get { return EndiciaProfileEntity.FieldsCustomProperties;}
		}
		...
		public virtual System.Int64 ShippingProfileID
		{
			...
			set	{ SetValue((int)EndiciaProfileFieldIndex.ShippingProfileID, value); }
		}
		...
		public virtual Nullable<System.Int64> EndiciaAccountID
		{
			...
			set	{ SetValue((int)EndiciaProfileFieldIndex.EndiciaAccountID, value); }
		}
		...
		public virtual PostalProfileEntity PostalProfile
		{
			...
			set
			{
				if(base.IsDeserializing)
				{
					...
					{
						value.SetRelatedEntity(this, "Endicia");
					}
				}
				else
				{
					...
					else
					{
						if(_postalProfile!=value)
						{
							...
							relatedEntity.SetRelatedEntity(this, "Endicia");
							SetupSyncPostalProfile(relatedEntity);
						}
					}
				}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.EndiciaProfileEntity; }
		}
		#endregion
