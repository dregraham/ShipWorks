...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'EndiciaProfile'.<br/><br/></summary>
	[Serializable]
	public partial class EndiciaProfileEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _postalProfile, new PropertyChangedEventHandler( OnPostalProfilePropertyChanged ), "PostalProfile", ShipWorks.Data.Model.RelationClasses.StaticEndiciaProfileRelations.PostalProfileEntityUsingShippingProfileIDStatic, true, signalRelatedEntity, "Endicia", false, new int[] { (int)EndiciaProfileFieldIndex.ShippingProfileID } );
			_postalProfile = null;
		}
		
		/// <summary> setups the sync logic for member _postalProfile</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncPostalProfile(IEntityCore relatedEntity)
		{
			if(_postalProfile!=relatedEntity)
			{
				DesetupSyncPostalProfile(true, true);
				_postalProfile = (PostalProfileEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _postalProfile, new PropertyChangedEventHandler( OnPostalProfilePropertyChanged ), "PostalProfile", ShipWorks.Data.Model.RelationClasses.StaticEndiciaProfileRelations.PostalProfileEntityUsingShippingProfileIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PostalProfileEntityFactory))), (IEntityRelation)GetRelationsForField("PostalProfile")[0], (int)ShipWorks.Data.Model.EntityType.EndiciaProfileEntity, (int)ShipWorks.Data.Model.EntityType.PostalProfileEntity, 0, null, null, null, null, "PostalProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShippingProfileID property of the Entity EndiciaProfile<br/><br/></summary>
		...
		/// <summary> The EndiciaAccountID property of the Entity EndiciaProfile<br/><br/></summary>
		...
		/// <summary> The StealthPostage property of the Entity EndiciaProfile<br/><br/></summary>
		...
		/// <summary> The ReferenceID property of the Entity EndiciaProfile<br/><br/></summary>
		...
		/// <summary> The ScanBasedReturn property of the Entity EndiciaProfile<br/><br/></summary>
