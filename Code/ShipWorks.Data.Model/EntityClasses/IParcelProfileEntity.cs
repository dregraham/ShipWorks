...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'IParcelProfile'.<br/><br/></summary>
	[Serializable]
	public partial class IParcelProfileEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Packages":
					toReturn.Add(Relations.IParcelProfilePackageEntityUsingShippingProfileID);
					break;
				case "ShippingProfile":
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'IParcelProfilePackage' to this entity.</summary>
		/// <returns></returns>
		...
		private void SetupSyncShippingProfile(IEntityCore relatedEntity)
		{
			if(_shippingProfile!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", ShipWorks.Data.Model.RelationClasses.StaticIParcelProfileRelations.ShippingProfileEntityUsingShippingProfileIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'IParcelProfilePackage' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathPackages
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<IParcelProfilePackageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(IParcelProfilePackageEntityFactory))), (IEntityRelation)GetRelationsForField("Packages")[0], (int)ShipWorks.Data.Model.EntityType.IParcelProfileEntity, (int)ShipWorks.Data.Model.EntityType.IParcelProfilePackageEntity, 0, null, null, null, null, "Packages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShippingProfileEntityFactory))), (IEntityRelation)GetRelationsForField("ShippingProfile")[0], (int)ShipWorks.Data.Model.EntityType.IParcelProfileEntity, (int)ShipWorks.Data.Model.EntityType.ShippingProfileEntity, 0, null, null, null, null, "ShippingProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShippingProfileID property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The IParcelAccountID property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The Service property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The Reference property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The TrackByEmail property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The TrackBySMS property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The IsDeliveryDutyPaid property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> The SkuAndQuantities property of the Entity IParcelProfile<br/><br/></summary>
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'IParcelProfilePackageEntity' which are related to this entity via a relation of type '1:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<IParcelProfilePackageEntity, IParcelProfilePackageEntityFactory>("IParcelProfile", true, false, ref _packages);	}
		}
		...
		public virtual ShippingProfileEntity ShippingProfile
		{
			...
			set
			{
				if(this.IsDeserializing)
				{
					...
					CallSetRelatedEntityDuringDeserialization(value, "IParcel");
				}
				else
				{
					if(value==null)
					...
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "IParcel");
							SetupSyncShippingProfile(value);
						}
					}
				}
