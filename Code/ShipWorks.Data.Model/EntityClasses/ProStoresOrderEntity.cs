...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ProStoresOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ProStoresOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ProStoresOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ProStoresOrderEntity()
		{
			SetName("ProStoresOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ProStoresOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("ProStoresOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ProStoresOrderEntity</param>
		public ProStoresOrderEntity(IValidator validator):base(validator)
		{
			SetName("ProStoresOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for ProStoresOrder which data should be fetched into this ProStoresOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProStoresOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("ProStoresOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this ProStoresOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProStoresOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("ProStoresOrderEntity");
		}
		...
		protected ProStoresOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ProStoresOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ProStoresOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProStoresOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ProStoresOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ProStoresOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(ProStoresOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ProStoresOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ProStoresOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ProStoresOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProStoresOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("AuthorizedDate", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("AuthorizedBy", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this ProStoresOrderEntity</param>
		...
		public new static ProStoresOrderRelations Relations
		{
			get	{ return new ProStoresOrderRelations(); }
		}
		...
		{
			get { return ProStoresOrderEntity.CustomProperties;}
		}
		...
		{
			get { return ProStoresOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity ProStoresOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProStoresOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)ProStoresOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)ProStoresOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual System.String ConfirmationNumber
		{
			...
			set	{ SetValue((int)ProStoresOrderFieldIndex.ConfirmationNumber, value); }
		}
		...
		public virtual Nullable<System.DateTime> AuthorizedDate
		{
			...
			set	{ SetValue((int)ProStoresOrderFieldIndex.AuthorizedDate, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ProStoresOrderEntity; }
		}
		#endregion
