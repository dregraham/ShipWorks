...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'WorldShipPackage'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class WorldShipPackageEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return WorldShipPackageEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "WorldShipShipment":
					toReturn.Add(WorldShipPackageEntity.Relations.WorldShipShipmentEntityUsingShipmentID);
					break;
		...
		public bool TestOriginalFieldValueForNull(WorldShipPackageFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(WorldShipPackageFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.WorldShipPackageEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _worldShipShipment, new PropertyChangedEventHandler( OnWorldShipShipmentPropertyChanged ), "WorldShipShipment", WorldShipPackageEntity.Relations.WorldShipShipmentEntityUsingShipmentID, true, signalRelatedEntity, "Packages", resetFKFields, new int[] { (int)WorldShipPackageFieldIndex.ShipmentID } );		
			_worldShipShipment = null;
		}
		...
		private void SetupSyncWorldShipShipment(IEntity2 relatedEntity)
		{
			if(_worldShipShipment!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _worldShipShipment, new PropertyChangedEventHandler( OnWorldShipShipmentPropertyChanged ), "WorldShipShipment", WorldShipPackageEntity.Relations.WorldShipShipmentEntityUsingShipmentID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathWorldShipShipment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(WorldShipShipmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("WorldShipShipment")[0], (int)ShipWorks.Data.Model.EntityType.WorldShipPackageEntity, (int)ShipWorks.Data.Model.EntityType.WorldShipShipmentEntity, 0, null, null, null, null, "WorldShipShipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return WorldShipPackageEntity.CustomProperties;}
		}
		...
		{
			get { return WorldShipPackageEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_worldShipShipment != null)
						{
							_worldShipShipment.UnsetRelatedEntity(this, "Packages");
						}
					}
					else
					{
