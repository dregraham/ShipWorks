...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ThreeDCartOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ThreeDCartOrderEntity : OrderEntity, ISerializable
			...
			
	{
		...
		static ThreeDCartOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ThreeDCartOrderEntity()
		{
			SetName("ThreeDCartOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ThreeDCartOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("ThreeDCartOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ThreeDCartOrderEntity</param>
		public ThreeDCartOrderEntity(IValidator validator):base(validator)
		{
			SetName("ThreeDCartOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for ThreeDCartOrder which data should be fetched into this ThreeDCartOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ThreeDCartOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("ThreeDCartOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this ThreeDCartOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ThreeDCartOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("ThreeDCartOrderEntity");
		}
		...
		protected ThreeDCartOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ThreeDCartOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ThreeDCartOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ThreeDCartOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ThreeDCartOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ThreeDCartOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(ThreeDCartOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ThreeDCartOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ThreeDCartOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ThreeDCartOrderRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ThreeDCartOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ThreeDCartOrderEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this ThreeDCartOrderEntity</param>
		...
		public new static ThreeDCartOrderRelations Relations
		{
			get	{ return new ThreeDCartOrderRelations(); }
		}
		...
		{
			get { return ThreeDCartOrderEntity.CustomProperties;}
		}
		...
		{
			get { return ThreeDCartOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity ThreeDCartOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ThreeDCartOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)ThreeDCartOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)ThreeDCartOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual System.Int64 ThreeDCartOrderID
		{
			...
			set	{ SetValue((int)ThreeDCartOrderFieldIndex.ThreeDCartOrderID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ThreeDCartOrderEntity; }
		}
		#endregion
