...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ThreeDCartOrder'.<br/><br/></summary>
	[Serializable]
	public partial class ThreeDCartOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ThreeDCartOrderSearch":
					toReturn.Add(Relations.ThreeDCartOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		public virtual IRelationPredicateBucket GetRelationInfoThreeDCartOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ThreeDCartOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		/// <summary> The ThreeDCartOrderID property of the Entity ThreeDCartOrder<br/><br/></summary>
