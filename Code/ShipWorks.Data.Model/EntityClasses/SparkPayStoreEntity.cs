...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'SparkPayStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class SparkPayStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SparkPayStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public SparkPayStoreEntity()
		{
			SetName("SparkPayStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public SparkPayStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("SparkPayStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SparkPayStoreEntity</param>
		public SparkPayStoreEntity(IValidator validator):base(validator)
		{
			SetName("SparkPayStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for SparkPayStore which data should be fetched into this SparkPayStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SparkPayStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("SparkPayStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this SparkPayStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SparkPayStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("SparkPayStoreEntity");
		}
		...
		protected SparkPayStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((SparkPayStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return SparkPayStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SparkPayStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("SparkPayStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("SparkPayStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(SparkPayStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(SparkPayStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("SparkPayStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new SparkPayStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.SparkPayStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SparkPayStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this SparkPayStoreEntity</param>
		...
		public new static SparkPayStoreRelations Relations
		{
			get	{ return new SparkPayStoreRelations(); }
		}
		...
		{
			get { return SparkPayStoreEntity.CustomProperties;}
		}
		...
		{
			get { return SparkPayStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity SparkPayStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "SparkPayStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)SparkPayStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)SparkPayStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.String Token
		{
			...
			set	{ SetValue((int)SparkPayStoreFieldIndex.Token, value); }
		}
		...
		public virtual System.String StoreUrl
		{
			...
			set	{ SetValue((int)SparkPayStoreFieldIndex.StoreUrl, value); }
		}
		...
		public virtual System.String StatusCodes
		{
			...
			set	{ SetValue((int)SparkPayStoreFieldIndex.StatusCodes, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.SparkPayStoreEntity; }
		}
		#endregion
