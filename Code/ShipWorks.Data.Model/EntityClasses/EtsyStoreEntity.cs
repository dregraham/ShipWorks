...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EtsyStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EtsyStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EtsyStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EtsyStoreEntity()
		{
			SetName("EtsyStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public EtsyStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("EtsyStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EtsyStoreEntity</param>
		public EtsyStoreEntity(IValidator validator):base(validator)
		{
			SetName("EtsyStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for EtsyStore which data should be fetched into this EtsyStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EtsyStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("EtsyStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this EtsyStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EtsyStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("EtsyStoreEntity");
		}
		...
		protected EtsyStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EtsyStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return EtsyStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EtsyStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("EtsyStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("EtsyStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(EtsyStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EtsyStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("EtsyStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new EtsyStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EtsyStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EtsyStoreEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("EtsyShopID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("EtsyLoginName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("EtsyStoreName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("OAuthToken", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("OAuthTokenSecret", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this EtsyStoreEntity</param>
		...
		public new static EtsyStoreRelations Relations
		{
			get	{ return new EtsyStoreRelations(); }
		}
		...
		{
			get { return EtsyStoreEntity.CustomProperties;}
		}
		...
		{
			get { return EtsyStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity EtsyStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "EtsyStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)EtsyStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)EtsyStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.Int64 EtsyShopID
		{
			...
			set	{ SetValue((int)EtsyStoreFieldIndex.EtsyShopID, value); }
		}
		...
		public virtual System.String EtsyLoginName
		{
			...
			set	{ SetValue((int)EtsyStoreFieldIndex.EtsyLoginName, value); }
		}
		...
		public virtual System.String EtsyStoreName
		{
			...
			set	{ SetValue((int)EtsyStoreFieldIndex.EtsyStoreName, value); }
		}
		...
		public virtual System.String OAuthToken
		{
			...
			set	{ SetValue((int)EtsyStoreFieldIndex.OAuthToken, value); }
		}
		...
		public virtual System.String OAuthTokenSecret
		{
			...
			set	{ SetValue((int)EtsyStoreFieldIndex.OAuthTokenSecret, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.EtsyStoreEntity; }
		}
		#endregion
