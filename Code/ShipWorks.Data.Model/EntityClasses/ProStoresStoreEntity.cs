...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ProStoresStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ProStoresStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((ProStoresStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ProStoresStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProStoresStoreEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(ProStoresStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ProStoresStoreFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ProStoresStoreEntity);
		}
		...
		{
			get { return ProStoresStoreEntity.CustomProperties;}
		}
		...
		{
			get { return ProStoresStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity ProStoresStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ProStoresStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)ProStoresStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)ProStoresStoreFieldIndex.StoreID, value); }
		}
