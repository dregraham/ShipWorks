...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'FtpAccount'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class FtpAccountEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((FtpAccountFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return FtpAccountEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(FtpAccountFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(FtpAccountFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.FtpAccountEntity);
		}
		...
		{
			get { return FtpAccountEntity.CustomProperties;}
		}
		...
		{
			get { return FtpAccountEntity.FieldsCustomProperties;}
		}
