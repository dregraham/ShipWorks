...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UpsPackage'.<br/><br/></summary>
	[Serializable]
	public partial class UpsPackageEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _upsShipment, new PropertyChangedEventHandler( OnUpsShipmentPropertyChanged ), "UpsShipment", ShipWorks.Data.Model.RelationClasses.StaticUpsPackageRelations.UpsShipmentEntityUsingShipmentIDStatic, true, signalRelatedEntity, "Packages", resetFKFields, new int[] { (int)UpsPackageFieldIndex.ShipmentID } );
			_upsShipment = null;
		}

		/// <summary> setups the sync logic for member _upsShipment</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncUpsShipment(IEntityCore relatedEntity)
		{
			if(_upsShipment!=relatedEntity)
			{
				DesetupSyncUpsShipment(true, true);
				_upsShipment = (UpsShipmentEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _upsShipment, new PropertyChangedEventHandler( OnUpsShipmentPropertyChanged ), "UpsShipment", ShipWorks.Data.Model.RelationClasses.StaticUpsPackageRelations.UpsShipmentEntityUsingShipmentIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UpsShipmentEntityFactory))),	(IEntityRelation)GetRelationsForField("UpsShipment")[0], (int)ShipWorks.Data.Model.EntityType.UpsPackageEntity, (int)ShipWorks.Data.Model.EntityType.UpsShipmentEntity, 0, null, null, null, null, "UpsShipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The UpsPackageID property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The ShipmentID property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The PackagingType property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The Weight property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DimsProfileID property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DimsLength property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DimsWidth property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DimsHeight property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DimsWeight property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DimsAddWeight property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The Insurance property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The InsuranceValue property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The InsurancePennyOne property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DeclaredValue property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The TrackingNumber property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The UspsTrackingNumber property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The AdditionalHandlingEnabled property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The VerbalConfirmationEnabled property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The VerbalConfirmationName property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The VerbalConfirmationPhone property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The VerbalConfirmationPhoneExtension property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DryIceEnabled property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DryIceRegulationSet property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DryIceWeight property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> The DryIceIsForMedicalUse property of the Entity UpsPackage<br/><br/></summary>
		...
		/// <summary> Gets / sets related entity of type 'UpsShipmentEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(true)]
		public virtual UpsShipmentEntity UpsShipment
		{
			get	{ return _upsShipment; }
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Packages", "UpsShipment", _upsShipment, true); 
				}
			}
		}
