...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'FilterNodeColumnSettings'.<br/><br/></summary>
	[Serializable]
	public partial class FilterNodeColumnSettingsEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "FilterNode":
					toReturn.Add(Relations.FilterNodeEntityUsingFilterNodeID);
					break;
				case "User":
		...
		{
			this.PerformDesetupSyncRelatedEntity( _filterNode, new PropertyChangedEventHandler( OnFilterNodePropertyChanged ), "FilterNode", ShipWorks.Data.Model.RelationClasses.StaticFilterNodeColumnSettingsRelations.FilterNodeEntityUsingFilterNodeIDStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)FilterNodeColumnSettingsFieldIndex.FilterNodeID } );
			_filterNode = null;
		}

		/// <summary> setups the sync logic for member _filterNode</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncFilterNode(IEntityCore relatedEntity)
		{
			if(_filterNode!=relatedEntity)
			{
				DesetupSyncFilterNode(true, true);
				_filterNode = (FilterNodeEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _filterNode, new PropertyChangedEventHandler( OnFilterNodePropertyChanged ), "FilterNode", ShipWorks.Data.Model.RelationClasses.StaticFilterNodeColumnSettingsRelations.FilterNodeEntityUsingFilterNodeIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", ShipWorks.Data.Model.RelationClasses.StaticFilterNodeColumnSettingsRelations.UserEntityUsingUserIDStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)FilterNodeColumnSettingsFieldIndex.UserID } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", ShipWorks.Data.Model.RelationClasses.StaticFilterNodeColumnSettingsRelations.UserEntityUsingUserIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(FilterNodeEntityFactory))),	(IEntityRelation)GetRelationsForField("FilterNode")[0], (int)ShipWorks.Data.Model.EntityType.FilterNodeColumnSettingsEntity, (int)ShipWorks.Data.Model.EntityType.FilterNodeEntity, 0, null, null, null, null, "FilterNode", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)ShipWorks.Data.Model.EntityType.FilterNodeColumnSettingsEntity, (int)ShipWorks.Data.Model.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The FilterNodeColumnSettingsID property of the Entity FilterNodeColumnSettings<br/><br/></summary>
		...
		/// <summary> The UserID property of the Entity FilterNodeColumnSettings<br/><br/></summary>
		...
		/// <summary> The FilterNodeID property of the Entity FilterNodeColumnSettings<br/><br/></summary>
		...
		/// <summary> The Inherit property of the Entity FilterNodeColumnSettings<br/><br/></summary>
		...
		/// <summary> The GridColumnLayoutID property of the Entity FilterNodeColumnSettings<br/><br/></summary>
		...
		public virtual FilterNodeEntity FilterNode
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "", "FilterNode", _filterNode, false); 
				}
			}
		}
