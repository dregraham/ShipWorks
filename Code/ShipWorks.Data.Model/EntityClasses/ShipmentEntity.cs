...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private AmazonSFPShipmentEntity _amazonSFP;
		...
		protected ShipmentEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_amazonSFP = (AmazonSFPShipmentEntity)info.GetValue("_amazonSFP", typeof(AmazonSFPShipmentEntity));
				if(_amazonSFP!=null)
				{
					_amazonSFP.AfterSave+=new EventHandler(OnEntityAfterSave);
				}
				_amazonSWA = (AmazonSWAShipmentEntity)info.GetValue("_amazonSWA", typeof(AmazonSWAShipmentEntity));
				if(_amazonSWA!=null)
				{
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "OrderCollectionViaValidatedAddress":
					...
					break;
				case "AmazonSFP":
					this.AmazonSFP = (AmazonSFPShipmentEntity)entity;
					break;
				case "AmazonSWA":
					this.AmazonSWA = (AmazonSWAShipmentEntity)entity;
					break;
				case "Asendia":
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "OrderCollectionViaValidatedAddress":
					...
					break;
				case "AmazonSFP":
					toReturn.Add(Relations.AmazonSFPShipmentEntityUsingShipmentID);
					break;
				case "AmazonSWA":
					toReturn.Add(Relations.AmazonSWAShipmentEntityUsingShipmentID);
					break;
				case "Asendia":
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'AmazonSFPShipment' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoAmazonSFP()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AmazonSFPShipmentFields.ShipmentID, null, ComparisonOperator.Equal, this.ShipmentID));
			return bucket;
		}

		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'AmazonSWAShipment' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoAmazonSWA()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AmazonSWAShipmentFields.ShipmentID, null, ComparisonOperator.Equal, this.ShipmentID));
			return bucket;
		}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'DhlExpressShipment' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoDhlExpress()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(DhlExpressShipmentFields.ShipmentID, null, ComparisonOperator.Equal, this.ShipmentID));
			return bucket;
		}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("IncludeReturns", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		private void SetupSyncAmazonSFP(IEntityCore relatedEntity)
		{
			if(_amazonSFP!=relatedEntity)
			{
				...
				_amazonSFP = (AmazonSFPShipmentEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _amazonSFP, new PropertyChangedEventHandler( OnAmazonSFPPropertyChanged ), "AmazonSFP", ShipWorks.Data.Model.RelationClasses.StaticShipmentRelations.AmazonSFPShipmentEntityUsingShipmentIDStatic, false, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _amazonSWA, new PropertyChangedEventHandler( OnAmazonSWAPropertyChanged ), "AmazonSWA", ShipWorks.Data.Model.RelationClasses.StaticShipmentRelations.AmazonSWAShipmentEntityUsingShipmentIDStatic, false, signalRelatedEntity, "Shipment", false, new int[] { (int)ShipmentFieldIndex.ShipmentID } );
			_amazonSWA = null;
		}
		...
		private void SetupSyncAmazonSWA(IEntityCore relatedEntity)
		{
			if(_amazonSWA!=relatedEntity)
			{
				...
				_amazonSWA = (AmazonSWAShipmentEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _amazonSWA, new PropertyChangedEventHandler( OnAmazonSWAPropertyChanged ), "AmazonSWA", ShipWorks.Data.Model.RelationClasses.StaticShipmentRelations.AmazonSWAShipmentEntityUsingShipmentIDStatic, false, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _dhlExpress, new PropertyChangedEventHandler( OnDhlExpressPropertyChanged ), "DhlExpress", ShipWorks.Data.Model.RelationClasses.StaticShipmentRelations.DhlExpressShipmentEntityUsingShipmentIDStatic, false, signalRelatedEntity, "Shipment", false, new int[] { (int)ShipmentFieldIndex.ShipmentID } );
			_dhlExpress = null;
		}
		...
		private void SetupSyncDhlExpress(IEntityCore relatedEntity)
		{
			if(_dhlExpress!=relatedEntity)
			{
				...
				_dhlExpress = (DhlExpressShipmentEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _dhlExpress, new PropertyChangedEventHandler( OnDhlExpressPropertyChanged ), "DhlExpress", ShipWorks.Data.Model.RelationClasses.StaticShipmentRelations.DhlExpressShipmentEntityUsingShipmentIDStatic, false, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'AmazonSFPShipment' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAmazonSFP
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AmazonSFPShipmentEntityFactory))), (IEntityRelation)GetRelationsForField("AmazonSFP")[0], (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, (int)ShipWorks.Data.Model.EntityType.AmazonSFPShipmentEntity, 0, null, null, null, null, "AmazonSFP", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'AmazonSWAShipment' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAmazonSWA
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AmazonSWAShipmentEntityFactory))), (IEntityRelation)GetRelationsForField("AmazonSWA")[0], (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, (int)ShipWorks.Data.Model.EntityType.AmazonSWAShipmentEntity, 0, null, null, null, null, "AmazonSWA", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DhlExpressShipmentEntityFactory))), (IEntityRelation)GetRelationsForField("DhlExpress")[0], (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, (int)ShipWorks.Data.Model.EntityType.DhlExpressShipmentEntity, 0, null, null, null, null, "DhlExpress", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The IncludeReturns property of the Entity Shipment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Shipment"."IncludeReturns"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IncludeReturns
		{
			get { return (System.Boolean)GetValue((int)ShipmentFieldIndex.IncludeReturns, true); }
			set	{ SetValue((int)ShipmentFieldIndex.IncludeReturns, value); }
		}

		/// <summary> The ApplyReturnProfile property of the Entity Shipment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Shipment"."ApplyReturnProfile"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean ApplyReturnProfile
		{
			get { return (System.Boolean)GetValue((int)ShipmentFieldIndex.ApplyReturnProfile, true); }
			set	{ SetValue((int)ShipmentFieldIndex.ApplyReturnProfile, value); }
		}

		/// <summary> The ReturnProfileID property of the Entity Shipment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Shipment"."ReturnProfileID"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 ReturnProfileID
		{
			get { return (System.Int32)GetValue((int)ShipmentFieldIndex.ReturnProfileID, true); }
		...
		/// <summary> Gets / sets related entity of type 'AmazonSFPShipmentEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned.<br/><br/>
		/// </summary>
		[Browsable(true)]
		public virtual AmazonSFPShipmentEntity AmazonSFP
		{
		...
		/// <summary> Gets / sets related entity of type 'AmazonSWAShipmentEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned.<br/><br/>
		/// </summary>
		[Browsable(true)]
		public virtual AmazonSWAShipmentEntity AmazonSWA
		{
		...
		/// <summary> Gets / sets related entity of type 'DhlExpressShipmentEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned.<br/><br/>
		/// </summary>
		[Browsable(true)]
		public virtual DhlExpressShipmentEntity DhlExpress
		{
