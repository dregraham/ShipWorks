...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'NetworkSolutionsOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class NetworkSolutionsOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NetworkSolutionsOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public NetworkSolutionsOrderEntity()
		{
			SetName("NetworkSolutionsOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public NetworkSolutionsOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("NetworkSolutionsOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NetworkSolutionsOrderEntity</param>
		public NetworkSolutionsOrderEntity(IValidator validator):base(validator)
		{
			SetName("NetworkSolutionsOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for NetworkSolutionsOrder which data should be fetched into this NetworkSolutionsOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NetworkSolutionsOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("NetworkSolutionsOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this NetworkSolutionsOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NetworkSolutionsOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("NetworkSolutionsOrderEntity");
		}
		...
		protected NetworkSolutionsOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((NetworkSolutionsOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return NetworkSolutionsOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("NetworkSolutionsOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NetworkSolutionsOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NetworkSolutionsOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(NetworkSolutionsOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(NetworkSolutionsOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("NetworkSolutionsOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new NetworkSolutionsOrderRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.NetworkSolutionsOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NetworkSolutionsOrderEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this NetworkSolutionsOrderEntity</param>
		...
		public new static NetworkSolutionsOrderRelations Relations
		{
			get	{ return new NetworkSolutionsOrderRelations(); }
		}
		...
		{
			get { return NetworkSolutionsOrderEntity.CustomProperties;}
		}
		...
		{
			get { return NetworkSolutionsOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity NetworkSolutionsOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "NetworkSolutionsOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)NetworkSolutionsOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)NetworkSolutionsOrderFieldIndex.OrderID, value); }
		}
		...
		{
			get { return (System.Int64)GetValue((int)NetworkSolutionsOrderFieldIndex.NetworkSolutionsOrderID, true); }
			set	{ SetValue((int)NetworkSolutionsOrderFieldIndex.NetworkSolutionsOrderID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.NetworkSolutionsOrderEntity; }
		}
		#endregion
