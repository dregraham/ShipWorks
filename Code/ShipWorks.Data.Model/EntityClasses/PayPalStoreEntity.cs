...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PayPalStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PayPalStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PayPalStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public PayPalStoreEntity()
		{
			SetName("PayPalStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public PayPalStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("PayPalStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PayPalStoreEntity</param>
		public PayPalStoreEntity(IValidator validator):base(validator)
		{
			SetName("PayPalStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for PayPalStore which data should be fetched into this PayPalStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PayPalStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("PayPalStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this PayPalStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PayPalStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("PayPalStoreEntity");
		}
		...
		protected PayPalStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((PayPalStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return PayPalStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PayPalStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("PayPalStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("PayPalStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(PayPalStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PayPalStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("PayPalStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new PayPalStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.PayPalStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PayPalStoreEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ApiCredentialType", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ApiUserName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ApiPassword", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ApiSignature", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ApiCertificate", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("LastTransactionDate", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("LastValidTransactionDate", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this PayPalStoreEntity</param>
		...
		public new static PayPalStoreRelations Relations
		{
			get	{ return new PayPalStoreRelations(); }
		}
		...
		{
			get { return PayPalStoreEntity.CustomProperties;}
		}
		...
		{
			get { return PayPalStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity PayPalStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "PayPalStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)PayPalStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)PayPalStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.Int16 ApiCredentialType
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.ApiCredentialType, value); }
		}
		...
		public virtual System.String ApiUserName
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.ApiUserName, value); }
		}
		...
		public virtual System.String ApiPassword
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.ApiPassword, value); }
		}
		...
		public virtual System.String ApiSignature
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.ApiSignature, value); }
		}
		...
		public virtual System.Byte[] ApiCertificate
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.ApiCertificate, value); }
		}
		...
		public virtual System.DateTime LastTransactionDate
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.LastTransactionDate, value); }
		}
		...
		public virtual System.DateTime LastValidTransactionDate
		{
			...
			set	{ SetValue((int)PayPalStoreFieldIndex.LastValidTransactionDate, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.PayPalStoreEntity; }
		}
		#endregion
