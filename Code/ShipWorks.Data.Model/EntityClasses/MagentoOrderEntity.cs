...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MagentoOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MagentoOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static MagentoOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public MagentoOrderEntity()
		{
			SetName("MagentoOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public MagentoOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("MagentoOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this MagentoOrderEntity</param>
		public MagentoOrderEntity(IValidator validator):base(validator)
		{
			SetName("MagentoOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for MagentoOrder which data should be fetched into this MagentoOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MagentoOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("MagentoOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this MagentoOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MagentoOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("MagentoOrderEntity");
		}
		...
		protected MagentoOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((MagentoOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return MagentoOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("MagentoOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MagentoOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MagentoOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(MagentoOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MagentoOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("MagentoOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new MagentoOrderRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.MagentoOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(MagentoOrderEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this MagentoOrderEntity</param>
		...
		public new static MagentoOrderRelations Relations
		{
			get	{ return new MagentoOrderRelations(); }
		}
		...
		{
			get { return MagentoOrderEntity.CustomProperties;}
		}
		...
		{
			get { return MagentoOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity MagentoOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "MagentoOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)MagentoOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)MagentoOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual System.Int64 MagentoOrderID
		{
			...
			set	{ SetValue((int)MagentoOrderFieldIndex.MagentoOrderID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.MagentoOrderEntity; }
		}
		#endregion
