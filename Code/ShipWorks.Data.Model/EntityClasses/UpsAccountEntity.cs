...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'UpsAccount'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UpsAccountEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return UpsAccountEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(UpsAccountFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(UpsAccountFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.UpsAccountEntity);
		}
		...
		{
			get { return UpsAccountEntity.CustomProperties;}
		}
		...
		{
			get { return UpsAccountEntity.FieldsCustomProperties;}
		}
