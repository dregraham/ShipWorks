...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ShopifyOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ShopifyOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((ShopifyOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ShopifyOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ShopifyOrderEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(ShopifyOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ShopifyOrderFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ShopifyOrderEntity);
		}
		...
		{
			get { return ShopifyOrderEntity.CustomProperties;}
		}
		...
		{
			get { return ShopifyOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity ShopifyOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ShopifyOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)ShopifyOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)ShopifyOrderFieldIndex.OrderID, value); }
		}
