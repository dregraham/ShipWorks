...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EndiciaAccount'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EndiciaAccountEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((EndiciaAccountFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return EndiciaAccountEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(EndiciaAccountFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EndiciaAccountFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EndiciaAccountEntity);
		}
		...
		{
			get { return EndiciaAccountEntity.CustomProperties;}
		}
		...
		{
			get { return EndiciaAccountEntity.FieldsCustomProperties;}
		}
