...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'FilterNodeContent'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class FilterNodeContentEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((FilterNodeContentFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return FilterNodeContentEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(FilterNodeContentFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(FilterNodeContentFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.FilterNodeContentEntity);
		}
		...
		{
			get { return FilterNodeContentEntity.CustomProperties;}
		}
		...
		{
			get { return FilterNodeContentEntity.FieldsCustomProperties;}
		}
