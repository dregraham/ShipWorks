...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ClickCartProOrder'.<br/><br/></summary>
	[Serializable]
	public partial class ClickCartProOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ClickCartProOrderSearch":
					toReturn.Add(Relations.ClickCartProOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		public virtual IRelationPredicateBucket GetRelationInfoClickCartProOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ClickCartProOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		/// <summary> The ClickCartProOrderID property of the Entity ClickCartProOrder<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<ClickCartProOrderSearchEntity, ClickCartProOrderSearchEntityFactory>("ClickCartProOrder", true, false, ref _clickCartProOrderSearch);	}
		}
