...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ClickCartProOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ClickCartProOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ClickCartProOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ClickCartProOrderEntity()
		{
			SetName("ClickCartProOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ClickCartProOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("ClickCartProOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ClickCartProOrderEntity</param>
		public ClickCartProOrderEntity(IValidator validator):base(validator)
		{
			SetName("ClickCartProOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for ClickCartProOrder which data should be fetched into this ClickCartProOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ClickCartProOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("ClickCartProOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this ClickCartProOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ClickCartProOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("ClickCartProOrderEntity");
		}
		...
		protected ClickCartProOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ClickCartProOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ClickCartProOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ClickCartProOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ClickCartProOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ClickCartProOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(ClickCartProOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ClickCartProOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ClickCartProOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ClickCartProOrderRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ClickCartProOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ClickCartProOrderEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this ClickCartProOrderEntity</param>
		...
		public new static ClickCartProOrderRelations Relations
		{
			get	{ return new ClickCartProOrderRelations(); }
		}
		...
		{
			get { return ClickCartProOrderEntity.CustomProperties;}
		}
		...
		{
			get { return ClickCartProOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity ClickCartProOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ClickCartProOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)ClickCartProOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)ClickCartProOrderFieldIndex.OrderID, value); }
		}
		...
		{
			get { return (System.String)GetValue((int)ClickCartProOrderFieldIndex.ClickCartProOrderID, true); }
			set	{ SetValue((int)ClickCartProOrderFieldIndex.ClickCartProOrderID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ClickCartProOrderEntity; }
		}
		#endregion
