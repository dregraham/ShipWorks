...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EmailOutbound'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EmailOutboundEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((EmailOutboundFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return EmailOutboundEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "RelatedObjects":
					toReturn.Add(EmailOutboundEntity.Relations.EmailOutboundRelationEntityUsingEmailOutboundID);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "RelatedObjects":
					base.PerformRelatedEntityRemoval(this.RelatedObjects, relatedEntity, signalRelatedEntityManyToOne);
					break;
		...
		public bool TestOriginalFieldValueForNull(EmailOutboundFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EmailOutboundFieldIndex fieldIndex)
		{
		...
		/// the related entities of type 'EmailOutboundRelation' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EmailOutboundEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			{
				_relatedObjects.ActiveContext = base.ActiveContext;
			}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'EmailOutboundRelation' 
		...
		public static IPrefetchPathElement2 PrefetchPathRelatedObjects
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<EmailOutboundRelationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailOutboundRelationEntityFactory))),
					(IEntityRelation)GetRelationsForField("RelatedObjects")[0], (int)ShipWorks.Data.Model.EntityType.EmailOutboundEntity, (int)ShipWorks.Data.Model.EntityType.EmailOutboundRelationEntity, 0, null, null, null, null, "RelatedObjects", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return EmailOutboundEntity.CustomProperties;}
		}
		...
		{
			get { return EmailOutboundEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'EmailOutboundRelationEntity' which are related to this entity via a relation of type '1:n'.
		...
		public virtual EntityCollection<EmailOutboundRelationEntity> RelatedObjects
		{
			get
			{
				if(_relatedObjects==null)
				{
					_relatedObjects = new EntityCollection<EmailOutboundRelationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailOutboundRelationEntityFactory)));
					_relatedObjects.SetContainingEntityInfo(this, "EmailOutbound");
				}
