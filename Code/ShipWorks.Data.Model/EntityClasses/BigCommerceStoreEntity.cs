...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'BigCommerceStore'.<br/><br/></summary>
	[Serializable]
	public partial class BigCommerceStoreEntity : StoreEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> The ApiUrl property of the Entity BigCommerceStore<br/><br/></summary>
		...
		/// <summary> The ApiUserName property of the Entity BigCommerceStore<br/><br/></summary>
		...
		/// <summary> The ApiToken property of the Entity BigCommerceStore<br/><br/></summary>
		...
		/// <summary> The StatusCodes property of the Entity BigCommerceStore<br/><br/></summary>
		...
		/// <summary> The WeightUnitOfMeasure property of the Entity BigCommerceStore<br/><br/></summary>
		...
		/// <summary> The DownloadModifiedNumberOfDaysBack property of the Entity BigCommerceStore<br/><br/></summary>
		...
		/// <summary> The Identifier property of the Entity BigCommerceStore<br/><br/></summary>
		...
		public virtual System.String Identifier
		{
			...
			set	{ SetValue((int)BigCommerceStoreFieldIndex.Identifier, value); }
		}
