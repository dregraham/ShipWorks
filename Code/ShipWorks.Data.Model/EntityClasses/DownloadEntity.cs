...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Download'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class DownloadEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return DownloadEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Computer":
					toReturn.Add(DownloadEntity.Relations.ComputerEntityUsingComputerID);
					break;
				case "Store":
					toReturn.Add(DownloadEntity.Relations.StoreEntityUsingStoreID);
					break;
				case "User":
					toReturn.Add(DownloadEntity.Relations.UserEntityUsingUserID);
					break;
		...
		public bool TestOriginalFieldValueForNull(DownloadFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(DownloadFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.DownloadEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _computer, new PropertyChangedEventHandler( OnComputerPropertyChanged ), "Computer", DownloadEntity.Relations.ComputerEntityUsingComputerID, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)DownloadFieldIndex.ComputerID } );		
			_computer = null;
		}
		...
		private void SetupSyncComputer(IEntity2 relatedEntity)
		{
			if(_computer!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _computer, new PropertyChangedEventHandler( OnComputerPropertyChanged ), "Computer", DownloadEntity.Relations.ComputerEntityUsingComputerID, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", DownloadEntity.Relations.StoreEntityUsingStoreID, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)DownloadFieldIndex.StoreID } );		
			_store = null;
		}
		...
		private void SetupSyncStore(IEntity2 relatedEntity)
		{
			if(_store!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", DownloadEntity.Relations.StoreEntityUsingStoreID, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", DownloadEntity.Relations.UserEntityUsingUserID, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)DownloadFieldIndex.UserID } );		
			_user = null;
		}
		...
		private void SetupSyncUser(IEntity2 relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", DownloadEntity.Relations.UserEntityUsingUserID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathComputer
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ComputerEntityFactory))),
					(IEntityRelation)GetRelationsForField("Computer")[0], (int)ShipWorks.Data.Model.EntityType.DownloadEntity, (int)ShipWorks.Data.Model.EntityType.ComputerEntity, 0, null, null, null, null, "Computer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathStore
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))),
					(IEntityRelation)GetRelationsForField("Store")[0], (int)ShipWorks.Data.Model.EntityType.DownloadEntity, (int)ShipWorks.Data.Model.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUser
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),
					(IEntityRelation)GetRelationsForField("User")[0], (int)ShipWorks.Data.Model.EntityType.DownloadEntity, (int)ShipWorks.Data.Model.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return DownloadEntity.CustomProperties;}
		}
		...
		{
			get { return DownloadEntity.FieldsCustomProperties;}
		}
