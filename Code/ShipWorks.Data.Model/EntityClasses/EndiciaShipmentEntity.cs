...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EndiciaShipment'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EndiciaShipmentEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EndiciaShipmentEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "PostalShipment":
					toReturn.Add(EndiciaShipmentEntity.Relations.PostalShipmentEntityUsingShipmentID);
					break;
				default:
		...
		public bool TestOriginalFieldValueForNull(EndiciaShipmentFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EndiciaShipmentFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EndiciaShipmentEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _postalShipment, new PropertyChangedEventHandler( OnPostalShipmentPropertyChanged ), "PostalShipment", EndiciaShipmentEntity.Relations.PostalShipmentEntityUsingShipmentID, true, signalRelatedEntity, "Endicia", false, new int[] { (int)EndiciaShipmentFieldIndex.ShipmentID } );
			_postalShipment = null;
		}
		...
		private void SetupSyncPostalShipment(IEntity2 relatedEntity)
		{
			if(_postalShipment!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _postalShipment, new PropertyChangedEventHandler( OnPostalShipmentPropertyChanged ), "PostalShipment", EndiciaShipmentEntity.Relations.PostalShipmentEntityUsingShipmentID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPostalShipment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PostalShipmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("PostalShipment")[0], (int)ShipWorks.Data.Model.EntityType.EndiciaShipmentEntity, (int)ShipWorks.Data.Model.EntityType.PostalShipmentEntity, 0, null, null, null, null, "PostalShipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return EndiciaShipmentEntity.CustomProperties;}
		}
		...
		{
			get { return EndiciaShipmentEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> The NoPostage property of the Entity EndiciaShipment<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "EndiciaShipment"."NoPostage"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean NoPostage
		{
			get { return (System.Boolean)GetValue((int)EndiciaShipmentFieldIndex.NoPostage, true); }
			set	{ SetValue((int)EndiciaShipmentFieldIndex.NoPostage, value); }
		}
