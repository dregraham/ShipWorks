...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AsendiaProfile'.<br/><br/></summary>
	[Serializable]
	public partial class AsendiaProfileEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static AsendiaProfileEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public AsendiaProfileEntity():base("AsendiaProfileEntity")
		{
		...
		public AsendiaProfileEntity(IEntityFields2 fields):base("AsendiaProfileEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AsendiaProfileEntity</param>
		public AsendiaProfileEntity(IValidator validator):base("AsendiaProfileEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="shippingProfileID">PK value for AsendiaProfile which data should be fetched into this AsendiaProfile object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AsendiaProfileEntity(System.Int64 shippingProfileID):base("AsendiaProfileEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this AsendiaProfileEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AsendiaProfileEntity(System.Int64 shippingProfileID, IValidator validator):base("AsendiaProfileEntity")
		{
			InitClassEmpty(validator, null);
			this.ShippingProfileID = shippingProfileID;
		}
		...
		protected AsendiaProfileEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((AsendiaProfileFieldIndex)fieldIndex)
			{
				case AsendiaProfileFieldIndex.ShippingProfileID:
		...
		{
			return new AsendiaProfileRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AsendiaProfileEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", ShipWorks.Data.Model.RelationClasses.StaticAsendiaProfileRelations.ShippingProfileEntityUsingShippingProfileIDStatic, true, signalRelatedEntity, "Asendia", false, new int[] { (int)AsendiaProfileFieldIndex.ShippingProfileID } );
		...
		private void SetupSyncShippingProfile(IEntityCore relatedEntity)
		{
			if(_shippingProfile!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", ShipWorks.Data.Model.RelationClasses.StaticAsendiaProfileRelations.ShippingProfileEntityUsingShippingProfileIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this AsendiaProfileEntity</param>
		...
		public  static AsendiaProfileRelations Relations
		{
			get	{ return new AsendiaProfileRelations(); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShippingProfileEntityFactory))), (IEntityRelation)GetRelationsForField("ShippingProfile")[0], (int)ShipWorks.Data.Model.EntityType.AsendiaProfileEntity, (int)ShipWorks.Data.Model.EntityType.ShippingProfileEntity, 0, null, null, null, null, "ShippingProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShippingProfileID property of the Entity AsendiaProfile<br/><br/></summary>
		...
		{
			get { return (System.Int64)GetValue((int)AsendiaProfileFieldIndex.ShippingProfileID, true); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.ShippingProfileID, value); }
		}

		/// <summary> The AsendiaAccountID property of the Entity AsendiaProfile<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AsendiaProfile"."AsendiaAccountID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		[DataMember]
		public virtual Nullable<System.Int64> AsendiaAccountID
		{
			get { return (Nullable<System.Int64>)GetValue((int)AsendiaProfileFieldIndex.AsendiaAccountID, false); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.AsendiaAccountID, value); }
		}

		/// <summary> The Service property of the Entity AsendiaProfile<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AsendiaProfile"."Service"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		[DataMember]
		public virtual Nullable<Interapptive.Shared.Enums.AsendiaServiceType> Service
		{
			get { return (Nullable<Interapptive.Shared.Enums.AsendiaServiceType>)GetValue((int)AsendiaProfileFieldIndex.Service, false); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.Service, value); }
		}

		/// <summary> The NonMachinable property of the Entity AsendiaProfile<br/><br/></summary>
		...
		{
			get { return (Nullable<System.Boolean>)GetValue((int)AsendiaProfileFieldIndex.NonMachinable, false); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.NonMachinable, value); }
		}

		/// <summary> The Contents property of the Entity AsendiaProfile<br/><br/></summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)AsendiaProfileFieldIndex.Contents, false); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.Contents, value); }
		}

		/// <summary> The NonDelivery property of the Entity AsendiaProfile<br/><br/></summary>
		...
		/// <summary> The CustomsRecipientTin property of the Entity AsendiaProfile<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)AsendiaProfileFieldIndex.CustomsRecipientTin, true); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.CustomsRecipientTin, value); }
		}

		/// <summary> The CustomsRecipientTinType property of the Entity AsendiaProfile<br/><br/></summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)AsendiaProfileFieldIndex.CustomsRecipientTinType, false); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.CustomsRecipientTinType, value); }
		}

		/// <summary> The CustomsRecipientEntityType property of the Entity AsendiaProfile<br/><br/></summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)AsendiaProfileFieldIndex.CustomsRecipientEntityType, false); }
			set	{ SetValue((int)AsendiaProfileFieldIndex.CustomsRecipientEntityType, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.AsendiaProfileEntity; }
		}
