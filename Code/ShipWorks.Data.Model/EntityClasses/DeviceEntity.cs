...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public DeviceEntity(IEntityFields2 fields):base("DeviceEntity")
		{
		...
		public DeviceEntity(IValidator validator):base("DeviceEntity")
		{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case DeviceFieldIndex.ComputerID:
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(DeviceEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("Model", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("IPAddress", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("PortNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _computer, new PropertyChangedEventHandler( OnComputerPropertyChanged ), "Computer", ShipWorks.Data.Model.RelationClasses.StaticDeviceRelations.ComputerEntityUsingComputerIDStatic, true, signalRelatedEntity, "Device", resetFKFields, new int[] { (int)DeviceFieldIndex.ComputerID } );
			_computer = null;
		}
		...
		private void SetupSyncComputer(IEntityCore relatedEntity)
		{
			if(_computer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _computer, new PropertyChangedEventHandler( OnComputerPropertyChanged ), "Computer", ShipWorks.Data.Model.RelationClasses.StaticDeviceRelations.ComputerEntityUsingComputerIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ComputerEntityFactory))),	(IEntityRelation)GetRelationsForField("Computer")[0], (int)ShipWorks.Data.Model.EntityType.DeviceEntity, (int)ShipWorks.Data.Model.EntityType.ComputerEntity, 0, null, null, null, null, "Computer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The ComputerID property of the Entity Device<br/><br/></summary>
		...
		{
			get { return (System.Int64)GetValue((int)DeviceFieldIndex.ComputerID, true); }
			set	{ SetValue((int)DeviceFieldIndex.ComputerID, value); }
		}
		...
		/// <summary> The IPAddress property of the Entity Device<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)DeviceFieldIndex.IPAddress, true); }
			set	{ SetValue((int)DeviceFieldIndex.IPAddress, value); }
		}
		...
		/// <summary> The RowVersion property of the Entity Device<br/><br/></summary>
		...
		{
			get { return (System.Byte[])GetValue((int)DeviceFieldIndex.RowVersion, true); }
		...
		public virtual ComputerEntity Computer
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Device", "Computer", _computer, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.DeviceEntity; }
		}
