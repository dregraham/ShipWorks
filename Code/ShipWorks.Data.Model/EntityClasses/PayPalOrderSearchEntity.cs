...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			switch((PayPalOrderSearchFieldIndex)fieldIndex)
			{
				case PayPalOrderSearchFieldIndex.OrderID:
					...
					break;
				case PayPalOrderSearchFieldIndex.StoreID:
		...
		{
			this.PerformDesetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", ShipWorks.Data.Model.RelationClasses.StaticPayPalOrderSearchRelations.StoreEntityUsingStoreIDStatic, true, signalRelatedEntity, "PayPalOrderSearch", resetFKFields, new int[] { (int)PayPalOrderSearchFieldIndex.StoreID } );
			_store = null;
		}
		...
		private void SetupSyncStore(IEntityCore relatedEntity)
		{
			if(_store!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", ShipWorks.Data.Model.RelationClasses.StaticPayPalOrderSearchRelations.StoreEntityUsingStoreIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))),	(IEntityRelation)GetRelationsForField("Store")[0], (int)ShipWorks.Data.Model.EntityType.PayPalOrderSearchEntity, (int)ShipWorks.Data.Model.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The StoreID property of the Entity PayPalOrderSearch<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PayPalOrderSearch"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)PayPalOrderSearchFieldIndex.StoreID, true); }
			set	{ SetValue((int)PayPalOrderSearchFieldIndex.StoreID, value); }
		}

		/// <summary> The OrderNumber property of the Entity PayPalOrderSearch<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PayPalOrderSearch"."OrderNumber"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 OrderNumber
		{
			get { return (System.Int64)GetValue((int)PayPalOrderSearchFieldIndex.OrderNumber, true); }
			set	{ SetValue((int)PayPalOrderSearchFieldIndex.OrderNumber, value); }
		}

		/// <summary> The OrderNumberComplete property of the Entity PayPalOrderSearch<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)PayPalOrderSearchFieldIndex.OrderNumberComplete, true); }
			set	{ SetValue((int)PayPalOrderSearchFieldIndex.OrderNumberComplete, value); }
		}
		...
		public virtual StoreEntity Store
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PayPalOrderSearch", "Store", _store, true); 
				}
			}
		}
