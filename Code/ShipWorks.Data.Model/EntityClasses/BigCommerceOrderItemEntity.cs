...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'BigCommerceOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class BigCommerceOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static BigCommerceOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public BigCommerceOrderItemEntity()
		{
			SetName("BigCommerceOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public BigCommerceOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("BigCommerceOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BigCommerceOrderItemEntity</param>
		public BigCommerceOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("BigCommerceOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for BigCommerceOrderItem which data should be fetched into this BigCommerceOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BigCommerceOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("BigCommerceOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this BigCommerceOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BigCommerceOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("BigCommerceOrderItemEntity");
		}
		...
		protected BigCommerceOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((BigCommerceOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return BigCommerceOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("BigCommerceOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("BigCommerceOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("BigCommerceOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(BigCommerceOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(BigCommerceOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("BigCommerceOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new BigCommerceOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.BigCommerceOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BigCommerceOrderItemEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("OrderAddressID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("OrderProductID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("IsDigitalItem", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this BigCommerceOrderItemEntity</param>
		...
		public new static BigCommerceOrderItemRelations Relations
		{
			get	{ return new BigCommerceOrderItemRelations(); }
		}
		...
		{
			get { return BigCommerceOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return BigCommerceOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity BigCommerceOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BigCommerceOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)BigCommerceOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)BigCommerceOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		public virtual System.Int64 OrderAddressID
		{
			...
			set	{ SetValue((int)BigCommerceOrderItemFieldIndex.OrderAddressID, value); }
		}
		...
		public virtual System.Int64 OrderProductID
		{
			...
			set	{ SetValue((int)BigCommerceOrderItemFieldIndex.OrderProductID, value); }
		}
		...
		public virtual System.Boolean IsDigitalItem
		{
			...
			set	{ SetValue((int)BigCommerceOrderItemFieldIndex.IsDigitalItem, value); }
		}
		...
		public virtual Nullable<System.DateTime> EventDate
		{
			...
			set	{ SetValue((int)BigCommerceOrderItemFieldIndex.EventDate, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.BigCommerceOrderItemEntity; }
		}
		#endregion
