...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'VolusionStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class VolusionStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static VolusionStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public VolusionStoreEntity()
		{
			SetName("VolusionStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public VolusionStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("VolusionStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this VolusionStoreEntity</param>
		public VolusionStoreEntity(IValidator validator):base(validator)
		{
			SetName("VolusionStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for VolusionStore which data should be fetched into this VolusionStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public VolusionStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("VolusionStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this VolusionStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public VolusionStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("VolusionStoreEntity");
		}
		...
		protected VolusionStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((VolusionStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return VolusionStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("VolusionStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("VolusionStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("VolusionStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(VolusionStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(VolusionStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("VolusionStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new VolusionStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.VolusionStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(VolusionStoreEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("WebUserName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			_fieldsCustomProperties.Add("PaymentMethods", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			_fieldsCustomProperties.Add("ServerTimeZoneDST", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this VolusionStoreEntity</param>
		...
		public new static VolusionStoreRelations Relations
		{
			get	{ return new VolusionStoreRelations(); }
		}
		...
		{
			get { return VolusionStoreEntity.CustomProperties;}
		}
		...
		{
			get { return VolusionStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity VolusionStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "VolusionStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)VolusionStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)VolusionStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.String StoreUrl
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.StoreUrl, value); }
		}
		...
		public virtual System.String WebUserName
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.WebUserName, value); }
		}
		...
		public virtual System.String WebPassword
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.WebPassword, value); }
		}
		...
		public virtual System.String ApiPassword
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.ApiPassword, value); }
		}
		...
		public virtual System.String PaymentMethods
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.PaymentMethods, value); }
		}
		...
		public virtual System.String ServerTimeZone
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.ServerTimeZone, value); }
		}
		...
		public virtual System.Boolean ServerTimeZoneDST
		{
			...
			set	{ SetValue((int)VolusionStoreFieldIndex.ServerTimeZoneDST, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.VolusionStoreEntity; }
		}
		#endregion
