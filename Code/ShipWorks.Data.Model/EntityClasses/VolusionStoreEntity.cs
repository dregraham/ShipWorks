...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'VolusionStore'.<br/><br/></summary>
	[Serializable]
	public partial class VolusionStoreEntity : StoreEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> The StoreUrl property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The WebUserName property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The WebPassword property of the Entity VolusionStore<br/><br/></summary>
		/// <remarks>Mapped on  table field: "VolusionStore"."WebPassword"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 280<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		[DataMember]
		...
		/// <summary> The ApiPassword property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The PaymentMethods property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The ShipmentMethods property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The DownloadOrderStatuses property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The ServerTimeZone property of the Entity VolusionStore<br/><br/></summary>
		...
		/// <summary> The ServerTimeZoneDST property of the Entity VolusionStore<br/><br/></summary>
