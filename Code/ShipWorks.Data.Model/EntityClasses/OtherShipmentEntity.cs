...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public OtherShipmentEntity(IEntityFields2 fields):base("OtherShipmentEntity")
		{
		...
		protected OtherShipmentEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((OtherShipmentFieldIndex)fieldIndex)
			{
				case OtherShipmentFieldIndex.ShipmentID:
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(OtherShipmentEntityFactory));
		}
#if !CF
		...
		public  static OtherShipmentRelations Relations
		{
			get	{ return new OtherShipmentRelations(); }
		}
		...
		{
			get { return (System.Int64)GetValue((int)OtherShipmentFieldIndex.ShipmentID, true); }
		...
		{
			get { return (System.String)GetValue((int)OtherShipmentFieldIndex.Carrier, true); }
		...
		{
			get { return (System.String)GetValue((int)OtherShipmentFieldIndex.Service, true); }
		...
		{
			get { return (System.Decimal)GetValue((int)OtherShipmentFieldIndex.InsuranceValue, true); }
			set	{ SetValue((int)OtherShipmentFieldIndex.InsuranceValue, value); }
		}

		/// <summary> The Insurance property of the Entity OtherShipment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "OtherShipment"."Insurance"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Insurance
		{
			get { return (System.Boolean)GetValue((int)OtherShipmentFieldIndex.Insurance, true); }
			set	{ SetValue((int)OtherShipmentFieldIndex.Insurance, value); }
		}
