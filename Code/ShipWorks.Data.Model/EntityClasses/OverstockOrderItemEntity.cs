...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'OverstockOrderItem'.<br/><br/></summary>
	[Serializable]
	public partial class OverstockOrderItemEntity : OrderItemEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static OverstockOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public OverstockOrderItemEntity()
		{
			InitClassEmpty();
			SetName("OverstockOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public OverstockOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("OverstockOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this OverstockOrderItemEntity</param>
		public OverstockOrderItemEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("OverstockOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for OverstockOrderItem which data should be fetched into this OverstockOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public OverstockOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this OverstockOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public OverstockOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			InitClassEmpty();
		...
		protected OverstockOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("OverstockOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("OverstockOrderItemEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("OverstockOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new OverstockOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(OverstockOrderItemEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this OverstockOrderItemEntity</param>
		...
		public new static OverstockOrderItemRelations Relations
		{
			get	{ return new OverstockOrderItemRelations(); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.OverstockOrderItemEntity; }
		}
