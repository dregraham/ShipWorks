...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ValidatedAddress'.<br/><br/></summary>
	[Serializable]
	public partial class ValidatedAddressEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Order":
					toReturn.Add(Relations.OrderEntityUsingConsumerID);
					break;
				case "Shipment":
					toReturn.Add(Relations.ShipmentEntityUsingConsumerID);
					break;
				default:
					break;				
			}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", ShipWorks.Data.Model.RelationClasses.StaticValidatedAddressRelations.OrderEntityUsingConsumerIDStatic, true, signalRelatedEntity, "ValidatedAddress", resetFKFields, new int[] { (int)ValidatedAddressFieldIndex.ConsumerID } );
			_order = null;
		}
		...
		private void SetupSyncOrder(IEntityCore relatedEntity)
		{
			if(_order!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", ShipWorks.Data.Model.RelationClasses.StaticValidatedAddressRelations.OrderEntityUsingConsumerIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", ShipWorks.Data.Model.RelationClasses.StaticValidatedAddressRelations.ShipmentEntityUsingConsumerIDStatic, true, signalRelatedEntity, "ValidatedAddress", resetFKFields, new int[] { (int)ValidatedAddressFieldIndex.ConsumerID } );
			_shipment = null;
		}
		...
		private void SetupSyncShipment(IEntityCore relatedEntity)
		{
			if(_shipment!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", ShipWorks.Data.Model.RelationClasses.StaticValidatedAddressRelations.ShipmentEntityUsingConsumerIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))),	(IEntityRelation)GetRelationsForField("Order")[0], (int)ShipWorks.Data.Model.EntityType.ValidatedAddressEntity, (int)ShipWorks.Data.Model.EntityType.OrderEntity, 0, null, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Shipment")[0], (int)ShipWorks.Data.Model.EntityType.ValidatedAddressEntity, (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, 0, null, null, null, null, "Shipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The ValidatedAddressID property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The ConsumerID property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The AddressPrefix property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The IsOriginal property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The Street1 property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The Street2 property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The Street3 property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The City property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The StateProvCode property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The PostalCode property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The CountryCode property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The ResidentialStatus property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The POBox property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The USTerritory property of the Entity ValidatedAddress<br/><br/></summary>
		...
		/// <summary> The MilitaryAddress property of the Entity ValidatedAddress<br/><br/></summary>
		...
		public virtual OrderEntity Order
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ValidatedAddress", "Order", _order, true); 
				}
			}
		}
		...
		public virtual ShipmentEntity Shipment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ValidatedAddress", "Shipment", _shipment, true); 
				}
			}
		}
