...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'GrouponStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GrouponStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static GrouponStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public GrouponStoreEntity()
		{
			SetName("GrouponStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public GrouponStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("GrouponStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this GrouponStoreEntity</param>
		public GrouponStoreEntity(IValidator validator):base(validator)
		{
			SetName("GrouponStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for GrouponStore which data should be fetched into this GrouponStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GrouponStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("GrouponStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this GrouponStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public GrouponStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("GrouponStoreEntity");
		}
		...
		protected GrouponStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((GrouponStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return GrouponStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("GrouponStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("GrouponStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("GrouponStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(GrouponStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(GrouponStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("GrouponStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new GrouponStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.GrouponStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(GrouponStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this GrouponStoreEntity</param>
		...
		public new static GrouponStoreRelations Relations
		{
			get	{ return new GrouponStoreRelations(); }
		}
		...
		{
			get { return GrouponStoreEntity.CustomProperties;}
		}
		...
		{
			get { return GrouponStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity GrouponStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "GrouponStore"."StoreID"<br/>
		...
		public virtual System.String SupplierID
		{
			...
			set	{ SetValue((int)GrouponStoreFieldIndex.SupplierID, value); }
		}
		...
		public virtual System.String Token
		{
			...
			set	{ SetValue((int)GrouponStoreFieldIndex.Token, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.GrouponStoreEntity; }
		}
		#endregion
