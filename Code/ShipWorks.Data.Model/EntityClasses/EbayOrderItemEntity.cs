...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'EbayOrderItem'.<br/><br/></summary>
	[Serializable]
	public partial class EbayOrderItemEntity : OrderItemEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EbayOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public EbayOrderItemEntity()
		{
			InitClassEmpty();
			SetName("EbayOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public EbayOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("EbayOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EbayOrderItemEntity</param>
		public EbayOrderItemEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("EbayOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for EbayOrderItem which data should be fetched into this EbayOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EbayOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this EbayOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EbayOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			InitClassEmpty();
		...
		protected EbayOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EbayOrderItemFieldIndex)fieldIndex)
			{
				case EbayOrderItemFieldIndex.LocalEbayOrderID:
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("EbayOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("EbayOrderItemEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("EbayOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new EbayOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EbayOrderItemEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("LocalEbayOrderID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EbayItemID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EffectiveCheckoutStatus", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EffectivePaymentMethod", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("FeedbackLeftComments", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("FeedbackReceivedType", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("FeedbackReceivedComments", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("MyEbayPaid", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("MyEbayShipped", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this EbayOrderItemEntity</param>
		...
		public new static EbayOrderItemRelations Relations
		{
			get	{ return new EbayOrderItemRelations(); }
		}
		...
		/// <summary> The LocalEbayOrderID property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int64 LocalEbayOrderID
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.LocalEbayOrderID, value); }
		}

		/// <summary> The EbayItemID property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int64 EbayItemID
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.EbayItemID, value); }
		}

		/// <summary> The EbayTransactionID property of the Entity EbayOrderItem<br/><br/></summary>
		...
		/// <summary> The SellingManagerRecord property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int32 SellingManagerRecord
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.SellingManagerRecord, value); }
		}

		/// <summary> The EffectiveCheckoutStatus property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int32 EffectiveCheckoutStatus
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.EffectiveCheckoutStatus, value); }
		}

		/// <summary> The EffectivePaymentMethod property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int32 EffectivePaymentMethod
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.EffectivePaymentMethod, value); }
		}

		/// <summary> The PaymentStatus property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int32 PaymentStatus
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.PaymentStatus, value); }
		}

		/// <summary> The PaymentMethod property of the Entity EbayOrderItem<br/><br/></summary>
		...
		/// <summary> The CompleteStatus property of the Entity EbayOrderItem<br/><br/></summary>
		...
		/// <summary> The FeedbackLeftType property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int32 FeedbackLeftType
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.FeedbackLeftType, value); }
		}

		/// <summary> The FeedbackLeftComments property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.String FeedbackLeftComments
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.FeedbackLeftComments, value); }
		}

		/// <summary> The FeedbackReceivedType property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Int32 FeedbackReceivedType
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.FeedbackReceivedType, value); }
		}

		/// <summary> The FeedbackReceivedComments property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.String FeedbackReceivedComments
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.FeedbackReceivedComments, value); }
		}

		/// <summary> The MyEbayPaid property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Boolean MyEbayPaid
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.MyEbayPaid, value); }
		}

		/// <summary> The MyEbayShipped property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.Boolean MyEbayShipped
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.MyEbayShipped, value); }
		}

		/// <summary> The PayPalTransactionID property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.String PayPalTransactionID
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.PayPalTransactionID, value); }
		}

		/// <summary> The PayPalAddressStatus property of the Entity EbayOrderItem<br/><br/></summary>
		...
		/// <summary> The ExtendedOrderID property of the Entity EbayOrderItem<br/><br/></summary>
		...
		public virtual System.String ExtendedOrderID
		{
			...
			set	{ SetValue((int)EbayOrderItemFieldIndex.ExtendedOrderID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.EbayOrderItemEntity; }
		}
