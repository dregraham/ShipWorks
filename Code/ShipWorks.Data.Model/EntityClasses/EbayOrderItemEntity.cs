...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EbayOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EbayOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EbayOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EbayOrderItemEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(EbayOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EbayOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EbayOrderItemEntity);
		}
		...
		{
			get { return EbayOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return EbayOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity EbayOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "EbayOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)EbayOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)EbayOrderItemFieldIndex.OrderItemID, value); }
		}
