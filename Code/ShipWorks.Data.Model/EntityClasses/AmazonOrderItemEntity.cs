...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AmazonOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AmazonOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static AmazonOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public AmazonOrderItemEntity()
		{
			SetName("AmazonOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public AmazonOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("AmazonOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AmazonOrderItemEntity</param>
		public AmazonOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("AmazonOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for AmazonOrderItem which data should be fetched into this AmazonOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AmazonOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("AmazonOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this AmazonOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AmazonOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("AmazonOrderItemEntity");
		}
		...
		protected AmazonOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((AmazonOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return AmazonOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("AmazonOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("AmazonOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("AmazonOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(AmazonOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AmazonOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("AmazonOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new AmazonOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.AmazonOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AmazonOrderItemEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("AmazonOrderItemCode", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ASIN", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ConditionNote", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this AmazonOrderItemEntity</param>
		...
		public new static AmazonOrderItemRelations Relations
		{
			get	{ return new AmazonOrderItemRelations(); }
		}
		...
		{
			get { return AmazonOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return AmazonOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity AmazonOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "AmazonOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)AmazonOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)AmazonOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		public virtual System.String ASIN
		{
			...
			set	{ SetValue((int)AmazonOrderItemFieldIndex.ASIN, value); }
		}
		...
		public virtual System.String ConditionNote
		{
			...
			set	{ SetValue((int)AmazonOrderItemFieldIndex.ConditionNote, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.AmazonOrderItemEntity; }
		}
		#endregion
