...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'NeweggOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class NeweggOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NeweggOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public NeweggOrderEntity()
		{
			SetName("NeweggOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public NeweggOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("NeweggOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NeweggOrderEntity</param>
		public NeweggOrderEntity(IValidator validator):base(validator)
		{
			SetName("NeweggOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for NeweggOrder which data should be fetched into this NeweggOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NeweggOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("NeweggOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this NeweggOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NeweggOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("NeweggOrderEntity");
		}
		...
		protected NeweggOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((NeweggOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return NeweggOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("NeweggOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NeweggOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NeweggOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(NeweggOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(NeweggOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("NeweggOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.NeweggOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NeweggOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("RefundAmount", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("IsAutoVoid", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this NeweggOrderEntity</param>
		...
		public new static NeweggOrderRelations Relations
		{
			get	{ return new NeweggOrderRelations(); }
		}
		...
		{
			get { return NeweggOrderEntity.CustomProperties;}
		}
		...
		{
			get { return NeweggOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity NeweggOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "NeweggOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)NeweggOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)NeweggOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual Nullable<System.Int64> InvoiceNumber
		{
			...
			set	{ SetValue((int)NeweggOrderFieldIndex.InvoiceNumber, value); }
		}
		...
		public virtual Nullable<System.Decimal> RefundAmount
		{
			...
			set	{ SetValue((int)NeweggOrderFieldIndex.RefundAmount, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.NeweggOrderEntity; }
		}
		#endregion
