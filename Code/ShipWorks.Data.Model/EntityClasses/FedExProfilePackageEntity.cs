...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'FedExProfilePackage'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class FedExProfilePackageEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return FedExProfilePackageEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "FedExProfile":
					toReturn.Add(FedExProfilePackageEntity.Relations.FedExProfileEntityUsingShippingProfileID);
					break;
		...
		public bool TestOriginalFieldValueForNull(FedExProfilePackageFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(FedExProfilePackageFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.FedExProfilePackageEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_fedExProfile!=null)
			{
				_fedExProfile.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _fedExProfile, new PropertyChangedEventHandler( OnFedExProfilePropertyChanged ), "FedExProfile", FedExProfilePackageEntity.Relations.FedExProfileEntityUsingShippingProfileID, true, signalRelatedEntity, "Packages", resetFKFields, new int[] { (int)FedExProfilePackageFieldIndex.ShippingProfileID } );		
			_fedExProfile = null;
		}

		/// <summary> setups the sync logic for member _fedExProfile</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncFedExProfile(IEntity2 relatedEntity)
		{
			if(_fedExProfile!=relatedEntity)
			{
				DesetupSyncFedExProfile(true, true);
				_fedExProfile = (FedExProfileEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _fedExProfile, new PropertyChangedEventHandler( OnFedExProfilePropertyChanged ), "FedExProfile", FedExProfilePackageEntity.Relations.FedExProfileEntityUsingShippingProfileID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathFedExProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(FedExProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("FedExProfile")[0], (int)ShipWorks.Data.Model.EntityType.FedExProfilePackageEntity, (int)ShipWorks.Data.Model.EntityType.FedExProfileEntity, 0, null, null, null, null, "FedExProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return FedExProfilePackageEntity.CustomProperties;}
		}
		...
		{
			get { return FedExProfilePackageEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_fedExProfile != null)
						{
							_fedExProfile.UnsetRelatedEntity(this, "Packages");
						}
					}
					else
					{
						if(_fedExProfile!=value)
						{
