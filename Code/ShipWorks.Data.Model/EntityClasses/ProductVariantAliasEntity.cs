...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ProductVariantAlias'.<br/><br/></summary>
	[Serializable]
	public partial class ProductVariantAliasEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ProductVariantAliasEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public ProductVariantAliasEntity():base("ProductVariantAliasEntity")
		{
		...
		public ProductVariantAliasEntity(IEntityFields2 fields):base("ProductVariantAliasEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ProductVariantAliasEntity</param>
		public ProductVariantAliasEntity(IValidator validator):base("ProductVariantAliasEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="productVariantAliasID">PK value for ProductVariantAlias which data should be fetched into this ProductVariantAlias object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductVariantAliasEntity(System.Int64 productVariantAliasID):base("ProductVariantAliasEntity")
		{
			InitClassEmpty(null, null);
			this.ProductVariantAliasID = productVariantAliasID;
		}
		...
		/// <param name="validator">The custom validator object for this ProductVariantAliasEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductVariantAliasEntity(System.Int64 productVariantAliasID, IValidator validator):base("ProductVariantAliasEntity")
		{
			InitClassEmpty(validator, null);
			this.ProductVariantAliasID = productVariantAliasID;
		}
		...
		protected ProductVariantAliasEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ProductVariantAliasFieldIndex)fieldIndex)
			{
				case ProductVariantAliasFieldIndex.ProductVariantID:
		...
		{
			return new ProductVariantAliasRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProductVariantAliasEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ProductVariantAliasID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _productVariant, new PropertyChangedEventHandler( OnProductVariantPropertyChanged ), "ProductVariant", ShipWorks.Data.Model.RelationClasses.StaticProductVariantAliasRelations.ProductVariantEntityUsingProductVariantIDStatic, true, signalRelatedEntity, "ProductVariantAlias", resetFKFields, new int[] { (int)ProductVariantAliasFieldIndex.ProductVariantID } );
		...
		private void SetupSyncProductVariant(IEntityCore relatedEntity)
		{
			if(_productVariant!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productVariant, new PropertyChangedEventHandler( OnProductVariantPropertyChanged ), "ProductVariant", ShipWorks.Data.Model.RelationClasses.StaticProductVariantAliasRelations.ProductVariantEntityUsingProductVariantIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this ProductVariantAliasEntity</param>
		...
		public  static ProductVariantAliasRelations Relations
		{
			get	{ return new ProductVariantAliasRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductVariantEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductVariant")[0], (int)ShipWorks.Data.Model.EntityType.ProductVariantAliasEntity, (int)ShipWorks.Data.Model.EntityType.ProductVariantEntity, 0, null, null, null, null, "ProductVariant", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual System.Int64 ProductVariantAliasID
		{
			...
			set	{ SetValue((int)ProductVariantAliasFieldIndex.ProductVariantAliasID, value); }
		}

		/// <summary> The ProductVariantID property of the Entity ProductVariantAlias<br/><br/></summary>
		...
		public virtual System.Int64 ProductVariantID
		{
			...
			set	{ SetValue((int)ProductVariantAliasFieldIndex.ProductVariantID, value); }
		}

		/// <summary> The AliasName property of the Entity ProductVariantAlias<br/><br/></summary>
		...
		public virtual System.String AliasName
		{
			...
			set	{ SetValue((int)ProductVariantAliasFieldIndex.AliasName, value); }
		}
		...
		public virtual ProductVariantEntity ProductVariant
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ProductVariantAlias", "ProductVariant", _productVariant, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ProductVariantAliasEntity; }
		}
