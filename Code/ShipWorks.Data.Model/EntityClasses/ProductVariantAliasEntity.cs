		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public virtual ProductVariantEntity ProductVariant
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Aliases", "ProductVariant", _productVariant, true); 
				}
			}
		}
