...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ShopSiteStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ShopSiteStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ShopSiteStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ShopSiteStoreEntity()
		{
			SetName("ShopSiteStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ShopSiteStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("ShopSiteStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ShopSiteStoreEntity</param>
		public ShopSiteStoreEntity(IValidator validator):base(validator)
		{
			SetName("ShopSiteStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for ShopSiteStore which data should be fetched into this ShopSiteStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShopSiteStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("ShopSiteStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this ShopSiteStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShopSiteStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("ShopSiteStoreEntity");
		}
		...
		protected ShopSiteStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ShopSiteStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ShopSiteStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ShopSiteStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ShopSiteStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ShopSiteStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(ShopSiteStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ShopSiteStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ShopSiteStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ShopSiteStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ShopSiteStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ShopSiteStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this ShopSiteStoreEntity</param>
		...
		public new static ShopSiteStoreRelations Relations
		{
			get	{ return new ShopSiteStoreRelations(); }
		}
		...
		{
			get { return ShopSiteStoreEntity.CustomProperties;}
		}
		...
		{
			get { return ShopSiteStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity ShopSiteStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ShopSiteStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)ShopSiteStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)ShopSiteStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.String Username
		{
			...
			set	{ SetValue((int)ShopSiteStoreFieldIndex.Username, value); }
		}
		...
		public virtual System.Boolean RequireSSL
		{
			...
			set	{ SetValue((int)ShopSiteStoreFieldIndex.RequireSSL, value); }
		}
		...
		public virtual System.Int32 DownloadPageSize
		{
			...
			set	{ SetValue((int)ShopSiteStoreFieldIndex.DownloadPageSize, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ShopSiteStoreEntity; }
		}
		#endregion
