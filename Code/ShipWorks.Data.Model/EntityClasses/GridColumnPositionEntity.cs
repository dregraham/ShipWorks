...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'GridColumnPosition'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GridColumnPositionEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return GridColumnPositionEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "GridColumnLayout":
					toReturn.Add(GridColumnPositionEntity.Relations.GridColumnLayoutEntityUsingGridColumnLayoutID);
					break;
		...
		public bool TestOriginalFieldValueForNull(GridColumnPositionFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(GridColumnPositionFieldIndex fieldIndex)
		{
		...
		/// the related entity of type 'GridColumnLayout' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.GridColumnPositionEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_gridColumnLayout!=null)
			{
				_gridColumnLayout.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _gridColumnLayout, new PropertyChangedEventHandler( OnGridColumnLayoutPropertyChanged ), "GridColumnLayout", GridColumnPositionEntity.Relations.GridColumnLayoutEntityUsingGridColumnLayoutID, true, signalRelatedEntity, "GridColumnPositions", resetFKFields, new int[] { (int)GridColumnPositionFieldIndex.GridColumnLayoutID } );		
			_gridColumnLayout = null;
		}

		/// <summary> setups the sync logic for member _gridColumnLayout</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncGridColumnLayout(IEntity2 relatedEntity)
		{
			if(_gridColumnLayout!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _gridColumnLayout, new PropertyChangedEventHandler( OnGridColumnLayoutPropertyChanged ), "GridColumnLayout", GridColumnPositionEntity.Relations.GridColumnLayoutEntityUsingGridColumnLayoutID, true, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'GridColumnLayout' 
		...
		public static IPrefetchPathElement2 PrefetchPathGridColumnLayout
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(GridColumnLayoutEntityFactory))),
					(IEntityRelation)GetRelationsForField("GridColumnLayout")[0], (int)ShipWorks.Data.Model.EntityType.GridColumnPositionEntity, (int)ShipWorks.Data.Model.EntityType.GridColumnLayoutEntity, 0, null, null, null, null, "GridColumnLayout", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return GridColumnPositionEntity.CustomProperties;}
		}
		...
		{
			get { return GridColumnPositionEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets / sets related entity of type 'GridColumnLayoutEntity' which has to be set using a fetch action earlier. If no related entity
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_gridColumnLayout != null)
						{
							_gridColumnLayout.UnsetRelatedEntity(this, "GridColumnPositions");
						}
					}
					else
					{
						if(_gridColumnLayout!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "GridColumnPositions");
						}
					}
				}
			}
