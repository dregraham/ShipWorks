...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'OnTracProfile'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OnTracProfileEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return OnTracProfileEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "ShippingProfile":
					toReturn.Add(OnTracProfileEntity.Relations.ShippingProfileEntityUsingShippingProfileID);
					break;
				default:
		...
		public bool TestOriginalFieldValueForNull(OnTracProfileFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(OnTracProfileFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.OnTracProfileEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", OnTracProfileEntity.Relations.ShippingProfileEntityUsingShippingProfileID, true, signalRelatedEntity, "OnTrac", false, new int[] { (int)OnTracProfileFieldIndex.ShippingProfileID } );
			_shippingProfile = null;
		}
		...
		private void SetupSyncShippingProfile(IEntity2 relatedEntity)
		{
			if(_shippingProfile!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", OnTracProfileEntity.Relations.ShippingProfileEntityUsingShippingProfileID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShippingProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShippingProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("ShippingProfile")[0], (int)ShipWorks.Data.Model.EntityType.OnTracProfileEntity, (int)ShipWorks.Data.Model.EntityType.ShippingProfileEntity, 0, null, null, null, null, "ShippingProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return OnTracProfileEntity.CustomProperties;}
		}
		...
		{
			get { return OnTracProfileEntity.FieldsCustomProperties;}
		}
