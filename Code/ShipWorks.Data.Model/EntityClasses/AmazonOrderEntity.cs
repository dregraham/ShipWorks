...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AmazonOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AmazonOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((AmazonOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return AmazonOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("AmazonOrderEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(AmazonOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AmazonOrderFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.AmazonOrderEntity);
		}
		...
		{
			get { return AmazonOrderEntity.CustomProperties;}
		}
		...
		{
			get { return AmazonOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity AmazonOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "AmazonOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)AmazonOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)AmazonOrderFieldIndex.OrderID, value); }
		}
