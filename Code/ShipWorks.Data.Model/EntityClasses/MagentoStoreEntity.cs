...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MagentoStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MagentoStoreEntity : GenericModuleStoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static MagentoStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public MagentoStoreEntity()
		{
			SetName("MagentoStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public MagentoStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("MagentoStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this MagentoStoreEntity</param>
		public MagentoStoreEntity(IValidator validator):base(validator)
		{
			SetName("MagentoStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for MagentoStore which data should be fetched into this MagentoStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MagentoStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("MagentoStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this MagentoStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MagentoStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("MagentoStoreEntity");
		}
		...
		protected MagentoStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((MagentoStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return MagentoStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("MagentoStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MagentoStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MagentoStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(MagentoStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MagentoStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("MagentoStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new MagentoStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.MagentoStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(MagentoStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this MagentoStoreEntity</param>
		...
		public new static MagentoStoreRelations Relations
		{
			get	{ return new MagentoStoreRelations(); }
		}
		...
		{
			get { return MagentoStoreEntity.CustomProperties;}
		}
		...
		{
			get { return MagentoStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity MagentoStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "MagentoStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)MagentoStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)MagentoStoreFieldIndex.StoreID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.MagentoStoreEntity; }
		}
		#endregion
