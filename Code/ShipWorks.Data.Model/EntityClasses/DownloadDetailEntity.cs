...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'DownloadDetail'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class DownloadDetailEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return DownloadDetailEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "DownloadLog":
					toReturn.Add(DownloadDetailEntity.Relations.DownloadEntityUsingDownloadID);
					break;
		...
		public bool TestOriginalFieldValueForNull(DownloadDetailFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(DownloadDetailFieldIndex fieldIndex)
		{
		...
		/// the related entity of type 'Download' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.DownloadDetailEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_downloadLog!=null)
			{
				_downloadLog.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _downloadLog, new PropertyChangedEventHandler( OnDownloadLogPropertyChanged ), "DownloadLog", DownloadDetailEntity.Relations.DownloadEntityUsingDownloadID, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)DownloadDetailFieldIndex.DownloadID } );		
			_downloadLog = null;
		}

		/// <summary> setups the sync logic for member _downloadLog</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncDownloadLog(IEntity2 relatedEntity)
		{
			if(_downloadLog!=relatedEntity)
			{
				DesetupSyncDownloadLog(true, true);
				_downloadLog = (DownloadEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _downloadLog, new PropertyChangedEventHandler( OnDownloadLogPropertyChanged ), "DownloadLog", DownloadDetailEntity.Relations.DownloadEntityUsingDownloadID, true, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Download' 
		...
		public static IPrefetchPathElement2 PrefetchPathDownloadLog
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DownloadEntityFactory))),
					(IEntityRelation)GetRelationsForField("DownloadLog")[0], (int)ShipWorks.Data.Model.EntityType.DownloadDetailEntity, (int)ShipWorks.Data.Model.EntityType.DownloadEntity, 0, null, null, null, null, "DownloadLog", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return DownloadDetailEntity.CustomProperties;}
		}
		...
		{
			get { return DownloadDetailEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets / sets related entity of type 'DownloadEntity' which has to be set using a fetch action earlier. If no related entity
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_downloadLog != null)
						{
							UnsetRelatedEntity(_downloadLog, "DownloadLog");
						}
					}
					else
					{
						if(_downloadLog!=value)
						{
							SetRelatedEntity((IEntity2)value, "DownloadLog");
						}
					}
				}
			}
