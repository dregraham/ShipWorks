...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'UspsShipment'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UspsShipmentEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return UspsShipmentEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ScanFormBatch":
					toReturn.Add(UspsShipmentEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID);
					break;


				case "PostalShipment":
					toReturn.Add(UspsShipmentEntity.Relations.PostalShipmentEntityUsingShipmentID);
					break;
				default:
		...
		public bool TestOriginalFieldValueForNull(UspsShipmentFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(UspsShipmentFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.UspsShipmentEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", UspsShipmentEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID, true, signalRelatedEntity, "UspsShipment", resetFKFields, new int[] { (int)UspsShipmentFieldIndex.ScanFormBatchID } );		
			_scanFormBatch = null;
		}
		...
		private void SetupSyncScanFormBatch(IEntity2 relatedEntity)
		{
			if(_scanFormBatch!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", UspsShipmentEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID, true, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _postalShipment, new PropertyChangedEventHandler( OnPostalShipmentPropertyChanged ), "PostalShipment", UspsShipmentEntity.Relations.PostalShipmentEntityUsingShipmentID, true, signalRelatedEntity, "Usps", false, new int[] { (int)UspsShipmentFieldIndex.ShipmentID } );
			_postalShipment = null;
		}
		...
		private void SetupSyncPostalShipment(IEntity2 relatedEntity)
		{
			if(_postalShipment!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _postalShipment, new PropertyChangedEventHandler( OnPostalShipmentPropertyChanged ), "PostalShipment", UspsShipmentEntity.Relations.PostalShipmentEntityUsingShipmentID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathScanFormBatch
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScanFormBatchEntityFactory))),
					(IEntityRelation)GetRelationsForField("ScanFormBatch")[0], (int)ShipWorks.Data.Model.EntityType.UspsShipmentEntity, (int)ShipWorks.Data.Model.EntityType.ScanFormBatchEntity, 0, null, null, null, null, "ScanFormBatch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathPostalShipment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PostalShipmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("PostalShipment")[0], (int)ShipWorks.Data.Model.EntityType.UspsShipmentEntity, (int)ShipWorks.Data.Model.EntityType.PostalShipmentEntity, 0, null, null, null, null, "PostalShipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return UspsShipmentEntity.CustomProperties;}
		}
		...
		{
			get { return UspsShipmentEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_scanFormBatch != null)
						{
							_scanFormBatch.UnsetRelatedEntity(this, "UspsShipment");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "UspsShipment");
						}
					}
				}
			}
