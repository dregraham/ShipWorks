...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ShopifyOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ShopifyOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ShopifyOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ShopifyOrderItemEntity()
		{
			SetName("ShopifyOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ShopifyOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("ShopifyOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ShopifyOrderItemEntity</param>
		public ShopifyOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("ShopifyOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for ShopifyOrderItem which data should be fetched into this ShopifyOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShopifyOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("ShopifyOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this ShopifyOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShopifyOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("ShopifyOrderItemEntity");
		}
		...
		protected ShopifyOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ShopifyOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ShopifyOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ShopifyOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ShopifyOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ShopifyOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(ShopifyOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ShopifyOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ShopifyOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ShopifyOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ShopifyOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ShopifyOrderItemEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this ShopifyOrderItemEntity</param>
		...
		public new static ShopifyOrderItemRelations Relations
		{
			get	{ return new ShopifyOrderItemRelations(); }
		}
		...
		{
			get { return ShopifyOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return ShopifyOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity ShopifyOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ShopifyOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)ShopifyOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)ShopifyOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		public virtual System.Int64 ShopifyOrderItemID
		{
			...
			set	{ SetValue((int)ShopifyOrderItemFieldIndex.ShopifyOrderItemID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ShopifyOrderItemEntity; }
		}
		#endregion
