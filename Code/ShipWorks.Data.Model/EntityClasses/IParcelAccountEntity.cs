...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'IParcelAccount'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class IParcelAccountEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((IParcelAccountFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return IParcelAccountEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(IParcelAccountFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(IParcelAccountFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.IParcelAccountEntity);
		}
		...
		{
			get { return IParcelAccountEntity.CustomProperties;}
		}
		...
		{
			get { return IParcelAccountEntity.FieldsCustomProperties;}
		}
