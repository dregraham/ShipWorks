...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'OdbcStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OdbcStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((OdbcStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return OdbcStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("OdbcStoreEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(OdbcStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(OdbcStoreFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.OdbcStoreEntity);
		}
		...
		{
			get { return OdbcStoreEntity.CustomProperties;}
		}
		...
		{
			get { return OdbcStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity OdbcStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "OdbcStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)OdbcStoreFieldIndex.StoreID, true); }
