...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'OdbcStore'.<br/><br/></summary>
	[Serializable]
	public partial class OdbcStoreEntity : StoreEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static OdbcStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public OdbcStoreEntity()
		{
			InitClassEmpty();
			SetName("OdbcStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public OdbcStoreEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("OdbcStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this OdbcStoreEntity</param>
		public OdbcStoreEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("OdbcStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for OdbcStore which data should be fetched into this OdbcStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public OdbcStoreEntity(System.Int64 storeID):base(storeID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this OdbcStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public OdbcStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			InitClassEmpty();
		...
		protected OdbcStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("OdbcStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("OdbcStoreEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("OdbcStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new OdbcStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(OdbcStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this OdbcStoreEntity</param>
		...
		public new static OdbcStoreRelations Relations
		{
			get	{ return new OdbcStoreRelations(); }
		}
		...
		/// <summary> The ImportConnectionString property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The ImportMap property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The ImportStrategy property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The ImportColumnSourceType property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The ImportColumnSource property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The UploadStrategy property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The UploadMap property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The UploadColumnSourceType property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The UploadColumnSource property of the Entity OdbcStore<br/><br/></summary>
		...
		/// <summary> The UploadConnectionString property of the Entity OdbcStore<br/><br/></summary>
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.OdbcStoreEntity; }
		}
