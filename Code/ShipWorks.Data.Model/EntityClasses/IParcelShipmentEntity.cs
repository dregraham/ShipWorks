...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'IParcelShipment'.<br/><br/></summary>
	[Serializable]
	public partial class IParcelShipmentEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Packages":
					toReturn.Add(Relations.IParcelPackageEntityUsingShipmentID);
					break;
				case "Shipment":
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'IParcelPackage' to this entity.</summary>
		/// <returns></returns>
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", ShipWorks.Data.Model.RelationClasses.StaticIParcelShipmentRelations.ShipmentEntityUsingShipmentIDStatic, true, signalRelatedEntity, "IParcel", false, new int[] { (int)IParcelShipmentFieldIndex.ShipmentID } );
			_shipment = null;
		}
		...
		private void SetupSyncShipment(IEntityCore relatedEntity)
		{
			if(_shipment!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", ShipWorks.Data.Model.RelationClasses.StaticIParcelShipmentRelations.ShipmentEntityUsingShipmentIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'IParcelPackage' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathPackages
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<IParcelPackageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(IParcelPackageEntityFactory))), (IEntityRelation)GetRelationsForField("Packages")[0], (int)ShipWorks.Data.Model.EntityType.IParcelShipmentEntity, (int)ShipWorks.Data.Model.EntityType.IParcelPackageEntity, 0, null, null, null, null, "Packages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipmentEntityFactory))), (IEntityRelation)GetRelationsForField("Shipment")[0], (int)ShipWorks.Data.Model.EntityType.IParcelShipmentEntity, (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, 0, null, null, null, null, "Shipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShipmentID property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The IParcelAccountID property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The Service property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The Reference property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The TrackByEmail property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The TrackBySMS property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The IsDeliveryDutyPaid property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> The RequestedLabelFormat property of the Entity IParcelShipment<br/><br/></summary>
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'IParcelPackageEntity' which are related to this entity via a relation of type '1:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(IParcelPackageEntity))]
		public virtual EntityCollection<IParcelPackageEntity> Packages
		{
			get { return GetOrCreateEntityCollection<IParcelPackageEntity, IParcelPackageEntityFactory>("IParcelShipment", true, false, ref _packages);	}
		}
