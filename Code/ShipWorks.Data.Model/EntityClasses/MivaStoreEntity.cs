...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MivaStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MivaStoreEntity : GenericModuleStoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static MivaStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public MivaStoreEntity()
		{
			SetName("MivaStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public MivaStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("MivaStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this MivaStoreEntity</param>
		public MivaStoreEntity(IValidator validator):base(validator)
		{
			SetName("MivaStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for MivaStore which data should be fetched into this MivaStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MivaStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("MivaStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this MivaStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MivaStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("MivaStoreEntity");
		}
		...
		protected MivaStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((MivaStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return MivaStoreEntity.GetRelationsForField(fieldName);
		}
		...
		public static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				default:
					toReturn = GenericModuleStoreEntity.GetRelationsForField(fieldName);
					break;				
			}
			return toReturn;
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("MivaStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MivaStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MivaStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(MivaStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MivaStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("MivaStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new MivaStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.MivaStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(MivaStoreEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("EncryptionPassphrase", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("LiveManualOrderNumbers", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("SebenzaCheckoutDataEnabled", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this MivaStoreEntity</param>
		...
		public new static MivaStoreRelations Relations
		{
			get	{ return new MivaStoreRelations(); }
		}
		...
		{
			get { return MivaStoreEntity.CustomProperties;}
		}
		...
		{
			get { return MivaStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity MivaStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "MivaStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)MivaStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)MivaStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.String EncryptionPassphrase
		{
			...
			set	{ SetValue((int)MivaStoreFieldIndex.EncryptionPassphrase, value); }
		}
		...
		public virtual System.Boolean LiveManualOrderNumbers
		{
			...
			set	{ SetValue((int)MivaStoreFieldIndex.LiveManualOrderNumbers, value); }
		}
		...
		public virtual System.Boolean SebenzaCheckoutDataEnabled
		{
			...
			set	{ SetValue((int)MivaStoreFieldIndex.SebenzaCheckoutDataEnabled, value); }
		}
		...
		public virtual System.Int32 OnlineUpdateStrategy
		{
			...
			set	{ SetValue((int)MivaStoreFieldIndex.OnlineUpdateStrategy, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.MivaStoreEntity; }
		}
		#endregion
