...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AmazonShipment'.<br/><br/></summary>
	[Serializable]
	public partial class AmazonShipmentEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", ShipWorks.Data.Model.RelationClasses.StaticAmazonShipmentRelations.ShipmentEntityUsingShipmentIDStatic, true, signalRelatedEntity, "Amazon", false, new int[] { (int)AmazonShipmentFieldIndex.ShipmentID } );
			_shipment = null;
		}
		...
		private void SetupSyncShipment(IEntityCore relatedEntity)
		{
			if(_shipment!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", ShipWorks.Data.Model.RelationClasses.StaticAmazonShipmentRelations.ShipmentEntityUsingShipmentIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipmentEntityFactory))), (IEntityRelation)GetRelationsForField("Shipment")[0], (int)ShipWorks.Data.Model.EntityType.AmazonShipmentEntity, (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, 0, null, null, null, null, "Shipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShipmentID property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The CarrierName property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The ShippingServiceName property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The ShippingServiceID property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DimsProfileID property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DimsLength property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DimsWidth property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DimsHeight property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DimsWeight property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DimsAddWeight property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DeliveryExperience property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The DeclaredValue property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The AmazonUniqueShipmentID property of the Entity AmazonShipment<br/><br/></summary>
		...
		/// <summary> The Insurance property of the Entity AmazonShipment<br/><br/></summary>
