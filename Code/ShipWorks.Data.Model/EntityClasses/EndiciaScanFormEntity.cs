...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'EndiciaScanForm'.<br/><br/></summary>
	[Serializable]
	public partial class EndiciaScanFormEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EndiciaScanFormEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public EndiciaScanFormEntity():base("EndiciaScanFormEntity")
		{
		...
		public EndiciaScanFormEntity(IEntityFields2 fields):base("EndiciaScanFormEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EndiciaScanFormEntity</param>
		public EndiciaScanFormEntity(IValidator validator):base("EndiciaScanFormEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="endiciaScanFormID">PK value for EndiciaScanForm which data should be fetched into this EndiciaScanForm object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EndiciaScanFormEntity(System.Int64 endiciaScanFormID):base("EndiciaScanFormEntity")
		{
			InitClassEmpty(null, null);
			this.EndiciaScanFormID = endiciaScanFormID;
		}
		...
		/// <param name="validator">The custom validator object for this EndiciaScanFormEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EndiciaScanFormEntity(System.Int64 endiciaScanFormID, IValidator validator):base("EndiciaScanFormEntity")
		{
			InitClassEmpty(validator, null);
			this.EndiciaScanFormID = endiciaScanFormID;
		}
		...
		protected EndiciaScanFormEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EndiciaScanFormFieldIndex)fieldIndex)
			{
				case EndiciaScanFormFieldIndex.ScanFormBatchID:
		...
		{
			return new EndiciaScanFormRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EndiciaScanFormEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("EndiciaScanFormID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EndiciaAccountID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EndiciaAccountNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", ShipWorks.Data.Model.RelationClasses.StaticEndiciaScanFormRelations.ScanFormBatchEntityUsingScanFormBatchIDStatic, true, signalRelatedEntity, "EndiciaScanForms", resetFKFields, new int[] { (int)EndiciaScanFormFieldIndex.ScanFormBatchID } );
			_scanFormBatch = null;
		}
		...
		private void SetupSyncScanFormBatch(IEntityCore relatedEntity)
		{
			if(_scanFormBatch!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", ShipWorks.Data.Model.RelationClasses.StaticEndiciaScanFormRelations.ScanFormBatchEntityUsingScanFormBatchIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this EndiciaScanFormEntity</param>
		...
		public  static EndiciaScanFormRelations Relations
		{
			get	{ return new EndiciaScanFormRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScanFormBatchEntityFactory))),	(IEntityRelation)GetRelationsForField("ScanFormBatch")[0], (int)ShipWorks.Data.Model.EntityType.EndiciaScanFormEntity, (int)ShipWorks.Data.Model.EntityType.ScanFormBatchEntity, 0, null, null, null, null, "ScanFormBatch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The EndiciaScanFormID property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		public virtual System.Int64 EndiciaScanFormID
		{
			...
			set	{ SetValue((int)EndiciaScanFormFieldIndex.EndiciaScanFormID, value); }
		}

		/// <summary> The EndiciaAccountID property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		public virtual System.Int64 EndiciaAccountID
		{
			...
			set	{ SetValue((int)EndiciaScanFormFieldIndex.EndiciaAccountID, value); }
		}

		/// <summary> The EndiciaAccountNumber property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		public virtual System.String EndiciaAccountNumber
		{
			...
			set	{ SetValue((int)EndiciaScanFormFieldIndex.EndiciaAccountNumber, value); }
		}

		/// <summary> The SubmissionID property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		public virtual System.String SubmissionID
		{
			...
			set	{ SetValue((int)EndiciaScanFormFieldIndex.SubmissionID, value); }
		}

		/// <summary> The CreatedDate property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		/// <summary> The ScanFormBatchID property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		public virtual System.Int64 ScanFormBatchID
		{
			...
			set	{ SetValue((int)EndiciaScanFormFieldIndex.ScanFormBatchID, value); }
		}

		/// <summary> The Description property of the Entity EndiciaScanForm<br/><br/></summary>
		...
		public virtual System.String Description
		{
			...
			set	{ SetValue((int)EndiciaScanFormFieldIndex.Description, value); }
		}
		...
		public virtual ScanFormBatchEntity ScanFormBatch
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "EndiciaScanForms", "ScanFormBatch", _scanFormBatch, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.EndiciaScanFormEntity; }
		}
