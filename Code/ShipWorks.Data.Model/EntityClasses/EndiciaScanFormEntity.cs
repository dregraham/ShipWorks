...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EndiciaScanForm'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EndiciaScanFormEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EndiciaScanFormEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ScanFormBatch":
					toReturn.Add(EndiciaScanFormEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID);
					break;
		...
		public bool TestOriginalFieldValueForNull(EndiciaScanFormFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EndiciaScanFormFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EndiciaScanFormEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", EndiciaScanFormEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID, true, signalRelatedEntity, "EndiciaScanForms", resetFKFields, new int[] { (int)EndiciaScanFormFieldIndex.ScanFormBatchID } );		
			_scanFormBatch = null;
		}
		...
		private void SetupSyncScanFormBatch(IEntity2 relatedEntity)
		{
			if(_scanFormBatch!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", EndiciaScanFormEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathScanFormBatch
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScanFormBatchEntityFactory))),
					(IEntityRelation)GetRelationsForField("ScanFormBatch")[0], (int)ShipWorks.Data.Model.EntityType.EndiciaScanFormEntity, (int)ShipWorks.Data.Model.EntityType.ScanFormBatchEntity, 0, null, null, null, null, "ScanFormBatch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return EndiciaScanFormEntity.CustomProperties;}
		}
		...
		{
			get { return EndiciaScanFormEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_scanFormBatch != null)
						{
							_scanFormBatch.UnsetRelatedEntity(this, "EndiciaScanForms");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "EndiciaScanForms");
						}
					}
				}
			}
