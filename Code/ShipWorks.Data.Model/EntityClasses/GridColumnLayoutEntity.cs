...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'GridColumnLayout'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GridColumnLayoutEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((GridColumnLayoutFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return GridColumnLayoutEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "GridColumnPositions":
					toReturn.Add(GridColumnLayoutEntity.Relations.GridColumnPositionEntityUsingGridColumnLayoutID);
					break;
		...
		public override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "GridColumnPositions":
					base.PerformRelatedEntityRemoval(this.GridColumnPositions, relatedEntity, signalRelatedEntityManyToOne);
					break;
		...
		public bool TestOriginalFieldValueForNull(GridColumnLayoutFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(GridColumnLayoutFieldIndex fieldIndex)
		{
		...
		/// the related entities of type 'GridColumnPosition' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.GridColumnLayoutEntity);
		}
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._gridColumnPositions != null)
			{
				return true;
			}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_gridColumnPositions!=null)
			{
				_gridColumnPositions.ActiveContext = base.ActiveContext;
			}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'GridColumnPosition' 
		...
		public static IPrefetchPathElement2 PrefetchPathGridColumnPositions
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<GridColumnPositionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GridColumnPositionEntityFactory))),
					(IEntityRelation)GetRelationsForField("GridColumnPositions")[0], (int)ShipWorks.Data.Model.EntityType.GridColumnLayoutEntity, (int)ShipWorks.Data.Model.EntityType.GridColumnPositionEntity, 0, null, null, null, null, "GridColumnPositions", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return GridColumnLayoutEntity.CustomProperties;}
		}
		...
		{
			get { return GridColumnLayoutEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'GridColumnPositionEntity' which are related to this entity via a relation of type '1:n'.
		...
		public virtual EntityCollection<GridColumnPositionEntity> GridColumnPositions
		{
			get
			{
				if(_gridColumnPositions==null)
				{
					_gridColumnPositions = new EntityCollection<GridColumnPositionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GridColumnPositionEntityFactory)));
					_gridColumnPositions.SetContainingEntityInfo(this, "GridColumnLayout");
				}
				return _gridColumnPositions;
			}
		}
