...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			switch((ClickCartProOrderSearchFieldIndex)fieldIndex)
			{
				case ClickCartProOrderSearchFieldIndex.OrderID:
					...
					break;
				case ClickCartProOrderSearchFieldIndex.StoreID:
		...
		{
			this.PerformDesetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", ShipWorks.Data.Model.RelationClasses.StaticClickCartProOrderSearchRelations.StoreEntityUsingStoreIDStatic, true, signalRelatedEntity, "ClickCartProOrderSearch", resetFKFields, new int[] { (int)ClickCartProOrderSearchFieldIndex.StoreID } );
			_store = null;
		}
		...
		private void SetupSyncStore(IEntityCore relatedEntity)
		{
			if(_store!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", ShipWorks.Data.Model.RelationClasses.StaticClickCartProOrderSearchRelations.StoreEntityUsingStoreIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))),	(IEntityRelation)GetRelationsForField("Store")[0], (int)ShipWorks.Data.Model.EntityType.ClickCartProOrderSearchEntity, (int)ShipWorks.Data.Model.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The StoreID property of the Entity ClickCartProOrderSearch<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ClickCartProOrderSearch"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)ClickCartProOrderSearchFieldIndex.StoreID, true); }
			set	{ SetValue((int)ClickCartProOrderSearchFieldIndex.StoreID, value); }
		}

		/// <summary> The OrderNumber property of the Entity ClickCartProOrderSearch<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ClickCartProOrderSearch"."OrderNumber"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 OrderNumber
		{
			get { return (System.Int64)GetValue((int)ClickCartProOrderSearchFieldIndex.OrderNumber, true); }
			set	{ SetValue((int)ClickCartProOrderSearchFieldIndex.OrderNumber, value); }
		}

		/// <summary> The OrderNumberComplete property of the Entity ClickCartProOrderSearch<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)ClickCartProOrderSearchFieldIndex.OrderNumberComplete, true); }
			set	{ SetValue((int)ClickCartProOrderSearchFieldIndex.OrderNumberComplete, value); }
		}
		...
		public virtual StoreEntity Store
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ClickCartProOrderSearch", "Store", _store, true); 
				}
			}
		}
