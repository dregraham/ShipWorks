...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'EtsyOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EtsyOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static EtsyOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public EtsyOrderEntity()
		{
			SetName("EtsyOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public EtsyOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("EtsyOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this EtsyOrderEntity</param>
		public EtsyOrderEntity(IValidator validator):base(validator)
		{
			SetName("EtsyOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for EtsyOrder which data should be fetched into this EtsyOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EtsyOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("EtsyOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this EtsyOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EtsyOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("EtsyOrderEntity");
		}
		...
		protected EtsyOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EtsyOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return EtsyOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EtsyOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("EtsyOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("EtsyOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(EtsyOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(EtsyOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("EtsyOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.EtsyOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(EtsyOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("WasPaid", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("WasShipped", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this EtsyOrderEntity</param>
		...
		public new static EtsyOrderRelations Relations
		{
			get	{ return new EtsyOrderRelations(); }
		}
		...
		{
			get { return EtsyOrderEntity.CustomProperties;}
		}
		...
		{
			get { return EtsyOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity EtsyOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "EtsyOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)EtsyOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)EtsyOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual System.Boolean WasPaid
		{
			...
			set	{ SetValue((int)EtsyOrderFieldIndex.WasPaid, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.EtsyOrderEntity; }
		}
		#endregion
