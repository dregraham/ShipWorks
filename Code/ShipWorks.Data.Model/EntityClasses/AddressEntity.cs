		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "ValidatedAddress":
					toReturn.Add(AddressEntity.Relations.ValidatedAddressEntityUsingAddressID);
					break;
		...
		public virtual IRelationPredicateBucket GetRelationInfoValidatedAddress()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ValidatedAddressFields.AddressID, null, ComparisonOperator.Equal, this.AddressID));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.AddressEntity);
		}
		...
		public static IPrefetchPathElement2 PrefetchPathValidatedAddress
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ValidatedAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ValidatedAddressEntityFactory))),
					(IEntityRelation)GetRelationsForField("ValidatedAddress")[0], (int)ShipWorks.Data.Model.EntityType.AddressEntity, (int)ShipWorks.Data.Model.EntityType.ValidatedAddressEntity, 0, null, null, null, null, "ValidatedAddress", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		/// <summary> The Street1 property of the Entity Address<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Address"."Street1"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 60<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Street1
		{
			get { return (System.String)GetValue((int)AddressFieldIndex.Street1, true); }
			set	{ SetValue((int)AddressFieldIndex.Street1, value); }
		}

		/// <summary> The Street2 property of the Entity Address<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Address"."Street2"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 60<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Street2
		{
			get { return (System.String)GetValue((int)AddressFieldIndex.Street2, true); }
			set	{ SetValue((int)AddressFieldIndex.Street2, value); }
		}

		/// <summary> The Street3 property of the Entity Address<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Address"."Street3"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 60<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Street3
		{
			get { return (System.String)GetValue((int)AddressFieldIndex.Street3, true); }
			set	{ SetValue((int)AddressFieldIndex.Street3, value); }
		}
		...
		/// <summary> The StateProvCode property of the Entity Address<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Address"."StateProvCode"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String StateProvCode
		{
			get { return (System.String)GetValue((int)AddressFieldIndex.StateProvCode, true); }
			set	{ SetValue((int)AddressFieldIndex.StateProvCode, value); }
		}
		...
		/// <summary> The CountryCode property of the Entity Address<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "Address"."CountryCode"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		public virtual EntityCollection<ValidatedAddressEntity> ValidatedAddress
		{
			get
			{
				if(_validatedAddress==null)
				{
					...
					_validatedAddress.SetContainingEntityInfo(this, "Address");
				}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.AddressEntity; }
		}
		#endregion
