...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ActionQueue'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ActionQueueEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return ActionQueueEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(ActionQueueFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ActionQueueFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ActionQueueEntity);
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSteps
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<ActionQueueStepEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionQueueStepEntityFactory))),
					(IEntityRelation)GetRelationsForField("Steps")[0], (int)ShipWorks.Data.Model.EntityType.ActionQueueEntity, (int)ShipWorks.Data.Model.EntityType.ActionQueueStepEntity, 0, null, null, null, null, "Steps", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return ActionQueueEntity.CustomProperties;}
		}
		...
		{
			get { return ActionQueueEntity.FieldsCustomProperties;}
		}
		...
		public virtual EntityCollection<ActionQueueStepEntity> Steps
		{
			get
			{
				if(_steps==null)
				{
					_steps = new EntityCollection<ActionQueueStepEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ActionQueueStepEntityFactory)));
					_steps.SetContainingEntityInfo(this, "ActionQueue");
				}
				return _steps;
			}
		}
