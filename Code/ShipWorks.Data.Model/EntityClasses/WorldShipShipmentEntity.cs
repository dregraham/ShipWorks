...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'WorldShipShipment'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class WorldShipShipmentEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return WorldShipShipmentEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Goods":
					toReturn.Add(WorldShipShipmentEntity.Relations.WorldShipGoodsEntityUsingShipmentID);
					break;
				case "Packages":
					toReturn.Add(WorldShipShipmentEntity.Relations.WorldShipPackageEntityUsingShipmentID);
					break;
				case "WorldShipProcessed":
					toReturn.Add(WorldShipShipmentEntity.Relations.WorldShipProcessedEntityUsingShipmentID);
					break;
		...
		public bool TestOriginalFieldValueForNull(WorldShipShipmentFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(WorldShipShipmentFieldIndex fieldIndex)
		{
		...
		/// the related entities of type 'WorldShipGoods' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entities of type 'WorldShipPackage' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entities of type 'WorldShipProcessed' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoWorldShipProcessed()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(WorldShipProcessedFields.ShipmentID, null, ComparisonOperator.Equal, this.ShipmentID));
			return bucket;
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.WorldShipShipmentEntity);
		}
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			if (this._worldShipProcessed != null)
			{
				return true;
			}
		...
		protected override void AddInternalsToContext()
		{
			if(_goods!=null)
			{
				_goods.ActiveContext = base.ActiveContext;
			}
			if(_packages!=null)
			{
			...
			{
				_worldShipProcessed.ActiveContext = base.ActiveContext;
			}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'WorldShipGoods' 
		...
		public static IPrefetchPathElement2 PrefetchPathGoods
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<WorldShipGoodsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorldShipGoodsEntityFactory))),
					(IEntityRelation)GetRelationsForField("Goods")[0], (int)ShipWorks.Data.Model.EntityType.WorldShipShipmentEntity, (int)ShipWorks.Data.Model.EntityType.WorldShipGoodsEntity, 0, null, null, null, null, "Goods", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'WorldShipPackage' 
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathPackages
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<WorldShipPackageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorldShipPackageEntityFactory))),
					(IEntityRelation)GetRelationsForField("Packages")[0], (int)ShipWorks.Data.Model.EntityType.WorldShipShipmentEntity, (int)ShipWorks.Data.Model.EntityType.WorldShipPackageEntity, 0, null, null, null, null, "Packages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'WorldShipProcessed' 
		/// for this entity. Add the object returned by this property to an existing PrefetchPath2 instance.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathWorldShipProcessed
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<WorldShipProcessedEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorldShipProcessedEntityFactory))),
					(IEntityRelation)GetRelationsForField("WorldShipProcessed")[0], (int)ShipWorks.Data.Model.EntityType.WorldShipShipmentEntity, (int)ShipWorks.Data.Model.EntityType.WorldShipProcessedEntity, 0, null, null, null, null, "WorldShipProcessed", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		{
			get { return WorldShipShipmentEntity.CustomProperties;}
		}
		...
		{
			get { return WorldShipShipmentEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'WorldShipPackageEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
		...
		public virtual EntityCollection<WorldShipPackageEntity> Packages
		{
			get
			{
				if(_packages==null)
				{
					_packages = new EntityCollection<WorldShipPackageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorldShipPackageEntityFactory)));
					_packages.SetContainingEntityInfo(this, "WorldShipShipment");
				}
				return _packages;
			}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'WorldShipProcessedEntity' which are related to this entity via a relation of type '1:n'.
		/// If the EntityCollection hasn't been fetched yet, the collection returned will be empty.</summary>
