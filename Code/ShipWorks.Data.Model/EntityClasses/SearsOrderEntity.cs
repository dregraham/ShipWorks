...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'SearsOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class SearsOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((SearsOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return SearsOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(SearsOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(SearsOrderFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.SearsOrderEntity);
		}
		...
		{
			get { return SearsOrderEntity.CustomProperties;}
		}
		...
		{
			get { return SearsOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity SearsOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "SearsOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)SearsOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)SearsOrderFieldIndex.OrderID, value); }
		}
