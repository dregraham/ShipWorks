...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'LemonStandOrder'.<br/><br/></summary>
	[Serializable]
	public partial class LemonStandOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "LemonStandOrderSearch":
					toReturn.Add(Relations.LemonStandOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		public virtual IRelationPredicateBucket GetRelationInfoLemonStandOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(LemonStandOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<LemonStandOrderSearchEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LemonStandOrderSearchEntityFactory))), (IEntityRelation)GetRelationsForField("LemonStandOrderSearch")[0], (int)ShipWorks.Data.Model.EntityType.LemonStandOrderEntity, (int)ShipWorks.Data.Model.EntityType.LemonStandOrderSearchEntity, 0, null, null, null, null, "LemonStandOrderSearch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The LemonStandOrderID property of the Entity LemonStandOrder<br/><br/></summary>
