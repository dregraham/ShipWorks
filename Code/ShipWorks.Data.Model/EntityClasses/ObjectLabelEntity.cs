...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ObjectLabel'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ObjectLabelEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ObjectLabelEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ObjectLabelEntity():base("ObjectLabelEntity")
		{
		...
		public ObjectLabelEntity(IEntityFields2 fields):base("ObjectLabelEntity")
		{
		...
		public ObjectLabelEntity(IValidator validator):base("ObjectLabelEntity")
		{
		...
		protected ObjectLabelEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ObjectLabelFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ObjectLabelEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(ObjectLabelFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ObjectLabelFieldIndex fieldIndex)
		{
		...
		{
			return new ObjectLabelRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ObjectLabelEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ObjectLabelEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ObjectType", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this ObjectLabelEntity</param>
		...
		public  static ObjectLabelRelations Relations
		{
			get	{ return new ObjectLabelRelations(); }
		}
		...
		{
			get { return ObjectLabelEntity.CustomProperties;}
		}
		...
		{
			get { return ObjectLabelEntity.FieldsCustomProperties;}
		}
		...
		public virtual System.Int32 ObjectType
		{
			...
			set	{ SetValue((int)ObjectLabelFieldIndex.ObjectType, value); }
		}
		...
		public virtual Nullable<System.Int64> ParentID
		{
			...
			set	{ SetValue((int)ObjectLabelFieldIndex.ParentID, value); }
		}
		...
		public virtual System.String Label
		{
			...
			set	{ SetValue((int)ObjectLabelFieldIndex.Label, value); }
		}
		...
		public virtual System.Boolean IsDeleted
		{
			...
			set	{ SetValue((int)ObjectLabelFieldIndex.IsDeleted, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ObjectLabelEntity; }
		}
		#endregion
