...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'AuditChange'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class AuditChangeEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return AuditChangeEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Audit":
					toReturn.Add(AuditChangeEntity.Relations.AuditEntityUsingAuditID);
					break;
				case "AuditChangeDetails":
					toReturn.Add(AuditChangeEntity.Relations.AuditChangeDetailEntityUsingAuditChangeID);
					break;
		...
		public bool TestOriginalFieldValueForNull(AuditChangeFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(AuditChangeFieldIndex fieldIndex)
		{
		...
		/// the related entities of type 'AuditChangeDetail' to this entity. Use DataAccessAdapter.FetchEntityCollection() to fetch these related entities.</summary>
		/// <returns></returns>
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch
		/// the related entity of type 'Audit' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.AuditChangeEntity);
		}
		...
		{
			if (this._auditChangeDetails != null)
			{
				return true;
			}
		...
		{
			if(_auditChangeDetails!=null)
			{
				_auditChangeDetails.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _audit, new PropertyChangedEventHandler( OnAuditPropertyChanged ), "Audit", AuditChangeEntity.Relations.AuditEntityUsingAuditID, true, signalRelatedEntity, "AuditChanges", resetFKFields, new int[] { (int)AuditChangeFieldIndex.AuditID } );		
			_audit = null;
		}

		/// <summary> setups the sync logic for member _audit</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncAudit(IEntity2 relatedEntity)
		{
			if(_audit!=relatedEntity)
			{
				DesetupSyncAudit(true, true);
				_audit = (AuditEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _audit, new PropertyChangedEventHandler( OnAuditPropertyChanged ), "Audit", AuditChangeEntity.Relations.AuditEntityUsingAuditID, true, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'AuditChangeDetail' 
		...
		public static IPrefetchPathElement2 PrefetchPathAuditChangeDetails
		{
			get
			{
				return new PrefetchPathElement2( new EntityCollection<AuditChangeDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditChangeDetailEntityFactory))),
					(IEntityRelation)GetRelationsForField("AuditChangeDetails")[0], (int)ShipWorks.Data.Model.EntityType.AuditChangeEntity, (int)ShipWorks.Data.Model.EntityType.AuditChangeDetailEntity, 0, null, null, null, null, "AuditChangeDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathAudit
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AuditEntityFactory))),
					(IEntityRelation)GetRelationsForField("Audit")[0], (int)ShipWorks.Data.Model.EntityType.AuditChangeEntity, (int)ShipWorks.Data.Model.EntityType.AuditEntity, 0, null, null, null, null, "Audit", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return AuditChangeEntity.CustomProperties;}
		}
		...
		{
			get { return AuditChangeEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'AuditChangeDetailEntity' which are related to this entity via a relation of type '1:n'.
		...
		public virtual EntityCollection<AuditChangeDetailEntity> AuditChangeDetails
		{
			get
			{
				if(_auditChangeDetails==null)
				{
					_auditChangeDetails = new EntityCollection<AuditChangeDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditChangeDetailEntityFactory)));

				}
				return _auditChangeDetails;
			}
		}


		/// <summary> Gets / sets related entity of type 'AuditEntity' which has to be set using a fetch action earlier. If no related entity
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_audit != null)
						{
							_audit.UnsetRelatedEntity(this, "AuditChanges");
						}
					}
					else
					{
						if(_audit!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "AuditChanges");
						}
					}
				}
			}
