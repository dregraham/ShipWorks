...
namespace ShipWorks.Data.Model.EntityClasses
{
			...
			
	{
		...
		static WalmartStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public WalmartStoreEntity()
		{
			InitClassEmpty();
			SetName("WalmartStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public WalmartStoreEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("WalmartStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this WalmartStoreEntity</param>
		public WalmartStoreEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("WalmartStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for WalmartStore which data should be fetched into this WalmartStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public WalmartStoreEntity(System.Int64 storeID):base(storeID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this WalmartStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public WalmartStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			InitClassEmpty();
		...
		protected WalmartStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("WalmartStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("WalmartStoreEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("WalmartStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new WalmartStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(WalmartStoreEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this WalmartStoreEntity</param>
		...
		public new static WalmartStoreRelations Relations
		{
			get	{ return new WalmartStoreRelations(); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.WalmartStoreEntity; }
		}
