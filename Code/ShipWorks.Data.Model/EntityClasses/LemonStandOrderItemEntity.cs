...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'LemonStandOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class LemonStandOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static LemonStandOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public LemonStandOrderItemEntity()
		{
			SetName("LemonStandOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public LemonStandOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("LemonStandOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this LemonStandOrderItemEntity</param>
		public LemonStandOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("LemonStandOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for LemonStandOrderItem which data should be fetched into this LemonStandOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public LemonStandOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("LemonStandOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this LemonStandOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public LemonStandOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("LemonStandOrderItemEntity");
		}
		...
		protected LemonStandOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((LemonStandOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return LemonStandOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("LemonStandOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("LemonStandOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("LemonStandOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(LemonStandOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(LemonStandOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("LemonStandOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new LemonStandOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.LemonStandOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(LemonStandOrderItemEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this LemonStandOrderItemEntity</param>
		...
		public new static LemonStandOrderItemRelations Relations
		{
			get	{ return new LemonStandOrderItemRelations(); }
		}
		...
		{
			get { return LemonStandOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return LemonStandOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity LemonStandOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "LemonStandOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)LemonStandOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)LemonStandOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.LemonStandOrderItemEntity; }
		}
		#endregion
