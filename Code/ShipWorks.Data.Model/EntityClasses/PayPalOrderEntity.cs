...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PayPalOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PayPalOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			SetName("PayPalOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public PayPalOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("PayPalOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PayPalOrderEntity</param>
		public PayPalOrderEntity(IValidator validator):base(validator)
		{
			SetName("PayPalOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for PayPalOrder which data should be fetched into this PayPalOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PayPalOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("PayPalOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this PayPalOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PayPalOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("PayPalOrderEntity");
		}
		...
		protected PayPalOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((PayPalOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return PayPalOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("PayPalOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("PayPalOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("PayPalOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(PayPalOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PayPalOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("PayPalOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.PayPalOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PayPalOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("AddressStatus", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("PayPalFee", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this PayPalOrderEntity</param>
		...
		public new static PayPalOrderRelations Relations
		{
			get	{ return new PayPalOrderRelations(); }
		}
		...
		{
			get { return PayPalOrderEntity.CustomProperties;}
		}
		...
		{
			get { return PayPalOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity PayPalOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "PayPalOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)PayPalOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)PayPalOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual System.String TransactionID
		{
			...
			set	{ SetValue((int)PayPalOrderFieldIndex.TransactionID, value); }
		}
		...
		public virtual System.Int32 AddressStatus
		{
			...
			set	{ SetValue((int)PayPalOrderFieldIndex.AddressStatus, value); }
		}
		...
		public virtual System.Decimal PayPalFee
		{
			...
			set	{ SetValue((int)PayPalOrderFieldIndex.PayPalFee, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.PayPalOrderEntity; }
		}
		#endregion
