...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'UspsScanForm'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UspsScanFormEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return UspsScanFormEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ScanFormBatch":
					toReturn.Add(UspsScanFormEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID);
					break;
		...
		public bool TestOriginalFieldValueForNull(UspsScanFormFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(UspsScanFormFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.UspsScanFormEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", UspsScanFormEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID, true, signalRelatedEntity, "UspsScanForms", resetFKFields, new int[] { (int)UspsScanFormFieldIndex.ScanFormBatchID } );		
			_scanFormBatch = null;
		}
		...
		private void SetupSyncScanFormBatch(IEntity2 relatedEntity)
		{
			if(_scanFormBatch!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _scanFormBatch, new PropertyChangedEventHandler( OnScanFormBatchPropertyChanged ), "ScanFormBatch", UspsScanFormEntity.Relations.ScanFormBatchEntityUsingScanFormBatchID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathScanFormBatch
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScanFormBatchEntityFactory))),
					(IEntityRelation)GetRelationsForField("ScanFormBatch")[0], (int)ShipWorks.Data.Model.EntityType.UspsScanFormEntity, (int)ShipWorks.Data.Model.EntityType.ScanFormBatchEntity, 0, null, null, null, null, "ScanFormBatch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return UspsScanFormEntity.CustomProperties;}
		}
		...
		{
			get { return UspsScanFormEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_scanFormBatch != null)
						{
							_scanFormBatch.UnsetRelatedEntity(this, "UspsScanForms");
						}
					}
					else
					{
						...
						{
							((IEntity2)value).SetRelatedEntity(this, "UspsScanForms");
						}
					}
				}
			}
