...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'FedExAccount'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class FedExAccountEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((FedExAccountFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return FedExAccountEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(FedExAccountFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(FedExAccountFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.FedExAccountEntity);
		}
		...
		{
			get { return FedExAccountEntity.CustomProperties;}
		}
		...
		{
			get { return FedExAccountEntity.FieldsCustomProperties;}
		}
