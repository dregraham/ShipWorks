...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> The CustomsRecipientTin property of the Entity PostalShipment<br/><br/></summary>
		...
		/// <summary> The InternalTransactionNumber property of the Entity PostalShipment<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PostalShipment"."InternalTransactionNumber"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 25<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		[DataMember]
		public virtual System.String InternalTransactionNumber
		{
			get { return (System.String)GetValue((int)PostalShipmentFieldIndex.InternalTransactionNumber, true); }
			set	{ SetValue((int)PostalShipmentFieldIndex.InternalTransactionNumber, value); }
		}
