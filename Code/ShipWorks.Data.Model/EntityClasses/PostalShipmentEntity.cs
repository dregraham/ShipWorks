...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'PostalShipment'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class PostalShipmentEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return PostalShipmentEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "Endicia":
					toReturn.Add(PostalShipmentEntity.Relations.EndiciaShipmentEntityUsingShipmentID);
					break;
				case "Shipment":
		...
		public bool TestOriginalFieldValueForNull(PostalShipmentFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(PostalShipmentFieldIndex fieldIndex)
		{
		...
		/// the related entity of type 'EndiciaShipment' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.PostalShipmentEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _endicia, new PropertyChangedEventHandler( OnEndiciaPropertyChanged ), "Endicia", PostalShipmentEntity.Relations.EndiciaShipmentEntityUsingShipmentID, false, signalRelatedEntity, "PostalShipment", false, new int[] { (int)PostalShipmentFieldIndex.ShipmentID } );
			_endicia = null;
		}
		...
		private void SetupSyncEndicia(IEntity2 relatedEntity)
		{
			if(_endicia!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _endicia, new PropertyChangedEventHandler( OnEndiciaPropertyChanged ), "Endicia", PostalShipmentEntity.Relations.EndiciaShipmentEntityUsingShipmentID, false, new string[] {  } );
			}
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", PostalShipmentEntity.Relations.ShipmentEntityUsingShipmentID, true, signalRelatedEntity, "Postal", false, new int[] { (int)PostalShipmentFieldIndex.ShipmentID } );
			_shipment = null;
		}
		...
		private void SetupSyncShipment(IEntity2 relatedEntity)
		{
			if(_shipment!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _shipment, new PropertyChangedEventHandler( OnShipmentPropertyChanged ), "Shipment", PostalShipmentEntity.Relations.ShipmentEntityUsingShipmentID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEndicia
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EndiciaShipmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("Endicia")[0], (int)ShipWorks.Data.Model.EntityType.PostalShipmentEntity, (int)ShipWorks.Data.Model.EntityType.EndiciaShipmentEntity, 0, null, null, null, null, "Endicia", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShipment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("Shipment")[0], (int)ShipWorks.Data.Model.EntityType.PostalShipmentEntity, (int)ShipWorks.Data.Model.EntityType.ShipmentEntity, 0, null, null, null, null, "Shipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);
			}
		}
		...
		{
			get { return PostalShipmentEntity.CustomProperties;}
		}
		...
		{
			get { return PostalShipmentEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets / sets related entity of type 'EndiciaShipmentEntity' which has to be set using a fetch action earlier. If no related entity
