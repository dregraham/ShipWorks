...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'IParcelPackage'.<br/><br/></summary>
	[Serializable]
	public partial class IParcelPackageEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _iParcelShipment, new PropertyChangedEventHandler( OnIParcelShipmentPropertyChanged ), "IParcelShipment", ShipWorks.Data.Model.RelationClasses.StaticIParcelPackageRelations.IParcelShipmentEntityUsingShipmentIDStatic, true, signalRelatedEntity, "Packages", resetFKFields, new int[] { (int)IParcelPackageFieldIndex.ShipmentID } );
			_iParcelShipment = null;
		}

		/// <summary> setups the sync logic for member _iParcelShipment</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncIParcelShipment(IEntityCore relatedEntity)
		{
			if(_iParcelShipment!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _iParcelShipment, new PropertyChangedEventHandler( OnIParcelShipmentPropertyChanged ), "IParcelShipment", ShipWorks.Data.Model.RelationClasses.StaticIParcelPackageRelations.IParcelShipmentEntityUsingShipmentIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IParcelShipmentEntityFactory))),	(IEntityRelation)GetRelationsForField("IParcelShipment")[0], (int)ShipWorks.Data.Model.EntityType.IParcelPackageEntity, (int)ShipWorks.Data.Model.EntityType.IParcelShipmentEntity, 0, null, null, null, null, "IParcelShipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The IParcelPackageID property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The ShipmentID property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The Weight property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DimsProfileID property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DimsLength property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DimsWidth property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DimsHeight property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DimsAddWeight property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DimsWeight property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The Insurance property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The InsuranceValue property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The InsurancePennyOne property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The DeclaredValue property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The TrackingNumber property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The ParcelNumber property of the Entity IParcelPackage<br/><br/></summary>
		...
		/// <summary> The SkuAndQuantities property of the Entity IParcelPackage<br/><br/></summary>
		...
		public virtual IParcelShipmentEntity IParcelShipment
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "Packages", "IParcelShipment", _iParcelShipment, true); 
				}
			}
		}
