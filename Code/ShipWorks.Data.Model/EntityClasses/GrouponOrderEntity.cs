...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'GrouponOrder'.<br/><br/></summary>
	[Serializable]
	public partial class GrouponOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "GrouponOrderSearch":
					toReturn.Add(Relations.GrouponOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		public virtual IRelationPredicateBucket GetRelationInfoGrouponOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(GrouponOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<GrouponOrderSearchEntity>(EntityFactoryCache2.GetEntityFactory(typeof(GrouponOrderSearchEntityFactory))), (IEntityRelation)GetRelationsForField("GrouponOrderSearch")[0], (int)ShipWorks.Data.Model.EntityType.GrouponOrderEntity, (int)ShipWorks.Data.Model.EntityType.GrouponOrderSearchEntity, 0, null, null, null, null, "GrouponOrderSearch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The GrouponOrderID property of the Entity GrouponOrder<br/><br/></summary>
