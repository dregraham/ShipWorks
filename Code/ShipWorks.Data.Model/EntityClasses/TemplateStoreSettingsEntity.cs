...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'TemplateStoreSettings'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class TemplateStoreSettingsEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return TemplateStoreSettingsEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Template":
					toReturn.Add(TemplateStoreSettingsEntity.Relations.TemplateEntityUsingTemplateID);
					break;
		...
		public bool TestOriginalFieldValueForNull(TemplateStoreSettingsFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(TemplateStoreSettingsFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.TemplateStoreSettingsEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _template, new PropertyChangedEventHandler( OnTemplatePropertyChanged ), "Template", TemplateStoreSettingsEntity.Relations.TemplateEntityUsingTemplateID, true, signalRelatedEntity, "StoreSettings", resetFKFields, new int[] { (int)TemplateStoreSettingsFieldIndex.TemplateID } );		
			_template = null;
		}
		...
		private void SetupSyncTemplate(IEntity2 relatedEntity)
		{
			if(_template!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _template, new PropertyChangedEventHandler( OnTemplatePropertyChanged ), "Template", TemplateStoreSettingsEntity.Relations.TemplateEntityUsingTemplateID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTemplate
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TemplateEntityFactory))),
					(IEntityRelation)GetRelationsForField("Template")[0], (int)ShipWorks.Data.Model.EntityType.TemplateStoreSettingsEntity, (int)ShipWorks.Data.Model.EntityType.TemplateEntity, 0, null, null, null, null, "Template", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return TemplateStoreSettingsEntity.CustomProperties;}
		}
		...
		{
			get { return TemplateStoreSettingsEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_template != null)
						{
							_template.UnsetRelatedEntity(this, "StoreSettings");
						}
					}
					else
					{
						if(_template!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "StoreSettings");
						}
					}
				}
			}
