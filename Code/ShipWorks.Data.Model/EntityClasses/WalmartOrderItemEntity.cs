...
namespace ShipWorks.Data.Model.EntityClasses
{
			...
			
	{
		...
		static WalmartOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public WalmartOrderItemEntity()
		{
			InitClassEmpty();
			SetName("WalmartOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public WalmartOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("WalmartOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this WalmartOrderItemEntity</param>
		public WalmartOrderItemEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("WalmartOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for WalmartOrderItem which data should be fetched into this WalmartOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public WalmartOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this WalmartOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public WalmartOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			InitClassEmpty();
		...
		protected WalmartOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("WalmartOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("WalmartOrderItemEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("WalmartOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new WalmartOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(WalmartOrderItemEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this WalmartOrderItemEntity</param>
		...
		public new static WalmartOrderItemRelations Relations
		{
			get	{ return new WalmartOrderItemRelations(); }
		}
		...
		/// <summary> The LineNumber property of the Entity WalmartOrderItem<br/><br/></summary>
		/// <remarks>Mapped on  table field: "WalmartOrderItem"."LineNumber"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 20<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String LineNumber
		{
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.WalmartOrderItemEntity; }
		}
