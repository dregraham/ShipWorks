...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Order":
					toReturn.Add(NoteEntity.Relations.OrderEntityUsingObjectID);
					break;
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.NoteEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", NoteEntity.Relations.OrderEntityUsingObjectID, true, signalRelatedEntity, "Notes", resetFKFields, new int[] { (int)NoteFieldIndex.ObjectID } );		
			_order = null;
		}
		...
		private void SetupSyncOrder(IEntity2 relatedEntity)
		{
			if(_order!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", NoteEntity.Relations.OrderEntityUsingObjectID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrder
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))),
					(IEntityRelation)GetRelationsForField("Order")[0], (int)ShipWorks.Data.Model.EntityType.NoteEntity, (int)ShipWorks.Data.Model.EntityType.OrderEntity, 0, null, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_order != null)
						{
							_order.UnsetRelatedEntity(this, "Notes");
						}
					}
					else
					{
