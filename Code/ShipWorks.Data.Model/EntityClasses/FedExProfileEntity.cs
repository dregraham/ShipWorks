...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Packages":
					toReturn.Add(Relations.FedExProfilePackageEntityUsingShippingProfileID);
					break;
				case "ShippingProfile":
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<FedExProfilePackageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(FedExProfilePackageEntityFactory))), (IEntityRelation)GetRelationsForField("Packages")[0], (int)ShipWorks.Data.Model.EntityType.FedExProfileEntity, (int)ShipWorks.Data.Model.EntityType.FedExProfilePackageEntity, 0, null, null, null, null, "Packages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<FedExProfilePackageEntity, FedExProfilePackageEntityFactory>("FedExProfile", true, false, ref _packages);	}
		}
