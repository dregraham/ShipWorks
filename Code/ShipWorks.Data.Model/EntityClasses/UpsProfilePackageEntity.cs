...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'UpsProfilePackage'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class UpsProfilePackageEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return UpsProfilePackageEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "UpsProfile":
					toReturn.Add(UpsProfilePackageEntity.Relations.UpsProfileEntityUsingShippingProfileID);
					break;
		...
		public bool TestOriginalFieldValueForNull(UpsProfilePackageFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(UpsProfilePackageFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.UpsProfilePackageEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_upsProfile!=null)
			{
				_upsProfile.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _upsProfile, new PropertyChangedEventHandler( OnUpsProfilePropertyChanged ), "UpsProfile", UpsProfilePackageEntity.Relations.UpsProfileEntityUsingShippingProfileID, true, signalRelatedEntity, "Packages", resetFKFields, new int[] { (int)UpsProfilePackageFieldIndex.ShippingProfileID } );		
			_upsProfile = null;
		}

		/// <summary> setups the sync logic for member _upsProfile</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncUpsProfile(IEntity2 relatedEntity)
		{
			if(_upsProfile!=relatedEntity)
			{
				DesetupSyncUpsProfile(true, true);
				_upsProfile = (UpsProfileEntity)relatedEntity;
				base.PerformSetupSyncRelatedEntity( _upsProfile, new PropertyChangedEventHandler( OnUpsProfilePropertyChanged ), "UpsProfile", UpsProfilePackageEntity.Relations.UpsProfileEntityUsingShippingProfileID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUpsProfile
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UpsProfileEntityFactory))),
					(IEntityRelation)GetRelationsForField("UpsProfile")[0], (int)ShipWorks.Data.Model.EntityType.UpsProfilePackageEntity, (int)ShipWorks.Data.Model.EntityType.UpsProfileEntity, 0, null, null, null, null, "UpsProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return UpsProfilePackageEntity.CustomProperties;}
		}
		...
		{
			get { return UpsProfilePackageEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_upsProfile != null)
						{
							_upsProfile.UnsetRelatedEntity(this, "Packages");
						}
					}
					else
					{
						if(_upsProfile!=value)
						{
