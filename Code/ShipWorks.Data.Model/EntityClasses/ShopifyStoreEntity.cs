...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ShopifyStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ShopifyStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ShopifyStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public ShopifyStoreEntity()
		{
			SetName("ShopifyStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public ShopifyStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("ShopifyStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ShopifyStoreEntity</param>
		public ShopifyStoreEntity(IValidator validator):base(validator)
		{
			SetName("ShopifyStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for ShopifyStore which data should be fetched into this ShopifyStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShopifyStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("ShopifyStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this ShopifyStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ShopifyStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("ShopifyStoreEntity");
		}
		...
		protected ShopifyStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ShopifyStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ShopifyStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ShopifyStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ShopifyStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ShopifyStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(ShopifyStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ShopifyStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ShopifyStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new ShopifyStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ShopifyStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ShopifyStoreEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ShopifyShopUrlName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ShopifyShopDisplayName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this ShopifyStoreEntity</param>
		...
		public new static ShopifyStoreRelations Relations
		{
			get	{ return new ShopifyStoreRelations(); }
		}
		...
		{
			get { return ShopifyStoreEntity.CustomProperties;}
		}
		...
		{
			get { return ShopifyStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity ShopifyStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ShopifyStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)ShopifyStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)ShopifyStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.String ShopifyShopUrlName
		{
			...
			set	{ SetValue((int)ShopifyStoreFieldIndex.ShopifyShopUrlName, value); }
		}
		...
		public virtual System.String ShopifyShopDisplayName
		{
			...
			set	{ SetValue((int)ShopifyStoreFieldIndex.ShopifyShopDisplayName, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.ShopifyStoreEntity; }
		}
		#endregion
