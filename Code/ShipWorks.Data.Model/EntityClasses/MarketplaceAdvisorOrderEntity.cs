...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'MarketplaceAdvisorOrder'.<br/><br/></summary>
	[Serializable]
	public partial class MarketplaceAdvisorOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static MarketplaceAdvisorOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public MarketplaceAdvisorOrderEntity()
		{
			InitClassEmpty();
			SetName("MarketplaceAdvisorOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public MarketplaceAdvisorOrderEntity(IEntityFields2 fields):base(fields)
		{
			InitClassEmpty();
			SetName("MarketplaceAdvisorOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this MarketplaceAdvisorOrderEntity</param>
		public MarketplaceAdvisorOrderEntity(IValidator validator):base(validator)
		{
			InitClassEmpty();
			SetName("MarketplaceAdvisorOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for MarketplaceAdvisorOrder which data should be fetched into this MarketplaceAdvisorOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MarketplaceAdvisorOrderEntity(System.Int64 orderID):base(orderID)
		{
			InitClassEmpty();
		...
		/// <param name="validator">The custom validator object for this MarketplaceAdvisorOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public MarketplaceAdvisorOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			InitClassEmpty();
		...
		protected MarketplaceAdvisorOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "MarketplaceAdvisorOrderSearch":
					toReturn.Add(Relations.MarketplaceAdvisorOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MarketplaceAdvisorOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("MarketplaceAdvisorOrderEntity", negate);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("MarketplaceAdvisorOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new MarketplaceAdvisorOrderRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoMarketplaceAdvisorOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(MarketplaceAdvisorOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(MarketplaceAdvisorOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("BuyerNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("SellerOrderNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("InvoiceNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ParcelID", fieldHashtable);
		}
		#endregion

		/// <summary> Initializes the class with empty data, as if it is a new Entity.</summary>
		/// <param name="validator">The validator object for this MarketplaceAdvisorOrderEntity</param>
		...
		public new static MarketplaceAdvisorOrderRelations Relations
		{
			get	{ return new MarketplaceAdvisorOrderRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<MarketplaceAdvisorOrderSearchEntity>(EntityFactoryCache2.GetEntityFactory(typeof(MarketplaceAdvisorOrderSearchEntityFactory))), (IEntityRelation)GetRelationsForField("MarketplaceAdvisorOrderSearch")[0], (int)ShipWorks.Data.Model.EntityType.MarketplaceAdvisorOrderEntity, (int)ShipWorks.Data.Model.EntityType.MarketplaceAdvisorOrderSearchEntity, 0, null, null, null, null, "MarketplaceAdvisorOrderSearch", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The BuyerNumber property of the Entity MarketplaceAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int64 BuyerNumber
		{
			...
			set	{ SetValue((int)MarketplaceAdvisorOrderFieldIndex.BuyerNumber, value); }
		}

		/// <summary> The SellerOrderNumber property of the Entity MarketplaceAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int64 SellerOrderNumber
		{
			...
			set	{ SetValue((int)MarketplaceAdvisorOrderFieldIndex.SellerOrderNumber, value); }
		}

		/// <summary> The InvoiceNumber property of the Entity MarketplaceAdvisorOrder<br/><br/></summary>
		...
		public virtual System.String InvoiceNumber
		{
			...
			set	{ SetValue((int)MarketplaceAdvisorOrderFieldIndex.InvoiceNumber, value); }
		}

		/// <summary> The ParcelID property of the Entity MarketplaceAdvisorOrder<br/><br/></summary>
		...
		public virtual System.Int64 ParcelID
		{
			...
			set	{ SetValue((int)MarketplaceAdvisorOrderFieldIndex.ParcelID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.MarketplaceAdvisorOrderEntity; }
		}
