...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'MarketplaceAdvisorOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MarketplaceAdvisorOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((MarketplaceAdvisorOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return MarketplaceAdvisorOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("MarketplaceAdvisorOrderEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(MarketplaceAdvisorOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(MarketplaceAdvisorOrderFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.MarketplaceAdvisorOrderEntity);
		}
		...
		{
			get { return MarketplaceAdvisorOrderEntity.CustomProperties;}
		}
		...
		{
			get { return MarketplaceAdvisorOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity MarketplaceAdvisorOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "MarketplaceAdvisorOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)MarketplaceAdvisorOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)MarketplaceAdvisorOrderFieldIndex.OrderID, value); }
		}
