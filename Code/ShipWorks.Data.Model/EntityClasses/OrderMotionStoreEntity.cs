...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'OrderMotionStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OrderMotionStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return OrderMotionStoreEntity.GetRelationsForField(fieldName);
		}
		...
		public static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "OrderMotionEmailAccount":
					toReturn.Add(OrderMotionStoreEntity.Relations.EmailAccountEntityUsingOrderMotionEmailAccountID);
					break;
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("OrderMotionStoreEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(OrderMotionStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(OrderMotionStoreFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.OrderMotionStoreEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_orderMotionEmailAccount!=null)
			{
				_orderMotionEmailAccount.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _orderMotionEmailAccount, new PropertyChangedEventHandler( OnOrderMotionEmailAccountPropertyChanged ), "OrderMotionEmailAccount", OrderMotionStoreEntity.Relations.EmailAccountEntityUsingOrderMotionEmailAccountID, true, signalRelatedEntity, "OrderMotionStore", resetFKFields, new int[] { (int)OrderMotionStoreFieldIndex.OrderMotionEmailAccountID } );		
			_orderMotionEmailAccount = null;
		}

		/// <summary> setups the sync logic for member _orderMotionEmailAccount</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncOrderMotionEmailAccount(IEntity2 relatedEntity)
		{
			if(_orderMotionEmailAccount!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _orderMotionEmailAccount, new PropertyChangedEventHandler( OnOrderMotionEmailAccountPropertyChanged ), "OrderMotionEmailAccount", OrderMotionStoreEntity.Relations.EmailAccountEntityUsingOrderMotionEmailAccountID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrderMotionEmailAccount
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmailAccountEntityFactory))),
					(IEntityRelation)GetRelationsForField("OrderMotionEmailAccount")[0], (int)ShipWorks.Data.Model.EntityType.OrderMotionStoreEntity, (int)ShipWorks.Data.Model.EntityType.EmailAccountEntity, 0, null, null, null, null, "OrderMotionEmailAccount", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return OrderMotionStoreEntity.CustomProperties;}
		}
		...
		{
			get { return OrderMotionStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity OrderMotionStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "OrderMotionStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)OrderMotionStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)OrderMotionStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual EmailAccountEntity OrderMotionEmailAccount
		{
			get
			{
				return _orderMotionEmailAccount;
			}
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_orderMotionEmailAccount != null)
						{
							_orderMotionEmailAccount.UnsetRelatedEntity(this, "OrderMotionStore");
						}
					}
					else
					{
						if(_orderMotionEmailAccount!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "OrderMotionStore");
						}
					}
				}
			}
