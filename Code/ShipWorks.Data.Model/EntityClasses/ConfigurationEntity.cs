...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'Configuration'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ConfigurationEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return ConfigurationEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(ConfigurationFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ConfigurationFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ConfigurationEntity);
		}
		...
		{
			get { return ConfigurationEntity.CustomProperties;}
		}
		...
		{
			get { return ConfigurationEntity.FieldsCustomProperties;}
		}
