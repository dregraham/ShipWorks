...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CommerceInterfaceOrder'.<br/><br/></summary>
	[Serializable]
	public partial class CommerceInterfaceOrderEntity : OrderEntity
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static new RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "CommerceInterfaceOrderSearch":
					toReturn.Add(Relations.CommerceInterfaceOrderSearchEntityUsingOrderID);
					break;
				default:
		...
		public virtual IRelationPredicateBucket GetRelationInfoCommerceInterfaceOrderSearch()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CommerceInterfaceOrderSearchFields.OrderID, null, ComparisonOperator.Equal, this.OrderID));
			return bucket;
		}
		...
		/// <summary> The CommerceInterfaceOrderNumber property of the Entity CommerceInterfaceOrder<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<CommerceInterfaceOrderSearchEntity, CommerceInterfaceOrderSearchEntityFactory>("CommerceInterfaceOrder", true, false, ref _commerceInterfaceOrderSearch);	}
		}
