...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected GenericFileStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("GenericFileStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("GenericFileStoreEntity", negate);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(GenericFileStoreEntityFactory));
		}
#if !CF
		...
		public new static GenericFileStoreRelations Relations
		{
			get	{ return new GenericFileStoreRelations(); }
		}
