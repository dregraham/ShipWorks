...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UpsProfile'.<br/><br/></summary>
	[Serializable]
	public partial class UpsProfileEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Packages":
					toReturn.Add(Relations.UpsProfilePackageEntityUsingShippingProfileID);
					break;
				case "ShippingProfile":
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", ShipWorks.Data.Model.RelationClasses.StaticUpsProfileRelations.ShippingProfileEntityUsingShippingProfileIDStatic, true, signalRelatedEntity, "Ups", false, new int[] { (int)UpsProfileFieldIndex.ShippingProfileID } );
		...
		private void SetupSyncShippingProfile(IEntityCore relatedEntity)
		{
			if(_shippingProfile!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shippingProfile, new PropertyChangedEventHandler( OnShippingProfilePropertyChanged ), "ShippingProfile", ShipWorks.Data.Model.RelationClasses.StaticUpsProfileRelations.ShippingProfileEntityUsingShippingProfileIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<UpsProfilePackageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UpsProfilePackageEntityFactory))), (IEntityRelation)GetRelationsForField("Packages")[0], (int)ShipWorks.Data.Model.EntityType.UpsProfileEntity, (int)ShipWorks.Data.Model.EntityType.UpsProfilePackageEntity, 0, null, null, null, null, "Packages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShippingProfileEntityFactory))), (IEntityRelation)GetRelationsForField("ShippingProfile")[0], (int)ShipWorks.Data.Model.EntityType.UpsProfileEntity, (int)ShipWorks.Data.Model.EntityType.ShippingProfileEntity, 0, null, null, null, null, "ShippingProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShippingProfileID property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The UpsAccountID property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The Service property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The SaturdayDelivery property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ResidentialDetermination property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The DeliveryConfirmation property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ReferenceNumber property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ReferenceNumber2 property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The PayorType property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The PayorAccount property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The PayorPostalCode property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The PayorCountryCode property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifySender property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifyRecipient property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifyOther property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifyOtherAddress property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifyFrom property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifySubject property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The EmailNotifyMessage property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ReturnService property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ReturnUndeliverableEmail property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ReturnContents property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The Endorsement property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The Subclassification property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The PaperlessAdditionalDocumentation property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ShipperRelease property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The CarbonNeutral property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The CommercialPaperlessInvoice property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The CostCenter property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The IrregularIndicator property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The Cn22Number property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ShipmentChargeType property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ShipmentChargeAccount property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ShipmentChargePostalCode property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The ShipmentChargeCountryCode property of the Entity UpsProfile<br/><br/></summary>
		...
		/// <summary> The UspsPackageID property of the Entity UpsProfile<br/><br/></summary>
		...
		{
			get { return GetOrCreateEntityCollection<UpsProfilePackageEntity, UpsProfilePackageEntityFactory>("UpsProfile", true, false, ref _packages);	}
		}
