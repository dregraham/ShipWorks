...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ShippingPrintOutputRule'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ShippingPrintOutputRuleEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return ShippingPrintOutputRuleEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "ShippingPrintOutput":
					toReturn.Add(ShippingPrintOutputRuleEntity.Relations.ShippingPrintOutputEntityUsingShippingPrintOutputID);
					break;
		...
		public bool TestOriginalFieldValueForNull(ShippingPrintOutputRuleFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ShippingPrintOutputRuleFieldIndex fieldIndex)
		{
		...
		/// the related entity of type 'ShippingPrintOutput' to this entity. Use DataAccessAdapter.FetchNewEntity() to fetch this related entity.</summary>
		/// <returns></returns>
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ShippingPrintOutputRuleEntity);
		}
		...
		protected override void AddInternalsToContext()
		{
			...
			if(_shippingPrintOutput!=null)
			{
				_shippingPrintOutput.ActiveContext = base.ActiveContext;
			}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _shippingPrintOutput, new PropertyChangedEventHandler( OnShippingPrintOutputPropertyChanged ), "ShippingPrintOutput", ShippingPrintOutputRuleEntity.Relations.ShippingPrintOutputEntityUsingShippingPrintOutputID, true, signalRelatedEntity, "Rules", resetFKFields, new int[] { (int)ShippingPrintOutputRuleFieldIndex.ShippingPrintOutputID } );		
			_shippingPrintOutput = null;
		}

		/// <summary> setups the sync logic for member _shippingPrintOutput</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncShippingPrintOutput(IEntity2 relatedEntity)
		{
			if(_shippingPrintOutput!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _shippingPrintOutput, new PropertyChangedEventHandler( OnShippingPrintOutputPropertyChanged ), "ShippingPrintOutput", ShippingPrintOutputRuleEntity.Relations.ShippingPrintOutputEntityUsingShippingPrintOutputID, true, new string[] {  } );
			}
		}
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'ShippingPrintOutput' 
		...
		public static IPrefetchPathElement2 PrefetchPathShippingPrintOutput
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShippingPrintOutputEntityFactory))),
					(IEntityRelation)GetRelationsForField("ShippingPrintOutput")[0], (int)ShipWorks.Data.Model.EntityType.ShippingPrintOutputRuleEntity, (int)ShipWorks.Data.Model.EntityType.ShippingPrintOutputEntity, 0, null, null, null, null, "ShippingPrintOutput", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return ShippingPrintOutputRuleEntity.CustomProperties;}
		}
		...
		{
			get { return ShippingPrintOutputRuleEntity.FieldsCustomProperties;}
		}
		...
		/// <summary> Gets / sets related entity of type 'ShippingPrintOutputEntity' which has to be set using a fetch action earlier. If no related entity
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_shippingPrintOutput != null)
						{
							_shippingPrintOutput.UnsetRelatedEntity(this, "Rules");
						}
					}
					else
					{
						if(_shippingPrintOutput!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "Rules");
						}
					}
				}
			}
