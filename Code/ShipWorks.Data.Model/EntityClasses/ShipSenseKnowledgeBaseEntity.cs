...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ShipSenseKnowledgebase'.<br/><br/></summary>
	[Serializable]
	public partial class ShipSenseKnowledgebaseEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("Hash", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("Entry", fieldHashtable);
		}
		#endregion
		...
		/// <summary> The Hash property of the Entity ShipSenseKnowledgebase<br/><br/></summary>
		...
		/// <summary> The Entry property of the Entity ShipSenseKnowledgebase<br/><br/></summary>
