...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'NeweggOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class NeweggOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NeweggOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public NeweggOrderItemEntity()
		{
			SetName("NeweggOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public NeweggOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("NeweggOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NeweggOrderItemEntity</param>
		public NeweggOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("NeweggOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for NeweggOrderItem which data should be fetched into this NeweggOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NeweggOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("NeweggOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this NeweggOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NeweggOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("NeweggOrderItemEntity");
		}
		...
		protected NeweggOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((NeweggOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return NeweggOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("NeweggOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NeweggOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NeweggOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(NeweggOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(NeweggOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("NeweggOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new NeweggOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.NeweggOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NeweggOrderItemEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("SellerPartNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("NeweggItemNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ManufacturerPartNumber", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ShippingStatusID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ShippingStatusDescription", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("QuantityShipped", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this NeweggOrderItemEntity</param>
		...
		public new static NeweggOrderItemRelations Relations
		{
			get	{ return new NeweggOrderItemRelations(); }
		}
		...
		{
			get { return NeweggOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return NeweggOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity NeweggOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "NeweggOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)NeweggOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)NeweggOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		public virtual System.String SellerPartNumber
		{
			...
			set	{ SetValue((int)NeweggOrderItemFieldIndex.SellerPartNumber, value); }
		}
		...
		public virtual System.String NeweggItemNumber
		{
			...
			set	{ SetValue((int)NeweggOrderItemFieldIndex.NeweggItemNumber, value); }
		}
		...
		public virtual System.String ManufacturerPartNumber
		{
			...
			set	{ SetValue((int)NeweggOrderItemFieldIndex.ManufacturerPartNumber, value); }
		}
		...
		public virtual Nullable<System.Int32> ShippingStatusID
		{
			...
			set	{ SetValue((int)NeweggOrderItemFieldIndex.ShippingStatusID, value); }
		}
		...
		public virtual System.String ShippingStatusDescription
		{
			...
			set	{ SetValue((int)NeweggOrderItemFieldIndex.ShippingStatusDescription, value); }
		}
		...
		public virtual Nullable<System.Int32> QuantityShipped
		{
			...
			set	{ SetValue((int)NeweggOrderItemFieldIndex.QuantityShipped, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.NeweggOrderItemEntity; }
		}
		#endregion
