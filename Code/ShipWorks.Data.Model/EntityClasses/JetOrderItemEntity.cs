...
namespace ShipWorks.Data.Model.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("JetOrderItemID", fieldHashtable);
		}
		#endregion
		...
		/// <summary> The JetOrderItemID property of the Entity JetOrderItem<br/><br/></summary>
		/// <remarks>Mapped on  table field: "JetOrderItem"."JetOrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String JetOrderItemID
		{
			get { return (System.String)GetValue((int)JetOrderItemFieldIndex.JetOrderItemID, true); }
			set	{ SetValue((int)JetOrderItemFieldIndex.JetOrderItemID, value); }
		}
