...
namespace ShipWorks.Data.Model.EntityClasses
{
			...
			
	{
		...
		static UpsLocalRatingDeliveryAreaSurchargeEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public UpsLocalRatingDeliveryAreaSurchargeEntity():base("UpsLocalRatingDeliveryAreaSurchargeEntity")
		{
		...
		public UpsLocalRatingDeliveryAreaSurchargeEntity(IEntityFields2 fields):base("UpsLocalRatingDeliveryAreaSurchargeEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this UpsLocalRatingDeliveryAreaSurchargeEntity</param>
		public UpsLocalRatingDeliveryAreaSurchargeEntity(IValidator validator):base("UpsLocalRatingDeliveryAreaSurchargeEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="deliveryAreaSurchargeID">PK value for UpsLocalRatingDeliveryAreaSurcharge which data should be fetched into this UpsLocalRatingDeliveryAreaSurcharge object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UpsLocalRatingDeliveryAreaSurchargeEntity(System.Int64 deliveryAreaSurchargeID):base("UpsLocalRatingDeliveryAreaSurchargeEntity")
		{
			InitClassEmpty(null, null);
			this.DeliveryAreaSurchargeID = deliveryAreaSurchargeID;
		}
		...
		/// <param name="validator">The custom validator object for this UpsLocalRatingDeliveryAreaSurchargeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public UpsLocalRatingDeliveryAreaSurchargeEntity(System.Int64 deliveryAreaSurchargeID, IValidator validator):base("UpsLocalRatingDeliveryAreaSurchargeEntity")
		{
			InitClassEmpty(validator, null);
			this.DeliveryAreaSurchargeID = deliveryAreaSurchargeID;
		}
		...
		protected UpsLocalRatingDeliveryAreaSurchargeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((UpsLocalRatingDeliveryAreaSurchargeFieldIndex)fieldIndex)
			{
				case UpsLocalRatingDeliveryAreaSurchargeFieldIndex.ZoneFileID:
		...
		{
			return new UpsLocalRatingDeliveryAreaSurchargeRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(UpsLocalRatingDeliveryAreaSurchargeEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("DeliveryAreaSurchargeID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ZoneFileID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("DestinationZip", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("DeliveryAreaType", fieldHashtable);
		}
		#endregion
		...
		{
			this.PerformDesetupSyncRelatedEntity( _upsLocalRatingZoneFile, new PropertyChangedEventHandler( OnUpsLocalRatingZoneFilePropertyChanged ), "UpsLocalRatingZoneFile", ShipWorks.Data.Model.RelationClasses.StaticUpsLocalRatingDeliveryAreaSurchargeRelations.UpsLocalRatingZoneFileEntityUsingZoneFileIDStatic, true, signalRelatedEntity, "UpsLocalRatingDeliveryAreaSurcharge", resetFKFields, new int[] { (int)UpsLocalRatingDeliveryAreaSurchargeFieldIndex.ZoneFileID } );
		...
		private void SetupSyncUpsLocalRatingZoneFile(IEntityCore relatedEntity)
		{
			if(_upsLocalRatingZoneFile!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _upsLocalRatingZoneFile, new PropertyChangedEventHandler( OnUpsLocalRatingZoneFilePropertyChanged ), "UpsLocalRatingZoneFile", ShipWorks.Data.Model.RelationClasses.StaticUpsLocalRatingDeliveryAreaSurchargeRelations.UpsLocalRatingZoneFileEntityUsingZoneFileIDStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this UpsLocalRatingDeliveryAreaSurchargeEntity</param>
		...
		public  static UpsLocalRatingDeliveryAreaSurchargeRelations Relations
		{
			get	{ return new UpsLocalRatingDeliveryAreaSurchargeRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UpsLocalRatingZoneFileEntityFactory))),	(IEntityRelation)GetRelationsForField("UpsLocalRatingZoneFile")[0], (int)ShipWorks.Data.Model.EntityType.UpsLocalRatingDeliveryAreaSurchargeEntity, (int)ShipWorks.Data.Model.EntityType.UpsLocalRatingZoneFileEntity, 0, null, null, null, null, "UpsLocalRatingZoneFile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The DeliveryAreaSurchargeID property of the Entity UpsLocalRatingDeliveryAreaSurcharge<br/><br/></summary>
		...
		public virtual System.Int64 DeliveryAreaSurchargeID
		{
			...
			set	{ SetValue((int)UpsLocalRatingDeliveryAreaSurchargeFieldIndex.DeliveryAreaSurchargeID, value); }
		}

		/// <summary> The ZoneFileID property of the Entity UpsLocalRatingDeliveryAreaSurcharge<br/><br/></summary>
		...
		public virtual System.Int64 ZoneFileID
		{
			...
			set	{ SetValue((int)UpsLocalRatingDeliveryAreaSurchargeFieldIndex.ZoneFileID, value); }
		}
		...
		/// <summary> The DeliveryAreaType property of the Entity UpsLocalRatingDeliveryAreaSurcharge<br/><br/></summary>
		...
		public virtual System.Int32 DeliveryAreaType
		{
			...
			set	{ SetValue((int)UpsLocalRatingDeliveryAreaSurchargeFieldIndex.DeliveryAreaType, value); }
		}
		...
		public virtual UpsLocalRatingZoneFileEntity UpsLocalRatingZoneFile
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "UpsLocalRatingDeliveryAreaSurcharge", "UpsLocalRatingZoneFile", _upsLocalRatingZoneFile, true); 
				}
			}
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.UpsLocalRatingDeliveryAreaSurchargeEntity; }
		}
