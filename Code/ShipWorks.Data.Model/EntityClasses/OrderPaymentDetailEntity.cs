...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'OrderPaymentDetail'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class OrderPaymentDetailEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return OrderPaymentDetailEntity.GetRelationsForField(fieldName);
		}
		...
		public static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Order":
					toReturn.Add(OrderPaymentDetailEntity.Relations.OrderEntityUsingOrderID);
					break;
		...
		public bool TestOriginalFieldValueForNull(OrderPaymentDetailFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(OrderPaymentDetailFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.OrderPaymentDetailEntity);
		}
		...
		{
			base.PerformDesetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", OrderPaymentDetailEntity.Relations.OrderEntityUsingOrderID, true, signalRelatedEntity, "OrderPaymentDetails", resetFKFields, new int[] { (int)OrderPaymentDetailFieldIndex.OrderID } );		
			_order = null;
		}
		...
		private void SetupSyncOrder(IEntity2 relatedEntity)
		{
			if(_order!=relatedEntity)
			{
				...
				base.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", OrderPaymentDetailEntity.Relations.OrderEntityUsingOrderID, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathOrder
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))),
					(IEntityRelation)GetRelationsForField("Order")[0], (int)ShipWorks.Data.Model.EntityType.OrderPaymentDetailEntity, (int)ShipWorks.Data.Model.EntityType.OrderEntity, 0, null, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return OrderPaymentDetailEntity.CustomProperties;}
		}
		...
		{
			get { return OrderPaymentDetailEntity.FieldsCustomProperties;}
		}
			...
			set
			{
				...
				else
				{
					if(value==null)
					{
						if(_order != null)
						{
							_order.UnsetRelatedEntity(this, "OrderPaymentDetails");
						}
					}
					else
					{
						if(_order!=value)
						{
							((IEntity2)value).SetRelatedEntity(this, "OrderPaymentDetails");
						}
					}
				}
			}
