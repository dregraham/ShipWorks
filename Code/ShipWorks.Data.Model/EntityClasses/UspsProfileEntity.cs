...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'UspsProfile'.<br/><br/></summary>
	[Serializable]
	public partial class UspsProfileEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _postalProfile, new PropertyChangedEventHandler( OnPostalProfilePropertyChanged ), "PostalProfile", ShipWorks.Data.Model.RelationClasses.StaticUspsProfileRelations.PostalProfileEntityUsingShippingProfileIDStatic, true, signalRelatedEntity, "Usps", false, new int[] { (int)UspsProfileFieldIndex.ShippingProfileID } );
			_postalProfile = null;
		}
		...
		private void SetupSyncPostalProfile(IEntityCore relatedEntity)
		{
			if(_postalProfile!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _postalProfile, new PropertyChangedEventHandler( OnPostalProfilePropertyChanged ), "PostalProfile", ShipWorks.Data.Model.RelationClasses.StaticUspsProfileRelations.PostalProfileEntityUsingShippingProfileIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PostalProfileEntityFactory))), (IEntityRelation)GetRelationsForField("PostalProfile")[0], (int)ShipWorks.Data.Model.EntityType.UspsProfileEntity, (int)ShipWorks.Data.Model.EntityType.PostalProfileEntity, 0, null, null, null, null, "PostalProfile", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The ShippingProfileID property of the Entity UspsProfile<br/><br/></summary>
		...
		/// <summary> The UspsAccountID property of the Entity UspsProfile<br/><br/></summary>
		...
		/// <summary> The HidePostage property of the Entity UspsProfile<br/><br/></summary>
		...
		/// <summary> The RequireFullAddressValidation property of the Entity UspsProfile<br/><br/></summary>
		...
		/// <summary> The RateShop property of the Entity UspsProfile<br/><br/></summary>
