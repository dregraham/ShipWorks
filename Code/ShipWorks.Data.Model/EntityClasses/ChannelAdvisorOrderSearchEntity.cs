		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			switch((ChannelAdvisorOrderSearchFieldIndex)fieldIndex)
			{
				case ChannelAdvisorOrderSearchFieldIndex.OrderID:
					...
					break;
				case ChannelAdvisorOrderSearchFieldIndex.StoreID:
		...
		private void SetupSyncStore(IEntityCore relatedEntity)
		{
			if(_store!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", ShipWorks.Data.Model.RelationClasses.StaticChannelAdvisorOrderSearchRelations.StoreEntityUsingStoreIDStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))),	(IEntityRelation)GetRelationsForField("Store")[0], (int)ShipWorks.Data.Model.EntityType.ChannelAdvisorOrderSearchEntity, (int)ShipWorks.Data.Model.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The StoreID property of the Entity ChannelAdvisorOrderSearch<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ChannelAdvisorOrderSearch"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)ChannelAdvisorOrderSearchFieldIndex.StoreID, true); }
			set	{ SetValue((int)ChannelAdvisorOrderSearchFieldIndex.StoreID, value); }
		}

		/// <summary> The OrderNumber property of the Entity ChannelAdvisorOrderSearch<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ChannelAdvisorOrderSearch"."OrderNumber"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 OrderNumber
		{
			get { return (System.Int64)GetValue((int)ChannelAdvisorOrderSearchFieldIndex.OrderNumber, true); }
			set	{ SetValue((int)ChannelAdvisorOrderSearchFieldIndex.OrderNumber, value); }
		}

		/// <summary> The OrderNumberComplete property of the Entity ChannelAdvisorOrderSearch<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)ChannelAdvisorOrderSearchFieldIndex.OrderNumberComplete, true); }
			set	{ SetValue((int)ChannelAdvisorOrderSearchFieldIndex.OrderNumberComplete, value); }
		}
		...
		public virtual StoreEntity Store
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ChannelAdvisorOrderSearch", "Store", _store, true); 
				}
			}
		}
