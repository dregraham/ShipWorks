...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'BuyDotComOrderItem'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class BuyDotComOrderItemEntity : OrderItemEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static BuyDotComOrderItemEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public BuyDotComOrderItemEntity()
		{
			SetName("BuyDotComOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public BuyDotComOrderItemEntity(IEntityFields2 fields):base(fields)
		{
			SetName("BuyDotComOrderItemEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BuyDotComOrderItemEntity</param>
		public BuyDotComOrderItemEntity(IValidator validator):base(validator)
		{
			SetName("BuyDotComOrderItemEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderItemID">PK value for BuyDotComOrderItem which data should be fetched into this BuyDotComOrderItem object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BuyDotComOrderItemEntity(System.Int64 orderItemID):base(orderItemID)
		{
			SetName("BuyDotComOrderItemEntity");
		}
		...
		/// <param name="validator">The custom validator object for this BuyDotComOrderItemEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BuyDotComOrderItemEntity(System.Int64 orderItemID, IValidator validator):base(orderItemID, validator)
		{
			SetName("BuyDotComOrderItemEntity");
		}
		...
		protected BuyDotComOrderItemEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((BuyDotComOrderItemFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return BuyDotComOrderItemEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("BuyDotComOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("BuyDotComOrderItemEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("BuyDotComOrderItemEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(BuyDotComOrderItemFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(BuyDotComOrderItemFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("BuyDotComOrderItemEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new BuyDotComOrderItemRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.BuyDotComOrderItemEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BuyDotComOrderItemEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("ReceiptItemID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("ListingID", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();

			_fieldsCustomProperties.Add("Shipping", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this BuyDotComOrderItemEntity</param>
		...
		public new static BuyDotComOrderItemRelations Relations
		{
			get	{ return new BuyDotComOrderItemRelations(); }
		}
		...
		{
			get { return BuyDotComOrderItemEntity.CustomProperties;}
		}
		...
		{
			get { return BuyDotComOrderItemEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderItemID property of the Entity BuyDotComOrderItem<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "BuyDotComOrderItem"."OrderItemID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderItemID
		{
			get { return (System.Int64)GetValue((int)BuyDotComOrderItemFieldIndex.OrderItemID, true); }
			set	{ SetValue((int)BuyDotComOrderItemFieldIndex.OrderItemID, value); }
		}
		...
		public virtual System.Int32 ListingID
		{
			...
			set	{ SetValue((int)BuyDotComOrderItemFieldIndex.ListingID, value); }
		}
		...
		public virtual System.Decimal Shipping
		{
			...
			set	{ SetValue((int)BuyDotComOrderItemFieldIndex.Shipping, value); }
		}
		...
		public virtual System.Decimal Tax
		{
			...
			set	{ SetValue((int)BuyDotComOrderItemFieldIndex.Tax, value); }
		}
		...
		public virtual System.Decimal Commission
		{
			...
			set	{ SetValue((int)BuyDotComOrderItemFieldIndex.Commission, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.BuyDotComOrderItemEntity; }
		}
		#endregion
