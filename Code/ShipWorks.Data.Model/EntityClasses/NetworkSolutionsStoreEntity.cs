...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'NetworkSolutionsStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class NetworkSolutionsStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NetworkSolutionsStoreEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public NetworkSolutionsStoreEntity()
		{
			SetName("NetworkSolutionsStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public NetworkSolutionsStoreEntity(IEntityFields2 fields):base(fields)
		{
			SetName("NetworkSolutionsStoreEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NetworkSolutionsStoreEntity</param>
		public NetworkSolutionsStoreEntity(IValidator validator):base(validator)
		{
			SetName("NetworkSolutionsStoreEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="storeID">PK value for NetworkSolutionsStore which data should be fetched into this NetworkSolutionsStore object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NetworkSolutionsStoreEntity(System.Int64 storeID):base(storeID)
		{
			SetName("NetworkSolutionsStoreEntity");
		}
		...
		/// <param name="validator">The custom validator object for this NetworkSolutionsStoreEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NetworkSolutionsStoreEntity(System.Int64 storeID, IValidator validator):base(storeID, validator)
		{
			SetName("NetworkSolutionsStoreEntity");
		}
		...
		protected NetworkSolutionsStoreEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((NetworkSolutionsStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return NetworkSolutionsStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("NetworkSolutionsStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NetworkSolutionsStoreEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("NetworkSolutionsStoreEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(NetworkSolutionsStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(NetworkSolutionsStoreFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("NetworkSolutionsStoreEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new NetworkSolutionsStoreRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.NetworkSolutionsStoreEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NetworkSolutionsStoreEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("UserToken", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this NetworkSolutionsStoreEntity</param>
		...
		public new static NetworkSolutionsStoreRelations Relations
		{
			get	{ return new NetworkSolutionsStoreRelations(); }
		}
		...
		{
			get { return NetworkSolutionsStoreEntity.CustomProperties;}
		}
		...
		{
			get { return NetworkSolutionsStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity NetworkSolutionsStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "NetworkSolutionsStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)NetworkSolutionsStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)NetworkSolutionsStoreFieldIndex.StoreID, value); }
		}
		...
		public virtual System.String UserToken
		{
			...
			set	{ SetValue((int)NetworkSolutionsStoreFieldIndex.UserToken, value); }
		}
		...
		public virtual System.String DownloadOrderStatuses
		{
			...
			set	{ SetValue((int)NetworkSolutionsStoreFieldIndex.DownloadOrderStatuses, value); }
		}
		...
		public virtual System.String StatusCodes
		{
			...
			set	{ SetValue((int)NetworkSolutionsStoreFieldIndex.StatusCodes, value); }
		}
		...
		public virtual System.String StoreUrl
		{
			...
			set	{ SetValue((int)NetworkSolutionsStoreFieldIndex.StoreUrl, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.NetworkSolutionsStoreEntity; }
		}
		#endregion
