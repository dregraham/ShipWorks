...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'WorldShipProcessed'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class WorldShipProcessedEntity : CommonEntityBase, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return WorldShipProcessedEntity.GetRelationsForField(fieldName);
		}
		...
		public bool TestOriginalFieldValueForNull(WorldShipProcessedFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(WorldShipProcessedFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.WorldShipProcessedEntity);
		}
		...
		public static IPrefetchPathElement2 PrefetchPathWorldShipShipment
		{
			get
			{
				return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(WorldShipShipmentEntityFactory))),
					(IEntityRelation)GetRelationsForField("WorldShipShipment")[0], (int)ShipWorks.Data.Model.EntityType.WorldShipProcessedEntity, (int)ShipWorks.Data.Model.EntityType.WorldShipShipmentEntity, 0, null, null, null, null, "WorldShipShipment", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne);
			}
		}
		...
		{
			get { return WorldShipProcessedEntity.CustomProperties;}
		}
		...
		{
			get { return WorldShipProcessedEntity.FieldsCustomProperties;}
		}
