...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'ChannelAdvisorStore'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class ChannelAdvisorStoreEntity : StoreEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			switch((ChannelAdvisorStoreFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return ChannelAdvisorStoreEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ChannelAdvisorStoreEntity", false);
		}
		...
		public bool TestOriginalFieldValueForNull(ChannelAdvisorStoreFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(ChannelAdvisorStoreFieldIndex fieldIndex)
		{
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.ChannelAdvisorStoreEntity);
		}
		...
		{
			get { return ChannelAdvisorStoreEntity.CustomProperties;}
		}
		...
		{
			get { return ChannelAdvisorStoreEntity.FieldsCustomProperties;}
		}

		/// <summary> The StoreID property of the Entity ChannelAdvisorStore<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "ChannelAdvisorStore"."StoreID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 StoreID
		{
			get { return (System.Int64)GetValue((int)ChannelAdvisorStoreFieldIndex.StoreID, true); }
			set	{ SetValue((int)ChannelAdvisorStoreFieldIndex.StoreID, value); }
		}
