...
namespace ShipWorks.Data.Model.EntityClasses
{
	...
	/// <summary>
	/// Entity class which represents the entity 'YahooOrder'.<br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class YahooOrderEntity : OrderEntity, ISerializable
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static YahooOrderEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary> CTor</summary>
		public YahooOrderEntity()
		{
			SetName("YahooOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <remarks>For framework usage.</remarks>
		/// <param name="fields">Fields object to set as the fields for this entity.</param>
		public YahooOrderEntity(IEntityFields2 fields):base(fields)
		{
			SetName("YahooOrderEntity");
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this YahooOrderEntity</param>
		public YahooOrderEntity(IValidator validator):base(validator)
		{
			SetName("YahooOrderEntity");
		}
		...
		/// <summary> CTor</summary>
		/// <param name="orderID">PK value for YahooOrder which data should be fetched into this YahooOrder object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public YahooOrderEntity(System.Int64 orderID):base(orderID)
		{
			SetName("YahooOrderEntity");
		}
		...
		/// <param name="validator">The custom validator object for this YahooOrderEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public YahooOrderEntity(System.Int64 orderID, IValidator validator):base(orderID, validator)
		{
			SetName("YahooOrderEntity");
		}
		...
		protected YahooOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((YahooOrderFieldIndex)fieldIndex)
			{
				default:
		...
		{
			return YahooOrderEntity.GetRelationsForField(fieldName);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("YahooOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("YahooOrderEntity", false);
		}
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("YahooOrderEntity", negate);
		}
		...
		public bool TestOriginalFieldValueForNull(YahooOrderFieldIndex fieldIndex)
		{
		...
		public bool TestCurrentFieldValueForNull(YahooOrderFieldIndex fieldIndex)
		{
		...
		{
			return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("YahooOrderEntity", ((ShipWorks.Data.Model.EntityType)typeOfEntity).ToString());
		}
		...
		{
			return new YahooOrderRelations().GetAllRelations();
		}
		...
		{
			return EntityFieldsFactory.CreateEntityFieldsObject(ShipWorks.Data.Model.EntityType.YahooOrderEntity);
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(YahooOrderEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("YahooOrderID", fieldHashtable);
		}
		#endregion
		...
		/// <param name="validator">The validator object for this YahooOrderEntity</param>
		...
		public new static YahooOrderRelations Relations
		{
			get	{ return new YahooOrderRelations(); }
		}
		...
		{
			get { return YahooOrderEntity.CustomProperties;}
		}
		...
		{
			get { return YahooOrderEntity.FieldsCustomProperties;}
		}

		/// <summary> The OrderID property of the Entity YahooOrder<br/><br/>
		/// </summary>
		/// <remarks>Mapped on  table field: "YahooOrder"."OrderID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public override System.Int64 OrderID
		{
			get { return (System.Int64)GetValue((int)YahooOrderFieldIndex.OrderID, true); }
			set	{ SetValue((int)YahooOrderFieldIndex.OrderID, value); }
		}
		...
		public virtual System.String YahooOrderID
		{
			get { return (System.String)GetValue((int)YahooOrderFieldIndex.YahooOrderID, true); }
			set	{ SetValue((int)YahooOrderFieldIndex.YahooOrderID, value); }
		}
		...
		{ 
			get { return (int)ShipWorks.Data.Model.EntityType.YahooOrderEntity; }
		}
		#endregion
