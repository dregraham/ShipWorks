...
{
    /// <summary>
    /// Read-only representation of the entity 'LemonStandStore'. <br/><br/>
    /// 
    /// </summary>
    [Serializable]
    public partial class ReadOnlyLemonStandStoreEntity : ReadOnlyStoreEntity, ILemonStandStoreEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public ILemonStandStoreEntity AsReadOnlyLemonStandStore() => this;

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public ILemonStandStoreEntity AsReadOnlyLemonStandStore(IDictionary<object, object> objectMap) => this;
