...
{
    /// <summary>
    /// Read-only representation of the entity 'GridColumnLayout'. <br/><br/>
    /// 
    /// </summary>
    [Serializable]
    public partial class ReadOnlyGridColumnLayoutEntity : IGridColumnLayoutEntity
    {
        ...
        internal ReadOnlyGridColumnLayoutEntity(IGridColumnLayoutEntity source, IDictionary<object, object> objectMap)
        {
            ...
            GridColumnPositions = source.GridColumnPositions?.Select(x => x.AsReadOnly(objectMap)).OfType<IGridColumnPositionEntity>().ToReadOnly() ??
