...
namespace ShipWorks.Data.Model.ReadOnlyEntityClasses
{
    ...
    public partial class ReadOnlyAmazonStoreEntity : ReadOnlyStoreEntity, IAmazonStoreEntity
    {
        ...
        internal ReadOnlyAmazonStoreEntity(IAmazonStoreEntity source, IDictionary<object, object> objectMap) : base(source, objectMap)
        {
            ...
            AmazonVATS = source.AmazonVATS;
            MaxOrderDatePreMigration = source.MaxOrderDatePreMigration;
        ...
        /// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        public System.Boolean AmazonVATS { get; }
        ...
        /// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
        /// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        public Nullable<System.DateTime> MaxOrderDatePreMigration { get; }
        ...
        /// Get a read only version of the entity
        /// </summary>
        public IAmazonStoreEntity AsReadOnlyAmazonStore() => this;

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public IAmazonStoreEntity AsReadOnlyAmazonStore(IDictionary<object, object> objectMap) => this;
