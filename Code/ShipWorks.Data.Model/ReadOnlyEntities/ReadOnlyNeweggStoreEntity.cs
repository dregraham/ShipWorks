...
{
    /// <summary>
    /// Read-only representation of the entity 'NeweggStore'. <br/><br/>
    /// 
    /// </summary>
    [Serializable]
    public partial class ReadOnlyNeweggStoreEntity : ReadOnlyStoreEntity, INeweggStoreEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public INeweggStoreEntity AsReadOnlyNeweggStore() => this;

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public INeweggStoreEntity AsReadOnlyNeweggStore(IDictionary<object, object> objectMap) => this;
