...
{
    /// <summary>
    /// Read-only representation of the entity 'NetworkSolutionsStore'. <br/><br/>
    /// 
    /// </summary>
    [Serializable]
    public partial class ReadOnlyNetworkSolutionsStoreEntity : ReadOnlyStoreEntity, INetworkSolutionsStoreEntity
    {
        ...
        /// Get a read only version of the entity
        /// </summary>
        public INetworkSolutionsStoreEntity AsReadOnlyNetworkSolutionsStore() => this;

        /// <summary>
        /// Get a read only version of the entity that handles cyclic references
        /// </summary>
        public INetworkSolutionsStoreEntity AsReadOnlyNetworkSolutionsStore(IDictionary<object, object> objectMap) => this;
