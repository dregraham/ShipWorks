...
{
    /// <summary>
    /// Read-only representation of the entity 'EtsyOrderSearch'. <br/><br/>
    /// 
    /// </summary>
    [Serializable]
    public partial class ReadOnlyEtsyOrderSearchEntity : IEtsyOrderSearchEntity
    {
        /// <summary>
        /// Constructor
        /// </summary>
        internal ReadOnlyEtsyOrderSearchEntity(IEtsyOrderSearchEntity source, IDictionary<object, object> objectMap)
        {
            ...
            EtsyOrderSearchID = source.EtsyOrderSearchID;
            ...
            EtsyOrder = source.EtsyOrder?.AsReadOnly(objectMap);
            Store = source.Store?.AsReadOnly(objectMap);
            

            CopyCustomEtsyOrderSearchData(source);
        }
        ...
        public System.Int64 EtsyOrderSearchID { get; }
        ...
        public IEtsyOrderEntity EtsyOrder { get; }
        ...
        /// </summary>
        public virtual IEtsyOrderSearchEntity AsReadOnly() => this;

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        public virtual IEtsyOrderSearchEntity AsReadOnly(IDictionary<object, object> objectMap) => this;

        /// <summary>
        /// Copy any custom data
        /// </summary>
        partial void CopyCustomEtsyOrderSearchData(IEtsyOrderSearchEntity source);
    }
}
