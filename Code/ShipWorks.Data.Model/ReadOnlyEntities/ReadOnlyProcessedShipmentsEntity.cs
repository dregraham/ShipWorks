...
{
    /// <summary>
    /// Read-only representation of the entity 'ProcessedShipments'. <br/><br/>
    /// 
    /// </summary>
    [Serializable]
    public partial class ReadOnlyProcessedShipmentsEntity : IProcessedShipmentsEntity
    {
        /// <summary>
        /// Constructor
        /// </summary>
        internal ReadOnlyProcessedShipmentsEntity(IProcessedShipmentsEntity source, IDictionary<object, object> objectMap)
        {
            ...
            CopyCustomProcessedShipmentsData(source);
        }

        
        /// <summary> The ShipmentID property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The ShipmentType property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The ShipDate property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The Insurance property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The InsuranceProvider property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        /// <remarks>Mapped on view field: "ProcessedShipmentsView"."InsuranceProvider"<br/>
        /// View field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
        /// View field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        public System.Int32 InsuranceProvider { get; }
        /// <summary> The ProcessedDate property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The ProcessedUserID property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        /// <remarks>Mapped on view field: "ProcessedShipmentsView"."ProcessedUserID"<br/>
        /// View field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
        /// View field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
        public Nullable<System.Int64> ProcessedUserID { get; }
        /// <summary> The ProcessedComputerID property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The TrackingNumber property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The ShipmentCost property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The ShipSenseStatus property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        /// <remarks>Mapped on view field: "ProcessedShipmentsView"."ShipSenseStatus"<br/>
        /// View field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
        /// View field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        public System.Int32 ShipSenseStatus { get; }
        /// <summary> The ShipAddressValidationStatus property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The ShipResidentialStatus property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// <summary> The OrderID property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        /// <remarks>Mapped on view field: "ProcessedShipmentsView"."OrderID"<br/>
        /// View field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
        /// View field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        public System.Int64 OrderID { get; }
        /// <summary> The OrderNumberComplete property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        /// <remarks>Mapped on view field: "ProcessedShipmentsView"."OrderNumberComplete"<br/>
        /// View field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
        /// View field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
        public System.String OrderNumberComplete { get; }
        /// <summary> The Service property of the Entity ProcessedShipments<br/><br/>
        /// </summary>
        ...
        /// </summary>
        public virtual IProcessedShipmentsEntity AsReadOnly() => this;

        /// <summary>
        /// Get a read only version of the entity
        /// </summary>
        public virtual IProcessedShipmentsEntity AsReadOnly(IDictionary<object, object> objectMap) => this;
        ...
        /// </summary>
        partial void CopyCustomProcessedShipmentsData(IProcessedShipmentsEntity source);
    }
}
