...
namespace ShipWorks.Data.Model.HelperClasses
{
	...
	internal class InheritanceInfoProviderCore : InheritanceInfoProviderBase
	{
		...
		private void Init()
		{
			base.AddEntityInfo("AmazonOrderEntity", "OrderEntity", new AmazonOrderRelations(), new AmazonOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("ChannelAdvisorOrderEntity", "OrderEntity", new ChannelAdvisorOrderRelations(), new ChannelAdvisorOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("ClickCartProOrderEntity", "OrderEntity", new ClickCartProOrderRelations(), new ClickCartProOrderEntityFactory(),  (64-64));
			base.AddEntityInfo("CommerceInterfaceOrderEntity", "OrderEntity", new CommerceInterfaceOrderRelations(), new CommerceInterfaceOrderEntityFactory(),  (64-64));
			base.AddEntityInfo("EbayOrderEntity", "OrderEntity", new EbayOrderRelations(), new EbayOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("EtsyOrderEntity", "OrderEntity", new EtsyOrderRelations(), new EtsyOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("MagentoOrderEntity", "OrderEntity", new MagentoOrderRelations(), new MagentoOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("MarketplaceAdvisorOrderEntity", "OrderEntity", new MarketplaceAdvisorOrderRelations(), new MarketplaceAdvisorOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("NetworkSolutionsOrderEntity", "OrderEntity", new NetworkSolutionsOrderRelations(), new NetworkSolutionsOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("NeweggOrderEntity", "OrderEntity", new NeweggOrderRelations(), new NeweggOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("OrderMotionOrderEntity", "OrderEntity", new OrderMotionOrderRelations(), new OrderMotionOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("PayPalOrderEntity", "OrderEntity", new PayPalOrderRelations(), new PayPalOrderEntityFactory(),  (64-64));
			base.AddEntityInfo("PayPalStoreEntity", "StoreEntity", new PayPalStoreRelations(), new PayPalStoreEntityFactory(),  (30-30));
			base.AddEntityInfo("ProStoresOrderEntity", "OrderEntity", new ProStoresOrderRelations(), new ProStoresOrderEntityFactory(),  (64-64));
			base.AddEntityInfo("ProStoresStoreEntity", "StoreEntity", new ProStoresStoreRelations(), new ProStoresStoreEntityFactory(),  (30-30));
			base.AddEntityInfo("SearsOrderEntity", "OrderEntity", new SearsOrderRelations(), new SearsOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("ShopifyOrderEntity", "OrderEntity", new ShopifyOrderRelations(), new ShopifyOrderEntityFactory(),  (64-64));
			...
			base.AddEntityInfo("YahooOrderEntity", "OrderEntity", new YahooOrderRelations(), new YahooOrderEntityFactory(),  (64-64));
