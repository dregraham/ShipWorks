...
{
	/// <summary>Implements the static Relations variant for the entity: ProStoresStore. </summary>
	public partial class ProStoresStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ProStoresStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ProStoresStore.StoreID - Store.StoreID
		/// </summary>
