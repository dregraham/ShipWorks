...
namespace ShipWorks.Data.Model.RelationClasses
{
	...
	public partial class ProStoresStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ProStoresStoreEntity and OrderSearchEntity over the 1:n relation they have, using the relation between the fields:
		/// ProStoresStore.StoreID - OrderSearch.StoreID
		/// </summary>
		public override IEntityRelation OrderSearchEntityUsingStoreID
		{
			get
			{
				...
				relation.AddEntityFieldPair(ProStoresStoreFields.StoreID, OrderSearchFields.StoreID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ProStoresStoreEntity", true);
	...
	internal static class StaticProStoresStoreRelations
	{
		...
		internal static readonly IEntityRelation OrderSearchEntityUsingStoreIDStatic = new ProStoresStoreRelations().OrderSearchEntityUsingStoreID;
