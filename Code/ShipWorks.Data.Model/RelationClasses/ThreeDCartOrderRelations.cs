...
{
	/// <summary>Implements the static Relations variant for the entity: ThreeDCartOrder. </summary>
	public partial class ThreeDCartOrderRelations : OrderRelations
	{
		...
		/// ThreeDCartOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(ThreeDCartOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between ThreeDCartOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ThreeDCartOrder.OrderID - Order.OrderID
		/// </summary>
