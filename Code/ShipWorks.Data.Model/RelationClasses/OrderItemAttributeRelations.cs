...
{
	/// <summary>Implements the static Relations variant for the entity: OrderItemAttribute. </summary>
	public partial class OrderItemAttributeRelations : IRelationFactory
	{
		...
		/// <summary>Returns a new IEntityRelation object, between OrderItemAttributeEntity and MivaOrderItemAttributeEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// OrderItemAttribute.OrderItemAttributeID - MivaOrderItemAttribute.OrderItemAttributeID
		/// </summary>
