...
{
	/// <summary>Implements the relations factory for the entity: EmailOutboundRelation. </summary>
	...
	internal static class StaticEmailOutboundRelationRelations
	{
		internal static readonly IEntityRelation EmailOutboundEntityUsingEmailOutboundIDStatic = new EmailOutboundRelationRelations().EmailOutboundEntityUsingEmailOutboundID;

		/// <summary>CTor</summary>
		static StaticEmailOutboundRelationRelations()
		{
		}
	}
}
