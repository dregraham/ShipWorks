...
{
	/// <summary>Implements the static Relations variant for the entity: LemonStandStore. </summary>
	public partial class LemonStandStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between LemonStandStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// LemonStandStore.StoreID - Store.StoreID
		/// </summary>
