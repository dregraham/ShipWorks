...
{
	/// <summary>Implements the static Relations variant for the entity: YahooOrder. </summary>
	public partial class YahooOrderRelations : OrderRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between YahooOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// YahooOrder.OrderID - Order.OrderID
		/// </summary>
