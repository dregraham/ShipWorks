...
{
	/// <summary>Implements the static Relations variant for the entity: NeweggStore. </summary>
	public partial class NeweggStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between NeweggStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// NeweggStore.StoreID - Store.StoreID
		/// </summary>
