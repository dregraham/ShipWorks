...
namespace ShipWorks.Data.Model.RelationClasses
{
	...
	public partial class NetworkSolutionsOrderSearchRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between NetworkSolutionsOrderSearchEntity and StoreEntity over the m:1 relation they have, using the relation between the fields:
		/// NetworkSolutionsOrderSearch.StoreID - Store.StoreID
		/// </summary>
	...
	internal static class StaticNetworkSolutionsOrderSearchRelations
	{
		...
		internal static readonly IEntityRelation StoreEntityUsingStoreIDStatic = new NetworkSolutionsOrderSearchRelations().StoreEntityUsingStoreID;
