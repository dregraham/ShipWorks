...
{
	/// <summary>Implements the static Relations variant for the entity: SearsOrder. </summary>
	public partial class SearsOrderRelations : OrderRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// SearsOrder.OrderID - Order.OrderID
		/// </summary>
