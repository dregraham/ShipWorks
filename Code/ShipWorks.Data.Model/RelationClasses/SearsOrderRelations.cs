...
{
	/// <summary>Implements the relations factory for the entity: SearsOrder. </summary>
	public partial class SearsOrderRelations : OrderRelations
	{
		/// <summary>CTor</summary>
		public SearsOrderRelations()
		{
		}

		/// <summary>Gets all relations of the SearsOrderEntity as a list of IEntityRelation objects.</summary>
		/// <returns>a list of IEntityRelation objects</returns>
		public override List<IEntityRelation> GetAllRelations()
		{
			List<IEntityRelation> toReturn = base.GetAllRelations();
			toReturn.Add(this.SearsOrderSearchEntityUsingOrderID);
			return toReturn;
		}
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and OrderChargeEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - OrderCharge.OrderID
		/// </summary>
		public override IEntityRelation OrderChargeEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, OrderChargeFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and OrderItemEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - OrderItem.OrderID
		/// </summary>
		public override IEntityRelation OrderItemEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, OrderItemFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and OrderPaymentDetailEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - OrderPaymentDetail.OrderID
		/// </summary>
		public override IEntityRelation OrderPaymentDetailEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, OrderPaymentDetailFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and OrderSearchEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - OrderSearch.OrderID
		/// </summary>
		public override IEntityRelation OrderSearchEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, OrderSearchFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and SearsOrderSearchEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - SearsOrderSearch.OrderID
		/// </summary>
		public virtual IEntityRelation SearsOrderSearchEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, SearsOrderSearchFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and ShipmentEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - Shipment.OrderID
		/// </summary>
		public override IEntityRelation ShipmentEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, ShipmentFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and ValidatedAddressEntity over the 1:n relation they have, using the relation between the fields:
		/// SearsOrder.OrderID - ValidatedAddress.ConsumerID
		/// </summary>
		public override IEntityRelation ValidatedAddressEntityUsingConsumerID
		{
			get
			{
				...
				relation.AddEntityFieldPair(SearsOrderFields.OrderID, ValidatedAddressFields.ConsumerID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and CustomerEntity over the m:1 relation they have, using the relation between the fields:
		/// SearsOrder.CustomerID - Customer.CustomerID
		/// </summary>
		public override IEntityRelation CustomerEntityUsingCustomerID
		{
			get
			{
				...
				relation.AddEntityFieldPair(CustomerFields.CustomerID, SearsOrderFields.CustomerID);
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("SearsOrderEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and StoreEntity over the m:1 relation they have, using the relation between the fields:
		/// SearsOrder.StoreID - Store.StoreID
		/// </summary>
		public override IEntityRelation StoreEntityUsingStoreID
		{
			get
			{
				...
				relation.AddEntityFieldPair(StoreFields.StoreID, SearsOrderFields.StoreID);
		...
		/// <summary>Returns a new IEntityRelation object, between SearsOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy</summary>
	...
	internal static class StaticSearsOrderRelations
	{
		...
		internal static readonly IEntityRelation OrderSearchEntityUsingOrderIDStatic = new SearsOrderRelations().OrderSearchEntityUsingOrderID;
		internal static readonly IEntityRelation SearsOrderSearchEntityUsingOrderIDStatic = new SearsOrderRelations().SearsOrderSearchEntityUsingOrderID;
		internal static readonly IEntityRelation ShipmentEntityUsingOrderIDStatic = new SearsOrderRelations().ShipmentEntityUsingOrderID;
		internal static readonly IEntityRelation ValidatedAddressEntityUsingConsumerIDStatic = new SearsOrderRelations().ValidatedAddressEntityUsingConsumerID;
		internal static readonly IEntityRelation CustomerEntityUsingCustomerIDStatic = new SearsOrderRelations().CustomerEntityUsingCustomerID;
		internal static readonly IEntityRelation StoreEntityUsingStoreIDStatic = new SearsOrderRelations().StoreEntityUsingStoreID;

		/// <summary>CTor</summary>
		static StaticSearsOrderRelations()
		{
		}
	}
}
