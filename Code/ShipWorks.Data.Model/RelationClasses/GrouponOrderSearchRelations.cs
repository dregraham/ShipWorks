...
{
	/// <summary>Implements the relations factory for the entity: GrouponOrderSearch. </summary>
	public partial class GrouponOrderSearchRelations
	{
		/// <summary>CTor</summary>
		public GrouponOrderSearchRelations()
		{
		}

		/// <summary>Gets all relations of the GrouponOrderSearchEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between GrouponOrderSearchEntity and GrouponOrderEntity over the m:1 relation they have, using the relation between the fields:
		/// GrouponOrderSearch.OrderID - GrouponOrder.OrderID
		/// </summary>
		public virtual IEntityRelation GrouponOrderEntityUsingOrderID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne, "GrouponOrder", false);
				relation.AddEntityFieldPair(GrouponOrderFields.OrderID, GrouponOrderSearchFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("GrouponOrderEntity", false);
