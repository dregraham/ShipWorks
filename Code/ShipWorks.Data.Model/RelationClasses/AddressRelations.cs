...
namespace ShipWorks.Data.Model.RelationClasses
{
	...
	public partial class AddressRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.ValidatedAddressEntityUsingAddressID);
		...
		/// <summary>Returns a new IEntityRelation object, between AddressEntity and ValidatedAddressEntity over the 1:n relation they have, using the relation between the fields:
		/// Address.AddressID - ValidatedAddress.AddressID
		/// </summary>
		public virtual IEntityRelation ValidatedAddressEntityUsingAddressID
		{
			get
			{
