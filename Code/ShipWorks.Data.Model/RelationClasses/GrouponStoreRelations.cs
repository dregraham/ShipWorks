...
{
	/// <summary>Implements the static Relations variant for the entity: GrouponStore. </summary>
	public partial class GrouponStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between GrouponStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// GrouponStore.StoreID - Store.StoreID
		/// </summary>
