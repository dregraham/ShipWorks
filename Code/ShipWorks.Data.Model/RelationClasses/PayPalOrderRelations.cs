...
{
	/// <summary>Implements the static Relations variant for the entity: PayPalOrder. </summary>
	public partial class PayPalOrderRelations : OrderRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between PayPalOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// PayPalOrder.OrderID - Order.OrderID
		/// </summary>
