...
{
	/// <summary>Implements the static Relations variant for the entity: CommerceInterfaceOrder. </summary>
	public partial class CommerceInterfaceOrderRelations : OrderRelations
	{
		...
		/// CommerceInterfaceOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(CommerceInterfaceOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between CommerceInterfaceOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// CommerceInterfaceOrder.OrderID - Order.OrderID
		/// </summary>
