...
{
	/// <summary>Implements the static Relations variant for the entity: OdbcStore. </summary>
	public partial class OdbcStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between OdbcStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// OdbcStore.StoreID - Store.StoreID
		/// </summary>
