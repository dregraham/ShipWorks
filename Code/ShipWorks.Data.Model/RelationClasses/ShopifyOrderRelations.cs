...
{
	/// <summary>Implements the static Relations variant for the entity: ShopifyOrder. </summary>
	public partial class ShopifyOrderRelations : OrderRelations
	{
		...
		/// ShopifyOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(ShopifyOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between ShopifyOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ShopifyOrder.OrderID - Order.OrderID
		/// </summary>
