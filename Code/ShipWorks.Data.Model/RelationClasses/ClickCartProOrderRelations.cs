...
{
	/// <summary>Implements the static Relations variant for the entity: ClickCartProOrder. </summary>
	public partial class ClickCartProOrderRelations : OrderRelations
	{
		...
		/// ClickCartProOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(ClickCartProOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between ClickCartProOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ClickCartProOrder.OrderID - Order.OrderID
		/// </summary>
