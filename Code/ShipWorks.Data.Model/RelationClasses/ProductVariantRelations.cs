...
namespace ShipWorks.Data.Model.RelationClasses
{
	...
	public partial class ProductVariantRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.ProductVariantAttributeEntityUsingProductVariantID);
		...
		public virtual IEntityRelation ProductBundleEntityUsingChildProductVariantID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "IncludedInBundles" , true);
		...
		public virtual IEntityRelation ProductVariantAliasEntityUsingProductVariantID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "Aliases" , true);
		...
		/// <summary>Returns a new IEntityRelation object, between ProductVariantEntity and ProductVariantAttributeEntity over the 1:n relation they have, using the relation between the fields:
		/// ProductVariant.ProductVariantID - ProductVariantAttribute.ProductVariantID
		/// </summary>
		public virtual IEntityRelation ProductVariantAttributeEntityUsingProductVariantID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "VariantAttributes" , true);
	...
	internal static class StaticProductVariantRelations
	{
		...
		internal static readonly IEntityRelation ProductVariantAttributeEntityUsingProductVariantIDStatic = new ProductVariantRelations().ProductVariantAttributeEntityUsingProductVariantID;
