...
{
	/// <summary>Implements the static Relations variant for the entity: StampsProfile. </summary>
	public partial class StampsProfileRelations
	{
		/// <summary>CTor</summary>
		public StampsProfileRelations()
		{
		}

		/// <summary>Gets all relations of the StampsProfileEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between StampsProfileEntity and PostalProfileEntity over the 1:1 relation they have, using the relation between the fields:
		/// StampsProfile.ShippingProfileID - PostalProfile.ShippingProfileID
		/// </summary>
