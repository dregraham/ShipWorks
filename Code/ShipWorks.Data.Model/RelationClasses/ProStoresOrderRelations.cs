...
{
	/// <summary>Implements the static Relations variant for the entity: ProStoresOrder. </summary>
	public partial class ProStoresOrderRelations : OrderRelations
	{
		...
		/// ProStoresOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(ProStoresOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between ProStoresOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ProStoresOrder.OrderID - Order.OrderID
		/// </summary>
