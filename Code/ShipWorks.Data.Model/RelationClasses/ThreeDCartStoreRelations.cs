...
{
	/// <summary>Implements the static Relations variant for the entity: ThreeDCartStore. </summary>
	public partial class ThreeDCartStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ThreeDCartStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ThreeDCartStore.StoreID - Store.StoreID
		/// </summary>
