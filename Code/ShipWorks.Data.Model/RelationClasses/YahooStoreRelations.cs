...
{
	/// <summary>Implements the static Relations variant for the entity: YahooStore. </summary>
	public partial class YahooStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between YahooStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// YahooStore.StoreID - Store.StoreID
		/// </summary>
