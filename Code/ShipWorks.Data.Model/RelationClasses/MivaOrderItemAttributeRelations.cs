...
{
	/// <summary>Implements the static Relations variant for the entity: MivaOrderItemAttribute. </summary>
	public partial class MivaOrderItemAttributeRelations : OrderItemAttributeRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between MivaOrderItemAttributeEntity and OrderItemAttributeEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// MivaOrderItemAttribute.OrderItemAttributeID - OrderItemAttribute.OrderItemAttributeID
		/// </summary>
