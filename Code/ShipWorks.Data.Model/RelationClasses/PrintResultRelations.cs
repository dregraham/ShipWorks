...
{
	/// <summary>Implements the relations factory for the entity: PrintResult. </summary>
	...
	internal static class StaticPrintResultRelations
	{
		internal static readonly IEntityRelation ComputerEntityUsingComputerIDStatic = new PrintResultRelations().ComputerEntityUsingComputerID;

		/// <summary>CTor</summary>
		static StaticPrintResultRelations()
		{
		}
	}
}
