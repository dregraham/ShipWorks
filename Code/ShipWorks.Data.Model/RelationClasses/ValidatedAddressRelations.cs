...
{
	/// <summary>Implements the relations factory for the entity: ValidatedAddress. </summary>
	...
	internal static class StaticValidatedAddressRelations
	{
		internal static readonly IEntityRelation OrderEntityUsingConsumerIDStatic = new ValidatedAddressRelations().OrderEntityUsingConsumerID;
		internal static readonly IEntityRelation ShipmentEntityUsingConsumerIDStatic = new ValidatedAddressRelations().ShipmentEntityUsingConsumerID;

		/// <summary>CTor</summary>
		static StaticValidatedAddressRelations()
		{
		}
	}
}
