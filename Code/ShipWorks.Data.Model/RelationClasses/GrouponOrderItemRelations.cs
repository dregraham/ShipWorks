...
{
	/// <summary>Implements the relations factory for the entity: GrouponOrderItem. </summary>
	public partial class GrouponOrderItemRelations : OrderItemRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between GrouponOrderItemEntity and OrderItemEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy</summary>
	...
	internal static class StaticGrouponOrderItemRelations
	{
		internal static readonly IEntityRelation OrderItemAttributeEntityUsingOrderItemIDStatic = new GrouponOrderItemRelations().OrderItemAttributeEntityUsingOrderItemID;
		internal static readonly IEntityRelation OrderEntityUsingOrderIDStatic = new GrouponOrderItemRelations().OrderEntityUsingOrderID;

		/// <summary>CTor</summary>
		static StaticGrouponOrderItemRelations()
		{
		}
	}
}
