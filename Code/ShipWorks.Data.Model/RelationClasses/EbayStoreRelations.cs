...
{
	/// <summary>Implements the static Relations variant for the entity: EbayStore. </summary>
	public partial class EbayStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between EbayStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// EbayStore.StoreID - Store.StoreID
		/// </summary>
