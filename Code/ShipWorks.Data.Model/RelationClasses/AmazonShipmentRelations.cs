...
{
	/// <summary>Implements the relations factory for the entity: AmazonShipment. </summary>
	...
	internal static class StaticAmazonShipmentRelations
	{
		internal static readonly IEntityRelation ShipmentEntityUsingShipmentIDStatic = new AmazonShipmentRelations().ShipmentEntityUsingShipmentID;

		/// <summary>CTor</summary>
		static StaticAmazonShipmentRelations()
		{
		}
	}
}
