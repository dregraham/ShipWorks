...
{
	/// <summary>Implements the relations factory for the entity: EndiciaShipment. </summary>
	...
	internal static class StaticEndiciaShipmentRelations
	{
		internal static readonly IEntityRelation PostalShipmentEntityUsingShipmentIDStatic = new EndiciaShipmentRelations().PostalShipmentEntityUsingShipmentID;
		internal static readonly IEntityRelation ScanFormBatchEntityUsingScanFormBatchIDStatic = new EndiciaShipmentRelations().ScanFormBatchEntityUsingScanFormBatchID;

		/// <summary>CTor</summary>
		static StaticEndiciaShipmentRelations()
		{
		}
	}
}
