...
{
	/// <summary>Implements the static Relations variant for the entity: NetworkSolutionsOrder. </summary>
	public partial class NetworkSolutionsOrderRelations : OrderRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between NetworkSolutionsOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// NetworkSolutionsOrder.OrderID - Order.OrderID
		/// </summary>
