...
{
	/// <summary>Implements the static Relations variant for the entity: EtsyOrder. </summary>
	public partial class EtsyOrderRelations : OrderRelations
	{
		...
		/// EtsyOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(EtsyOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between EtsyOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// EtsyOrder.OrderID - Order.OrderID
		/// </summary>
