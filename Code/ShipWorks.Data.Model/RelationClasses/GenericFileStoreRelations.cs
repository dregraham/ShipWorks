...
{
	/// <summary>Implements the static Relations variant for the entity: GenericFileStore. </summary>
	public partial class GenericFileStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between GenericFileStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// GenericFileStore.StoreID - Store.StoreID
		/// </summary>
