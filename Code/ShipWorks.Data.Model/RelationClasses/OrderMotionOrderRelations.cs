...
{
	/// <summary>Implements the static Relations variant for the entity: OrderMotionOrder. </summary>
	public partial class OrderMotionOrderRelations : OrderRelations
	{
		...
		/// OrderMotionOrder.OrderID - Note.ObjectID
		/// </summary>
		public override IEntityRelation NoteEntityUsingObjectID
		{
			get
			{
				...
				relation.AddEntityFieldPair(OrderMotionOrderFields.OrderID, NoteFields.ObjectID);
		...
		/// <summary>Returns a new IEntityRelation object, between OrderMotionOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// OrderMotionOrder.OrderID - Order.OrderID
		/// </summary>
