...
{
	/// <summary>Implements the relations factory for the entity: JetOrder. </summary>
	public partial class JetOrderRelations : OrderRelations
	{
		/// <summary>CTor</summary>
		public JetOrderRelations()
		{
		}

		/// <summary>Gets all relations of the JetOrderEntity as a list of IEntityRelation objects.</summary>
		...
		public override IEntityRelation NoteEntityUsingEntityID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, NoteFields.EntityID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and OrderChargeEntity over the 1:n relation they have, using the relation between the fields:
		/// JetOrder.OrderID - OrderCharge.OrderID
		/// </summary>
		public override IEntityRelation OrderChargeEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, OrderChargeFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and OrderItemEntity over the 1:n relation they have, using the relation between the fields:
		/// JetOrder.OrderID - OrderItem.OrderID
		/// </summary>
		public override IEntityRelation OrderItemEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, OrderItemFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and OrderPaymentDetailEntity over the 1:n relation they have, using the relation between the fields:
		/// JetOrder.OrderID - OrderPaymentDetail.OrderID
		/// </summary>
		public override IEntityRelation OrderPaymentDetailEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, OrderPaymentDetailFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and OrderSearchEntity over the 1:n relation they have, using the relation between the fields:
		/// JetOrder.OrderID - OrderSearch.OrderID
		/// </summary>
		public override IEntityRelation OrderSearchEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, OrderSearchFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and ShipmentEntity over the 1:n relation they have, using the relation between the fields:
		/// JetOrder.OrderID - Shipment.OrderID
		/// </summary>
		public override IEntityRelation ShipmentEntityUsingOrderID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, ShipmentFields.OrderID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and ValidatedAddressEntity over the 1:n relation they have, using the relation between the fields:
		/// JetOrder.OrderID - ValidatedAddress.ConsumerID
		/// </summary>
		public override IEntityRelation ValidatedAddressEntityUsingConsumerID
		{
			get
			{
				...
				relation.AddEntityFieldPair(JetOrderFields.OrderID, ValidatedAddressFields.ConsumerID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and CustomerEntity over the m:1 relation they have, using the relation between the fields:
		/// JetOrder.CustomerID - Customer.CustomerID
		/// </summary>
		public override IEntityRelation CustomerEntityUsingCustomerID
		{
			get
			{
				...
				relation.AddEntityFieldPair(CustomerFields.CustomerID, JetOrderFields.CustomerID);
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("JetOrderEntity", true);
				return relation;
			}
		}
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and StoreEntity over the m:1 relation they have, using the relation between the fields:
		/// JetOrder.StoreID - Store.StoreID
		/// </summary>
		public override IEntityRelation StoreEntityUsingStoreID
		{
			get
			{
				...
				relation.AddEntityFieldPair(StoreFields.StoreID, JetOrderFields.StoreID);
		...
		/// <summary>Returns a new IEntityRelation object, between JetOrderEntity and OrderEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy</summary>
	...
	internal static class StaticJetOrderRelations
	{
		...
		internal static readonly IEntityRelation OrderPaymentDetailEntityUsingOrderIDStatic = new JetOrderRelations().OrderPaymentDetailEntityUsingOrderID;
		internal static readonly IEntityRelation OrderSearchEntityUsingOrderIDStatic = new JetOrderRelations().OrderSearchEntityUsingOrderID;
		internal static readonly IEntityRelation ShipmentEntityUsingOrderIDStatic = new JetOrderRelations().ShipmentEntityUsingOrderID;
		internal static readonly IEntityRelation ValidatedAddressEntityUsingConsumerIDStatic = new JetOrderRelations().ValidatedAddressEntityUsingConsumerID;
		internal static readonly IEntityRelation CustomerEntityUsingCustomerIDStatic = new JetOrderRelations().CustomerEntityUsingCustomerID;
		internal static readonly IEntityRelation StoreEntityUsingStoreIDStatic = new JetOrderRelations().StoreEntityUsingStoreID;

		/// <summary>CTor</summary>
		static StaticJetOrderRelations()
		{
		}
	}
}
