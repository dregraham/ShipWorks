...
{
	/// <summary>Implements the relations factory for the entity: AmazonOrderItem. </summary>
	public partial class AmazonOrderItemRelations : OrderItemRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between AmazonOrderItemEntity and OrderItemEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy</summary>
	...
	internal static class StaticAmazonOrderItemRelations
	{
		internal static readonly IEntityRelation OrderItemAttributeEntityUsingOrderItemIDStatic = new AmazonOrderItemRelations().OrderItemAttributeEntityUsingOrderItemID;
		internal static readonly IEntityRelation OrderEntityUsingOrderIDStatic = new AmazonOrderItemRelations().OrderEntityUsingOrderID;

		/// <summary>CTor</summary>
		static StaticAmazonOrderItemRelations()
		{
		}
	}
}
