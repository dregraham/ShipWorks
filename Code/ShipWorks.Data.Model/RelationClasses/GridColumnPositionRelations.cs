...
{
	/// <summary>Implements the relations factory for the entity: GridColumnPosition. </summary>
	...
	internal static class StaticGridColumnPositionRelations
	{
		internal static readonly IEntityRelation GridColumnLayoutEntityUsingGridColumnLayoutIDStatic = new GridColumnPositionRelations().GridColumnLayoutEntityUsingGridColumnLayoutID;

		/// <summary>CTor</summary>
		static StaticGridColumnPositionRelations()
		{
		}
	}
}
