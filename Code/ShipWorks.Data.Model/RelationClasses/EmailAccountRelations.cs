...
namespace ShipWorks.Data.Model.RelationClasses
{
	...
	public partial class EmailAccountRelations
	{
		...
		public EmailAccountRelations()
		{
		}

		/// <summary>Gets all relations of the EmailAccountEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EmailAccountEntity and OrderMotionStoreEntity over the 1:n relation they have, using the relation between the fields:
		/// EmailAccount.EmailAccountID - OrderMotionStore.OrderMotionEmailAccountID
		/// </summary>
		public virtual IEntityRelation OrderMotionStoreEntityUsingOrderMotionEmailAccountID
		{
			get
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "OrderMotionStore" , true);
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("OrderMotionStoreEntity", false);
				return relation;
			}
		}
