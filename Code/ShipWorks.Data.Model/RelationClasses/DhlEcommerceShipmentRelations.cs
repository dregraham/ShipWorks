...
{
	/// <summary>Implements the relations factory for the entity: DhlEcommerceShipment. </summary>
	public partial class DhlEcommerceShipmentRelations
	{
		/// <summary>CTor</summary>
		public DhlEcommerceShipmentRelations()
		{
		}

		/// <summary>Gets all relations of the DhlEcommerceShipmentEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between DhlEcommerceShipmentEntity and ShipmentEntity over the 1:1 relation they have, using the relation between the fields:
		/// DhlEcommerceShipment.ShipmentID - Shipment.ShipmentID
		/// </summary>
