...
{
	/// <summary>Implements the static Relations variant for the entity: ThreeDCartOrderItem. </summary>
	public partial class ThreeDCartOrderItemRelations : OrderItemRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ThreeDCartOrderItemEntity and OrderItemEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ThreeDCartOrderItem.OrderItemID - OrderItem.OrderItemID
		/// </summary>
