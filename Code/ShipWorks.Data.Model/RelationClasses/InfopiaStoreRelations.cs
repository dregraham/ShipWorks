...
{
	/// <summary>Implements the static Relations variant for the entity: InfopiaStore. </summary>
	public partial class InfopiaStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between InfopiaStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// InfopiaStore.StoreID - Store.StoreID
		/// </summary>
