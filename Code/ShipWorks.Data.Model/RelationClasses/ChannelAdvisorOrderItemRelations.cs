...
{
	/// <summary>Implements the static Relations variant for the entity: ChannelAdvisorOrderItem. </summary>
	public partial class ChannelAdvisorOrderItemRelations : OrderItemRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ChannelAdvisorOrderItemEntity and OrderItemEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ChannelAdvisorOrderItem.OrderItemID - OrderItem.OrderItemID
		/// </summary>
