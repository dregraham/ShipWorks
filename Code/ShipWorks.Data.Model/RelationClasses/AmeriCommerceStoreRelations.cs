...
{
	/// <summary>Implements the static Relations variant for the entity: AmeriCommerceStore. </summary>
	public partial class AmeriCommerceStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between AmeriCommerceStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// AmeriCommerceStore.StoreID - Store.StoreID
		/// </summary>
