...
{
	/// <summary>Implements the static Relations variant for the entity: ChannelAdvisorStore. </summary>
	public partial class ChannelAdvisorStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between ChannelAdvisorStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// ChannelAdvisorStore.StoreID - Store.StoreID
		/// </summary>
