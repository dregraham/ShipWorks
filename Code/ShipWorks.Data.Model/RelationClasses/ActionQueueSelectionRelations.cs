...
{
	/// <summary>Implements the relations factory for the entity: ActionQueueSelection. </summary>
	...
	internal static class StaticActionQueueSelectionRelations
	{
		internal static readonly IEntityRelation ActionQueueEntityUsingActionQueueIDStatic = new ActionQueueSelectionRelations().ActionQueueEntityUsingActionQueueID;

		/// <summary>CTor</summary>
		static StaticActionQueueSelectionRelations()
		{
		}
	}
}
