...
{
	/// <summary>Implements the static Relations variant for the entity: MagentoStore. </summary>
	public partial class MagentoStoreRelations : GenericModuleStoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between MagentoStoreEntity and GenericModuleStoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// MagentoStore.StoreID - GenericModuleStore.StoreID
		/// </summary>
