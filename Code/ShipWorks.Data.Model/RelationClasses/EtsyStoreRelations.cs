...
{
	/// <summary>Implements the relations factory for the entity: EtsyStore. </summary>
	public partial class EtsyStoreRelations : StoreRelations
	{
		/// <summary>CTor</summary>
		public EtsyStoreRelations()
		{
		}

		/// <summary>Gets all relations of the EtsyStoreEntity as a list of IEntityRelation objects.</summary>
		...
		/// <summary>Returns a new IEntityRelation object, between EtsyStoreEntity and OrderEntity over the 1:n relation they have, using the relation between the fields:
		/// EtsyStore.StoreID - Order.StoreID
		/// </summary>
		public override IEntityRelation OrderEntityUsingStoreID
		{
			...
			{
				IEntityRelation relation = new EntityRelation(SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany, "" , true);
				relation.AddEntityFieldPair(EtsyStoreFields.StoreID, OrderFields.StoreID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EtsyStoreEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between EtsyStoreEntity and OrderSearchEntity over the 1:n relation they have, using the relation between the fields:
		/// EtsyStore.StoreID - OrderSearch.StoreID
		/// </summary>
		public override IEntityRelation OrderSearchEntityUsingStoreID
		{
			get
			{
				...
				relation.AddEntityFieldPair(EtsyStoreFields.StoreID, OrderSearchFields.StoreID);
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("EtsyStoreEntity", true);
		...
		/// <summary>Returns a new IEntityRelation object, between EtsyStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy</summary>
	...
	internal static class StaticEtsyStoreRelations
	{
		...
		internal static readonly IEntityRelation OrderSearchEntityUsingStoreIDStatic = new EtsyStoreRelations().OrderSearchEntityUsingStoreID;
