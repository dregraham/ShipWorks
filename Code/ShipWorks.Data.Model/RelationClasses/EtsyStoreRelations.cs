...
{
	/// <summary>Implements the static Relations variant for the entity: EtsyStore. </summary>
	public partial class EtsyStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between EtsyStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// EtsyStore.StoreID - Store.StoreID
		/// </summary>
