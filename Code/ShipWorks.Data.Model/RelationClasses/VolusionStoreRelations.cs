...
{
	/// <summary>Implements the static Relations variant for the entity: VolusionStore. </summary>
	public partial class VolusionStoreRelations : StoreRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between VolusionStoreEntity and StoreEntity over the 1:1 relation they have, which is used to build a target per entity hierarchy, and is using the relation between the fields:
		/// VolusionStore.StoreID - Store.StoreID
		/// </summary>
