...
{
	/// <summary>Implements the relations factory for the entity: UspsScanForm. </summary>
	...
	internal static class StaticUspsScanFormRelations
	{
		internal static readonly IEntityRelation ScanFormBatchEntityUsingScanFormBatchIDStatic = new UspsScanFormRelations().ScanFormBatchEntityUsingScanFormBatchID;

		/// <summary>CTor</summary>
		static StaticUspsScanFormRelations()
		{
		}
	}
}
