...
{
	/// <summary>Implements the relations factory for the entity: PostalShipment. </summary>
	...
	internal static class StaticPostalShipmentRelations
	{
		internal static readonly IEntityRelation EndiciaShipmentEntityUsingShipmentIDStatic = new PostalShipmentRelations().EndiciaShipmentEntityUsingShipmentID;
		internal static readonly IEntityRelation ShipmentEntityUsingShipmentIDStatic = new PostalShipmentRelations().ShipmentEntityUsingShipmentID;
		internal static readonly IEntityRelation UspsShipmentEntityUsingShipmentIDStatic = new PostalShipmentRelations().UspsShipmentEntityUsingShipmentID;

		/// <summary>CTor</summary>
		static StaticPostalShipmentRelations()
		{
		}
	}
}
