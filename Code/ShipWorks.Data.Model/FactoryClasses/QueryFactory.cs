...
namespace ShipWorks.Data.Model.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the DhlEcommerceAccount entity</summary>
		public EntityQuery<DhlEcommerceAccountEntity> DhlEcommerceAccount
		{
			get { return Create<DhlEcommerceAccountEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the DhlEcommerceProfile entity</summary>
		public EntityQuery<DhlEcommerceProfileEntity> DhlEcommerceProfile
		{
		...
		{
			get { return Create<DhlEcommerceShipmentEntity>(); }
		}
		...
		/// <summary>Creates and returns a new EntityQuery for the RakutenOrder entity</summary>
		public EntityQuery<RakutenOrderEntity> RakutenOrder
		{
			get { return Create<RakutenOrderEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the RakutenOrderSearch entity</summary>
		public EntityQuery<RakutenOrderSearchEntity> RakutenOrderSearch
		{
			get { return Create<RakutenOrderSearchEntity>(); }
		}
		...
		{
			get { return Create<RakutenStoreEntity>(); }
		}
