...
namespace ShipWorks.Data.Model.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'ShipWorksDisabledDefaultIndex'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class ShipWorksDisabledDefaultIndexTypedView : TypedViewBase<ShipWorksDisabledDefaultIndexRow>, ITypedView2
			...
			
	{
		...
		static ShipWorksDisabledDefaultIndexTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ShipWorksDisabledDefaultIndexTypedView():base("ShipWorksDisabledDefaultIndex")
		{
			InitClass();
		}
#if !CF	
		...
		protected ShipWorksDisabledDefaultIndexTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new ShipWorksDisabledDefaultIndexRow(rowBuilder);
		}
		...
		{
			TableName = "ShipWorksDisabledDefaultIndex";		
		...
		{
			ShipWorksDisabledDefaultIndexTypedView cloneToReturn = ((ShipWorksDisabledDefaultIndexTypedView)(base.Clone()));
		...
		{
			return new ShipWorksDisabledDefaultIndexTypedView();
		}
#endif
		...
		{
			get { return ShipWorksDisabledDefaultIndexTypedView.CustomProperties;}
		}
		...
		{
			get { return ShipWorksDisabledDefaultIndexTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable ShipWorksDisabledDefaultIndex</summary>
	public partial class ShipWorksDisabledDefaultIndexRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END
			
	{
		#region Class Member Declarations
		private ShipWorksDisabledDefaultIndexTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal ShipWorksDisabledDefaultIndexRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((ShipWorksDisabledDefaultIndexTypedView)(this.Table));
		}
