...
namespace ShipWorks.Data.Model.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'ShipWorksMissingIndexRequest'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class ShipWorksMissingIndexRequestTypedView : TypedViewBase<ShipWorksMissingIndexRequestRow>, ITypedView2
			...
			
	{
		...
		static ShipWorksMissingIndexRequestTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public ShipWorksMissingIndexRequestTypedView():base("ShipWorksMissingIndexRequest")
		{
			InitClass();
		}
#if !CF	
		...
		protected ShipWorksMissingIndexRequestTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new ShipWorksMissingIndexRequestRow(rowBuilder);
		}
		...
		{
			TableName = "ShipWorksMissingIndexRequest";		
		...
		{
			ShipWorksMissingIndexRequestTypedView cloneToReturn = ((ShipWorksMissingIndexRequestTypedView)(base.Clone()));
		...
		{
			return new ShipWorksMissingIndexRequestTypedView();
		}
#endif
		...
		{
			get { return ShipWorksMissingIndexRequestTypedView.CustomProperties;}
		}
		...
		{
			get { return ShipWorksMissingIndexRequestTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable ShipWorksMissingIndexRequest</summary>
	public partial class ShipWorksMissingIndexRequestRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END
			
	{
		#region Class Member Declarations
		private ShipWorksMissingIndexRequestTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal ShipWorksMissingIndexRequestRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((ShipWorksMissingIndexRequestTypedView)(this.Table));
		}
